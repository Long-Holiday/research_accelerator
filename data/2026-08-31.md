...
- [JAG](#JAG) [Total: 8]
- [GIScience & RS](#GIScience & RS) [Total: 2]
...
Abstract (英文): Texture image classification plays a significant role in computer vision applications, including industrial inspection, medical image analysis, remote sensing, and object recognition. Handcrafted features can capture local texture characteristics but may have limited capability to represent complex visual patterns. In contrast, deep learning models automatically learn discriminative representations but may not fully exploit the multiscale spatial-frequency information inherent in texture images. This paper proposes a hybrid feature fusion framework, termed DWT_AlexNet_DNN, which combines Discrete Wavelet Transform (DWT) features with deep features extracted using AlexNet for texture image classification.
...
### [76] [MRIo3DS-Net: a mutually reinforcing images to 3D surface RNN-like framework for model-adaptation indoor 3D reconstruction](https://doi.org/10.1016/j.isprsjprs.2026.08.035)
...
### [77] [Fusion of hyperspectral and multisource remote sensing data using intelligent optimized ensemble learning to estimate the SOC content of seven mangrove species in China](https://doi.org/10.1016/j.isprsjprs.2026.08.009)
...
### [78] [Sparse weakly semi-supervised learning for oriented ship detection in polarimetric SAR images](https://doi.org/10.1016/j.isprsjprs.2026.08.025)
...
### [79] [SMS-Diff: Physics-aware spectral-spatial diffusion for unified geospatial multi-modal reconstruction](https://doi.org/10.1016/j.isprsjprs.2026.08.014)
...
### [80] [Pixels, points and polygons: A dataset and benchmark for multimodal building vectorization](https://doi.org/10.1016/j.isprsjprs.2026.07.027)
...
### [81] [DSTD: Dual stable triangle descriptor with sliding window optimization for LiDAR place recognition](https://doi.org/10.1016/j.isprsjprs.2026.08.015)
...
### [82] [Combining knowledge-based training data generation and deep learning algorithms for mapping surface water bodies, wetlands, and paddy rice in Northeast Asia](https://doi.org/10.1016/j.isprsjprs.2026.08.024)
...
### [83] [MMDiff: Multi-modal remote sensing image generation via cross-modality spatial feature transfer](https://doi.org/10.1016/j.isprsjprs.2026.08.018)
...
### [84] [Explicit spatial localization and task-adaptive balancing for remote sensing image-text retrieval](https://doi.org/10.1016/j.isprsjprs.2026.08.022)
...
### [85] [Editorial Board](https://doi.org/10.1016/s0924-2716(26)00428-4)
*Unknown Author*
...
### [86] [A Global, Gap-Free daily Ocean-Colour dataset (2000–2024) for robust marine ecological monitoring](https://doi.org/10.1016/j.jag.2026.105532)
...
### [87] [Viewing-geometry effects on UAV-based tree height retrieval using BRDF-derived vegetation indices](https://doi.org/10.1016/j.jag.2026.105537)
...
### [89] [A multi-task collaborative method for individual tree segmentation and multi-dimensional attribute extraction in mountainous areas using deep learning technologies](https://doi.org/10.1016/j.jag.2026.105539)
...
### [90] [Enhanced retrieval of aerosol optical/microphysical parameters for Himawari-8 geostationary satellite measurements with data-driven deep learning method](https://doi.org/10.1016/j.jag.2026.105530)
...
### [91] [Deep learning-based burned area mapping of California wildfires using Sentinel-2 and Landsat-8 imagery enhanced with super-resolution techniques](https://doi.org/10.1016/j.jag.2026.105526)
...
### [92] [Parameter-efficient multimodal adaptation of vision foundation models for remote sensing semantic segmentation](https://doi.org/10.1016/j.jag.2026.105520)
...
### [93] [Physics-Guided Machine learning approach for estimating spatiotemporally seamless FAPAR from Landsat surface reflectance](https://doi.org/10.1016/j.jag.2026.105544)
...
### [94] [Satellite mapping and hydrographic characterization of Greenland-wide proglacial rivers and lakes](https://doi.org/10.1080/15481603.2026.2720959)
...
### [95] [A multi-scale analysis of vegetation and soil burn severity drivers during the 2025 wildfire season in NW Spain](https://doi.org/10.1080/15481603.2026.2724597)
...
### [96] [Time Capsule of Testable Human Knowledge: 41 Years of Jeopardy! in a Single Free Local Model](https://arxiv.org/abs/2608.27459)
...
### [105] [Context Localization for Generalized Level-Based Evaluation in Knowledge-Based Systems](https://arxiv.org/abs/2608.27482)
...
### [114] [A Framework for Object-Centric Predictive Monitoring of Collaborative Processes](https://arxiv.org/abs/2608.27671)
...
### [119] [Credo: Reusable Declarative Primitives for Agentic Workflows](https://arxiv.org/abs/2608.27790)
...
### [130] [CoRe-MoE: Compact Reusable MoE for Continual Multimodal Instruction Tuning](https://arxiv.org/abs/2608.27867)
...
### [137] [A Deep Learning-Based Stacking Ensemble Framework for Turbofan Engine Remaining Useful Life Prediction](https://arxiv.org/abs/2608.27940)
...
### [144] [openJiuwen: Beyond Static Harnesses for Long-Horizon Coding Agents](https://arxiv.org/abs/2608.27969)
...
### [145] [Learning from Hard Prompts: Difficulty-aware Advantage Amplification in Dynamic Sampling](https://arxiv.org/abs/2608.27982)
...
### [154] [Learning to Allocate Incentives for Incentivized Advertising via Offline Model-Based Reinforcement Learning](https://arxiv.org/abs/2608.28065)
...
### [155] [SEPO: Evidence-Grounded Prompt Optimization via Structural Editing](https://arxiv.org/abs/2608.28067)
...
### [160] [Expert Knowledge & Machine Understanding: Bridging Reactome's Ontology with LLM Semantic Embeddings](https://arxiv.org/abs/2608.28178)
...
### [171] [MAIL: Memory-driven, Adaptive, Incremental, and Literature-grounded Framework for Hypothesis Generation in Chemistry](https://arxiv.org/abs/2608.28315)
...
Abstract (英文): The ever-expanding volume of the chemical literature offers unprecedented opportunities to generate novel and impactful hypotheses. However, the bottleneck lies in efficiently navigating this vast knowledge base to formulate high-quality, experimentally meaningful insights.
...
### [172] [Real-Valued Hyperdimensional Sequence Representations with Hadamard Product Binding and Shift Equivariance](https://arxiv.org/abs/2608.28334)
...
### [174] [Propagating construction-time knowledge quality into medical question answering: A framework grounded in clinical guidelines](https://arxiv.org/abs/2608.28360)
...
### [176] [EvoUndo: Recoverability-Constrained Self-Evolution for LLM Agent Harnesses](https://arxiv.org/abs/2608.28363)
...
Abstract (英文): Proof assistants such as Lean 4 promise the paradigm of formally verified mathematics, but large-scale formalization projects have faced major barriers to entry, including the need for expertise in formal verification (as well as the underlying mathematics) and the significant time required for writing formal proofs. AI coding agents have dramatically reduced these barriers; human users can now use natural language to prompt agents to write complex proofs in Lean. This opens up the intriguing possibility of internet-scale mathematical collaboration involving both humans and AI agents, where correctness is machine-checked.
...
### [183] [Learning to Use Tools: Reinforcement Learning for Tool-Integrated Mathematical Reasoning](https://arxiv.org/abs/2608.28447)
*Minghui Xu,Zi Wang*
...
### [189] [Logos: An Agent Harness on a Cross-Process Bus](https://arxiv.org/abs/2608.28553)
...
### [190] [Submerged Hazard Identification and Processing Using Augmented Image-Based Detection (SHIP-AID)](https://doi.org/10.3390/rs18172884)
...
### [191] [High-Resolution Mapping of Forest Vegetation Types Using Multiplatform Imagery and Advanced Classification Techniques](https://doi.org/10.3390/rs18172871)
...
### [192] [Hybrid Cloud Segmentation Approach Combining YOLOv8 Instance Segmentation with HSV Thresholding for Multi-Site Assessment](https://doi.org/10.3390/rs18172869)
...
### [193] [Marine Radar Oil Spill Detection Method Based on RBM and Improved Quantum Golden Jackal Optimization Algorithm](https://doi.org/10.3390/rs18172870)
...
### [194] [HSAR-DETR: Hierarchical Spatial–Frequency Attention Network for UAV Small Object Detection](https://doi.org/10.3390/rs18172861)
...
### [195] [FFR-YOLO: A Frequency-Guided Fusion Reconstruction Network for Small-Object Detection in Remote Sensing Images](https://doi.org/10.3390/rs18172872)
...
### [196] [Cross-Scale Performance Evaluation of GPM IMERG V07 Precipitation Products in a Typical Mountainous Monsoon Region](https://doi.org/10.3390/rs18172867)
...
### [197] [Aerosol Optical Depth Retrieval from MODIS Using a Physically Informed Machine Learning Framework](https://doi.org/10.3390/rs18172862)
...
### [198] [CL-LGFM: Early-Season Winter Wheat Mapping by Integrating Sentinel-2 NDVI and GPM Precipitation Data—A Case Study in the Chaohu Basin, China](https://doi.org/10.3390/rs18172860)
...
### [199] [ACBDT: SAR-Optical Cross-Modal Distillation for Sentinel-1/2 Building-Footprint Mapping in Heterogeneous Yangtze River Delta Cities](https://doi.org/10.3390/rs18172868)
...
### [200] [An Enhanced Nonlinear Grid Transformation Method for Weather Radar Echo Extrapolation](https://doi.org/10.3390/rs18172865)
...
### [201] [Retrieval of Warm-Season Radar Composite Reflectivity in Sichuan by Integrating FY-4A Multi-Channel Satellite Data and DEM Topographic Information](https://doi.org/10.3390/rs18172866)
...
### [202] [Quantitative Assessment of LiDAR Availability in Smoke-Filled Tunnels Using a Degradation Scoring Algorithm](https://doi.org/10.3390/rs18172864)
...
### [203] [HNGT-Net: Hard-Negative Guided Topology Transfer for Lightweight Hyperspectral Small-Target Detection](https://doi.org/10.3390/rs18172863)
...
### [204] [Altitude and Geographic Sensitivity Characteristics of the AIRS Satellite Spectrometer and Drift Correction Using Methane (CH4) Data](https://doi.org/10.3390/rs18172875)
...
### [205] [Target Superresolution Reconstruction Approach for Bistatic Airborne Radar Based on Joint Convolution Echo Model](https://doi.org/10.3390/rs18172873)
...
### [206] [Controlled Accuracy Degradation of Photogrammetric 3D City Models](https://doi.org/10.3390/rs18172878)
...
### [207] [Evaluating Scale Transferability and Observation-Based Calibration in High-Resolution PM2.5 Downscaling](https://doi.org/10.3390/rs18172876)
...
### [208] [SFPRNet: A Spatio-Frequency Synergistic Progressive Restoration Network for Infrared Image Destriping](https://doi.org/10.3390/rs18172877)
...
### [209] [Process-Informed Satellite-Ground Fusion for Coastal Compound Humid-Heat and Photochemical Oxidant Early Warning](https://doi.org/10.3390/rs18172874)
...
### [210] [Phenology-Aware Compound Heat and Drought Events and Potential Exposure for Summer Maize in the Huang–Huai–Hai Plain, China](https://doi.org/10.3390/rs18172893)
...
### [211] [A Closed-Form Statistical Expression for Evaluating Wind Speed and Direction Prediction Intervals from Doppler Lidar Arc Scans](https://doi.org/10.3390/rs18172879)
...
### [212] [Mapping Vegetation Alliances Using Deep Learning and Multi-Source Remote Sensing Data](https://doi.org/10.3390/rs18172880)
...
### [213] [How Accurately Can Smartphone LiDAR Document the Exposed Coarse Root Architecture of Scots Pine? A Low-Cost Field Workflow](https://doi.org/10.3390/rs18172883)
...
### [214] [Enhanced 3D Lightning Localization for Low-Frequency Radio Observations over the Tibetan Plateau](https://doi.org/10.3390/rs18172881)
...
### [215] [Insulator-DETR: A Detection Transformer Tailored for Insulator Defect Inspection Based on UAV Remote Sensing](https://doi.org/10.3390/rs18172888)
...
### [216] [Few-Shot Shrub Identification via Hyperspectral Deep Learning: A Case Study of Caragana microphylla Lam in Shrub-Encroached Grasslands](https://doi.org/10.3390/rs18172887)
...
### [217] [Semantic–Texture Complementation and Prediction-Guided SAM Fusion for Plastic Mulch Segmentation in GF-7 Imagery](https://doi.org/10.3390/rs18172885)
...
### [218] [Adaptive Fusion of Multiple Land-Cover Products for Improved Spatial Representation of Key Land Classes in Central Asia](https://doi.org/10.3390/rs18172894)
...
### [219] [SAR-Oriented and Physics-Guided Ocean Wave Spectrum Retrieval](https://doi.org/10.3390/rs18172892)
...
### [220] [Radargrammetric 3D Positioning of Pseudo Corner-Reflector Scatterers in KOMPSAT-5 Stacks with Per-Target Conditioning Diagnostics](https://doi.org/10.3390/rs18172889)
...
### [221] [Vegetation Mapping Through Multiscale Remote Sensing](https://doi.org/10.3390/rs18172882)
...
### [222] [Predictive Performance and Resampling-Based Prediction Uncertainty of a Stacking Ensemble for Landslide Susceptibility Assessment in Bayi District, China](https://doi.org/10.3390/rs18172891)
...
### [223] [Automatic Identification and Assessment of Potential Geohazards in a Wide Area Based on Multisource Remote Sensing and Deep Learning](https://doi.org/10.3390/rs18172890)
...
### [224] [What Drives the Glacier Retreat, and How Do We See It? A Study of Measurement Methods and Environmental Drivers of Retreat in the Amundsenisen Glacial System, Svalbard](https://doi.org/10.3390/rs18172886)
...
### [225] [Benchmarking Open-Access Building Footprints: A Multi-Dimensional Assessment with High-Fidelity References](https://doi.org/10.3390/rs18172895)
...
### [226] [Decoupled Aquatic Greening and Water-Area Dynamics in Northeast Siberian Arctic Thermokarst Lakes from 2000 to 2025](https://doi.org/10.3390/rs18172898)
...
### [227] [DC4Former: Orientation-Stable UAV Disaster Image Segmentation via Diagonal-Complemented C4 Consistency](https://doi.org/10.3390/rs18172896)
*Wenhao Wu,Tao Jiang*
...
### [228] [SWH Retrieval from SWOT KaRIn Data by Combining Backscattering and Interference Characteristics](https://doi.org/10.3390/rs18172899)
...
### [229] [FBR-DETR: An Efficient End-to-End Network for Real-Time Small-Object Detection in UAV Imagery](https://doi.org/10.3390/rs18172900)
...
### [230] [Automating Tree Crown Delineation in UAV Orthomosaics Without Annotation: An Annotation-Free Framework Coupling DeepForest, Segment Anything, and Unsupervised Clustering](https://doi.org/10.3390/rs18172897)
...
### [231] [On the possibility of recognising different phytoplankton functional groups and size classes in optically complex waters](https://doi.org/10.1016/j.rse.2026.115609)
...
Abstract (英文): Knowledge of the phytoplankton functional types (PFTs) and size classes (PSCs) is critical for many purposes, from early warning of potentially harmful blooms to carbon cycle studies. The feasibility of retrieving this information has been demonstrated in clear natural waters where phytoplankton is the main optically active substance. We studied the possibility of retrieving PFTs and PSCs in optically complex waters, namely in the Baltic Sea, using multiple methods: (1) recognising the group-specific marker pigments in water reflectance and/or phytoplankton absorption coefficient spectra, (2) linking particle backscattering to particle size classes, (3) using look-up-tables and (4) applying empirical algorithms linking biomass to percentage presence of PFTs and PSCs. Most of the marker pigments characteristic of a certain functional type absorb light at the same wavelengths in the blue part (400-500 nm) of the spectrum. These pigments are optically indistinguishable from one another, even when using pure pigments and hyperspectral sensors - let alone when trying to detect them within natural phytoplankton assemblages using sensors such as OLCI on Sentinel-3 or MSI on Sentinel-2. In the Baltic Sea, PSCs did not correlate with the backscattering coefficient, because most of the particulate material was mineral particles rather than organic particulate matter, and not all organic particulate matter was phytoplankton. The biomass-based approach, which retrieves all PFTs and PSCs simultaneously (e.g., as used by the Copernicus Marine Service), does not work in the Baltic Sea.Not only because the remote sensing estimates of biomass (Chl-a), from which the PFTs and PSCs are calculated, are poor. The median concentrations of the optically active substances (phytoplankton, CDOM, SPM) in the Baltic Sea are similar to the medians in the largest coastal and inland water bio-optical database, GLORIA. Consequently, the results of this study – showing that PFT/PSC retrieval from water reflectance is not possible in waters whose optical properties are not determined by phytoplankton - apply to most optically complex waters worldwide.

</details>


### [232] [Developing the optimal observation scale model for maize canopy solar-induced chlorophyll fluorescence ground measurements based on UAV system and DART model](https://doi.org/10.1016/j.rse.2026.115638)
...
### [233] [Revealing buried tectonic structures in the Gulf of Mexico using SWOT-derived marine gravity](https://doi.org/10.1016/j.rse.2026.115628)
...
### [234] [Landsat Instrument Suite (LandIS) sensor design for the Landsat 10 mission](https://doi.org/10.1016/j.rse.2026.115634)
...
### [235] [Angular anisotropy of Landsat and MODIS land surface temperature toward multi-source LST consistency](https://doi.org/10.1016/j.rse.2026.115624)
...
### [236] [FORMSpoT: Revealing fine-scale forest disturbances from nation-wide 1.5 m forest canopy height time series](https://doi.org/10.1016/j.rse.2026.115631)
...
### [237] [Identifying regional drivers of variability in SWOT-derived water surface elevation accuracy](https://doi.org/10.1016/j.rse.2026.115627)
...
### [238] [A global system for monitoring radiative transfer and directional temperatures over heterogeneous surfaces](https://doi.org/10.1016/j.rse.2026.115635)
...
### [239] [UNIQUE: UNified, high-resolution Intelligent carbon QUantification and Explanation](https://doi.org/10.1016/j.rse.2026.115636)
...
### [240] [An algorithm for the retrieval of particle backscattering, size, and suspended particulate matter in turbid coastal and estuarine waters (MOSAIC)](https://doi.org/10.1016/j.rse.2026.115629)
...
### [241] [On-demand global Landsat evapotranspiration product: development, evaluation, and dissemination](https://doi.org/10.1016/j.rse.2026.115633)

...
- [Remote Sensing](#Remote Sensing) [Total: 89]
- [RSE](#RSE) [Total: 6]
...
### [62] [Advancing global urban mapping with multimodal robustness and versatile applications](https://doi.org/10.1016/j.isprsjprs.2026.08.042)
...
### [63] [GBOV-trained Gaussian process models for Sentinel-3 SYN vegetation traits with decomposed uncertainty quantification](https://doi.org/10.1016/j.isprsjprs.2026.08.028)
...
### [64] [PELNet: A general physics-embedded learning framework for polarimetric target decomposition](https://doi.org/10.1016/j.isprsjprs.2026.08.040)
...
### [65] [Synergizing motion and depth: A distilled dual-branch network for moving infrared small target detection](https://doi.org/10.1016/j.isprsjprs.2026.08.038)
...
### [66] [Editorial Board](https://doi.org/10.1016/s0924-2716(26)00455-7)
*Unknown Author*
...
### [67] [Four decades of Landsat-based river turbidity reconstruction reveal spatially heterogeneous declines across U.S. rivers](https://doi.org/10.1016/j.isprsjprs.2026.09.007)
...
### [68] [WheatScoper: A lightweight organ-based framework for multi-view wheat phenotyping using time-series RGB images](https://doi.org/10.1016/j.isprsjprs.2026.08.039)
...
### [69] [An ensemble version of fire potential index (eFPI) integrating seasonal variability in sub-pixel fuel composition](https://doi.org/10.1016/j.isprsjprs.2026.09.010)
...
### [70] [Real-time image absolute orientation framework with Optical-GNSS data fusion for lightweight UAVs](https://doi.org/10.1016/j.isprsjprs.2026.09.005)
...
### [71] [SAAD-SR: A multi-altitude aerial object detection benchmark evaluated using an altitude-conditioned distillation detector](https://doi.org/10.1016/j.isprsjprs.2026.09.006)
...
### [72] [Space-time dynamics of rainfed wheat yield in Ethiopia: Insights from remote sensing](https://doi.org/10.1016/j.isprsjprs.2026.08.037)
...
### [73] [When multimodal fusion helps or hurts: Exploring modality synergy and cross-scene transferability for mangrove species mapping](https://doi.org/10.1016/j.isprsjprs.2026.08.036)
...
### [100] [SoK: Rethinking Jailbreaking in the Era of Agentic AI: Attacks, Defenses, and Practical Consideration](https://arxiv.org/abs/2609.12413)
...
### [103] [Do LLMs Trust the Accuser or the Accusation? Measuring Belief Shifts in Werewolf](https://arxiv.org/abs/2609.12446)
...
Abstract (英文): Editing is a core component of video production, requiring creative planning and decisions under multiple constraints. Here, we report methods for agentic tooling for automated video editing across three tasks varying in editorial goal, complexity and creativity, namely scene previews, video summaries and cinematic trailers. We evaluate the outputs and discuss implications for automation and agency.
...
### [137] [A Change Detection Network for Heterogeneous Remote Sensing Images Based on Decoupled Differential Architecture Search](https://doi.org/10.3390/rs18173060)
*Hui Li,Dengfeng Yang,Huiyao Wan,Jie Chen,Xueshi Hou,Hongcheng Zeng,Yice Cao,Wei Yang,Yingsong Li,Zhixiang Huang*
...
### [143] [Correction: Lin et al. Adaptive Sliding-Window Filtering for GNSS SPP-Aided Orbit Determination in Earth-Moon Space. Remote Sens. 2026, 18, 1646](https://doi.org/10.3390/rs18173047)
*Jinru Lin,Ying Xu,Ran Li,Ming Gao,Chao Yuan,Ye Feng,Xiang Li*
...
Abstract (英文): Additional Affiliation [...]

</details>


### [144] [A Geometry-Constrained Framework for Automatic Geometric Positioning Accuracy Assessment of Large-Scale Satellite Imagery](https://doi.org/10.3390/rs18173055)
*Jiaming Cui,Weibin Wang,Liming Fan,Shuhai Yu,Xing Zhong,Hongguang Jia,Zhenjiang Li*
...
Abstract (英文): Error in Figure [...]

</details>


### [146] [Applicability Assessment of Lutan-1 and Sentinel-1 for Potential Landslide Identification in Densely Vegetated Mountainous Areas: A Case Study of Hanyuan County, Sichuan Province, China](https://doi.org/10.3390/rs18173053)
*Liangliang Du,Weile Li,Juan Ren,Shengsen Zhou,Huiyan Lu,Hao Fu,Jiayang He,Jiasong Qin,Zhigang Li,Yunfeng Shan,Yuyang Song*
...
### [153] [Enhanced GNSS Tomography Using Synthetic Ray Augmentation Constrained by Observed Tropospheric Gradients](https://doi.org/10.3390/rs18183070)
...
### [154] [Estimation of Soil Total Nitrogen in Hemerocallis citrina Across Multiple Phenological Stages Using Partitioned Feature Bands](https://doi.org/10.3390/rs18183065)
...
### [155] [ContextFireAgent: A Multi-Role Consensus Agent for RGB Wildfire Monitoring](https://doi.org/10.3390/rs18183066)
...
### [156] [Machine-Learning-Based GNSS Signal Anomaly Classification Using COSMIC-2 POD Data](https://doi.org/10.3390/rs18183074)
...
### [157] [Multi-Temporal Phenology–Spectral Feature Optimization and Decision Tree Classification for Estuarine Wetland Vegetation Mapping](https://doi.org/10.3390/rs18183076)
...
### [158] [Landslide Identification Based on Diverse Remote-Sensing Datasets and Improved Deep Learning Models](https://doi.org/10.3390/rs18183078)
...
### [159] [An Interpretable BO-TCBDA Deep Learning Framework for Winter Wheat Yield Estimation Using Multi-Source Remote Sensing Data](https://doi.org/10.3390/rs18183061)
...
### [160] [Azimuth-Extended Spotlight SAR Based on Multifrequency Subpulse Diversity](https://doi.org/10.3390/rs18183081)
...
### [161] [Bistatic Radar Polarization Roll-Invariants and Verification on Canonical Scatterers](https://doi.org/10.3390/rs18183072)
...
### [162] [DGCR-Net: Dynamic Graph Contextual Reasoning Network for Semantic Segmentation of Remote Sensing Imagery](https://doi.org/10.3390/rs18183069)
...
### [163] [Noise-Adjusted Feature Extraction for Deep Learning-Based Classification of Hyperspectral Imagery](https://doi.org/10.3390/rs18183071)
*Yan Xu,Qian Du*
...
### [164] [Error Budget Analysis of a Sun Glint Based In-Flight Polarization Calibration Method from Blue to SWIR Spectral Bands](https://doi.org/10.3390/rs18183068)
...
### [165] [Confusion-Resistant Learning for Few-Shot Oriented Object Detection in Aerial Images](https://doi.org/10.3390/rs18183062)
...
### [166] [Evaluating Aeolus HLOS Winds and Characterizing the Low-Level Jet (LLJ) and Tropical Easterly Jet (TEJ) over the Indian Summer Monsoon: An Intercomparison with Radiosonde and Reanalysis Datasets](https://doi.org/10.3390/rs18183077)
...
### [167] [Harmonizing Fengyun-3D MERSI-II with MODIS NDVI for a Global Climate Data Record](https://doi.org/10.3390/rs18183075)
...
### [168] [Enhanced Magnetotelluric Responses of Deep Resistive Anomalies Beneath Sedimentary Cover from Deep Underground Observations](https://doi.org/10.3390/rs18183080)
...
### [169] [A Robust Distributed-Target-Based Quality Assessment Method for PolSAR Calibration Without Corner Reflectors](https://doi.org/10.3390/rs18183073)
...
### [170] [Filtered Distillation from a Large Vision Teacher for Infrared Small Target Detection](https://doi.org/10.3390/rs18183079)
...
### [171] [A Multi-Source UAV Framework for Courtyard-Scale Visual–Material Integrity Assessment in Mountain Traditional Villages](https://doi.org/10.3390/rs18183067)
...
### [172] [Spatiotemporal Displacement and Frozen-Ground Conditions of the Baishuigou Rock Glacier Revealed by InSAR and In Situ Observations](https://doi.org/10.3390/rs18183064)
...
### [173] [Multi-Sensor Mapping of Aquatic Vegetation Using Sentinel-2, SAR–Optical Fusion and Derived Spectral and SAR Indices in South Florida](https://doi.org/10.3390/rs18183086)
...
### [174] [Enhancing Our View from Above: A Downscaling Technique to Reveal Finer-Scale Urban Heat Patterns](https://doi.org/10.3390/rs18183091)
...
### [175] [Station-Based Evaluation of AI Weather Models for Near-Surface Temperature, Pressure, and Wind Forecasts over Eastern Coastal China](https://doi.org/10.3390/rs18183082)
...
### [176] [Frequency-Guided Cross-Scale Refinement Network for UAV Detection](https://doi.org/10.3390/rs18183096)
...
### [177] [A Hybrid Super-Resolution and Object Detection Framework for Small Ship Recognition in Optical Remote Sensing Imagery](https://doi.org/10.3390/rs18183092)
...
### [178] [Stratified Spatiotemporal Residual Detection of Weak Active-Fire Anomalies from VIIRS 375 m Time Series](https://doi.org/10.3390/rs18183085)
...
### [179] [Winter Wheat Yield Estimations Based on Multisource Remote Sensing Parameters and the BiLSTM–CNN Model](https://doi.org/10.3390/rs18183098)
...
### [180] [The Capacity of Generative Models to Synthesize Regional Landslide and Non-Landslide Remote Sensing Imagery Under Data-Scarce Scenarios: Insights from Multimodal Foundation Models](https://doi.org/10.3390/rs18183100)
...
### [181] [Ground-Based GNSS Atmospheric Remote Sensing for Ultra-Short-Term Wind-Power Forecasting: A Direction-Proxy-Guided Graph-Residual Approach](https://doi.org/10.3390/rs18183095)
...
### [182] [Geo-XAI Reveals Wildfire Risk Driver Differences and Spatial Heterogeneity Between Drought and Non-Drought Periods in Southwest China Mountains](https://doi.org/10.3390/rs18183089)
...
### [183] [Inshore Analysis of the Morphostructural Evolution of the Coastal Cliffs of Bessin, Basse Normandie, France](https://doi.org/10.3390/rs18183097)
...
### [184] [An Intelligent Method for Ice Thickness Identification Using Drone-Borne Ground-Penetrating Radar](https://doi.org/10.3390/rs18183087)
...
### [185] [Hyperspectral Mineral Mapping of Drill-Core Samples at Sadiola Hill Gold Deposit, Mali, West Africa: The Paragenesis of the Polyphase Alteration Mineralogy](https://doi.org/10.3390/rs18183083)
...
### [186] [Retrieval of Vegetation Nitrogen from Hyperspectral Remote Sensing: A Critical Review of Recent Methodological Advances](https://doi.org/10.3390/rs18183093)
...
### [187] [High-Spectral-Resolution Retrieval of Ultraviolet and Visible Aerosol Optical Depth Using the Pandora Spectrometer](https://doi.org/10.3390/rs18183088)
...
### [188] [Weak-Observation-Aware Multi-Object Tracking in Satellite Video with Temporal Evidence and Trajectory Reliability](https://doi.org/10.3390/rs18183084)
...
### [189] [Spatiotemporal Dynamics and Nonlinear Associations of Eco-Environmental Quality in Mining Areas Using MRSEI and an Object-Based XGBoost-SHAP Framework](https://doi.org/10.3390/rs18183099)
...
### [190] [OPMS-Seg: A UAV-Based High-Resolution Image Dataset for Semantic Segmentation of Open-Pit Coal Mine Slopes](https://doi.org/10.3390/rs18183094)
...
### [191] [An Integrated Approach for Mapping Multi-Category Abandoned Cropland Based on Swin-Unet, Land-Use Trajectories and Phenological Features in a Double-Cropping Rice Region of Southern China](https://doi.org/10.3390/rs18183090)
...
### [192] [Sentinel-2 Forel–Ule Index as a Proxy for Ecological Status in Reservoirs: A Case Study in Southern Portugal](https://doi.org/10.3390/rs18183109)
...
### [193] [Scattering–Semantic Collaborative Learning via Asymmetric Dual-Branch DINO Network for Inshore SAR Ship Detection](https://doi.org/10.3390/rs18183110)
...
### [194] [MTCPNet: A Mamba-Based Registration Network with Tri-Branch Consistency Projection for SAR-Visible Image Registration](https://doi.org/10.3390/rs18183114)
...
### [195] [Semantic-Driven Adversarial Reconstruction Learning for Open-Set Recognition in Remote Sensing Imagery](https://doi.org/10.3390/rs18183101)
...
### [196] [A Comprehensive Evaluation of Deep Learning-Based Image Super-Resolution for GCP Chip Matching Using High-Resolution Satellite Imagery](https://doi.org/10.3390/rs18183104)
...
### [197] [Assessing the Contributions and Thresholds of Multi-Source Remote Sensing Informatiuon in Vegetation Aboveground Biomass Estimation Under Optical Saturation](https://doi.org/10.3390/rs18183113)
...
### [198] [A Spatial Prior-Guided Feature Enhancement and Multi-Branch Complementary Learning Framework for Small Ship Detection in SAR Images](https://doi.org/10.3390/rs18183106)
...
### [199] [Wildfire Scar Detection in Mediterranean Chile Using Sentinel-1 InSAR Coherence and Machine Learning: The 2017 “Las Máquinas” Megafire](https://doi.org/10.3390/rs18183105)
...
### [200] [Properties and Temporal Evolution of an Elevated Arctic Liquid Fog by Lidar](https://doi.org/10.3390/rs18183111)
...
### [201] [ZOS-Net: A Lightweight RGB-T Object Detection Network with Cross-Modal Relation Enhancement and Selective Target Awareness](https://doi.org/10.3390/rs18183112)
...
### [202] [Hierarchical Sparsity-Guided DeepLassoNet: Interpretable PolSAR Feature Selection for Typical Land-Cover Classification in the Hunshandake Sandy Land](https://doi.org/10.3390/rs18183103)
...
### [203] [Plastic Greenhouse Extraction Based on Index-Guided Three-Stage Large-Factor Remote Sensing Image Super-Resolution Reconstruction](https://doi.org/10.3390/rs18183108)
...
### [204] [Deep Learning-Based Classification of Plunging Breaker Conditions Using Simulation Radar HRRP Sea-Surface Scattering Data](https://doi.org/10.3390/rs18183102)
...
### [205] [Extending Multidimensional Rao’s Quadratic Entropy to Optical–Radar Lava-Flow Mapping Using Sentinel-1 and Sentinel-2: Evidence from the 2021 La Palma Eruption](https://doi.org/10.3390/rs18183115)
...
### [206] [Crop Yield Estimation with MODIS Derived Normalized Difference Vegetation Index and Comparative Study on Crop Yield Prediction Among Linear Regression, Random Forest and Gradient Boosting as Well as CatBoost](https://doi.org/10.3390/rs18183107)
...
### [207] [Adaptive Neural Network Approaches in Remote Sensing Imagery: A Systematic Review](https://doi.org/10.3390/rs18183116)
...
### [208] [RSEI-Based Assessment of Ecological Quality in an Alpine Transitional Region Incorporating Climate Accumulation Effects and Multiscale Drivers](https://doi.org/10.3390/rs18183120)
...
### [209] [Genotype-Aware Prediction of Soybean Seed Composition from Multimodal UAV Imagery of the Standing Crop](https://doi.org/10.3390/rs18183121)
...
### [210] [Land-Use Change and Land-Cover-Based Ecological Quality Patterns in a Coal Resource-Based City: A Case Study of Ordos, China](https://doi.org/10.3390/rs18183131)
...
### [211] [Fly High or Fly Low? Selecting Time-Efficient UAV Search Strategies for High-Recall Aerial Detection](https://doi.org/10.3390/rs18183129)
...
### [212] [An Antecedent-Precipitation-Informed Soil Water Balance and Time-Aware Mamba–MoE Framework for Surface Soil Moisture Forecasting](https://doi.org/10.3390/rs18183125)
...
### [213] [Boosting Multi-Class SAR Oriented Object Detection via Geo-Topology-Guided Diffusion Synthesis](https://doi.org/10.3390/rs18183128)
...
### [214] [Multi-Timescale Variations in Cloud Water Resources and Their Relationships with Climatic and Environmental Factors over Northwest China](https://doi.org/10.3390/rs18183117)
...
### [215] [Learning Thermospheric State Evolution: An Adaptive Neural Operator Framework Based on TIE-GCM Simulations](https://doi.org/10.3390/rs18183134)
...
### [216] [Developing an Approach to Agricultural Drought Monitoring for Timor-Leste Using Space-Based Observations](https://doi.org/10.3390/rs18183122)
...
### [217] [Geometric Adaptive Matched Filtering on HPD Manifolds for Radar Target Detection](https://doi.org/10.3390/rs18183123)
...
### [218] [Dual-Space Knowledge Distillation with Cross-Geometric Feature Interaction for Hyperspectral Image Classification](https://doi.org/10.3390/rs18183127)
...
### [219] [Study on Nonlinear Driving Mechanisms of Spatiotemporal Evolution in Sanjiang Plain Wetlands Based on Explainable Learning Methods](https://doi.org/10.3390/rs18183132)
...
### [220] [Improving the Spatial Resolution of GRACE-Derived GFZ G3P Groundwater Storage Anomaly Product Through Unsupervised Deep Learning Downscaling](https://doi.org/10.3390/rs18183119)
...
### [221] [Phenology-Guided Weakly Supervised Cropping Structure Mapping with Phenological Similarity Constraints](https://doi.org/10.3390/rs18183130)
...
### [222] [Dual-Stream Spatial–Spectral Network with Nested Attention for Hyperspectral Image Classification](https://doi.org/10.3390/rs18183126)
...
### [223] [Thorpe Analysis of Atmospheric Turbulence in Parts of Inner Mongolia and Guangdong, China, Based on a Round-Trip Intelligent Sounding System](https://doi.org/10.3390/rs18183133)
...
### [224] [Applying the IOTA2 Chain for Automated 10 m Crop Map Production in a Mediterranean Environment](https://doi.org/10.3390/rs18183118)
...
### [225] [DPFS-YOLO: Missed-Detection Alleviation and False-Detection Risk Suppression for Small Objects in Complex UAV Aerial Scenes](https://doi.org/10.3390/rs18183124)
...
### [226] [A new adaptive approach for detecting crop sowing and harvesting dates from Sentinel-1 time series](https://doi.org/10.1016/j.rse.2026.115649)
...
### [227] [Monitoring global mangrove spatial evolution and functional degradation using BTSAD and CBPA methods over a 36-year dense Landsat and HLSv2.0 time series](https://doi.org/10.1016/j.rse.2026.115656)
...
### [228] [Editorial Board](https://doi.org/10.1016/s0034-4257(26)00423-2)
*Unknown Author*
...
### [229] [Next frontier of Earth observation: Quantum-enhanced multispectral remote sensing for ultra-low signal environments](https://doi.org/10.1016/j.rse.2026.115665)
...
### [230] [Unified knowledge transfer boosts individual tree crown segmentation without scene-specific labels](https://doi.org/10.1016/j.rse.2026.115646)
...
### [231] [Reconstructing cloud-free Sentinel-2 time series under complex degradations with state-driven spatio-temporal modeling](https://doi.org/10.1016/j.rse.2026.115661)
...
### [232] [Balancing solution quality and runtime in modular mobile hospital location: a hybrid approach of deep reinforcement learning and integer programming](https://doi.org/10.1080/15481603.2026.2730795)
...
### [233] [Assessing local and transferable spectral endmembers for disturbance detection in Pinus sylvestris L. forests across Spain](https://doi.org/10.1080/15481603.2026.2728760)
...
### [234] [A soil-thickness-constrained geospatial framework for reconstructing monthly shallow soil water storage across the Tibetan Plateau](https://doi.org/10.1080/15481603.2026.2728825)
...
### [235] [A multi-scale voxel-based framework for robust multisource forest LiDAR registration](https://doi.org/10.1080/15481603.2026.2724603)
...
### [236] [Aboveground woody biomass regression and uncertainty estimation from spaceborne lidar and optical datasets](https://doi.org/10.1080/15481603.2026.2707801)
...
### [237] [Nonlinear responses of net ecosystem productivity to heatwaves over the Qinghai–Tibetan Plateau: insights from climate and vegetation](https://doi.org/10.1080/15481603.2026.2728311)

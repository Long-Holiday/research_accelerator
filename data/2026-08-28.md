...
Abstract (英文): This paper introduces a unified mathematical framework for modeling information propagation through convolutional neural networks (CNNs), with the aim of connecting descriptions of physical space and information space.
...
Abstract (英文): Generative retrieval has demonstrated strong performance by directly generating product semantic identifiers (SIDs).
...
Abstract (英文): Scene reconstruction with 3D Gaussian Splatting (3DGS) has become common, however deployment remains painful as the uncompressed file sizes can be massive. Current 3DGS compression systems combine multiple strategies for file size reduction, which can obscure where gains come from and limit component reuse across training pipelines. To make the gains more transparent, we propose KISS-GS, a modular compression pipeline named after the principle of keeping things simple, designed to decouple compression entirely from training.
...
### [94] [Fusion of hyperspectral and multisource remote sensing data using intelligent optimized ensemble learning to estimate the SOC content of seven mangrove species in China](https://doi.org/10.1016/j.isprsjprs.2026.08.009)
...
### [95] [Sparse weakly semi-supervised learning for oriented ship detection in polarimetric SAR images](https://doi.org/10.1016/j.isprsjprs.2026.08.025)
...
### [96] [SMS-Diff: Physics-aware spectral-spatial diffusion for unified geospatial multi-modal reconstruction](https://doi.org/10.1016/j.isprsjprs.2026.08.014)
...
### [97] [Pixels, points and polygons: A dataset and benchmark for multimodal building vectorization](https://doi.org/10.1016/j.isprsjprs.2026.07.027)
...
### [98] [DSTD: Dual stable triangle descriptor with sliding window optimization for LiDAR place recognition](https://doi.org/10.1016/j.isprsjprs.2026.08.015)
...
### [99] [Combining knowledge-based training data generation and deep learning algorithms for mapping surface water bodies, wetlands, and paddy rice in Northeast Asia](https://doi.org/10.1016/j.isprsjprs.2026.08.024)
...
### [100] [On the possibility of recognising different phytoplankton functional groups and size classes in optically complex waters](https://doi.org/10.1016/j.rse.2026.115609)
...
### [101] [Revealing buried tectonic structures in the Gulf of Mexico using SWOT-derived marine gravity](https://doi.org/10.1016/j.rse.2026.115628)
...
### [103] [Angular anisotropy of Landsat and MODIS land surface temperature toward multi-source LST consistency](https://doi.org/10.1016/j.rse.2026.115624)
...
### [104] [FORMSpoT: Revealing fine-scale forest disturbances from nation-wide 1.5 m forest canopy height time series](https://doi.org/10.1016/j.rse.2026.115631)
...
### [105] [Identifying regional drivers of variability in SWOT-derived water surface elevation accuracy](https://doi.org/10.1016/j.rse.2026.115627)
...
### [106] [Satellite mapping and hydrographic characterization of Greenland-wide proglacial rivers and lakes](https://doi.org/10.1080/15481603.2026.2720959)
...
### [107] [Submerged Hazard Identification and Processing Using Augmented Image-Based Detection (SHIP-AID)](https://doi.org/10.3390/rs18172884)
...
### [108] [Hyper-VMIL: Topology-Aware Variational Hypergraph Multiple-Instance Learning for Weakly Supervised Hyperspectral Target Detection](https://doi.org/10.3390/rs18162838)
...
### [109] [Tracking Total Precipitable Water Vapor: A Multi-Instrument Comparative Analysis](https://doi.org/10.3390/rs18162840)
...
### [110] [Mitigating Class Imbalance and False-Negative Supervision in Remote Sensing Semantic Segmentation Using Object-Centric Patch Sampling](https://doi.org/10.3390/rs18162844)
...
### [111] [Weakly Supervised Remote Sensing Segmentation via Decoupled Cross-Modal Distillation and Semantic-Guided Refinement](https://doi.org/10.3390/rs18162843)
...
### [112] [Development and Verification of an Automatic Tower-Based SIF Observation System Based on Narrow Field-of-View Scanning and DOAS Atmospheric Correction](https://doi.org/10.3390/rs18162837)
...
### [113] [Integrating Kernel-Based Vegetation Indices and Ensemble Learning for Mangrove Canopy Height Mapping Using GEDI and Sentinel Data](https://doi.org/10.3390/rs18162834)
...
### [114] [DA-GDNet: A Data-Augmented Gather-and-Distribute Network for Robust SAR Target Detection](https://doi.org/10.3390/rs18162839)
...
### [115] [High-Resolution Mapping and Interpretation of Stable Urban Surface CO2 Concentration Patterns Using CSF-Processed Mobile Observations and Multiscale Remote Sensing in Shenzhen, China](https://doi.org/10.3390/rs18162836)
...
### [116] [Dual-Level Spatial–Frequency Collaborative Detector for Oriented Object Detection in Remote Sensing Images](https://doi.org/10.3390/rs18162845)
...
### [117] [HRRP Reconstruction Method for Coded Interrupted Sampling Radar Echoes Based on Multi-Frame Sequential Priors](https://doi.org/10.3390/rs18162842)
...
### [118] [SFSMamba-DETR: Selective Feature Scanning with State Space Models and Dual-Scale Window Attention for Remote Sensing Object Detection](https://doi.org/10.3390/rs18162835)
...
### [119] [Sharing Cultural Values Through 3D Point-Cloud-Based Documentation of Transylvanian Heritage](https://doi.org/10.3390/rs18162841)
...
### [120] [Spatio-Temporal Dynamics of Mining-Induced Surface Disturbance and Backfilling in Open-Pit Coal Mines Across China’s Arid and Desert Regions (1990–2023)](https://doi.org/10.3390/rs18172858)
...
### [121] [Spatiotemporal Evolution and Multi-Factor Driving Mechanism of Land Subsidence in Shanghai Hongqiao Transport Hub Core Area Based on SBAS-InSAR (2015–2024)](https://doi.org/10.3390/rs18172848)
...
### [122] [High-Resolution Mapping of Forest Vegetation Types Using Multiplatform Imagery and Advanced Classification Techniques](https://doi.org/10.3390/rs18172871)
...
### [123] [Hybrid Cloud Segmentation Approach Combining YOLOv8 Instance Segmentation with HSV Thresholding for Multi-Site Assessment](https://doi.org/10.3390/rs18172869)
...
### [124] [Three-Dimensional Displacement Analysis and Statistical Modeling of the Pubugou Rockfill Dam Using Multi-Track InSAR](https://doi.org/10.3390/rs18172853)
...
### [125] [Marine Radar Oil Spill Detection Method Based on RBM and Improved Quantum Golden Jackal Optimization Algorithm](https://doi.org/10.3390/rs18172870)
...
### [126] [HSAR-DETR: Hierarchical Spatial–Frequency Attention Network for UAV Small Object Detection](https://doi.org/10.3390/rs18172861)
...
### [127] [FFR-YOLO: A Frequency-Guided Fusion Reconstruction Network for Small-Object Detection in Remote Sensing Images](https://doi.org/10.3390/rs18172872)
...
### [128] [SeaScope: A Transparent and Reproducible LLM-Assisted Framework for Maritime Earth Observation Analysis](https://doi.org/10.3390/rs18172849)
...
### [129] [Towards Lightweight and Accurate Remote-Sensing Image Super-Resolution via Reparameterized Feature Enhancement Network](https://doi.org/10.3390/rs18172850)
...
### [130] [Cross-Domain Mixup for Parcel-Level Crop Mapping on a Multi-Year Sentinel-2 Dataset from Slovakia](https://doi.org/10.3390/rs18172857)
...
### [131] [Cross-Scale Performance Evaluation of GPM IMERG V07 Precipitation Products in a Typical Mountainous Monsoon Region](https://doi.org/10.3390/rs18172867)
...
### [132] [Aerosol Optical Depth Retrieval from MODIS Using a Physically Informed Machine Learning Framework](https://doi.org/10.3390/rs18172862)
...
### [133] [Digital Mapping of Soil and Water Indicators in Arid Regions Driven by High-Dimensional Environmental Covariates: A Comprehensive Evaluation of Metaheuristic Feature Selection and Hybrid Deep Learning Frameworks](https://doi.org/10.3390/rs18172859)
...
### [134] [CL-LGFM: Early-Season Winter Wheat Mapping by Integrating Sentinel-2 NDVI and GPM Precipitation Data—A Case Study in the Chaohu Basin, China](https://doi.org/10.3390/rs18172860)
...
### [135] [Assessing Conservation Effectiveness of the Hainan Tropical Rainforest National Park Using Multi-Temporal Remote Sensing and Landscape Metrics](https://doi.org/10.3390/rs18172846)
...
### [136] [ACBDT: SAR-Optical Cross-Modal Distillation for Sentinel-1/2 Building-Footprint Mapping in Heterogeneous Yangtze River Delta Cities](https://doi.org/10.3390/rs18172868)
...
### [137] [A Novel Calibration Method for Networked X-Band Radar Based on Opposing RHI Scans](https://doi.org/10.3390/rs18172854)
...
### [138] [An Enhanced Nonlinear Grid Transformation Method for Weather Radar Echo Extrapolation](https://doi.org/10.3390/rs18172865)
...
### [139] [Evaluation of the Fengyun-4B Downward Surface Shortwave Radiation (DSSR) Product over Guangxi Using a Dense Photovoltaic Station Network](https://doi.org/10.3390/rs18172852)
...
### [140] [HR2SIOD-CL: A Compressed Learning Framework for Object Detection in High-Resolution Remote Sensing Images](https://doi.org/10.3390/rs18172851)
...
### [141] [Retrieval of Warm-Season Radar Composite Reflectivity in Sichuan by Integrating FY-4A Multi-Channel Satellite Data and DEM Topographic Information](https://doi.org/10.3390/rs18172866)
...
### [142] [Quantitative Assessment of LiDAR Availability in Smoke-Filled Tunnels Using a Degradation Scoring Algorithm](https://doi.org/10.3390/rs18172864)
...
### [143] [Reliability-Aware Adaptive Band Gating with Domain Expansion for Cross-Scene Hyperspectral Band Selection](https://doi.org/10.3390/rs18172855)
...
### [144] [Spatiotemporal Dynamics and Climatic Responses of Rubber Plantations’ Aboveground Biomass in Western Hainan Island Based on Multi-Source Remote Sensing and Explainable Machine Learning](https://doi.org/10.3390/rs18172856)
...
### [145] [A New Method for Extracting Short-Term Deformation Signals from InSAR Time Series and Its Application to the Haihe River ‘23·7’ Basin-Wide Extreme Flood Event](https://doi.org/10.3390/rs18172847)
...
### [146] [HNGT-Net: Hard-Negative Guided Topology Transfer for Lightweight Hyperspectral Small-Target Detection](https://doi.org/10.3390/rs18172863)
...
### [147] [Altitude and Geographic Sensitivity Characteristics of the AIRS Satellite Spectrometer and Drift Correction Using Methane (CH4) Data](https://doi.org/10.3390/rs18172875)
...
### [148] [Target Superresolution Reconstruction Approach for Bistatic Airborne Radar Based on Joint Convolution Echo Model](https://doi.org/10.3390/rs18172873)
...
### [149] [Controlled Accuracy Degradation of Photogrammetric 3D City Models](https://doi.org/10.3390/rs18172878)
...
### [150] [Evaluating Scale Transferability and Observation-Based Calibration in High-Resolution PM2.5 Downscaling](https://doi.org/10.3390/rs18172876)
...
### [151] [SFPRNet: A Spatio-Frequency Synergistic Progressive Restoration Network for Infrared Image Destriping](https://doi.org/10.3390/rs18172877)
...
### [152] [Process-Informed Satellite-Ground Fusion for Coastal Compound Humid-Heat and Photochemical Oxidant Early Warning](https://doi.org/10.3390/rs18172874)
...
### [153] [Phenology-Aware Compound Heat and Drought Events and Potential Exposure for Summer Maize in the Huang–Huai–Hai Plain, China](https://doi.org/10.3390/rs18172893)
...
### [154] [A Closed-Form Statistical Expression for Evaluating Wind Speed and Direction Prediction Intervals from Doppler Lidar Arc Scans](https://doi.org/10.3390/rs18172879)
...
### [155] [Mapping Vegetation Alliances Using Deep Learning and Multi-Source Remote Sensing Data](https://doi.org/10.3390/rs18172880)
...
### [156] [How Accurately Can Smartphone LiDAR Document the Exposed Coarse Root Architecture of Scots Pine? A Low-Cost Field Workflow](https://doi.org/10.3390/rs18172883)
...
### [157] [Enhanced 3D Lightning Localization for Low-Frequency Radio Observations over the Tibetan Plateau](https://doi.org/10.3390/rs18172881)
...
### [158] [Insulator-DETR: A Detection Transformer Tailored for Insulator Defect Inspection Based on UAV Remote Sensing](https://doi.org/10.3390/rs18172888)
...
### [159] [Few-Shot Shrub Identification via Hyperspectral Deep Learning: A Case Study of Caragana microphylla Lam in Shrub-Encroached Grasslands](https://doi.org/10.3390/rs18172887)
...
### [160] [Semantic–Texture Complementation and Prediction-Guided SAM Fusion for Plastic Mulch Segmentation in GF-7 Imagery](https://doi.org/10.3390/rs18172885)
...
### [161] [Adaptive Fusion of Multiple Land-Cover Products for Improved Spatial Representation of Key Land Classes in Central Asia](https://doi.org/10.3390/rs18172894)
...
### [162] [SAR-Oriented and Physics-Guided Ocean Wave Spectrum Retrieval](https://doi.org/10.3390/rs18172892)
...
### [163] [Radargrammetric 3D Positioning of Pseudo Corner-Reflector Scatterers in KOMPSAT-5 Stacks with Per-Target Conditioning Diagnostics](https://doi.org/10.3390/rs18172889)
...
### [164] [Vegetation Mapping Through Multiscale Remote Sensing](https://doi.org/10.3390/rs18172882)
...
### [165] [Predictive Performance and Resampling-Based Prediction Uncertainty of a Stacking Ensemble for Landslide Susceptibility Assessment in Bayi District, China](https://doi.org/10.3390/rs18172891)
...
### [166] [Automatic Identification and Assessment of Potential Geohazards in a Wide Area Based on Multisource Remote Sensing and Deep Learning](https://doi.org/10.3390/rs18172890)
...
### [167] [What Drives the Glacier Retreat, and How Do We See It? A Study of Measurement Methods and Environmental Drivers of Retreat in the Amundsenisen Glacial System, Svalbard](https://doi.org/10.3390/rs18172886)
...
### [168] [A Global, Gap-Free daily Ocean-Colour dataset (2000–2024) for robust marine ecological monitoring](https://doi.org/10.1016/j.jag.2026.105532)
...
### [169] [Radiometric fingerprinting of object surfaces using mobile laser scanning and semantic 3D road space models](https://doi.org/10.1016/j.jag.2026.105533)
...
### [170] [Remote SAMsing: From segment anything to segment everything](https://doi.org/10.1016/j.jag.2026.105528)
...
### [171] [Satellite tracking of long-term spatiotemporal dynamics in China’s largest seagrass meadow](https://doi.org/10.1016/j.jag.2026.105536)
...
### [172] [Viewing-geometry effects on UAV-based tree height retrieval using BRDF-derived vegetation indices](https://doi.org/10.1016/j.jag.2026.105537)
...
### [173] [Optimal soil dielectric model map for global soil moisture retrieval from SMAP](https://doi.org/10.1016/j.jag.2026.105543)
...
### [174] [A multi-task collaborative method for individual tree segmentation and multi-dimensional attribute extraction in mountainous areas using deep learning technologies](https://doi.org/10.1016/j.jag.2026.105539)
...
### [175] [Enhanced retrieval of aerosol optical/microphysical parameters for Himawari-8 geostationary satellite measurements with data-driven deep learning method](https://doi.org/10.1016/j.jag.2026.105530)
...
### [176] [Deep learning-based burned area mapping of California wildfires using Sentinel-2 and Landsat-8 imagery enhanced with super-resolution techniques](https://doi.org/10.1016/j.jag.2026.105526)
...
### [177] [EduRiskX: A Neuro-Symbolic Framework with F-Logic Reasoning for Early Academic Risk Prediction](https://arxiv.org/abs/2608.26107)
...
### [189] [Selection Bias Correction in Retail Intelligence](https://arxiv.org/abs/2608.26156)
...
### [209] [Agent Mesh: Reliability Primitives for Non-Idempotent Agent Delegation - Identity Adequacy and Evidence Adequacy](https://arxiv.org/abs/2608.26225)
...
### [216] [FaithSieve: Fine-Grained Evaluation of Math Proofs with Faithful Formal Evidence](https://arxiv.org/abs/2608.26310)
...
### [219] [Don't Overthink, Don't Underthink: Toward Adaptive Reasoning in Agentic AI](https://arxiv.org/abs/2608.26442)
...
### [220] [PILOT in the Loop: Live Self-Improvement for Long-Horizon Agents](https://arxiv.org/abs/2608.26530)
...
### [221] [Multi2AV-Safety: Benchmarking Safety in Multimodal-to-Audio-Video Generation](https://arxiv.org/abs/2608.26535)
...
### [226] [Five Primitives for Governing Autonomous AI Agents at Runtime](https://arxiv.org/abs/2608.26696)
...
### [242] [Learning-Augmented Online Allocation under Unreliable Advice: Robustness, Exposure Fairness, and Distribution Shift](https://arxiv.org/abs/2608.26889)
*Fredy Pokou*
...
Abstract (英文): Learning-augmented algorithms improve online decisions using predictions, but unreliable advice may harm efficiency and fairness. We study an online allocation problem with finite candidate sets, irreversible decisions, and exposure constraints. We propose a robust and fair rule combining advice with a conservative fallback and fairness correction. Under bounded-error assumptions, we prove consistency and robustness with loss proportional to prediction error. Experiments show stability under adversarial advice and significant reductions in exposure disparity.

</details>


### [243] [AI agents in Algorithmic Electricity Markets: On the Emergence of Tacit Collusion](https://arxiv.org/abs/2608.26896)
...
### [253] [pro-team at LLMs4OL 2026 Tasks Flagship and Reuse: Retrieval-Augmented Generation and Vocabulary-Constrained Filtering for Ontology Learning](https://arxiv.org/abs/2608.27101)
...
### [259] [Thomson: Continual Learning of Frontier Models for SovereignAI](https://arxiv.org/abs/2608.27147)
...
Abstract (英文): Currently used sepsis severity indices rely on fixed variables and weights established decades ago, which are coarsely discretized and calibrated to a cohort that no longer reflects contemporary critical care. No alternative learned directly from patient trajectories is in routine use. We conducted a retrospective two-cohort study on a total of 29,116 and 7,691 adult patients meeting Sepsis-3 criteria from two hospital systems in Massachusetts and Georgie, respectively.
...
### [271] [Mechanistic Reaction Prediction via Discrete Flow Matching on Graph-Structured Electron Occupation](https://arxiv.org/abs/2608.27429)
...
Abstract (英文): Chemical reactions are fundamentally transformations in electron space, yet most machine learning approaches model them either through \textit{de novo} generation of product molecules or through heuristic graph edits that operate directly on molecular topology.
...
### [272] [WikiSkill: Compiling Agent Experience into Persistent Knowledge for Skill Evolution](https://arxiv.org/abs/2608.27454)

...
- [ISPRS J P&RS](#ISPRS J P&RS) [Total: 10]
- [cs.AI](#cs.AI) [Total: 119]
- [GIScience & RS](#GIScience & RS) [Total: 7]
- [Remote Sensing](#Remote Sensing) [Total: 38]
- [RSE](#RSE) [Total: 9]
- [JAG](#JAG) [Total: 8]
...
Abstract (英文): We introduce PhiZero, a physical world model built around physical language, a compact discrete representation of world-state transitions. Existing physical world models typically predict future videos directly in pixel space, leaving the underlying world dynamics implicit within high-dimensional visual predictors. Motivated by humans' ability to abstract predictive structure from visual experience and organize it in natural language for explicit reasoning, we learn physical language from in-the-wild videos through self-supervision and use it to explicitly reason about how the physical world evolves. Accordingly, PhiZero adopts a reason-then-render paradigm: it first infers future world evolution as a physical-language sequence and then renders the inferred transitions into videos. Extensive experiments across generation and understanding benchmarks validate the ability of PhiZero to model physically coherent world evolution. We further show its potential for realistic and interactive world modeling, fine-grained action-conditioned simulation, and zero-shot motion transfer.
...
### [108] [MapGlue: Multimodal remote sensing image matching](https://doi.org/10.1016/j.isprsjprs.2026.07.007)
...
### [109] [Deep learning-based decoupling of hydro-meteorological signals from Cheonji caldera lake water levels for volcanic precursor detection](https://doi.org/10.1016/j.isprsjprs.2026.07.006)
*Eu-Ru Lee,Sunghwan Park,Won-Kyung Baek,Hyung-Sup Jung,Ha-Seong Lee,Sun‐Cheon Park*
...
Abstract (英文): Although lake level fluctuations in caldera lakes serve as critical precursors reflecting the hydro-thermal instability of magma systems, their utility as precise monitoring indicators has been limited because volcanic signals are often masked by meteorological variability, such as precipitation and evaporation. This study proposes a novel deep learning-based framework that integrates long-term Landsat and Sentinel-2 optical satellite imagery (1987–2021) to extract candidate volcanic water-level anomalies by decoupling meteorological factors. The proposed framework consists of three key steps: 1) precise segmentation of water bodies from heterogeneous satellite imagery using a multi-encoder SiU-Net model, followed by DEM-referenced water level retrieval via integration with the Copernicus DEM and independent cross-validation against ICESat-2 ATL13 altimetry; 2) quantitative modeling and decoupling of nonlinear meteorological effects through a five-variable (T, H, PP, DiY, SAT) LSTM-based Multivariate Influence Correction Model (MICM) driven by ERA5-Land reanalysis data; and 3) identification of volcanic activity periods using the finally corrected time-series water-level anomalies. Experimental results demonstrate the robustness of the constructed time series, with SiU-Net achieving a high F1-score of over 0.99 for both Landsat and Sentinel-2 imagery. The ERA5-Land-driven MICM achieved a water-level RMSE of 0.4284 m, and the resulting anomaly distribution (μ = +0.063 m, σ = 0.424 m) yielded a 99% confidence interval of ±1.092 m for outlier detection. Three statistically significant water-level anomalies — at DOY 248 of 2000, DOY 216 of 2006, and DOY 267 of 2010 — temporally aligned with independently documented Mt. Baekdu unrest periods, including the 2002–2005 magma injection episode and its 2006–2010 continued-injection phase. These findings suggest that the proposed satellite-based hydrological monitoring approach using deep learning can serve as a complementary screening tool for volcanic surveillance alongside traditional geophysical observations.

</details>


### [110] [Graph-Regularized Point-to-Trajectory Association for RS-AIS fusion toward maritime moving-ship identification and spatial refinement](https://doi.org/10.1016/j.isprsjprs.2026.07.005)
*Du Xin,Ruofei Zhong,Marco Scaioni,Marco Gianinetto,Shiyue Zhang,Qingyang Li,Zhenxing Sun,Chengming Li*
...
### [111] [ParkingTwin: Training-free streaming 3D reconstruction for parking-lot digital twins](https://doi.org/10.1016/j.isprsjprs.2026.07.009)
*Xinhao Liu,Yu Wang,Xiansheng Guo,Xiansheng Guo,Gordon Owusu Boateng,Yu Cao,Haonan Si,Xiaoyan Guo,Xiaoyan Guo,Nirwan Ansari*
...
### [112] [Deep unrolling for unified pansharpening with satellite-specific and image-adaptive priors](https://doi.org/10.1016/j.isprsjprs.2026.07.016)
...
### [113] [Advancing hyperspectral nutrient modeling through transfer learning: Insights from foliar N–P–K estimation in cranberries](https://doi.org/10.1016/j.isprsjprs.2026.07.022)
...
### [114] [GeoGS: Geometric Prior-Guided Gaussian Splatting for robust urban reconstruction from sparse views](https://doi.org/10.1016/j.isprsjprs.2026.07.011)
...
### [115] [Beyond coherence: scale-invariant phase quality estimation via gradient-field modeling](https://doi.org/10.1016/j.isprsjprs.2026.07.015)
...
### [116] [Aerial–ground LiDAR place recognition with patch-level self-supervised learning and expanded reciprocal re-ranking](https://doi.org/10.1016/j.isprsjprs.2026.07.018)
...
### [117] [DAChanger: A remote sensing change detector inspired by differential amplifier circuit for signal energy Decoupling and geometric consistency](https://doi.org/10.1016/j.isprsjprs.2026.07.021)
...
### [118] [Multi-Head Attention Residuals](https://arxiv.org/abs/2607.27230)
...
Abstract (英文): Agent self-evolution has primarily focused on learning how to act, while overlooking an equally important capability: learning to discover what an agent does not know. Existing approaches typically assume that failure discovery is given, focusing on how to repair failures once they are identified. We ask whether blind-spot diagnosis itself can be learned. We thus study diagnosis as an agent capability separate from execution, and exclude two alternative sources of progress: executor adaptation and human supervision. Under these constraints, performance cannot improve through executor updates or annotated examples, forcing all improvements to originate from the learned diagnostic capability. We propose SkillMentor, which trains a Mentor policy via reinforcement learning to generate diagnostic tasks, identify recurrent failure modes, and curate them into reusable corrective skills. Across AppWorld and BFCLv3, SkillMentor improves executor performance by an average of 44.2%. These results suggest that blind-spot diagnosis is a learnable capability, enabling self-evolution without updating executor weights or relying on human-curated data.
...
### [132] [INCLAIR: Inception-Based Longitudinal Clinical Anomaly Detection with Informed Reasoning](https://arxiv.org/abs/2607.27487)
...
### [138] [Evaluating Agentic Bioinformatics through Function, Evidence, and Validation](https://arxiv.org/abs/2607.27556)
...
### [139] [DeepResearch Agent System](https://arxiv.org/abs/2607.27562)
...
### [142] [Wiring diagram extraction and gluing: a case study in classifying figure skating jumps using 3D dataset](https://arxiv.org/abs/2607.27598)
...
### [148] [HealthCAT: An Interpretable Encoder-only Transformer Framework for Health Indicator Prediction and Temporal Interpretation of Wearable Sensor Data](https://arxiv.org/abs/2607.27635)
...
### [155] [MECA: A Mechanism-Centered Agent for Constructing Well-Specified and Valuable Mathematical Conjectures](https://arxiv.org/abs/2607.27709)
...
### [160] [Annotating Topical Legal Insights from Case Proceedings](https://arxiv.org/abs/2607.27792)
...
### [164] [MemTxn: A Transaction Boundary for Source-Supported Updates and Complete-State Recovery in Agent Memory](https://arxiv.org/abs/2607.27834)
...
### [166] [Virtual Process Dossier: A Process-Aware Data Catalogue](https://arxiv.org/abs/2607.27840)
...
### [169] [Orca: Neural Operators for Causal Reasoning in Continuous Time](https://arxiv.org/abs/2607.27867)
...
### [172] [Not All Tokens Deserve Equal Credit: Counterfactual Sensitivity Credit Reallocation for Long-CoT Reasoning](https://arxiv.org/abs/2607.27888)
...
### [175] [A Cross-Architecture Audit of Direction-Based Inference-Time Defences in Vision-Language Models](https://arxiv.org/abs/2607.27910)
...
Abstract (英文): Credit assignment is a fundamental challenge in cooperative multi-agent reinforcement learning, particularly in embodied AI settings characterized by limited and delayed feedback as well as dynamically changing numbers of active agents. We propose MARS-RA, a framework that reformulates credit assignment as a rank aggregation problem using contribution-based pairwise comparisons among agents generated by large multimodal models. This shift from absolute to relative estimation ensures robustness against noise and dynamic agent participation, converting comparison results into contribution scores for potential-based reward shaping. We provide theoretical justification for the convergence and robustness of the proposed framework, and show that Shapley values can be used as an interpretive reference. Experimental results on challenging tasks of different types indicate that MARS-RA can guide agents toward effective cooperation.
...
### [197] [SciDataSailor: Deep Scientific Data Exploring](https://arxiv.org/abs/2607.28098)
...
### [202] [AgenticASR: Refining Speech Recognition in Real-World Scenarios via an Agentic Approach](https://arxiv.org/abs/2607.28175)
...
### [205] [CDAE: Enhancing Perturbation Robustness in Pretrained Language Models with Contrastive Denoising](https://arxiv.org/abs/2607.28236)
...
### [206] [AI and Authenticity in Islamic Research: A Critical Evaluation of Generative AI Reliability, Hallucination, and Source Fidelity in Quranic, Hadith, and Fiqh Knowledge](https://arxiv.org/abs/2607.28237)
...
### [207] [Operationally Guided Placement-Aware Learning for Industrial Online 3D Bin Packing](https://arxiv.org/abs/2607.28257)
...
### [211] [One Human, $N$ Agents: Audit-Budget Allocation for LLM Agent Fleets under Miscalibrated, Correlated Confidence](https://arxiv.org/abs/2607.28317)
...
Abstract (英文): Large language models (LLMs) are increasingly required to integrate multiple sources of information that may be inconsistent or conflicting. However, there is still a lack of controllable and attributable methods for analyzing how models resolve conflicts between competing specifications. We propose a controlled experimental framework for studying model preferences under conflicting specifications. By constructing specifications with explicit conflicts, the framework enables model choices between competing specifications to be directly observed and analyzed. A symmetry-based design further reduces confounding factors, allowing preferences across representation types to be compared systematically.
...
### [218] [GLM-RAG: Graph Language Models for Graph-Based Retrieval-Augmented Generation](https://arxiv.org/abs/2607.28397)
...
### [224] [SVR: Self-Verifying Refinement via Joint Verdict-Confidence Reinforcement Learning for Adaptive Test-Time Compute](https://arxiv.org/abs/2607.28457)
...
### [229] [SCOPE: Supply-Chain Operations through Coupled Policies for End-to-End Coordination](https://arxiv.org/abs/2607.28488)
...
### [232] [Selective Credibility-Limited Belief Update](https://arxiv.org/abs/2607.28523)
...
### [234] [Rethinking Inference-Time Scaling in Local Computer-Use Agents: Failure Modes and Compute Tradeoffs](https://arxiv.org/abs/2607.28573)
...
### [237] [Landsat-derived gap-free monthly 30-m dataset (2000–2021) unraveling intra-annual surface water dynamics on the Tibetan Plateau](https://doi.org/10.1080/15481603.2026.2707752)
*Zhongxiang Liu,Qiuyu Yao,Shihan Shan,Dejun Zhu,Lei Wang,Danxun Li,Guiliang Zhong,Fuling Wen*
...
Abstract (英文): Validation of spatial prediction models is still dominated by global metrics such as root mean square error (RMSE), which summarize average model performance but can underrepresent the spatial concentration and heterogeneity of prediction errors. To complement existing residual-diagnostic approaches, we propose the Generalised Spatial Error (GSE), a validation metric that combines local RMSE with local error variance and assigns greater weight to neighborhoods with unstable performance. We evaluated GSE using nine predictive models for vascular plant species richness in the Murray–Darling Basin (MDB), Australia. Across models, GSE was consistently 20.29–24.40% higher than RMSE, reflecting the total increase from variance-weighted aggregation of local error magnitude and instability. Maps of local error variance further showed that predictive instability was concentrated mainly in the species-rich eastern part of the basin. Sensitivity analyses based on geographical area, elevation and species-richness stratification yielded consistent differences between GSE and RMSE, supporting the robustness of GSE across contrasting environmental settings. These results suggest that GSE provides a useful complementary metric for diagnosing spatial reliability beyond average prediction accuracy and for identifying locations where model predictions are less dependable for environmental assessment and decision-making.

</details>


### [239] [Improved estimation of daily surface all-wave net radiation from FY3D MERSI-II data based on pseudo-label learning](https://doi.org/10.1080/15481603.2026.2702169)
*Yingping Chen,Bo Jiang,Shaopeng Li,Y ZHAO,Xiuwan Yin,Xiang Zhao,Qian Wang,Kun Jia,Xi Zhang,Yunjun Yao*
...
### [241] [High-precision monthly monitoring of surface water dynamics in Central Asia from 1990 to 2022 using remote sensing gap-filling techniques](https://doi.org/10.1080/15481603.2026.2689680)
...
### [242] [MAPSRNet: a task-oriented super-resolution network that enhances building extraction beyond raw high-resolution imagery](https://doi.org/10.1080/15481603.2026.2704291)
...
### [243] [Monitoring water surface elevation and river width using SWOT: insights into observation geometry, phase noise, and geomorphic modulation in the Yangtze River](https://doi.org/10.1080/15481603.2026.2705654)
...
### [244] [Spatially Robust Land Cover Classification with Multi-Seasonal Sentinel-2 Imagery: A Comparison of CNN, UNet++, ConvNeXt and ViT](https://doi.org/10.3390/rs18152463)
*Georgios Dimitrios Gkologkinas,Eftychios Protopapadakis,Aikaterini Stamou,Ioannis Tavantzis,Anna Dosiou,Ifigeneia Skalidi,Efstratios Stylianidis*
...
Abstract (英文): Mapping bamboo forest dynamics is essential for forest resource management and understanding vegetation succession, but it is hindered by the lack of historical samples. To address this challenge, this study developed a percentile-based head/tail break (P-HTB) method to reconstruct historical samples and produced bamboo forest maps for Jiangxi Province at five-year intervals from 1990 to 2020. Compared with the OTSU and original head/tail breaks (HTB) methods, P-HTB performed better in automatic threshold determination across most target years. Using the migrated samples and random forest algorithm, bamboo forest dynamics in Jiangxi Province from 1990 to 2020 were mapped at 5-year intervals. The results showed that the bamboo forest area more than doubled over the 30-year period, from 57.74 × 104 ha to 120.78 × 104 ha. Expansion was most pronounced in hilly and lower-elevation areas, driving the elevation centroid of bamboo forests downward by 89 m, yet increases were also observed at high elevations. This expansion came largely at the expense of evergreen broadleaved forests. This study provides a reliable long-term bamboo forest dataset for Jiangxi Province and a transferable methodology for large-scale vegetation monitoring, thereby offering support for sustainable forest management and improved land cover mapping.

</details>


### [257] [A Ground-Based Multi-Doppler Wind Retrieval Algorithm for Turbulent Convection: An LES-Based Radar Wind Retrieval Framework](https://doi.org/10.3390/rs18152468)
*S. M. Shajedul Karim,Stephen R. Guimond*
...
### [259] [Flexible High-Resolution Water Quality Monitoring and Mapping Using an Autonomous Surface Vehicle and Drone-Based Multispectral Imaging System](https://doi.org/10.3390/rs18152473)
*Ekaterina Miliutina,Hongxing Liu,Amanjit Premsagar,Jilin Men,Haibin Su,YueHan Lu,Anindya Palaparthi,Tantu Mandal,Dan Tian,Jihee Seo*
...
Abstract (英文): Oxbow lakes are key geomorphic and ecological components of river floodplains, but basin-scale inventories remain limited because these features are narrow, fragmented, and spectrally similar to active channels and other floodplain water bodies. This study developed a deep-learning-based workflow for oxbow lake extraction in the Amazon Basin using Landsat imagery. A reference label dataset was constructed by combining automated cutoff extraction, surface-water transition information, and manual interpretation. An enhanced DeepLabV3+ semantic segmentation model was trained with nine-band Landsat image patches and applied to basin-wide Landsat 8/9 composite images through sliding-window inference and post-processing. Independent validation against manually digitized PlanetScope imagery showed strong detection performance, with an overall F1-score of 0.819 and recall of 0.966. A spatially independent sub-basin validation further indicated partial transferability in an unseen Amazon sub-basin, with an F1-score/Dice coefficient of 0.532, precision of 0.498, recall of 0.571, and IoU of 0.362. Basin-scale inference detected 1836 oxbow lake objects, approximately 2.34 times the number of reference labels. Our study provides a new image-based semantic segmentation approach for basin-scale oxbow lake mapping and offers an expanded spatial inventory to support floodplain geomorphology, river dynamics, and river–floodplain ecosystem studies.

</details>


### [261] [SpecGateNet: Spectral-Guided Fusion Network for Cloud and Cloud Shadow Segmentation in Optical Remote Sensing Imagery](https://doi.org/10.3390/rs18152469)
*Kaibo Qin,Shengyan Liu,Wengzheng Wu,Haoyu Yin,Tengyue Guo,Min Xia*
...
### [265] [A Multidimensional Hotspot Assessment of Long-Term Terrestrial Water Storage Anomaly Change Across China](https://doi.org/10.3390/rs18152478)
...
### [266] [An Integrated Deep Learning Approach to Estimate Canopy Height and Uncertainty by Combining Seasonal Optical, SAR and Limited GEDI LiDAR Data over Ontario’s Managed Forests, Canada](https://doi.org/10.3390/rs18152477)
...
### [267] [ChangePixel: Pixel-Level Evidence-Grounded Disaster Change Narration via Single-Backbone Transfer](https://doi.org/10.3390/rs18152480)
...
### [268] [Relative Radiometric Normalization of Multisource Optical Satellite Imagery via Automatic Construction and Intelligent Refinement of Radiometric Reference Sample Set](https://doi.org/10.3390/rs18152479)
...
### [269] [Reliability-Aware Cross-Modal Fusion of Sentinel-1 SAR and Sentinel-2 Optical Imagery for Robust Patch-Level Land Cover Scene Classification](https://doi.org/10.3390/rs18152484)
...
### [270] [Comparative Performance Analysis of Mainstream Deep Learning and Vision Foundation Models for Small-Sample Vegetation Segmentation in High-Resolution Remote Sensing Imagery](https://doi.org/10.3390/rs18152487)
*Le Hu,Fuquan Zhang*
...
### [271] [Correction: Jang et al. Automated Machine Learning for High-Resolution Daily and Hourly Methane Emission Mapping for Rice Paddies over South Korea: Integrating MODIS, ERA5-Land, and Soil Data. Remote Sens. 2026, 18, 753](https://doi.org/10.3390/rs18152485)
...
### [272] [Influence of Lens Distortion Correction and Image Resampling on Vehicle Detection in UAV Imagery](https://doi.org/10.3390/rs18152486)
...
### [273] [Extracting Linear Structures from LiDAR Data by Msplit Estimation and Different Segmentation Approaches](https://doi.org/10.3390/rs18152488)
...
### [274] [An Automated Farm Field Unit Identification Framework for Large-Scale Farms Based on Remote Sensing Image Segmentation and Parameter Optimization](https://doi.org/10.3390/rs18152482)
...
### [275] [Sentinel-1 SAR and Temporal Lag Soil Moisture Estimation at Instrumented Field Sites: A Stacked Ensemble Approach](https://doi.org/10.3390/rs18152483)
...
### [276] [Drought-Triggering Thresholds and Vegetation Resilience Across Aridity Gradients in Central Asian Grasslands](https://doi.org/10.3390/rs18152493)
...
### [277] [Use of PSInSAR for Long-Term Surface Displacement Monitoring as a Complement to the Official Landslide Susceptibility Map in the Saguenay–Lac-Saint-Jean Region, Quebec](https://doi.org/10.3390/rs18152492)
...
### [278] [OrbitGS: High-Fidelity 3D Reconstruction of On-Orbit Non-Cooperative Targets via Physically Decoupled Gaussian Splatting](https://doi.org/10.3390/rs18152489)
...
### [279] [Deep Learning Applications in Remote Sensing for Forest Inventory Methods](https://doi.org/10.3390/rs18152490)
...
### [280] [PCINet: A Prior-Guided Correlation Interaction Network for High-Resolution Remote Sensing Image Change Detection](https://doi.org/10.3390/rs18152491)
...
### [281] [Self-Supervised Hyperspectral Image Clustering via Spatial–Frequency Interaction and Amplitude–Phase Decoupling](https://doi.org/10.3390/rs18152494)
...
### [282] [MUSTI: Multi-scale spatiotemporal tensor imputation for global leaf area index time series reconstruction](https://doi.org/10.1016/j.rse.2026.115559)
*Xinpei Yu,Kai Yan,Jiabin Pu,Jinxiu Liu,Jin Wu,Alexander J. Winkler,Qiao Wang*
...
### [283] [GNSS–T for ecohydrological monitoring of a european beech forest: Assessing different system and band characteristics for resolving temporal VOD dynamics](https://doi.org/10.1016/j.rse.2026.115580)
*Nicolas Bader,Ruxandra-Maria Zotta,Eugenio Díaz‐Pinés,Gregor Möller,Walter Loderer,Thomas Kager,Wouter Dorigo*
...
Abstract (英文): European beech Fagus sylvatica L. is a climatically sensitive and ecologically significant tree species in Europe. While satellite products of Vegetation Optical Depth (VOD) provide valuable large-scale information on canopy water content, structure and biomass, critical for understanding forest resilience to environmental change, ground-based observations are required to resolve canopy-scale processes and to understand and improve satellite VOD retrievals. In this study, we employ a stationary GNSS Transmissometry (GNSS–T) setup in a mature European beech forest, exploiting signals from satellites of GPS, GALILEO, GLONASS and BDS, at different carrier frequencies within L-band. In particular, we focus on ranging code type impacts on VOD retrievals. Ranging codes modulate the GNSS signal, impacting the physical interaction between signal and vegetation, and determine the GNSS receiver’s capability to track these signals, which further may impact the recorded Signal-to-Noise Ratio (SNR). Yet, ranging code types largely remain an unexplored source of variability. Retrieved VOD magnitudes are broadly consistent across all combinations, except GPS L2 W, using the encrypted military code transmitted on the L2 band, indicating that differences in ranging code types can induce larger VOD discrepancies than differences between carrier frequencies and emphasize the importance of signal selection for GNSS–T VOD retrieval. VOD retrieved captures structural canopy features, diel and seasonal dynamics, and shows sensitivity to meteorological drivers. It aligns well with vegetation proxies derived from cameras, particularly during rapid phenological transitions, and exhibits moderate correlations with satellite-based vegetation indicators (AMSR2 LPRM X- and Ku-band VOD, MODIS LAI, Sentinel-1 cross-polarization ratio). Our results demonstrate the capability of GNSS–T to resolve canopy-scale hydraulic dynamics and provide insights into vegetation responses to climatic drivers, while highlighting key considerations in system design and data processing.

</details>


### [284] [Global comparison of different effective scattering albedo and soil roughness parameterization schemes for SMAP soil moisture and L-VOD retrieval](https://doi.org/10.1016/j.rse.2026.115590)
*Yao Xiao,Xiaojun Li,Lei Fan,Andress Colliander,Ardeshir Ebtehaj,Jian Peng,Frédéric Frappart,L. Karthikeyan,Wei Zhao,Gabrielle De Lannoy,Patricia de Rosnay,Zanpin Xing,Mengjia Wang,Xiangzhuo Liu,Pariha Helili,Preethi Konkathi,Jean-Pierre Wigneron*
...
### [285] [Rice leaf pathogen infection alters the spectral–biochemical relationships revealed by radiative transfer model inversion](https://doi.org/10.1016/j.rse.2026.115592)
*Long Tian,Susan L. Ustin,Yuanyuan Kong,Bowen Xue,Pablo J. Zarco-Tejada,Chongya Jiang,Xia Yao,Yufang Jin,Yan Zhu,Weixing Cao,Tao Cheng*
...
### [286] [STCAFormer: Spatio-temporal cross attention based transformer for fusion of remote sensing images](https://doi.org/10.1016/j.rse.2026.115594)
...
### [287] [Deep learning tree and forest biomass from sub-meter resolution optical imagery](https://doi.org/10.1016/j.rse.2026.115539)
...
### [288] [An enhanced GRACE-based index for nationwide flood-prone region monitoring in China from 2003 to 2022](https://doi.org/10.1016/j.rse.2026.115600)
...
### [289] [Beyond RMSE: The GEDI imputed waveform product minimizes artificial homogeneity evident in existing global forest height maps](https://doi.org/10.1016/j.rse.2026.115591)
...
### [290] [Enhancements to the USGS Landsat Level 2 surface temperature and emissivity product for Collection 3 reprocessing](https://doi.org/10.1016/j.rse.2026.115563)
...
### [291] [Beyond fidelity: Rethinking realism through human behavior in VR city modeling LOD design](https://doi.org/10.1016/j.jag.2026.105484)
*Yixian Su,Yang Guosheng,Wufan Zhao,Cai Wu*
...
Abstract (英文): Current research on bimodal extraction of Martian impact craters, which integrates satellite imagery and digital elevation models (DEMs), remains limited to the object level, with no existing reports about addressing both pixel-level and irregularly vectorized extraction. Furthermore, there is a lack of open-source bimodal datasets that include statistics (such as crater count, area and volume) for Martian impact craters, and no deep learning approaches have been reported for simultaneous extraction and quantitative analysis of Martian impact craters. To address these gaps, this study is the first to create and release a bimodal catalogic and quantitative dataset (BCQDS), combining DEM and satellite imagery with topographic landscape pattern indices. We also propose an innovative bimodal quantitative ensemble learning network (BQEL-Net) with uncertainty-aware paradigm designed for pixel-level, vectorized and quantitative extraction for Martian impact craters from BCQDS. BQEL-Net uses an uncertainty-aware Bayesian ensemble learning strategy (UBELS) by combining multiple strong segmentors confidence and pixel-level confidence to enhance robustness and accuracy; the proposed bimodal coordinate channel attention (BC 2 AM) aligns bimodal features in the latent space, making them complementary; and a newly developed quantitative statistics module (QSM) with a pioneer quantitative task loss function, enabling the simultaneous extraction of up to 140 quantitative indices. Experiments conducted using MOLA data within the BCQDS demonstrated that BQEL-Net achieves a maximum MIoU of 0.858. Ablation studies confirmed that the bimodal structure, BC 2 AM, UBELS and QSM contribute MIoU gains. This work pioneers a crater catalog with 3D geometric morphology to support quantitative studies of Martian surface evolution.

</details>


### [293] [Identification and classification of risk zones for Calliptamus italicus based on remote sensing and ensemble modeling: considering population density and habitat suitability](https://doi.org/10.1016/j.jag.2026.105498)
*Junteng Luo,Liang Liu,Jianghua Zheng,Jun Lin,Wanqiang Han,Yang Yan,Jianhao Li,Feifei Zhang,Zhong Liang,Qige Qi*
...
Abstract (英文): Locust outbreaks remain a major challenge to global ecological and environmental security. Calliptamus italicus is the most common migratory locust in the China-Kazakhstan border region. Although relevant countries are actively carrying out control, the excessively large control area has become an important burden. Previous studies have mapped its potential suitable areas, but most studies used only a single model and focused only on suitability changes. Limited attention has been paid to the effect of density on population distribution. This study identifies risk zones by integrating potential suitable areas with population density. It aims to enhance suitable habitat prediction and is of great significance for improving locust control. Based on five categories of Earth observation data and field-surveyed occurrence and density data, this study constructed a regional risk zoning framework using nine models, geographical detector, and path analysis. The ensemble model yielded an AUC value of 0.98, outperforming previous studies in this region. The suitable areas of Calliptamus italicus showed a radial spatial pattern expanding outward from highly suitable areas. Seasonal temperature and precipitation, vegetation condition, and soil texture had the highest explanatory power for regional locust density, and formed multiple impact pathways. Risk zones were distributed in the northern part of the study area and the transboundary continuous grassland belt, and gradually extended toward the central region, showing an overall banded or mosaic spatial pattern. A spatial mismatch existed between suitable areas and risk zones, highlighting the complementary value of field-measured density data in locust risk assessment. This framework helps provide a new perspective for pest management and control under climate change.

</details>


### [294] [An interpretable Earth observation framework for estimating lake dissolved organic carbon in Sweden using Sentinel-2 and ERA5-Land data](https://doi.org/10.1016/j.jag.2026.105488)
*Xufeng Wei,Wenbo Xu,Lanhui Wang,Renkui Guo,Zheng Duan*
...
Abstract (英文): Inland-water dissolved organic carbon (DOC) is a key regulator of aquatic carbon cycling and water quality, yet it remains difficult to observe at the spatial and temporal scales targeted by Earth observation (EO). This study developed an interpretable machine learning (ML) framework to estimate lake DOC and interpret model behavior across Sweden using Sentinel-2 MultiSpectral Instrument (MSI) reflectance (RS), ERA5-Land environmental variables (E), and geographic features (G). Using 1,595 spatiotemporal match-ups from 349 lake locations during the period 2017–2024, this study benchmarked five regression algorithms across four feature combinations. XGBoost with the full E + RS + G configuration achieved the best estimation performance (RMSE ≈ 2.46 mg C L −1 ; Bias ≈ −1.6 %) and enabled 10 m quarterly DOC estimation and mapping for examining spatiotemporal changes in Swedish lakes. Robustness was further evaluated using a held-out test set, spatially separated validation, interpolation, and coordinate-only baselines to assess potential spatial confounding. SHapley Additive exPlanations (SHAP) analysis indicated that DOC predictability in the Sweden-wide dataset is strongly spatially structured: geographic features capture broad-scale spatial context, while vegetation, hydroclimatic variables, and visible-to-near-infrared reflectance provide more directly interpretable process-related signals. Overall, the framework provides an operational EO–ML workflow for DOC estimation in Sweden, with explicit robustness tests to assess the respective roles of auxiliary spatial context and EO–environmental predictors.

</details>


### [295] [Fusing very high-resolution aerial imagery with Sentinel-1 and Sentinel-2 time series improves multi-year orchard type classification](https://doi.org/10.1016/j.jag.2026.105495)
*Lior Fine,Tarin Paz-Kagan,Offer Rozenstein*
...
### [297] [Spatially varying NDVI–stand structure relationships in Scots pine forests across Poland using HLS, LiDAR metrics and GGP-GAM](https://doi.org/10.1016/j.jag.2026.105500)
...
### [298] [Dual-polarization GNSS reflectometry for FYI–MYI sea ice type classification using microsatellite observations](https://doi.org/10.1016/j.jag.2026.105502)

...
- [Remote Sensing](#Remote Sensing) [Total: 56]
...
### [175] [UniOrtho: From view-centric to unified orthographic framework for satellite semantic 3D reconstruction](https://doi.org/10.1016/j.isprsjprs.2026.06.039)
...
### [176] [DG-SLAM: A hybrid direct georeferencing and SLAM framework for real-time orthophoto mapping in weak-textured environments](https://doi.org/10.1016/j.isprsjprs.2026.07.004)
...
### [177] [Surface Heat Source Variations and Driving Factors in Typical Permafrost Areas of the Tibetan Plateau](https://doi.org/10.3390/rs18142312)
...
### [178] [Integrating Deep Generative AI and Hyperspectral–Multispectral Data Fusion for Enhancing Digital Soil Mapping](https://doi.org/10.3390/rs18142320)
...
### [179] [Independent Multi-Sensor Validation of Machine-Learning Landslide Susceptibility: Footprint Construction Decides the Verdict—May 2023 Emilia-Romagna Event](https://doi.org/10.3390/rs18142318)
...
### [180] [Nonlinear Responses and Spatial Heterogeneity of Net Ecosystem Productivity to Extreme Weather Events in Central Asia](https://doi.org/10.3390/rs18142315)
...
### [181] [Structure-Confidence Guided Phase Congruency and Cascade Matching for Registration of Optical and SAR Images](https://doi.org/10.3390/rs18142322)
...
### [182] [Joint Cross-Range Scaling and Phase Autofocus for ISAR Imaging Based on Adaptive Phase Tracking with Application to Asteroid Imaging](https://doi.org/10.3390/rs18142311)
...
### [183] [Research on Few-Shot Mars Rover Onboard Surface Scene Classification Based on SE-ResNet-MTL](https://doi.org/10.3390/rs18142319)
...
### [184] [Multi-Stage Aggregation CNN–Transformer Hybrid Architecture for Infrared Small-Target Detection](https://doi.org/10.3390/rs18142309)
...
### [185] [Influence of Internal Climate Variability on Satellite-Altimeter-Derived Regional Sea-Level Trends](https://doi.org/10.3390/rs18142313)
*Se‐Hyeon Cheon*
...
### [186] [Physics-Informed Semantic Prompt Learning for Few-Shot Low-Altitude Radar Target Recognition in Remote Sensing](https://doi.org/10.3390/rs18142316)
...
### [187] [A Sub-Scene-Based GNSS-Constrained Structure from Motion for Robust Long-Corridor UAV Image Reconstruction](https://doi.org/10.3390/rs18142321)
...
### [188] [Climate-Driven Phenological Responses of Fagus sylvatica Across European Climatic Zones Using Remote Sensing](https://doi.org/10.3390/rs18142314)
...
### [189] [Removing Cirrus-Induced Errors in Operational Landsat 8 and 9 Daytime Surface Temperature Products over Waters](https://doi.org/10.3390/rs18142317)
...
### [190] [Exploring the Potential of Machine Learning Post-Processing to Generate ERA5-Consistent Atmospheric Profiles from Geostationary Satellite Retrievals](https://doi.org/10.3390/rs18142310)
...
### [191] [A New Deep Learning Method for Sea Fog Detection Using Fengyun-4A Satellite Data](https://doi.org/10.3390/rs18142334)
...
### [192] [Category-Aware Global–Local Semantic Alignment for Remote Sensing Image–Text Retrieval](https://doi.org/10.3390/rs18142335)
*Da Ha,Haisu Zhang*
...
### [193] [Deconstructing and Ameliorating Woody Volume Estimation Errors Arising from Leaves in Quantitative Structure Models of Trees](https://doi.org/10.3390/rs18142342)
...
### [194] [Decoupling Deep Mining and Tailings Consolidation-Induced Subsidence Using SBAS-InSAR and NMF: A Case Study at South Deep Gold Mine, South Africa](https://doi.org/10.3390/rs18142337)
...
### [195] [Spatiotemporal Variations in Terrestrial Water Storage and Water Scarcity Assessment Across China Based on TWSA_BTCH](https://doi.org/10.3390/rs18142324)
...
### [196] [UAV 3D Scene Understanding: A Survey from an Agent-Capability Evolution Perspective](https://doi.org/10.3390/rs18142323)
...
### [197] [Multi-Method Identification and Spatiotemporal Evolution Analysis of Active Deformation Areas in the Binchang Mining Area](https://doi.org/10.3390/rs18142339)
...
### [198] [Normalized Dynamic Fluorescence Height: An Alternative Algorithm for Chlorophyll a Estimation in Algae-Dominated Waters Using Hyperspectral Remote Sensing Reflectance from In Situ and Spaceborne Imagers](https://doi.org/10.3390/rs18142332)
...
### [199] [Assessing the Capabilities of UAV-Based Observation for Marginalized Communities: A Case Study of Roma Settlements in Slovakia](https://doi.org/10.3390/rs18142326)
...
### [200] [Nighttime Thermal Patterns and County Life Expectancy: A 20-Year Multimodal Satellite Fusion for the Contiguous United States](https://doi.org/10.3390/rs18142330)
...
### [201] [Significance-Preserving Progressive Network for Infrared and Visible Image Fusion](https://doi.org/10.3390/rs18142328)
...
### [202] [HFG-YOLO: A High-Frequency-Guided Network for Small-Object Detection](https://doi.org/10.3390/rs18142343)
...
### [203] [ECDF-Stabilized Sentinel-1 InSAR Coherence for Verification-Oriented Heritage Monitoring: A TabICLv2-SHAP and Three-Horizon DEMATEL Architecture](https://doi.org/10.3390/rs18142325)
...
### [233] [Coupling functional heterogeneity activation and distance impedance: a distance-decay model for urban population spatial interactions](https://doi.org/10.1080/15481603.2026.2698143)
...
### [234] [A Hybrid Window Transformer for accurate and generalizable soil salinity prediction across China](https://doi.org/10.1080/15481603.2026.2700119)
...
### [235] [PADS: a partitioned adaptive data synthesis framework integrating SMOGN and adaptive data selection for small-sample maize yield prediction](https://doi.org/10.1080/15481603.2026.2703926)
...
### [236] [Optimizing 1D-Var near-surface wind speed from SSMIS with RapidScat](https://doi.org/10.1016/j.rse.2026.115560)
...
### [237] [Seasonal mass balance of Hofsjökull ice cap, Iceland, estimated from repeat ICESat-2 satellite altimetry](https://doi.org/10.1016/j.rse.2026.115555)
...
### [238] [Synergistic analysis and vertical transport attribution of carbon monoxide surface concentrations and satellite column loadings over China](https://doi.org/10.1016/j.rse.2026.115562)
...
### [239] [A hybrid machine learning and data assimilation framework for penman–monteith evapotranspiration estimation over China](https://doi.org/10.1016/j.rse.2026.115565)
...
### [240] [An improved 15-year record of ice sheet elevation from CryoSat-2 radar altimetry](https://doi.org/10.1016/j.rse.2026.115561)
...
### [241] [A two-stage machine learning framework for Chl-a reconstruction and short-term prediction in eutrophic lakes using GOCI observations](https://doi.org/10.1016/j.jag.2026.105468)
...
### [242] [Reproducible mapping of marine biodiversity using autonomous surface vehicles and deep learning](https://doi.org/10.1016/j.jag.2026.105462)
...
### [243] [Label-efficient mapping of unregulated waste dumps via mixed supervision with feature masked recovery](https://doi.org/10.1016/j.jag.2026.105471)
...
### [244] [BLB_TVI: A hyperspectral triangular index for satellite-scale characterization of rice bacterial leaf blight severity](https://doi.org/10.1016/j.jag.2026.105472)
...
### [245] [Individual urban street tree detection and species-level mapping from street-view images and GIS data](https://doi.org/10.1016/j.jag.2026.105449)
...
### [246] [A high-resolution interchange classification model enhanced by multi-scale geometric structural feature fusion](https://doi.org/10.1016/j.jag.2026.105450)
...
### [247] [From flood extent mapping to mechanism-aware flood products: integrating flood type classification into satellite-based flood monitoring](https://doi.org/10.1016/j.jag.2026.105482)
...
### [248] [Spatiotemporal bias in OCO-2 XCO2 retrievals relative to TCCON observations](https://doi.org/10.1016/j.jag.2026.105466)
...
### [249] [Satellite evidence of reduced resistance and resilience to water stress after antecedent fire across a rainfall gradient in northern Australia](https://doi.org/10.1016/j.jag.2026.105478)
...
### [250] [The impacts of cover crop biomass on satellite-based detectability of cover crops in Maryland](https://doi.org/10.1016/j.jag.2026.105453)

...
- [Remote Sensing](#Remote Sensing) [Total: 99]
...
### [103] [Framework for Cross-Disaster Building Damage Assessment Using Cost-Sensitive Learning](https://doi.org/10.3390/rs18172920)
...
### [104] [Pixel-Level Sentinel-2 Modeling Reveals Scale-Dependent Edge Effects and Structural Heterogeneity in Semideciduous Seasonal Forest Fragments of the Brazilian Cerrado](https://doi.org/10.3390/rs18172999)
...
### [105] [GeoAI-Driven Wetland Change Analysis in the Sangamon River Watershed (2000–2025): A Comparative Assessment of Machine Learning and Deep Learning Approaches](https://doi.org/10.3390/rs18172949)
...
### [106] [iSAGE: A Human-in-the-Loop Framework for Remote Sensing Semantic Segmentation via Sparse Point Supervision](https://doi.org/10.3390/rs18172973)
...
### [107] [Complex-Valued HRU-Net with Cross-Gated Attention for PolSAR Semantic Segmentation](https://doi.org/10.3390/rs18172947)
...
### [108] [Spatial Prompt and Wavelet Mamba-Based Multi-Scale Cross-Domain Feature Fusion Network for Segmentation of Mining-Disturbed Land](https://doi.org/10.3390/rs18172963)
...
### [109] [GRAZE-FUSE: Grazing-Informed Integration of APSIM and Sentinel-2 for Pasture Biomass Monitoring](https://doi.org/10.3390/rs18172911)
...
### [110] [Geometry-Constrained Reference Sample Construction from Forest Inventory Compartments for Dominant Tree Species Mapping](https://doi.org/10.3390/rs18172915)
...
### [111] [Terrain Effects on Time-Frequency Characteristics of Negative Return Stroke Electric Fields: A Path-Incremental Method](https://doi.org/10.3390/rs18172908)
...
### [112] [Assimilation of FY-3G Precipitation Data Using a Machine Learning-Based Observation Operator in the CMA-MESO Regional Model](https://doi.org/10.3390/rs18172912)
...
### [113] [Enhancing the Spatial Applicability of SMAP Soil Moisture Using Multi-Stage Machine Learning Downscaling](https://doi.org/10.3390/rs18172913)
...
### [114] [DROMAL-Net: A Forest Larch Casebearer Detection Model Focusing on Global Feature Enhancement and Positional Dynamic Clustering](https://doi.org/10.3390/rs18172916)
...
### [115] [Preprocessing Mismatch and Input Normalisation in Transferring a Multispectral Foundation Model to Marine Surface Segmentation](https://doi.org/10.3390/rs18172905)
...
### [116] [Bias-Aware Machine Learning Spatial Downscaling of GRACE Signals: Application to the Bug River Basin](https://doi.org/10.3390/rs18172909)
...
### [117] [Disentangling Spectral and Environmental Controls on Inland River–Lake Water Quality Using Satellite Earth Observation-Driven Optimized Machine Learning](https://doi.org/10.3390/rs18172921)
...
### [118] [SiamNet: A Double-Temporal SAR Avalanche Detection Method Integrating Multiscale Features and an Attention Mechanism](https://doi.org/10.3390/rs18172917)
...
### [119] [Spatially Complete Monthly XCH4 Mapping over China from 2019 to 2024: A Multi-Model Analysis Using Machine Learning](https://doi.org/10.3390/rs18172919)
...
### [120] [A Spectral–Spatial Decoupling and Fusion Network with Multi-Scale Perception for Multispectral Image Compression](https://doi.org/10.3390/rs18172904)
...
### [121] [Spatiotemporal Variations and Associated Environmental Factors of Coastal Polynyas in the Kara–Laptev Seas from 2003 to 2025](https://doi.org/10.3390/rs18172914)
...
### [122] [Long-Term InSAR Monitoring and Anomaly Detection of Railway Deformation in Shanghai](https://doi.org/10.3390/rs18172918)
...
### [123] [Physics-Informed Residual Learning for Vertical Profile Reconstruction of Atmospheric Optical Turbulence from Tethered UAV Observations over the Ngari Plateau](https://doi.org/10.3390/rs18172907)
...
### [124] [Multiscale Decomposition Reveals the Scale-Dependent Drivers of Complex Urban Ground Deformation in Zhengzhou, China](https://doi.org/10.3390/rs18172910)
...
### [125] [Long-Term Dynamics of Land Degradation Risk in Arid Northwest China Revealed by an Integrated Risk Index](https://doi.org/10.3390/rs18172906)
...
### [126] [Impact of Radar-Constrained Effective Drop-Shape Relations on Polarimetric Radar Quantitative Precipitation Estimation in Typhoons](https://doi.org/10.3390/rs18172927)
...
### [127] [Jacobians of Light Scattering Properties Based on the Improved Geometric Optics Method (IGOM)](https://doi.org/10.3390/rs18172942)
...
### [128] [Deep Learning-Based Quantitative Precipitation Estimation Using Ground-Based Microwave Radiometer and Micro-Rain Radar Observations](https://doi.org/10.3390/rs18172941)
...
### [129] [Satellite Remote Sensing of a Melting Glacier Albedo: Examples from EnMAP and an Intercomparison with Other Satellite and Ground Measurements](https://doi.org/10.3390/rs18172929)
...
### [130] [Assessing Vegetation–Hydrothermal Trend Regimes Across Elevation Gradients in Semiarid Mountains via Gaussian Mixture Models in Saudi Arabia](https://doi.org/10.3390/rs18172948)
...
### [131] [Volumetric Impact Characterization of the 2025 Palisades and Eaton Fires Using Aerial LiDAR](https://doi.org/10.3390/rs18172943)
...
### [132] [Physics-Informed Spatially Variant Image Restoration for Unresolved Infrared Remote Sensing Small Targets](https://doi.org/10.3390/rs18172934)
...
### [133] [Machine-Learning-Based Radar Quantitative Precipitation Estimation Using Intra-Hour Temporal Features from Dual-Polarization Observations](https://doi.org/10.3390/rs18172937)
...
### [134] [A Linear Attention Framework with Dual-Axis Multi-Scale Fusion for Fine-Grained Eucalyptus Change Detection](https://doi.org/10.3390/rs18172944)
...
### [135] [ST-PaveCLIP: A Spatio-Temporal Vision–Language Framework for Road Anomaly Segmentation in Images and Videos](https://doi.org/10.3390/rs18172922)
...
### [136] [Deep Learning-Based Monitoring of Tea Plant Growth and Nitrogen Status Using UAV Multisource Remote Sensing Features](https://doi.org/10.3390/rs18172923)
...
### [137] [Performance Analysis of BDS-3 PPP-B2b During the Satellite In-Orbit Upgrade Period](https://doi.org/10.3390/rs18172936)
...
### [138] [Generalized Matérn Process for GNSS Coordinate Series Noise Modeling](https://doi.org/10.3390/rs18172932)
...
### [139] [Multidimensional Quantification of Engineering Distresses and Secondary Periglacial Hazards Along Linear Infrastructure in the Permafrost Region of Northeast China Using UAV-LiDAR and Synchronous Visible-Light Imagery](https://doi.org/10.3390/rs18172938)
...
### [140] [An Earth-Limb-Constrained Framework for On-Orbit Geometric Calibration of GEO Wide-Field Area-Array Cameras](https://doi.org/10.3390/rs18172930)
...
### [141] [Improvement of Flood Risk Model Performance by Incorporating Sediment Factors](https://doi.org/10.3390/rs18172933)
...
### [142] [Layout Optimization of Urban Emergency Shelter Sites Under Compound Disaster Scenarios Based on MOGWO](https://doi.org/10.3390/rs18172945)
...
### [143] [NWCSAF High Resolution Winds (NWCSAF GEO-I HRW) Stereo AMVs over the Atlantic Ocean](https://doi.org/10.3390/rs18172940)
...
### [144] [EGDNet: An Event-Guided Frequency-Aware Network with Cross-Modal Attention for Robust Weak Signature UAV Detection](https://doi.org/10.3390/rs18172925)
...
### [145] [Multi-Temporal Remote Sensing Assessment and Pareto-Based Land-Use Optimization for Balancing Carbon Storage, Ecological Value, and Economic Value in Jiangsu Province, China](https://doi.org/10.3390/rs18172924)
...
### [146] [Scale-Aware Gated Routing Distillation for Lightweight Remote Sensing Object Counting](https://doi.org/10.3390/rs18172939)
...
### [147] [Physically Constrained Quadratic Programming for Spectral Unmixing of Nighttime Lighting: A Case Study with Data Generation Procedure](https://doi.org/10.3390/rs18172935)
...
### [148] [Probabilistic Spatial Completion of FEMA Special Flood Hazard Area Coverage in Louisiana Using Conditional Diffusion and Distributionally Trustworthy Explanation](https://doi.org/10.3390/rs18172926)
...
### [149] [Prior-Guided Lightweight Dual-Task Network for Composite Active Jamming Recognition and Time-Frequency Parameter Estimation in Radar Remote Sensing](https://doi.org/10.3390/rs18172946)
...
### [150] [Seasonal Consistency Between Solar-Induced Chlorophyll Fluorescence and Vegetation Indices Across Global Urban Ecosystems](https://doi.org/10.3390/rs18172931)
...
### [151] [A Practical Framework for Surface Water Extraction from GF1/GF6 Wide-Field-View Imagery](https://doi.org/10.3390/rs18172928)
...
### [152] [TAPO: Task-Decoupled Alignment and Pseudo-Label Optimization for Cross-Scene Inshore SAR Ship Detection](https://doi.org/10.3390/rs18172953)
...
### [153] [Geospatial Foundation Models Improve Atoll Island Ecosystem Mapping: A Case Study Using AlphaEarth Embeddings](https://doi.org/10.3390/rs18172964)
...
### [154] [Landscape Greening Following Unseasonal Precipitation Along a Desert–Alpine Gradient](https://doi.org/10.3390/rs18172951)
...
### [155] [Odometry and Mapping for Complex Environment Perception Under Partial-View Sensing](https://doi.org/10.3390/rs18172959)
...
### [156] [MARC-Net: A Modality-Availability-Aware Robust Change Network for Missing-Optical Bi-Temporal Optical–SAR Change Detection of Reclaimed Cropland](https://doi.org/10.3390/rs18172960)
...
### [157] [Geometry-Guided Semi-Supervised Multimodal Segmentation for UAV-Based Rice-Lodging Mapping](https://doi.org/10.3390/rs18172961)
...
### [158] [TFCRNet: Dual-Discriminator SAR-to-Optical Translation and Region-Gated Cross-Attention Fusion for Thick-Cloud Removal](https://doi.org/10.3390/rs18172962)
...
### [159] [Hyperspectral Technology: A Method Framework for the Estimation of Metal Content in Cobalt-Rich Crusts](https://doi.org/10.3390/rs18172968)
...
### [160] [A Change-Point-Based Deformation Grouping Strategy in Long-Term Near-Real-Time Deformation Monitoring](https://doi.org/10.3390/rs18172956)
...
### [161] [FuseCLIP: Semantic-Guided Multidomain Fusion for Few-Shot Radar Active Jamming Recognition](https://doi.org/10.3390/rs18172967)
...
### [162] [FD-ProtoSCD: Semantic Change Detection in High-Resolution Remote Sensing Images via Frequency-Domain Disentanglement and Dynamic Prototype Learning](https://doi.org/10.3390/rs18172957)
...
### [163] [Spatiotemporal Deep Learning for Continuous Illumination Mapping and Sun-Synchronous Path Planning in Lunar Polar Exploration Under Chang’E-7 Mission Constraints](https://doi.org/10.3390/rs18172950)
...
### [164] [Improving Backscatter-Based Surface Water Classification in Arid Environments Through Interferometric Coherence](https://doi.org/10.3390/rs18172966)
...
### [165] [Potential Source-to-Sink Spatial Correspondence in a Martian Analog Environment of the Qaidam Basin Based on GF-5A Hyperspectral Imagery](https://doi.org/10.3390/rs18172958)
...
### [166] [Beyond Standalone Geo-Embeddings: Weighted Multi-Model Ensemble Prediction for Tropical Land-Cover Mapping](https://doi.org/10.3390/rs18172952)
...
### [167] [Tracing 80 Years of Forest Succession and Species Trajectories Using Historical Aerial Photography and Sentinel-2 Imagery](https://doi.org/10.3390/rs18172954)
...
### [168] [MFRA-YOLOv11: Remote Sensing Small Object Detection Algorithm Based on Multiscale Feature Extraction and Region Awareness](https://doi.org/10.3390/rs18172965)
...
### [169] [Severe Positive Ionospheric Storm at American Low Latitudes During an Intense Long-Lasting CEJ Period of the August 2018 Geomagnetic Storm](https://doi.org/10.3390/rs18172955)
...
### [170] [Deep Learning for Water Body Segmentation in Remote Sensing Imagery: A Review](https://doi.org/10.3390/rs18172972)
...
### [171] [A Terrain-Corrected Vegetation Index Strategy for Improving Leaf Area Index Estimation in Mountainous Areas](https://doi.org/10.3390/rs18172977)
...
### [172] [Controlled Evaluation of Sentinel-2 Annual Compositing Strategies for Deep Learning-Based Mangrove Mapping in China](https://doi.org/10.3390/rs18172975)
...
### [173] [Building Footprint Extraction in High-Density Urban Areas Based on Multi-Source Remote Sensing Data Fusion and ACM-PSPNet](https://doi.org/10.3390/rs18172971)
...
### [174] [Land-Cover and Land-Use Mapping Under Limited Data Highlights Hyperparameter Stability and Predictor Design](https://doi.org/10.3390/rs18172969)
...
### [175] [Monthly Trophic Dynamics of Lakes and Reservoirs in Eastern China Based on Harmonized Landsat–Sentinel Observations](https://doi.org/10.3390/rs18172970)
...
### [176] [Seafloor Morphology and Inner Shelf Benthic Habitats of the Sinuessa Shallow Coralligenous Bank, Eastern Tyrrhenian Margin](https://doi.org/10.3390/rs18172974)
...
### [177] [Cloud Occurrence, Phase, and Vertical Structure in a Dust-Influenced Eastern Mediterranean Region: Observations from Limassol, Cyprus](https://doi.org/10.3390/rs18172976)
...
### [178] [Estimating the Effects of Climate and Human Activities on Vegetation Coverage in Diverse Ecosystems: A Case Study of the Gansu Section of the Yellow River Basin](https://doi.org/10.3390/rs18172978)
...
### [179] [Predicting Spatial Variability of PR Protein Concentration in White Grape Juice Using UAV Multispectral Data and Machine Learning](https://doi.org/10.3390/rs18172979)
...
### [180] [Monitoring Coastal Geomorphic Change and Sediment Transport Using Kite Aerial Photography (KAP) and Structure-from-Motion (SfM) Photogrammetry](https://doi.org/10.3390/rs18172998)
...
### [181] [Surface Subsidence Analysis and Prediction in an Open-Pit Mine Using Time-Series InSAR and a CL-TSF Hybrid Model](https://doi.org/10.3390/rs18172996)
...
### [182] [Semantic Segmentation for 3D Point Clouds with Curvature-Aware Sampling and Inverse-Density Weighting](https://doi.org/10.3390/rs18172993)
...
### [183] [Spatiotemporal Variations in Aerosol Optical Depth and Their Relationships with Cloud Properties and Precipitation over Sudan: Insights from Satellite Observations and CMIP6 Model Projections](https://doi.org/10.3390/rs18172986)
...
### [184] [PFIRNet: UAV-to-Satellite Cross-View Self-Localization via Continuous Probability Field Inference](https://doi.org/10.3390/rs18172984)
...
### [185] [Discrepancy-Conditioned Residual Feature Refinement for Multi-Source Hyperspectral Classification](https://doi.org/10.3390/rs18172995)
...
### [186] [High-Resolution 3D GPR Imaging of Concealed Surface Masonry in Pompeian Walls: Performance Analysis of Contact and Non-Contact Surveys](https://doi.org/10.3390/rs18173002)
...
### [187] [Boot-Shaped Terrain Screening and Deep Learning Semantic Segmentation for Landslide-Hazard Candidate Extraction from Airborne LiDAR DEM: A Case Study in Zhenxiong County, China](https://doi.org/10.3390/rs18172983)
...
### [188] [CenterPoint-UAV: Context-Detail BEV Refinement for 3D Object Detection in UAV Point Clouds](https://doi.org/10.3390/rs18172994)
...
### [189] [YOLO-ROSS: A Robust Small Object Detection Model for UAV Aerial Imagery in Complex Interference Environments](https://doi.org/10.3390/rs18172997)
...
### [190] [A Phenology-Adaptive Rubber Plantation Mapping (PARM) Framework Coupling Sentinel-1 SAR and Optimally Selected Spectral Indices Across Heterogeneous Tropical Regions](https://doi.org/10.3390/rs18172989)
...
### [191] [Adaptive Segmented Doppler Compensation for Forward-Looking Radar Imaging](https://doi.org/10.3390/rs18172985)
...
### [192] [Visible Nearshore Object Detection in Overhead Surveillance Imagery: A Large-Scale Dataset and Benchmark](https://doi.org/10.3390/rs18172982)
...
### [193] [Diurnal Asymmetry in the Relationships Between Urban Morphology and Canopy Urban Heat Islands: An Interpretable Machine Learning Analysis](https://doi.org/10.3390/rs18172980)
*Tao Shi,Gaopeng Lu*
...
### [194] [A Biome-Specific Light Use Efficiency Model for Spatiotemporal Dynamics of GPP Across Europe Using PROBA-V and Sentinel-3 FAPAR](https://doi.org/10.3390/rs18172981)
...
### [195] [Satellite-Driven Spatiotemporal Multiscale Perception Learning for Estimating Daily Arctic Sea Ice Thickness](https://doi.org/10.3390/rs18172991)
...
### [196] [Global Navigation Satellite Systems (GNSS) in Climate Change Research: A Comprehensive Review](https://doi.org/10.3390/rs18173001)
...
### [197] [HDSMNet: Height-Guided Sparse Cross-Modal Fusion for High-Resolution Remote Sensing Semantic Segmentation](https://doi.org/10.3390/rs18172992)
...
### [198] [Evaluating the Impact of DEM Resolution on Landslide Hazard Assessment: A Comparative Study Using LiDAR and 1:5000 Topographic Map-Derived DEMs](https://doi.org/10.3390/rs18172988)
...
### [199] [Aerial Scene Classification Using Hierarchical and Multi-Stage Swin Transformer Features](https://doi.org/10.3390/rs18172987)
...
### [200] [Satellite Remote Sensing for Fishing Vessel Identification and Monitoring: A Comparative Analysis of Modalities and a Review of Datasets](https://doi.org/10.3390/rs18173000)
...
### [201] [GFE-Net: Geometry-Enhanced Feature Extraction Network for Semantic Segmentation of Large-Scale LiDAR Point Clouds](https://doi.org/10.3390/rs18172990)
...
### [202] [MRIo3DS-Net: a mutually reinforcing images to 3D surface RNN-like framework for model-adaptation indoor 3D reconstruction](https://doi.org/10.1016/j.isprsjprs.2026.08.035)
...
### [203] [AWARE: Adaptive whole-body active rotating control for enhanced LiDAR-inertial odometry under human-in-the-loop interaction](https://doi.org/10.1016/j.isprsjprs.2026.08.027)
...
### [204] [Editorial Board](https://doi.org/10.1016/s0924-2716(26)00428-4)
*Unknown Author*
...
### [211] [Structure and Implementation of New Practical English Textbooks Driven by Artificial Intelligence](https://arxiv.org/abs/2609.02981)
...
### [212] [MasterControl Seventeen Every Time](https://arxiv.org/abs/2609.03209)
...
### [213] [Speculative Macro Commit for Faster Tool-Using Agents](https://arxiv.org/abs/2609.03236)
...
### [214] [Fresh Memory, Stale Plans: Dependency-Scoped Validation for Distributed LLM-Agent Memory](https://arxiv.org/abs/2609.03340)
...
### [216] [Caught in the Story: Narrative Captivity in Multi-turn LLMs Conversation](https://arxiv.org/abs/2609.03407)
...
### [217] [Dude: A Dual-Detection Multi-Agent System for Paper-Code Discrepancy Detection](https://arxiv.org/abs/2609.03416)
...
### [218] [DuplexSpeechBench-IFEval: Evaluating Implicit Instruction Following in Full-Duplex Voice Agents](https://arxiv.org/abs/2609.03423)
...
### [219] [Do GUI Agents Know When Not to Act? Enabling Conflict-Aware Termination for Multimodal GUI Agents](https://arxiv.org/abs/2609.03438)
...
### [220] [Beyond "Made with AI": Visualizing Provenance Density to Mitigate the Transparency Penalty](https://arxiv.org/abs/2609.03460)
...
### [221] [AutoGraphForge: Towards Automated Graph Theory Discovery](https://arxiv.org/abs/2609.03478)
*Ján Pastorek*
...
### [222] [Making Every Tool Call Count: Necessary Tool-Evidence Path Rewards for Agentic Vision-Language Models](https://arxiv.org/abs/2609.03493)
...
### [223] [GrowPage: On-Demand KV Budgeting for Efficient LLM Reasoning Serving](https://arxiv.org/abs/2609.03494)
...
### [224] [PPO-STGNN: A Proximal Policy Optimization Approach with Spatio-Temporal Graph Neural Networks for DAG Task Scheduling in Cloud-Edge-End Computing](https://arxiv.org/abs/2609.03503)
...
### [225] [What Matters for Aggressive Decoding-Time KV Eviction? Temporal Aggregation and Ranking Preservation](https://arxiv.org/abs/2609.03515)
...
### [226] [CulturalMenuBench: Probing the Knowledge-Application Gap in Multimodal Culinary Reasoning](https://arxiv.org/abs/2609.03526)
...
### [227] [NeoRed: A Knowledge-Logic-Alignment Multimodal Large Language Model for Neonatal Respiratory Disease Diagnosis](https://arxiv.org/abs/2609.03527)
...
### [228] [Feature Reconfiguration With Visual Prior for Medical Lesion Segmentation](https://arxiv.org/abs/2609.03535)
...
### [229] [Dalek: A Constructive Agent Machine](https://arxiv.org/abs/2609.03546)
*Wanpeng Xie*
...
### [230] [GPS-Bench: A Governance Policy Benchmark for Automating Policy Analysis](https://arxiv.org/abs/2609.03553)
...
### [231] [HalluPeer: A Taxonomy-driven Benchmark for Detecting Hallucinations in Scientific Peer Reviews](https://arxiv.org/abs/2609.03580)
...
### [232] [The Attention Triangle in Audio-Video Models](https://arxiv.org/abs/2609.03586)
...
### [233] [KC-Bench: A Dynamic Interactive Benchmark for Evaluating Knowledge Conflicts in LLM Agents](https://arxiv.org/abs/2609.03588)
...
### [234] [A computable representation of the physical laboratory enables verifiable workflows](https://arxiv.org/abs/2609.03621)
...
### [235] [Analysis of Prompt Engineering for Drug Toxicity Prediction](https://arxiv.org/abs/2609.03635)
...
### [236] [Synthetic Semantic Supervision for Contrastive Code Representation Learning in Small Transformers: An Empirical Study](https://arxiv.org/abs/2609.03702)
...
### [237] [Counterfactual Routing Using Integer Programming with Constraint Generation](https://arxiv.org/abs/2609.03707)
...
### [238] [Artificial Intelligence for Energy Optimization in Data Centers](https://arxiv.org/abs/2609.03716)
...
### [239] [Proactive Service Agents: A Unified Decision Framework, Methods, and Evaluation](https://arxiv.org/abs/2609.03727)
...
### [240] [SimSkill: A Lifelong Learning AI Agent for Autonomous Mastery of Traffic Simulation](https://arxiv.org/abs/2609.03753)
...
### [241] [Rethinking World Models for Safety-Critical Embodied Systems](https://arxiv.org/abs/2609.03774)
...
### [242] [DNative-Twin: Decision Graphs and Digital Twins for Reconstructable Agentic Decisions](https://arxiv.org/abs/2609.03787)
...
### [243] [Transfiver: Human-AI Co-Inference through a Shared Editable State](https://arxiv.org/abs/2609.03797)
...
### [244] [Govern the Model, Not Only the Data: Storage, Circulation, and Learning in Creative AI](https://arxiv.org/abs/2609.03800)
...
### [245] [SVG-Score: Human-Aligned Evaluation of Text-to-SVG Generation](https://arxiv.org/abs/2609.03806)
...
### [246] [CauseCollab: Causal Unified and Modality-Agnostic Network for Heterogeneous Collaborative Perception](https://arxiv.org/abs/2609.03818)
...
### [247] [Semantic Bayesian World Models](https://arxiv.org/abs/2609.03834)
*Tommaso Soru*
...
### [248] [Adapting to Evolving Requirements: Agentic AI for Retail Supply Chain Operations](https://arxiv.org/abs/2609.03860)
...
### [249] [Bioinfoysis Technical Report](https://arxiv.org/abs/2609.03871)
...
### [268] [DRACO: Fine-Grained Credit Assignment with Dynamic Rubrics for Long-Horizon Agent Training](https://arxiv.org/abs/2609.04094)
...
### [269] [Why Gated DeltaNet Survives 4-Bit Quantization: NVFP4 W4A4 for the Recurrent Half of a Hybrid 27B LLM](https://arxiv.org/abs/2609.04098)
...
### [270] [Epistemic Warrant for LLM Recommendations: Characterizing the Basis for Reliance When Ground Truth Is Unavailable](https://arxiv.org/abs/2609.04127)
...
### [271] [Environment Evolution for Terminal Agents](https://arxiv.org/abs/2609.04128)
...
### [272] [The Natural Language Interaction Protocol and Standard for AI Agents](https://arxiv.org/abs/2609.04135)
...
### [273] [Efficient Test-Time Adaptation through Human-AI Interaction](https://arxiv.org/abs/2609.04141)
...
### [274] [Terminal-Universe: Turning Agent Trajectories into Scalable Terminal Environments](https://arxiv.org/abs/2609.04148)
...
### [275] [From Deceptive Outputs to Deceptive Mechanisms: A Causal Framework for Language-Model Deception Research](https://arxiv.org/abs/2609.04166)
...
### [276] [A Case Study on Emergent Cheating and Whistleblowing in Autonomous Research Swarms](https://arxiv.org/abs/2609.04170)
...
### [277] [Rethinking On-Policy Distillation of Large Language Models II: One Training Example](https://arxiv.org/abs/2609.04172)
...
### [278] [A Computationally Feasible Framework for Causal Probabilistic Explanation](https://arxiv.org/abs/2609.04177)
...
### [280] [Field-scale irrigation estimation using Sentinel-1 and Sentinel-2 data within a soil water balance model coupled to the Water Cloud Model](https://doi.org/10.1016/j.rse.2026.115639)
...
### [281] [Geostationary observations of air pollutants from biomass burning: A synergy of GIIRS and GEMS over Southeast Asia](https://doi.org/10.1016/j.rse.2026.115642)
...
### [282] [Using a planted tree biodiversity experiment to evaluate imaging spectroscopy for species classification](https://doi.org/10.1016/j.rse.2026.115644)
...
### [283] [An algorithm for the retrieval of particle backscattering, size, and suspended particulate matter in turbid coastal and estuarine waters (MOSAIC)](https://doi.org/10.1016/j.rse.2026.115629)
...
### [284] [On-demand global Landsat evapotranspiration product: development, evaluation, and dissemination](https://doi.org/10.1016/j.rse.2026.115633)
...
### [285] [Disentangling diverse findings on how urbanization, vegetation, and background climate shape the surface urban heat island at large scales](https://doi.org/10.1016/j.rse.2026.115637)
...
### [286] [Comparative analysis of contemporary remote sensing techniques and species distribution modelling in predicting spatial distribution of coastal habitats](https://doi.org/10.1016/j.rse.2026.115640)
...
### [287] [The BioSat indices designed for biodiversity science and conservation](https://doi.org/10.1016/j.rse.2026.115625)
...
### [288] [Corrigendum to ‘Angular anisotropy of Landsat and MODIS land surface temperature toward multi-source LST consistency’ [Remote Sens. Environ. 346 (2026) 115624]](https://doi.org/10.1016/j.rse.2026.115643)
...
### [289] [Multi-frequency microwave remote sensing reveals stratified forest responses to diverse drought stresses](https://doi.org/10.1016/j.jag.2026.105545)
...
### [290] [Improving text–image alignment for referring remote sensing image segmentation guided by vision foundation model](https://doi.org/10.1016/j.jag.2026.105439)
...
### [291] [Improving hourly PM2.5 estimation from geostationary satellite TOA reflectance through physically constrained multi-task learning](https://doi.org/10.1016/j.jag.2026.105546)
...
### [292] [SFMNet: Joint semantic and structural modeling via spatial–frequency collaboration for remote sensing scene segmentation](https://doi.org/10.1016/j.jag.2026.105541)
...
### [293] [Resolution-dependent divergence of optimal segmentation scale across land-cover types in a coastal wetland landscape: A systematic empirical characterization from 0.02 to 30 m near the Yellow River estuary, Dongying, China](https://doi.org/10.1016/j.jag.2026.105558)
...
### [294] [A multi-scale spatial-conditioned spectral routing network for hyperspectral and multispectral image fusion](https://doi.org/10.1016/j.jag.2026.105547)
...
### [295] [DPNet: A disaster perception network for building damage detection using single-temporal remote sensing imagery](https://doi.org/10.1016/j.jag.2026.105554)
...
### [296] [SRAIN: An isolated-neighborhood-based framework for LST-based surface thermal anomaly extraction](https://doi.org/10.1016/j.jag.2026.105542)
...
### [297] [PLGCA-SAM: Progressive local and global context-aware network incorporating SAM for remote sensing crop mapping](https://doi.org/10.1016/j.jag.2026.105548)
...
### [298] [Probabilistic associations between meteorological drought and compound moisture sources-transport anomalies in the middle and lower Yangtze River](https://doi.org/10.1016/j.jag.2026.105551)
...
### [299] [Tropoformer-S: iTransformer-based spatiotemporal reconstruction of three-dimensional tropospheric delay fields integrating ERA5 reanalysis and GNSS observations](https://doi.org/10.1016/j.jag.2026.105553)
...
### [300] [A spatiotemporal framework for identifying urban flood priority areas in megacities using social media data](https://doi.org/10.1016/j.jag.2026.105562)
...
### [301] [Quantifying lake expansion probability under compound glacier–climate forcing using a GCL-CPF framework integrating multi-source Earth observation and vine copula theory](https://doi.org/10.1016/j.jag.2026.105559)
...
### [302] [Modeling regional coseismic landslide intensity with an interpretable Log-Gaussian GAM: Integrating size, mobility, and their interactions](https://doi.org/10.1016/j.jag.2026.105563)

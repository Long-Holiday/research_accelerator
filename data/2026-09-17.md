...
Abstract (英文): Underwater semantic segmentation is essential for marine ecosystem monitoring, yet remains challenging due to severe visual degradation. Light absorption and scattering often lead to color shifts, low contrast, and blurred boundaries, making shallow detail features unreliable. Existing underwater segmentation methods improve RGB feature aggregation or boundary prediction, but still lack an explicit mechanism to distinguish structure-related details from degradation-induced responses. To address this limitation, we propose GeoCueFormer, a lightweight framework that combines geometry-constrained frequency enhancement with prediction-cued refinement. GeoCueFormer performs stage-specific wavelet enhancement on hierarchical encoder features to complement shallow boundary details while preserving deep structural semantics. A depth-derived spatial gate constrains shallow frequency enhancement toward geometry-consistent regions, and a prediction-cued dual-stage decoder further refines ambiguous high-resolution features. GeoCueFormer obtains 82.23% and 73.04% mIoU on SUIM and DUT, respectively. Under comparable model complexity and standard benchmark settings on SUIM and DUT, it achieves SOTA performance while maintaining a favorable accuracy-complexity trade-off. These results show that distinguishing structural details from degradation-induced interference is more effective for underwater segmentation.
...
Abstract (英文): Graphical User Interface (GUI) grounding is a fundamental perception task for multimodal agents, enabling them to interpret natural language instructions and interact with digital interfaces. Existing methods face a fundamental trade-off between accuracy and efficiency: direct full-image inference often fails to capture small or visually similar UI elements, while multi-crop strategies improve localization at the cost of multiple expensive Vision-Language Model (VLM) calls per query.
...
Abstract (英文): Graph-based retrieval-augmented generation (RAG) can help answer questions that require information from many documents. However, building a graph often requires many language-model calls during ingestion. It is therefore important to ask whether its quality gains justify the additional cost.
...
Abstract (英文): Agentic workflows now make consequential decisions in regulated settings, and the governance placed around them is almost entirely step-scoped: input-output classifiers, per turn rails, and span-level evaluators. The policies organizations actually hold, such as referral thresholds, authority limits, and review requirements, are properties of the whole execution rather than of any one step. This mismatch admits a failure mode we call a Compositional Policy Violation (CPV): every individual step passes its own check while the composed execution violates the governing policy. A predicate over a single step cannot evaluate a property that step does not determine, so no improvement in the accuracy of the step-scoped monitors detects this class. We define CPVs as the failure of step-level compliance to compose, and present a taxonomy of four types: Authority Creep, Threshold Laundering, Cumulative Sum Violation, and Context Collapse. We show that the correct repair for each class is dictated by where the guarded quantity mutates. We then introduce a provenance-aware runtime architecture that evaluates policies over complete execution traces, recomputing guarded quantities from raw provenance rather than the pipeline's derived representation.
...
### [178] [Editorial Board](https://doi.org/10.1016/s0924-2716(26)00455-7)
*Unknown Author*
...
### [179] [Four decades of Landsat-based river turbidity reconstruction reveal spatially heterogeneous declines across U.S. rivers](https://doi.org/10.1016/j.isprsjprs.2026.09.007)
...
### [180] [WheatScoper: A lightweight organ-based framework for multi-view wheat phenotyping using time-series RGB images](https://doi.org/10.1016/j.isprsjprs.2026.08.039)
...
### [181] [An ensemble version of fire potential index (eFPI) integrating seasonal variability in sub-pixel fuel composition](https://doi.org/10.1016/j.isprsjprs.2026.09.010)
...
### [182] [Real-time image absolute orientation framework with Optical-GNSS data fusion for lightweight UAVs](https://doi.org/10.1016/j.isprsjprs.2026.09.005)
...
### [183] [SAAD-SR: A multi-altitude aerial object detection benchmark evaluated using an altitude-conditioned distillation detector](https://doi.org/10.1016/j.isprsjprs.2026.09.006)
...
### [184] [Space-time dynamics of rainfed wheat yield in Ethiopia: Insights from remote sensing](https://doi.org/10.1016/j.isprsjprs.2026.08.037)
...
### [185] [When multimodal fusion helps or hurts: Exploring modality synergy and cross-scene transferability for mangrove species mapping](https://doi.org/10.1016/j.isprsjprs.2026.08.036)
...
### [186] [Structure-preserving feature disentanglement with an adaptive transformer for unsupervised cross-domain object detection in heterogeneous SAR imagery](https://doi.org/10.1016/j.isprsjprs.2026.08.044)
...
### [187] [Toward scalable organ-level 3D plant segmentation: A systematic and quantitative review through the lens of the data-algorithm-computing triangle](https://doi.org/10.1016/j.isprsjprs.2026.09.003)
...
### [188] [A novel change homogenizing flood index and an expedited locally tuned Markov random field model for unsupervised rural floodwater detection in sentinel-1 data: An application to flood impact assessment](https://doi.org/10.1016/j.isprsjprs.2026.08.021)
...
### [189] [Conditional diffusion model with residual decomposition generation strategy for SAR to optical image translation](https://doi.org/10.1016/j.isprsjprs.2026.08.043)
...
### [190] [Nonlinear responses of net ecosystem productivity to heatwaves over the Qinghai–Tibetan Plateau: insights from climate and vegetation](https://doi.org/10.1080/15481603.2026.2728311)
...
### [191] [MambaMPD: a mamba-driven segmentation framework for marine pollution detection from remote sensing imagery](https://doi.org/10.1080/15481603.2026.2730893)
...
### [192] [High-resolution land cover mapping from coarse labels via a noisy label learning-guided cross-scale framework](https://doi.org/10.1080/15481603.2026.2726002)
...
### [193] [Audio-visual fusion for near-surface wind speed estimation using surveillance cameras](https://doi.org/10.1080/15481603.2026.2731700)
...
### [194] [Shifting pathways of post-earthquake vegetation structural and functional recovery under varying earthquake disturbance intensities](https://doi.org/10.1080/15481603.2026.2728759)
...
### [195] [Context-aware quantile baselines for disturbance detection in non-stationary short-rotation forest plantations](https://doi.org/10.1016/j.jag.2026.105555)
...
### [196] [Monitoring global mangrove spatial evolution and functional degradation using BTSAD and CBPA methods over a 36-year dense Landsat and HLSv2.0 time series](https://doi.org/10.1016/j.rse.2026.115656)
...
### [197] [Editorial Board](https://doi.org/10.1016/s0034-4257(26)00423-2)
*Unknown Author*
...
### [198] [Next frontier of Earth observation: Quantum-enhanced multispectral remote sensing for ultra-low signal environments](https://doi.org/10.1016/j.rse.2026.115665)
...
### [199] [Unified knowledge transfer boosts individual tree crown segmentation without scene-specific labels](https://doi.org/10.1016/j.rse.2026.115646)
...
### [200] [Reconstructing cloud-free Sentinel-2 time series under complex degradations with state-driven spatio-temporal modeling](https://doi.org/10.1016/j.rse.2026.115661)
...
### [201] [Deep learning-based forest disturbance detection for Europe using Landsat time series](https://doi.org/10.1016/j.rse.2026.115670)
...
### [202] [First vegetation optical depth product retrieved from FengYun-3D X-band observations](https://doi.org/10.1016/j.rse.2026.115647)
...
### [203] [Multitemporal InSAR analysis of long-term creep and active thickness changes in a paleo riverbank landslide driven by anomalous water levels](https://doi.org/10.1016/j.rse.2026.115657)
...
### [204] [A knowledge-guided machine learning framework for cross-scale wheat harvest monitoring via sample augmentation](https://doi.org/10.1016/j.rse.2026.115671)
...
### [205] [Development of a new water stress index combining PRI and soil moisture for assessing olive tree water status in Morocco](https://doi.org/10.1016/j.rse.2026.115676)
...
### [206] [Sentinel-2 Forel–Ule Index as a Proxy for Ecological Status in Reservoirs: A Case Study in Southern Portugal](https://doi.org/10.3390/rs18183109)
...
### [207] [Scattering–Semantic Collaborative Learning via Asymmetric Dual-Branch DINO Network for Inshore SAR Ship Detection](https://doi.org/10.3390/rs18183110)
...
### [208] [MTCPNet: A Mamba-Based Registration Network with Tri-Branch Consistency Projection for SAR-Visible Image Registration](https://doi.org/10.3390/rs18183114)
...
### [209] [Semantic-Driven Adversarial Reconstruction Learning for Open-Set Recognition in Remote Sensing Imagery](https://doi.org/10.3390/rs18183101)
...
### [210] [A Comprehensive Evaluation of Deep Learning-Based Image Super-Resolution for GCP Chip Matching Using High-Resolution Satellite Imagery](https://doi.org/10.3390/rs18183104)
...
### [211] [Assessing the Contributions and Thresholds of Multi-Source Remote Sensing Informatiuon in Vegetation Aboveground Biomass Estimation Under Optical Saturation](https://doi.org/10.3390/rs18183113)
...
### [212] [A Spatial Prior-Guided Feature Enhancement and Multi-Branch Complementary Learning Framework for Small Ship Detection in SAR Images](https://doi.org/10.3390/rs18183106)
...
### [213] [Wildfire Scar Detection in Mediterranean Chile Using Sentinel-1 InSAR Coherence and Machine Learning: The 2017 “Las Máquinas” Megafire](https://doi.org/10.3390/rs18183105)
...
### [214] [Properties and Temporal Evolution of an Elevated Arctic Liquid Fog by Lidar](https://doi.org/10.3390/rs18183111)
...
### [215] [ZOS-Net: A Lightweight RGB-T Object Detection Network with Cross-Modal Relation Enhancement and Selective Target Awareness](https://doi.org/10.3390/rs18183112)
...
### [216] [Hierarchical Sparsity-Guided DeepLassoNet: Interpretable PolSAR Feature Selection for Typical Land-Cover Classification in the Hunshandake Sandy Land](https://doi.org/10.3390/rs18183103)
...
### [217] [Plastic Greenhouse Extraction Based on Index-Guided Three-Stage Large-Factor Remote Sensing Image Super-Resolution Reconstruction](https://doi.org/10.3390/rs18183108)
...
### [218] [Deep Learning-Based Classification of Plunging Breaker Conditions Using Simulation Radar HRRP Sea-Surface Scattering Data](https://doi.org/10.3390/rs18183102)
...
### [219] [Extending Multidimensional Rao’s Quadratic Entropy to Optical–Radar Lava-Flow Mapping Using Sentinel-1 and Sentinel-2: Evidence from the 2021 La Palma Eruption](https://doi.org/10.3390/rs18183115)
...
### [220] [Crop Yield Estimation with MODIS Derived Normalized Difference Vegetation Index and Comparative Study on Crop Yield Prediction Among Linear Regression, Random Forest and Gradient Boosting as Well as CatBoost](https://doi.org/10.3390/rs18183107)
...
### [221] [Adaptive Neural Network Approaches in Remote Sensing Imagery: A Systematic Review](https://doi.org/10.3390/rs18183116)

...
- [RSE](#RSE) [Total: 2]
- [JAG](#JAG) [Total: 11]
- [Remote Sensing](#Remote Sensing) [Total: 84]
...
Abstract (英文): Human-pet interaction estimation and generation remain underexplored due to the absence of a high-quality large-scale dataset. We present InterPet4D, the first multimodal dataset capturing natural interactions between humans and dogs. Using a synchronized multi-view capture system, we record human-dog obedience tasks and provide annotations for both humans and dogs, including multi-view and egocentric videos, segmentations, 2D and 3D keypoints, meshes, and audio tracks. InterPet4D consists of 6.8 million frames collected from 13 dogs of 11 breeds interacting with 23 human participants. We further introduce the InterPetMoGen framework for human-pet interaction motion generation. Our proposed model achieves an FID score of 11.21 and substantially outperforms the Seq2Seq and DiT baselines, demonstrating the effectiveness of InterPet4D for modeling realistic human-pet interactions.
...
Abstract (英文): Vision Language Models (VLMs) offer powerful multimodal ability but also expose users to text-based privacy attacks where adversaries crawl online photos and query VLMs to extract sensitive attributes. Existing reversible adversarial example (RAE) methods protect images in purely visual tasks but fail in multimodal settings, and current adversarial examples on VLMs rely on high frequency noise that severely degrades visual quality. We propose CloakDiff, the first framework for reversible, high fidelity privacy protection against text-based query attacks in VLMs. CloakDiff produces imperceptible adversarial examples by combining diffusion based adversarial editing with an invertible network that embeds the original image for lossless recovery. It perturbs both pixel space embeddings and manipulates latent cross attention maps to ensure strong cross-model and cross-prompt transferability while preserving global visual structure. To further enhance fidelity, we design EDM Heuristic Sampling, a principled diffusion schedule for adversarial guidance. Experiments on multiple datasets and VLMs demonstrate that CloakDiff delivers multimodal privacy preservation with high visual quality and reversibility.
...
Abstract (英文): Edge deployment is often the preferred solution for industrial machine vision systems when low latency, data security, or limited connectivity are critical requirements. Several frameworks are available to optimise inference on edge devices; however, relatively few studies have systematically compared their inference-time performance under industrial deployment conditions.
...
### [152] [Uncertainty Quantification for EO Regression Tasks: Building Height, Tree Canopy Height and Above-ground Biomass Estimation](https://arxiv.org/abs/2607.11412)
...
### [189] [Leveraging EMIT spectroscopy and machine learning to estimate soil texture and particle grain size in dust-producing regions](https://doi.org/10.1016/j.rse.2026.115557)
...
### [190] [Optimizing 1D-Var near-surface wind speed from SSMIS with RapidScat](https://doi.org/10.1016/j.rse.2026.115560)
*Sisma Samuel,Anton Verhoef,Ad Stoffelen*
...
### [191] [Multi-source complementary feature self-integration network for geological lithology interpretation](https://doi.org/10.1016/j.jag.2026.105463)
...
### [192] [Feasibility of space-borne remote sensing to detect features related to CO2 and N2O exchange of boreal agricultural fields](https://doi.org/10.1016/j.jag.2026.105455)
...
### [193] [Geomorphology-constrained bathymetric inversion of turbid tidal channels using centerline-network priors and machine learning](https://doi.org/10.1016/j.jag.2026.105465)
...
### [194] [Spatiotemporal fusion of radar backscatter for enhanced monitoring of surface melt dynamics over Antarctic ice shelves](https://doi.org/10.1016/j.jag.2026.105448)
...
### [195] [Mapping the extent, type and remnant areas of the coastal dunes of Australia and New Zealand by integrating multi-source data](https://doi.org/10.1016/j.jag.2026.105464)
...
### [196] [C2D2: Matching UAV images with cycle-consistency and channel-separation for joint detector and descriptor](https://doi.org/10.1016/j.jag.2026.105451)
...
### [197] [Time-series framework integrating rainfall and satellite soil moisture for multi-scale urban flood risk assessment](https://doi.org/10.1016/j.jag.2026.105470)
*Sang Yeob Kim*
...
### [198] [Referring Remote Sensing Image Segmentation method based on Scene-Aware Guided Network model](https://doi.org/10.1016/j.jag.2026.105457)
...
### [199] [A SIF-Constrained Noah-MP land surface model for simulating water use efficiency and drought Resilience: Application in a Semi-Arid Basin](https://doi.org/10.1016/j.jag.2026.105460)
...
### [200] [A two-stage machine learning framework for Chl-a reconstruction and short-term prediction in eutrophic lakes using GOCI observations](https://doi.org/10.1016/j.jag.2026.105468)
...
### [202] [Simulation of BepiColombo’s Gravity Investigation with Dynamical Mismodeling](https://doi.org/10.3390/rs18132253)
...
### [203] [Realistic Error Budget and Cross-Validation of Sentinel-1 3D Displacement for the 2025 Dingri Earthquake](https://doi.org/10.3390/rs18132252)
*Zhangdi Xie*
...
### [204] [Physically Consistent SAR Image Generation for Unseen Aspect Angles via Attributed Scattering Center Evolution](https://doi.org/10.3390/rs18132247)
...
### [205] [Mapping Evapotranspiration Patterns in the Desert-Oasis Ecotone Using UAV-Based Thermal Infrared Imagery with a Three-Temperature Model](https://doi.org/10.3390/rs18132242)
...
### [206] [Multi-Scale Assessment of Nighttime Heat Health Risk and Dominant Factors Using MODIS and SDGSAT-1 Observations](https://doi.org/10.3390/rs18132243)
...
### [207] [Estimation of High-Resolution Multi-Layer Soil Moisture Using Land Data Assimilation and the Three-Cornered Hat Method](https://doi.org/10.3390/rs18132248)
...
### [208] [Reconstruction of Land Surface Temperature Based on EATC Constraints and Spatially Adaptive Residual Correction: A Case Study of the Qinghai–Tibet Engineering Corridor](https://doi.org/10.3390/rs18132254)
...
### [209] [Filling Satellite Microwave Observation Gaps via Generative Synthesis](https://doi.org/10.3390/rs18132256)
...
### [210] [Spatial-Temporal Evolution of Proglacial Lake Volumes and Estimation Models in the Himalaya and Nyainqentanglha Ranges](https://doi.org/10.3390/rs18132249)
...
### [211] [DEAF-Net: Dual-Domain Enhanced Adaptive Fusion Network for UAV Visible–Infrared Object Detection](https://doi.org/10.3390/rs18132241)
...
### [212] [Stereo Matching in Satellite Imagery: A Depth Estimation Foundation Model-Assisted Iterative Approach](https://doi.org/10.3390/rs18132245)
*Kunpeng Hu,Wei Zhao*
...
### [213] [An Adaptive Wet Tropospheric Correction Method Using a Spaceborne Microwave Radiometer](https://doi.org/10.3390/rs18132250)
...
### [214] [On the Spectral–Phenological Features for Crop Mapping Under Complex Planting Patterns: A Case Study in Jiangsu Province, China](https://doi.org/10.3390/rs18132244)
...
### [215] [Deep Learning Enables the Automatic Mapping of Tell Sites on Satellite Synthetic Aperture Radar Products](https://doi.org/10.3390/rs18132255)
...
### [216] [Mapping Acid Mine Drainage Areas with Sentinel-2 and WorldView-3 VNIR Satellite Images: An Example in the SE of Spain](https://doi.org/10.3390/rs18132240)
...
### [217] [A Sentinel-2-Based Framework for Methane Point-Source Detection and Quantification Using Low-Reflectance Artifact Detection](https://doi.org/10.3390/rs18132251)
...
### [218] [The Impact of Dynamic Observation Error and Hydrometeor Control Variables on GK-2A AMI All-Sky Radiance Assimilation](https://doi.org/10.3390/rs18132246)
...
### [219] [GHF-DETR: An Improved DETR Framework with a Multi-Path Backbone and Dual-Domain Downsampling for UAV Object Detection](https://doi.org/10.3390/rs18132239)
...
### [220] [Development of PXB-BVC Framework for Multivariate Flood-Risk Assessment Under Climate Change](https://doi.org/10.3390/rs18142275)
...
### [221] [CAF-Net: A Unified Framework for Resolving Spatial–Frequency Representation Conflicts in Multimodal Remote Sensing Segmentation](https://doi.org/10.3390/rs18142284)
...
### [222] [Lightweight Raw Echo Image Preprocessing for Long-Range Airborne Streak Tube Imaging LiDAR Using Adaptive Frequency-Domain Noise Suppression](https://doi.org/10.3390/rs18142281)
...
### [223] [Comparing DESIS Hyperspectral and Landsat 10 Simulated Superspectral Data for Crop Type Classification in California’s Central Valley](https://doi.org/10.3390/rs18142282)
...
### [224] [Earth Observation Data and Indigenous Perspectives: Two-Eyed Seeing Approach to Understanding Long-Term Wildfire and Landscape Changes](https://doi.org/10.3390/rs18132259)
...
### [225] [Intraspecific Drought Stress Responses Detected Using Remotely Sensed Vegetation Indices in Sitka Spruce (Picea sitchensis)](https://doi.org/10.3390/rs18142280)
...
### [226] [Water Anomaly Type Identification Based on Deep Multisphere Decision Boundaries Using Remote Sensing Data](https://doi.org/10.3390/rs18142273)
...
### [227] [Consistent-Innovation-Aided Distributed Cooperative Localization for Multi-UAV Navigation in GNSS-Denied Environments](https://doi.org/10.3390/rs18142286)
...
### [228] [Revealing the Driving Mechanism of Urban Development Based on the 3D Building Morphological Changes in the Beijing–Tianjin–Hebei Region](https://doi.org/10.3390/rs18142276)
...
### [229] [DWFSeg: A Dynamic Multiscale Feature Fusion and Dual Attention-Enhanced Network for High-Precision Water Body Segmentation Based on Super-Resolution Remote Sensing Imagery](https://doi.org/10.3390/rs18142271)
...
### [230] [A Multi-Stage Outlier Removal Method for Point Clouds with High Outlier Ratio](https://doi.org/10.3390/rs18142289)
...
### [231] [Synergistic SAR and Wide-Swath Interferometric Altimetry Observations for Estimating Flood Dynamics and Water Storage Variations in East Dongting Lake](https://doi.org/10.3390/rs18142283)
...
### [232] [Spectral Variability and Prediction of Nitrogen, Phosphorus, and Potassium in Fresh Sugarcane (Saccharum officinarum) Leaves by VIS–NIR–SWIR Spectroscopy](https://doi.org/10.3390/rs18132260)
...
### [233] [A Parcel-Level Asynchronous SpatioTemporal Framework for Cropping Pattern Classification in Fragmented Agricultural Landscapes](https://doi.org/10.3390/rs18142268)
...
### [234] [WCMNet: A Wavelet-Guided and CNN–Mamba Hybrid Network Approach for Unsupervised Domain Adaptation in Building Extraction](https://doi.org/10.3390/rs18132265)
...
### [235] [RadarEchoMamba: A Fast, High-Fidelity Pyramidal Bidirectional Mamba Model for Radar Echo Extrapolation](https://doi.org/10.3390/rs18142287)
...
### [236] [Cross-Platform Comparison of Marine Boundary Layer Cloud and Drizzle Properties over the Southern Ocean Using Airborne, Shipborne, and Satellite Observations](https://doi.org/10.3390/rs18132262)
...
### [237] [Attention-Guided Generative Adversarial Network for False Alarm-Resistant Change Detection in Remote Sensing Orthophotos](https://doi.org/10.3390/rs18142290)
...
### [238] [Comparative Scientometric Assessment of Remote Sensing Journals in 2025 Across Seven Performance Indicators](https://doi.org/10.3390/rs18142267)
...
### [239] [A Novel Photogrammetry-Based Data Generation Technique for Post-Disaster Human Detection in UAV Imagery](https://doi.org/10.3390/rs18142272)
...
### [240] [Using UAV-Based RGB and Multispectral Imagery to Estimate Cotton Above-Ground Biomass by Integrating Multi-Modal Features and Machine Learning Algorithms](https://doi.org/10.3390/rs18142278)
...
### [241] [Spatiotemporal Dynamics and Influencing Factors of Landscape Ecological Risk in the Shandong Peninsula Urban Agglomeration Based on Sub-Watershed Units](https://doi.org/10.3390/rs18132266)
...
### [242] [A Novel Target Extraction and Energy-Balancing Method for HoloSAR 3D Imaging](https://doi.org/10.3390/rs18142274)
...
### [243] [Automated Victim Detection from UAV Thermal Infrared Imagery for Nighttime Search and Rescue Using Multi-Pose Ground Camera Data](https://doi.org/10.3390/rs18142279)
...
### [244] [CT-TreeFlow: Probabilistic Groundwater-Potential Mapping Using Remote Sensing-Derived Environmental Predictors in Karst Aquifers](https://doi.org/10.3390/rs18132258)
...
### [245] [Research on the Evolution Mode and Growth Characteristics of Urban Blue–Green Space Based on Landsat Data and National Policy Driven: A Case Study of the Shandong Peninsula Urban Agglomeration](https://doi.org/10.3390/rs18142277)
...
### [246] [Few-Shot Remote Sensing Scene Classification via Fusion of Zigzag Scanning Feature Sequence and Riemannian Geometric Barycenter Network](https://doi.org/10.3390/rs18132264)
...
### [247] [Aquatic Vegetation Classification in Crab Ponds Using UAV Multispectral Imagery and a Multi-Scale Frequency-Spatial Collaborative Model](https://doi.org/10.3390/rs18142269)
...
### [248] [Landslide Susceptibility Mapping Using Multi-Source Geospatial Data and XGBoost](https://doi.org/10.3390/rs18142270)
...
### [249] [A Scale-Invariance-Based Algorithm Application for Land Surface Temperature Downscaling in Denmark](https://doi.org/10.3390/rs18132263)
...
### [250] [Intensifying Drought Under a Warming–Wetting Climate: Multi-Scale Impacts on Vegetation Phenology and Productivity in Xinjiang, China](https://doi.org/10.3390/rs18142285)
...
### [251] [Phenology-Adaptive Maize Mapping Using an Enhanced Red-Edge NDVI from Sentinel-2 Across Representative Global Agroecosystems](https://doi.org/10.3390/rs18132261)
...
### [252] [Crop-Tool-Augmented Active Perception with Reinforcement Learning for High-Resolution Remote Sensing Visual Question Answering](https://doi.org/10.3390/rs18142288)
...
### [253] [UAV-Based Photogrammetric Inspection in Deep Vertical Shafts: A Case Study from the KGHM GG-1 Mineshaft in Poland](https://doi.org/10.3390/rs18132257)
...
### [254] [Using Remote Sensing Data and Google Earth Engine to Quantify Regional Climate Responses to Afforestation](https://doi.org/10.3390/rs18142305)
...
### [255] [DMSF-Net: A Dual-Encoder Multi-Source Feature Fusion Network for Fine-Grained Urban Green Space Segmentation](https://doi.org/10.3390/rs18142308)
...
### [256] [Integrating Multi-Source Remote Sensing and Meteorological Features for Fine Mapping of Crop in Liaoning Province](https://doi.org/10.3390/rs18142301)
...
### [257] [Large-Scale Interseismic Crustal Deformation, Fault Slip Rate, Coupling and Earthquake Potential in the Upper Yellow River Basin](https://doi.org/10.3390/rs18142297)
...
### [258] [A Hybrid CNN–Transformer Model for Terrace Extraction from Remote Sensing Imagery](https://doi.org/10.3390/rs18142291)
...
### [259] [A Modular and Transferable Framework for Enhancing Satellite-Derived Daily Precipitation: Adjusting Values, Aligning Distributions, and Preserving Extremes](https://doi.org/10.3390/rs18142298)
...
### [260] [Short-Term Forecasting of Ocean Surface Current Maps Using High-Frequency Radar Observations and LSTM Neural Networks: A Case Study of Southwestern Taiwan](https://doi.org/10.3390/rs18142303)
...
### [261] [Flash Drought Dynamics in China’s Major Agricultural Plains: Spatiotemporal Patterns and Crop Photosynthetic Recovery Across Cropping Systems](https://doi.org/10.3390/rs18142295)
...
### [262] [Temporary Floodplain Ponds Shape Vegetation Mosaic in a Natural River Valley: Evidence from SAR and Optical Remote Sensing](https://doi.org/10.3390/rs18142292)
...
### [263] [Large-Scale Stratigraphic Analysis of Paintings by OCT: A Supervised Learning and Volumetric Stitching Approach](https://doi.org/10.3390/rs18142300)
...
### [264] [Spatiotemporal Variation and Drivers of Vegetation Phenology Along an Urban–Rural Gradient in Rapidly Urbanizing Beijing, China](https://doi.org/10.3390/rs18142302)
...
### [265] [A Multi-Source Remote Sensing-Based AGB Synergistic Inversion Approach Integrating Terrain-Corrected Canopy Height and Forest-Type Heterogeneity](https://doi.org/10.3390/rs18142304)
...
### [266] [VFM-MoME: A Remote Sensing Landslide Image Segmentation Network Guided by a Visual Foundation Model and a Mixture of Mamba Experts](https://doi.org/10.3390/rs18142293)
...
### [267] [Vertical Structure of Air Temperature Excesses of the 2025 Mw 8.8 Kamchatka Earthquake](https://doi.org/10.3390/rs18142306)
...
### [268] [VODet: A Vertex Offset-Based Method for Oriented Object Detection in Remote Sensing Images](https://doi.org/10.3390/rs18142296)
...
### [269] [PanDiM: A Diffusion Mamba Network for High-Fidelity Pansharpening](https://doi.org/10.3390/rs18142299)
...
### [270] [Monitoring and Prediction of Ground Deformation Using InSAR and Machine Learning Approaches in Tianjin City, China](https://doi.org/10.3390/rs18142294)
...
### [271] [Geohazard Risk Identification and Validation in Hunan Province Using Synergistic Multi-Resolution SAR Monitoring](https://doi.org/10.3390/rs18142307)
...
### [272] [Surface Heat Source Variations and Driving Factors in Typical Permafrost Areas of the Tibetan Plateau](https://doi.org/10.3390/rs18142312)
...
### [273] [Integrating Deep Generative AI and Hyperspectral–Multispectral Data Fusion for Enhancing Digital Soil Mapping](https://doi.org/10.3390/rs18142320)
...
### [274] [Independent Multi-Sensor Validation of Machine-Learning Landslide Susceptibility: Footprint Construction Decides the Verdict—May 2023 Emilia-Romagna Event](https://doi.org/10.3390/rs18142318)
...
### [275] [Nonlinear Responses and Spatial Heterogeneity of Net Ecosystem Productivity to Extreme Weather Events in Central Asia](https://doi.org/10.3390/rs18142315)
...
### [276] [Structure-Confidence Guided Phase Congruency and Cascade Matching for Registration of Optical and SAR Images](https://doi.org/10.3390/rs18142322)
...
### [277] [Joint Cross-Range Scaling and Phase Autofocus for ISAR Imaging Based on Adaptive Phase Tracking with Application to Asteroid Imaging](https://doi.org/10.3390/rs18142311)
...
### [278] [Research on Few-Shot Mars Rover Onboard Surface Scene Classification Based on SE-ResNet-MTL](https://doi.org/10.3390/rs18142319)
...
### [279] [Multi-Stage Aggregation CNN–Transformer Hybrid Architecture for Infrared Small-Target Detection](https://doi.org/10.3390/rs18142309)
...
### [280] [Influence of Internal Climate Variability on Satellite-Altimeter-Derived Regional Sea-Level Trends](https://doi.org/10.3390/rs18142313)
*Se‐Hyeon Cheon*
...
### [281] [Physics-Informed Semantic Prompt Learning for Few-Shot Low-Altitude Radar Target Recognition in Remote Sensing](https://doi.org/10.3390/rs18142316)
...
### [282] [A Sub-Scene-Based GNSS-Constrained Structure from Motion for Robust Long-Corridor UAV Image Reconstruction](https://doi.org/10.3390/rs18142321)
...
### [283] [Climate-Driven Phenological Responses of Fagus sylvatica Across European Climatic Zones Using Remote Sensing](https://doi.org/10.3390/rs18142314)
...
### [284] [Removing Cirrus-Induced Errors in Operational Landsat 8 and 9 Daytime Surface Temperature Products over Waters](https://doi.org/10.3390/rs18142317)
...
### [285] [Exploring the Potential of Machine Learning Post-Processing to Generate ERA5-Consistent Atmospheric Profiles from Geostationary Satellite Retrievals](https://doi.org/10.3390/rs18142310)
...
### [286] [PRGD: Proximal Residual-Guided Diffusion with pattern-aware experts for remote sensing image super-resolution](https://doi.org/10.1016/j.isprsjprs.2026.06.037)
...
### [287] [Unveiling strong microclimatic cooling by small wetlands in China: landscape context-dependent spatial and climatic drivers](https://doi.org/10.1016/j.isprsjprs.2026.07.002)
...
### [288] [CDHNet: An implicit calibration and difference-guided hierarchical perception change detection network for remote sensing images](https://doi.org/10.1016/j.isprsjprs.2026.06.040)
...
### [289] [Monitoring mining impacts using harmonic decomposition of time series vegetation indices](https://doi.org/10.1016/j.isprsjprs.2026.07.001)
...
### [290] [A coherence time-series framework for earthquake-induced building damage detection using SAR](https://doi.org/10.1080/15481603.2026.2698138)
...
### [291] [Can the MODIS EVI formula be directly applied to other sensor data? A case study with Landsat data](https://doi.org/10.1080/15481603.2026.2697413)
...
### [292] [Correction](https://doi.org/10.1080/15481603.2026.2700880)
*Unknown Author*
...
### [293] [Analyzing dominant driving factors of ground deformation in mining area via multimodal feature fusion and explainable modeling](https://doi.org/10.1080/15481603.2026.2700121)
...
### [294] [Coupling functional heterogeneity activation and distance impedance: a distance-decay model for urban population spatial interactions](https://doi.org/10.1080/15481603.2026.2698143)
*Junhao Wang,Rui Li,Jing Xia,Xiaorui Yang,Weifeng Xu,Rui Guo*
...
Abstract (英文): Distance-decay models, which formulate the relationship between interaction intensity and distance, are fundamental to understanding population spatial interactions. However, classical models struggle to capture the non-monotonic distance-decay patterns in cities, while statistically driven models lack geographic semantic interpretability for their parameters. Therefore, we propose the Activation-Impedance Decay Model (AIDM). Building upon the distance friction effect, AIDM integrates the driving force of urban functional heterogeneity on spatial interactions. By quantifying this force as an activation process of interaction potential that increases non-linearly with distance, the model accurately reproduces the hump-shaped distribution of spatial interaction. Considering the fractal properties of urban structures and functions, power-law functions are employed to model the non-linear spatial transition gradients of functional heterogeneity and distance friction. In addition, AIDM introduces two parameters with explicit geographical semantics to quantify the characteristic spatial scales of urban population interactions: one represents the local functional homogeneity scale (ranging from hundreds of meters to several kilometers), within which functional similarity suppresses spatial interactions; the other denotes the distance friction scale (on the order of several kilometers), beyond which increasing travel costs rapidly outweigh interaction benefits, thereby significantly reducing interaction intensity. These parameters provide an interpretable quantification of the effective spatial ranges of functional complementarity and distance friction, thereby revealing the underlying spatial mechanisms shaping intra-urban interaction patterns. Experimental results across different spatial scales of diverse cities demonstrate that AIDM consistently outperforms baseline models, achieving an AIC reduction of over 29.9%. Correlation analyses with urban functional and structural characteristics further validate the AIDM parameters' geographical semantics. In empirical applications, population spatial accessibility derived from AIDM aligns closely with observed urban vitality distribution. Furthermore, the model effectively differentiates variations in interaction intensities and patterns across distinct functional units. Thus, AIDM provides an interpretable analytical framework for uncovering the regularities of complex intra-urban population spatial interactions.
...
### [295] [From ML Predictions to Informed Diagnostic Assistance Using the Toulmin Model of Argumentation](https://arxiv.org/abs/2607.09664)
...
Abstract (英文): Least privilege, the principle that an identity should hold only the permissions strictly required for its task, has been a foundational primitive of access control for decades. We argue that this principle is insufficient for agentic AI systems, which do not merely hold permissions but can combine, approve, and amplify them across workflows and system boundaries.
...
### [310] [SupplyNetPy: An Open-Source Python Library for High-Fidelity Modeling and Simulation of Arbitrary Supply Chain and Inventory Networks](https://arxiv.org/abs/2607.09745)
...
### [312] [Task-Conditioned Synthetic Data Generation for Improving Machine Learning Performance in Agricultural Prediction Tasks](https://arxiv.org/abs/2607.09751)
...
### [330] [MAG: A Web-Agent Benchmark and Harness for Multimodal Action and Guide Generation](https://arxiv.org/abs/2607.10079)
...
### [333] [IdeaTrail: Full-Process Agent Trajectories for Scientific Ideation](https://arxiv.org/abs/2607.10144)
*Hengquan Guo*
...
### [341] [SPARK: Susceptibility-Guided Profiling and Steering of Latent Reasoning States in Large Language Models](https://arxiv.org/abs/2607.10296)
...
### [350] [AI YOU Town: Make Friends and Money with Your Digital Twin](https://arxiv.org/abs/2607.10539)
...
### [357] [The Compliance Trap: Diagnosing How AI Agents Consume Conflicting Memory](https://arxiv.org/abs/2607.10608)
...
### [369] [SETA: Scaling Environments for Terminal Agents](https://arxiv.org/abs/2607.10891)
...
### [372] [SVR-R1: Bootstrapping Multi-modal Reasoning with Self-verification in Reinforcement Learning](https://arxiv.org/abs/2607.10966)
...
### [398] [Omni-Decision: A Progressive Evidence-State Agent System for Omni-Modal QA](https://arxiv.org/abs/2607.11433)
...
### [404] [MAGIC: Transition-Aware Generation of Navigable Multi-Scene Game Worlds with Large Language Models](https://arxiv.org/abs/2607.11594)
...
Abstract (英文): There are two standard ways to spend more compute at test time: let a model reason longer, or sample more attempts and keep one. Both share a hidden limit: they are internal. Every extra token comes from the same frozen weights and the same prompt, so neither can tell the model anything it does not already know. We study a third way, interaction: the model proposes an artifact, an external instrument observes how it actually behaves, and the model revises. Each cycle imports a real observation, so interaction breaks through the ceiling the other two hit.
...
### [406] [Auditing the Risk Claims of Distributional Reinforcement Learning](https://arxiv.org/abs/2607.11607)
*Hari Prasad*
...
Abstract (英文): Self-refinement often fails to strengthen few-shot inductive reasoning in large language models. Prompting a model to explicitly state its inferred rule does little on its own. What actually matters is a structurally enforced isolation between reasoning stages, so that information can only pass between them as a compressed symbolic state.
...
### [410] [Playful AI in Professional Email: A Field Experiment on Tone and Recipient Engagement](https://arxiv.org/abs/2607.11749)

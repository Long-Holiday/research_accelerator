...
### [97] [PRGD: Proximal Residual-Guided Diffusion with pattern-aware experts for remote sensing image super-resolution](https://doi.org/10.1016/j.isprsjprs.2026.06.037)
...
### [98] [Unveiling strong microclimatic cooling by small wetlands in China: landscape context-dependent spatial and climatic drivers](https://doi.org/10.1016/j.isprsjprs.2026.07.002)
...
### [99] [CDHNet: An implicit calibration and difference-guided hierarchical perception change detection network for remote sensing images](https://doi.org/10.1016/j.isprsjprs.2026.06.040)
...
### [100] [Monitoring mining impacts using harmonic decomposition of time series vegetation indices](https://doi.org/10.1016/j.isprsjprs.2026.07.001)
...
### [101] [UniOrtho: From view-centric to unified orthographic framework for satellite semantic 3D reconstruction](https://doi.org/10.1016/j.isprsjprs.2026.06.039)
...
### [102] [Optimal Adaptive Market Making: A Theoretical Framework for High-Yield Liquidity Provision in Perpetual Futures Markets](https://arxiv.org/abs/2607.11888)
*Minmin Zeng,Yi Liu*
...
Abstract (英文): Good tasks are correct, solvable, verifiable, well-specified, and hard for interesting reasons. The best tasks describe a real problem an experienced practitioner would recognize, in language a practitioner would use, with tests that verify the outcome rather than the approach.

</details>


### [118] [Rethinking the Evaluation of Harness Evolution for Agents](https://arxiv.org/abs/2607.12227)
...
### [129] [TRACE: An Operational Reasoning Schema for Auditable Agentic Commitments](https://arxiv.org/abs/2607.12480)
...
### [142] [Who Grades the Grader? Co-Evolving Evaluation Metrics and Skills for Self-Improving LLM Agents](https://arxiv.org/abs/2607.12790)
...
### [144] [Human-AI Agent Interaction as a Neuroplastic Training Environment](https://arxiv.org/abs/2607.12823)
...
### [147] [MemOps: Benchmarking Lifecycle Memory Operations in Long-Horizon Conversations](https://arxiv.org/abs/2607.12893)
...
### [154] [Do AI Agents Know When a Task Is Simple? Toward Complexity-Aware Reasoning and Execution](https://arxiv.org/abs/2607.13034)
...
### [155] [Spatiotemporal fusion of radar backscatter for enhanced monitoring of surface melt dynamics over Antarctic ice shelves](https://doi.org/10.1016/j.jag.2026.105448)
...
### [156] [C2D2: Matching UAV images with cycle-consistency and channel-separation for joint detector and descriptor](https://doi.org/10.1016/j.jag.2026.105451)
...
### [157] [Time-series framework integrating rainfall and satellite soil moisture for multi-scale urban flood risk assessment](https://doi.org/10.1016/j.jag.2026.105470)
*Sang Yeob Kim*
...
### [158] [Referring Remote Sensing Image Segmentation method based on Scene-Aware Guided Network model](https://doi.org/10.1016/j.jag.2026.105457)
...
### [159] [A SIF-Constrained Noah-MP land surface model for simulating water use efficiency and drought Resilience: Application in a Semi-Arid Basin](https://doi.org/10.1016/j.jag.2026.105460)
...
### [160] [A two-stage machine learning framework for Chl-a reconstruction and short-term prediction in eutrophic lakes using GOCI observations](https://doi.org/10.1016/j.jag.2026.105468)
...
### [161] [Reproducible mapping of marine biodiversity using autonomous surface vehicles and deep learning](https://doi.org/10.1016/j.jag.2026.105462)
...
### [162] [Label-efficient mapping of unregulated waste dumps via mixed supervision with feature masked recovery](https://doi.org/10.1016/j.jag.2026.105471)
...
### [163] [BLB_TVI: A hyperspectral triangular index for satellite-scale characterization of rice bacterial leaf blight severity](https://doi.org/10.1016/j.jag.2026.105472)
...
### [164] [Can the MODIS EVI formula be directly applied to other sensor data? A case study with Landsat data](https://doi.org/10.1080/15481603.2026.2697413)
...
### [165] [Analyzing dominant driving factors of ground deformation in mining area via multimodal feature fusion and explainable modeling](https://doi.org/10.1080/15481603.2026.2700121)
...
### [166] [Coupling functional heterogeneity activation and distance impedance: a distance-decay model for urban population spatial interactions](https://doi.org/10.1080/15481603.2026.2698143)
...
### [167] [Development of PXB-BVC Framework for Multivariate Flood-Risk Assessment Under Climate Change](https://doi.org/10.3390/rs18142275)
...
### [168] [CAF-Net: A Unified Framework for Resolving Spatial–Frequency Representation Conflicts in Multimodal Remote Sensing Segmentation](https://doi.org/10.3390/rs18142284)
...
### [169] [Lightweight Raw Echo Image Preprocessing for Long-Range Airborne Streak Tube Imaging LiDAR Using Adaptive Frequency-Domain Noise Suppression](https://doi.org/10.3390/rs18142281)
...
### [170] [Comparing DESIS Hyperspectral and Landsat 10 Simulated Superspectral Data for Crop Type Classification in California’s Central Valley](https://doi.org/10.3390/rs18142282)
...
### [171] [Intraspecific Drought Stress Responses Detected Using Remotely Sensed Vegetation Indices in Sitka Spruce (Picea sitchensis)](https://doi.org/10.3390/rs18142280)
...
### [172] [Water Anomaly Type Identification Based on Deep Multisphere Decision Boundaries Using Remote Sensing Data](https://doi.org/10.3390/rs18142273)
...
### [173] [Consistent-Innovation-Aided Distributed Cooperative Localization for Multi-UAV Navigation in GNSS-Denied Environments](https://doi.org/10.3390/rs18142286)
...
### [174] [Revealing the Driving Mechanism of Urban Development Based on the 3D Building Morphological Changes in the Beijing–Tianjin–Hebei Region](https://doi.org/10.3390/rs18142276)
...
### [175] [DWFSeg: A Dynamic Multiscale Feature Fusion and Dual Attention-Enhanced Network for High-Precision Water Body Segmentation Based on Super-Resolution Remote Sensing Imagery](https://doi.org/10.3390/rs18142271)
...
### [176] [A Multi-Stage Outlier Removal Method for Point Clouds with High Outlier Ratio](https://doi.org/10.3390/rs18142289)
...
### [177] [Synergistic SAR and Wide-Swath Interferometric Altimetry Observations for Estimating Flood Dynamics and Water Storage Variations in East Dongting Lake](https://doi.org/10.3390/rs18142283)
...
### [178] [A Parcel-Level Asynchronous SpatioTemporal Framework for Cropping Pattern Classification in Fragmented Agricultural Landscapes](https://doi.org/10.3390/rs18142268)
...
### [179] [RadarEchoMamba: A Fast, High-Fidelity Pyramidal Bidirectional Mamba Model for Radar Echo Extrapolation](https://doi.org/10.3390/rs18142287)
...
### [180] [Attention-Guided Generative Adversarial Network for False Alarm-Resistant Change Detection in Remote Sensing Orthophotos](https://doi.org/10.3390/rs18142290)
...
### [181] [Comparative Scientometric Assessment of Remote Sensing Journals in 2025 Across Seven Performance Indicators](https://doi.org/10.3390/rs18142267)
...
### [182] [A Novel Photogrammetry-Based Data Generation Technique for Post-Disaster Human Detection in UAV Imagery](https://doi.org/10.3390/rs18142272)
...
### [183] [Using UAV-Based RGB and Multispectral Imagery to Estimate Cotton Above-Ground Biomass by Integrating Multi-Modal Features and Machine Learning Algorithms](https://doi.org/10.3390/rs18142278)
...
### [184] [A Novel Target Extraction and Energy-Balancing Method for HoloSAR 3D Imaging](https://doi.org/10.3390/rs18142274)
...
### [185] [Automated Victim Detection from UAV Thermal Infrared Imagery for Nighttime Search and Rescue Using Multi-Pose Ground Camera Data](https://doi.org/10.3390/rs18142279)
...
### [186] [Research on the Evolution Mode and Growth Characteristics of Urban Blue–Green Space Based on Landsat Data and National Policy Driven: A Case Study of the Shandong Peninsula Urban Agglomeration](https://doi.org/10.3390/rs18142277)
...
### [187] [Aquatic Vegetation Classification in Crab Ponds Using UAV Multispectral Imagery and a Multi-Scale Frequency-Spatial Collaborative Model](https://doi.org/10.3390/rs18142269)
...
### [188] [Landslide Susceptibility Mapping Using Multi-Source Geospatial Data and XGBoost](https://doi.org/10.3390/rs18142270)
...
### [189] [Intensifying Drought Under a Warming–Wetting Climate: Multi-Scale Impacts on Vegetation Phenology and Productivity in Xinjiang, China](https://doi.org/10.3390/rs18142285)
...
### [190] [Crop-Tool-Augmented Active Perception with Reinforcement Learning for High-Resolution Remote Sensing Visual Question Answering](https://doi.org/10.3390/rs18142288)
...
### [191] [Using Remote Sensing Data and Google Earth Engine to Quantify Regional Climate Responses to Afforestation](https://doi.org/10.3390/rs18142305)
...
### [192] [DMSF-Net: A Dual-Encoder Multi-Source Feature Fusion Network for Fine-Grained Urban Green Space Segmentation](https://doi.org/10.3390/rs18142308)
...
### [193] [Integrating Multi-Source Remote Sensing and Meteorological Features for Fine Mapping of Crop in Liaoning Province](https://doi.org/10.3390/rs18142301)
...
### [194] [Large-Scale Interseismic Crustal Deformation, Fault Slip Rate, Coupling and Earthquake Potential in the Upper Yellow River Basin](https://doi.org/10.3390/rs18142297)
...
### [195] [A Hybrid CNN–Transformer Model for Terrace Extraction from Remote Sensing Imagery](https://doi.org/10.3390/rs18142291)
...
### [196] [A Modular and Transferable Framework for Enhancing Satellite-Derived Daily Precipitation: Adjusting Values, Aligning Distributions, and Preserving Extremes](https://doi.org/10.3390/rs18142298)
...
### [197] [Short-Term Forecasting of Ocean Surface Current Maps Using High-Frequency Radar Observations and LSTM Neural Networks: A Case Study of Southwestern Taiwan](https://doi.org/10.3390/rs18142303)
...
### [198] [Flash Drought Dynamics in China’s Major Agricultural Plains: Spatiotemporal Patterns and Crop Photosynthetic Recovery Across Cropping Systems](https://doi.org/10.3390/rs18142295)
...
### [199] [Temporary Floodplain Ponds Shape Vegetation Mosaic in a Natural River Valley: Evidence from SAR and Optical Remote Sensing](https://doi.org/10.3390/rs18142292)
...
### [200] [Large-Scale Stratigraphic Analysis of Paintings by OCT: A Supervised Learning and Volumetric Stitching Approach](https://doi.org/10.3390/rs18142300)
...
### [201] [Spatiotemporal Variation and Drivers of Vegetation Phenology Along an Urban–Rural Gradient in Rapidly Urbanizing Beijing, China](https://doi.org/10.3390/rs18142302)
...
### [202] [A Multi-Source Remote Sensing-Based AGB Synergistic Inversion Approach Integrating Terrain-Corrected Canopy Height and Forest-Type Heterogeneity](https://doi.org/10.3390/rs18142304)
...
### [203] [VFM-MoME: A Remote Sensing Landslide Image Segmentation Network Guided by a Visual Foundation Model and a Mixture of Mamba Experts](https://doi.org/10.3390/rs18142293)
...
### [204] [Vertical Structure of Air Temperature Excesses of the 2025 Mw 8.8 Kamchatka Earthquake](https://doi.org/10.3390/rs18142306)
...
### [205] [VODet: A Vertex Offset-Based Method for Oriented Object Detection in Remote Sensing Images](https://doi.org/10.3390/rs18142296)
...
### [206] [PanDiM: A Diffusion Mamba Network for High-Fidelity Pansharpening](https://doi.org/10.3390/rs18142299)
...
### [207] [Monitoring and Prediction of Ground Deformation Using InSAR and Machine Learning Approaches in Tianjin City, China](https://doi.org/10.3390/rs18142294)
...
### [208] [Geohazard Risk Identification and Validation in Hunan Province Using Synergistic Multi-Resolution SAR Monitoring](https://doi.org/10.3390/rs18142307)
...
### [209] [Surface Heat Source Variations and Driving Factors in Typical Permafrost Areas of the Tibetan Plateau](https://doi.org/10.3390/rs18142312)
...
### [210] [Integrating Deep Generative AI and Hyperspectral–Multispectral Data Fusion for Enhancing Digital Soil Mapping](https://doi.org/10.3390/rs18142320)
...
### [211] [Independent Multi-Sensor Validation of Machine-Learning Landslide Susceptibility: Footprint Construction Decides the Verdict—May 2023 Emilia-Romagna Event](https://doi.org/10.3390/rs18142318)
...
### [212] [Nonlinear Responses and Spatial Heterogeneity of Net Ecosystem Productivity to Extreme Weather Events in Central Asia](https://doi.org/10.3390/rs18142315)
...
### [213] [Structure-Confidence Guided Phase Congruency and Cascade Matching for Registration of Optical and SAR Images](https://doi.org/10.3390/rs18142322)
...
### [214] [Joint Cross-Range Scaling and Phase Autofocus for ISAR Imaging Based on Adaptive Phase Tracking with Application to Asteroid Imaging](https://doi.org/10.3390/rs18142311)
...
### [215] [Research on Few-Shot Mars Rover Onboard Surface Scene Classification Based on SE-ResNet-MTL](https://doi.org/10.3390/rs18142319)
...
### [216] [Multi-Stage Aggregation CNN–Transformer Hybrid Architecture for Infrared Small-Target Detection](https://doi.org/10.3390/rs18142309)
...
### [217] [Influence of Internal Climate Variability on Satellite-Altimeter-Derived Regional Sea-Level Trends](https://doi.org/10.3390/rs18142313)
*Se‐Hyeon Cheon*
...
### [218] [Physics-Informed Semantic Prompt Learning for Few-Shot Low-Altitude Radar Target Recognition in Remote Sensing](https://doi.org/10.3390/rs18142316)
...
### [219] [A Sub-Scene-Based GNSS-Constrained Structure from Motion for Robust Long-Corridor UAV Image Reconstruction](https://doi.org/10.3390/rs18142321)
...
### [220] [Climate-Driven Phenological Responses of Fagus sylvatica Across European Climatic Zones Using Remote Sensing](https://doi.org/10.3390/rs18142314)
...
### [221] [Removing Cirrus-Induced Errors in Operational Landsat 8 and 9 Daytime Surface Temperature Products over Waters](https://doi.org/10.3390/rs18142317)
...
### [222] [Exploring the Potential of Machine Learning Post-Processing to Generate ERA5-Consistent Atmospheric Profiles from Geostationary Satellite Retrievals](https://doi.org/10.3390/rs18142310)
...
### [223] [A New Deep Learning Method for Sea Fog Detection Using Fengyun-4A Satellite Data](https://doi.org/10.3390/rs18142334)
...
### [224] [Category-Aware Global–Local Semantic Alignment for Remote Sensing Image–Text Retrieval](https://doi.org/10.3390/rs18142335)
*Da Ha,Haisu Zhang*
...
### [225] [Deconstructing and Ameliorating Woody Volume Estimation Errors Arising from Leaves in Quantitative Structure Models of Trees](https://doi.org/10.3390/rs18142342)
...
### [226] [Decoupling Deep Mining and Tailings Consolidation-Induced Subsidence Using SBAS-InSAR and NMF: A Case Study at South Deep Gold Mine, South Africa](https://doi.org/10.3390/rs18142337)
...
### [227] [Spatiotemporal Variations in Terrestrial Water Storage and Water Scarcity Assessment Across China Based on TWSA_BTCH](https://doi.org/10.3390/rs18142324)
...
### [228] [UAV 3D Scene Understanding: A Survey from an Agent-Capability Evolution Perspective](https://doi.org/10.3390/rs18142323)
...
### [229] [Multi-Method Identification and Spatiotemporal Evolution Analysis of Active Deformation Areas in the Binchang Mining Area](https://doi.org/10.3390/rs18142339)
...
### [230] [Normalized Dynamic Fluorescence Height: An Alternative Algorithm for Chlorophyll a Estimation in Algae-Dominated Waters Using Hyperspectral Remote Sensing Reflectance from In Situ and Spaceborne Imagers](https://doi.org/10.3390/rs18142332)
...
### [231] [Assessing the Capabilities of UAV-Based Observation for Marginalized Communities: A Case Study of Roma Settlements in Slovakia](https://doi.org/10.3390/rs18142326)
...
### [232] [Nighttime Thermal Patterns and County Life Expectancy: A 20-Year Multimodal Satellite Fusion for the Contiguous United States](https://doi.org/10.3390/rs18142330)
...
### [233] [Significance-Preserving Progressive Network for Infrared and Visible Image Fusion](https://doi.org/10.3390/rs18142328)
...
### [234] [HFG-YOLO: A High-Frequency-Guided Network for Small-Object Detection](https://doi.org/10.3390/rs18142343)
...
### [235] [ECDF-Stabilized Sentinel-1 InSAR Coherence for Verification-Oriented Heritage Monitoring: A TabICLv2-SHAP and Three-Horizon DEMATEL Architecture](https://doi.org/10.3390/rs18142325)
...
### [236] [CASA-Net: Context-Aware Small-Object Adaptation Network for UAV Aerial Images](https://doi.org/10.3390/rs18142327)
...
### [237] [COSM: Satellite and Ground Segment](https://doi.org/10.3390/rs18142340)
...
### [238] [IC-EWH: Energy-Weighted Hough Transform with Iterative Curvature Compensation for Squint Angle Estimation of Highly Squinted SAR](https://doi.org/10.3390/rs18142344)
...
### [239] [Target Detection for UAV Inspection in Complex Illumination Environments: A Lightweight Dual-Modal Fusion Method with Multi-Directional Mamba Cross-Attention](https://doi.org/10.3390/rs18142329)
...
### [240] [A Dual-Perspective Analysis of Ozone Formation Sensitivity in the Yangtze River Delta: Satellite and Ground-Based Evidence](https://doi.org/10.3390/rs18142336)
...
### [241] [Enhancing the Estimation and Mapping of Soil Cadmium by Using Geospatial Information-Guided Machine Learning and Principal Component Spectra](https://doi.org/10.3390/rs18142341)
...
### [242] [Physics-Guided cGAN with Multi-Scale Attention for Robust 2D Phase Unwrapping in Low-Coherence Regions](https://doi.org/10.3390/rs18142338)
...
### [243] [Optimizing Spectral Inputs for Deep Learning-Based Vegetation Destruction Detection Using Sentinel-2 Imagery](https://doi.org/10.3390/rs18142333)
...
### [244] [Flood Regulation Service Responses to Urban Green Space Change in a Plateau Valley City: A Case Study of Lhasa, China](https://doi.org/10.3390/rs18142331)
...
### [245] [Leveraging EMIT spectroscopy and machine learning to estimate soil texture and particle grain size in dust-producing regions](https://doi.org/10.1016/j.rse.2026.115557)
...
### [246] [Optimizing 1D-Var near-surface wind speed from SSMIS with RapidScat](https://doi.org/10.1016/j.rse.2026.115560)
...
### [247] [Seasonal mass balance of Hofsjökull ice cap, Iceland, estimated from repeat ICESat-2 satellite altimetry](https://doi.org/10.1016/j.rse.2026.115555)
...
### [248] [Synergistic analysis and vertical transport attribution of carbon monoxide surface concentrations and satellite column loadings over China](https://doi.org/10.1016/j.rse.2026.115562)

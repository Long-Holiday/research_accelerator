...
- [JAG](#JAG) [Total: 18]
- [Remote Sensing](#Remote Sensing) [Total: 109]
...
### [82] [Multi-frequency microwave remote sensing reveals stratified forest responses to diverse drought stresses](https://doi.org/10.1016/j.jag.2026.105545)
...
### [83] [Improving text–image alignment for referring remote sensing image segmentation guided by vision foundation model](https://doi.org/10.1016/j.jag.2026.105439)
...
### [84] [CGHU-CD: A contrast-guided hierarchical unsupervised method for detecting Martian anthropogenic changes](https://doi.org/10.1016/j.jag.2026.105556)
...
### [86] [A multi-scale spatial-conditioned spectral routing network for hyperspectral and multispectral image fusion](https://doi.org/10.1016/j.jag.2026.105547)
...
### [87] [DPNet: A disaster perception network for building damage detection using single-temporal remote sensing imagery](https://doi.org/10.1016/j.jag.2026.105554)
...
### [88] [SRAIN: An isolated-neighborhood-based framework for LST-based surface thermal anomaly extraction](https://doi.org/10.1016/j.jag.2026.105542)
...
### [89] [PLGCA-SAM: Progressive local and global context-aware network incorporating SAM for remote sensing crop mapping](https://doi.org/10.1016/j.jag.2026.105548)
...
### [90] [Probabilistic associations between meteorological drought and compound moisture sources-transport anomalies in the middle and lower Yangtze River](https://doi.org/10.1016/j.jag.2026.105551)
...
### [91] [Tropoformer-S: iTransformer-based spatiotemporal reconstruction of three-dimensional tropospheric delay fields integrating ERA5 reanalysis and GNSS observations](https://doi.org/10.1016/j.jag.2026.105553)
...
### [92] [A spatiotemporal framework for identifying urban flood priority areas in megacities using social media data](https://doi.org/10.1016/j.jag.2026.105562)
...
### [93] [Quantifying lake expansion probability under compound glacier–climate forcing using a GCL-CPF framework integrating multi-source Earth observation and vine copula theory](https://doi.org/10.1016/j.jag.2026.105559)
...
### [94] [Modeling regional coseismic landslide intensity with an interpretable Log-Gaussian GAM: Integrating size, mobility, and their interactions](https://doi.org/10.1016/j.jag.2026.105563)
...
### [95] [Methane detection and emission estimation from space: Benchmarking PRISMA and EnMAP with the GHGSat constellation](https://doi.org/10.1016/j.jag.2026.105557)
...
### [96] [Virtual geographical scene modeling towards geospatial digital twins: A case study of urban highway tunnel scenarios](https://doi.org/10.1016/j.jag.2026.105561)
...
### [97] [A factorial spatial–temporal null-model framework for satellite–ground lightning fusion across Chinese marginal seas](https://doi.org/10.1016/j.jag.2026.105552)
...
### [99] [Filtering GEDI footprints based on combined spatial-spectral characteristics for individual building height mapping in 12 major global cities](https://doi.org/10.1016/j.jag.2026.105566)
*Xiao Ma,Yajie Qu,Hexiang Wang,Meiyuan Chen,Chuyi Yang,Guang Zheng,Chi Xu,Yixi Bi*
...
### [100] [Pixel-Level Sentinel-2 Modeling Reveals Scale-Dependent Edge Effects and Structural Heterogeneity in Semideciduous Seasonal Forest Fragments of the Brazilian Cerrado](https://doi.org/10.3390/rs18172999)
...
### [101] [GeoAI-Driven Wetland Change Analysis in the Sangamon River Watershed (2000–2025): A Comparative Assessment of Machine Learning and Deep Learning Approaches](https://doi.org/10.3390/rs18172949)
...
### [102] [iSAGE: A Human-in-the-Loop Framework for Remote Sensing Semantic Segmentation via Sparse Point Supervision](https://doi.org/10.3390/rs18172973)
...
### [103] [Complex-Valued HRU-Net with Cross-Gated Attention for PolSAR Semantic Segmentation](https://doi.org/10.3390/rs18172947)
...
### [104] [Spatial Prompt and Wavelet Mamba-Based Multi-Scale Cross-Domain Feature Fusion Network for Segmentation of Mining-Disturbed Land](https://doi.org/10.3390/rs18172963)
...
### [105] [Impact of Radar-Constrained Effective Drop-Shape Relations on Polarimetric Radar Quantitative Precipitation Estimation in Typhoons](https://doi.org/10.3390/rs18172927)
...
### [106] [Jacobians of Light Scattering Properties Based on the Improved Geometric Optics Method (IGOM)](https://doi.org/10.3390/rs18172942)
...
### [107] [Deep Learning-Based Quantitative Precipitation Estimation Using Ground-Based Microwave Radiometer and Micro-Rain Radar Observations](https://doi.org/10.3390/rs18172941)
...
### [108] [Satellite Remote Sensing of a Melting Glacier Albedo: Examples from EnMAP and an Intercomparison with Other Satellite and Ground Measurements](https://doi.org/10.3390/rs18172929)
...
### [109] [Assessing Vegetation–Hydrothermal Trend Regimes Across Elevation Gradients in Semiarid Mountains via Gaussian Mixture Models in Saudi Arabia](https://doi.org/10.3390/rs18172948)
...
### [110] [Volumetric Impact Characterization of the 2025 Palisades and Eaton Fires Using Aerial LiDAR](https://doi.org/10.3390/rs18172943)
...
### [111] [Physics-Informed Spatially Variant Image Restoration for Unresolved Infrared Remote Sensing Small Targets](https://doi.org/10.3390/rs18172934)
...
### [112] [Machine-Learning-Based Radar Quantitative Precipitation Estimation Using Intra-Hour Temporal Features from Dual-Polarization Observations](https://doi.org/10.3390/rs18172937)
...
### [113] [A Linear Attention Framework with Dual-Axis Multi-Scale Fusion for Fine-Grained Eucalyptus Change Detection](https://doi.org/10.3390/rs18172944)
...
### [114] [ST-PaveCLIP: A Spatio-Temporal Vision–Language Framework for Road Anomaly Segmentation in Images and Videos](https://doi.org/10.3390/rs18172922)
...
### [115] [Deep Learning-Based Monitoring of Tea Plant Growth and Nitrogen Status Using UAV Multisource Remote Sensing Features](https://doi.org/10.3390/rs18172923)
...
### [116] [Performance Analysis of BDS-3 PPP-B2b During the Satellite In-Orbit Upgrade Period](https://doi.org/10.3390/rs18172936)
...
### [117] [Generalized Matérn Process for GNSS Coordinate Series Noise Modeling](https://doi.org/10.3390/rs18172932)
...
### [118] [Multidimensional Quantification of Engineering Distresses and Secondary Periglacial Hazards Along Linear Infrastructure in the Permafrost Region of Northeast China Using UAV-LiDAR and Synchronous Visible-Light Imagery](https://doi.org/10.3390/rs18172938)
...
### [119] [An Earth-Limb-Constrained Framework for On-Orbit Geometric Calibration of GEO Wide-Field Area-Array Cameras](https://doi.org/10.3390/rs18172930)
...
### [120] [Improvement of Flood Risk Model Performance by Incorporating Sediment Factors](https://doi.org/10.3390/rs18172933)
...
### [121] [Layout Optimization of Urban Emergency Shelter Sites Under Compound Disaster Scenarios Based on MOGWO](https://doi.org/10.3390/rs18172945)
...
### [122] [NWCSAF High Resolution Winds (NWCSAF GEO-I HRW) Stereo AMVs over the Atlantic Ocean](https://doi.org/10.3390/rs18172940)
...
### [123] [EGDNet: An Event-Guided Frequency-Aware Network with Cross-Modal Attention for Robust Weak Signature UAV Detection](https://doi.org/10.3390/rs18172925)
...
### [124] [Multi-Temporal Remote Sensing Assessment and Pareto-Based Land-Use Optimization for Balancing Carbon Storage, Ecological Value, and Economic Value in Jiangsu Province, China](https://doi.org/10.3390/rs18172924)
...
### [125] [Scale-Aware Gated Routing Distillation for Lightweight Remote Sensing Object Counting](https://doi.org/10.3390/rs18172939)
...
### [126] [Physically Constrained Quadratic Programming for Spectral Unmixing of Nighttime Lighting: A Case Study with Data Generation Procedure](https://doi.org/10.3390/rs18172935)
...
### [127] [Probabilistic Spatial Completion of FEMA Special Flood Hazard Area Coverage in Louisiana Using Conditional Diffusion and Distributionally Trustworthy Explanation](https://doi.org/10.3390/rs18172926)
...
### [128] [Prior-Guided Lightweight Dual-Task Network for Composite Active Jamming Recognition and Time-Frequency Parameter Estimation in Radar Remote Sensing](https://doi.org/10.3390/rs18172946)
...
### [129] [Seasonal Consistency Between Solar-Induced Chlorophyll Fluorescence and Vegetation Indices Across Global Urban Ecosystems](https://doi.org/10.3390/rs18172931)
...
### [130] [A Practical Framework for Surface Water Extraction from GF1/GF6 Wide-Field-View Imagery](https://doi.org/10.3390/rs18172928)
...
### [131] [TAPO: Task-Decoupled Alignment and Pseudo-Label Optimization for Cross-Scene Inshore SAR Ship Detection](https://doi.org/10.3390/rs18172953)
...
### [132] [Geospatial Foundation Models Improve Atoll Island Ecosystem Mapping: A Case Study Using AlphaEarth Embeddings](https://doi.org/10.3390/rs18172964)
...
### [133] [Landscape Greening Following Unseasonal Precipitation Along a Desert–Alpine Gradient](https://doi.org/10.3390/rs18172951)
...
### [134] [Odometry and Mapping for Complex Environment Perception Under Partial-View Sensing](https://doi.org/10.3390/rs18172959)
...
### [135] [MARC-Net: A Modality-Availability-Aware Robust Change Network for Missing-Optical Bi-Temporal Optical–SAR Change Detection of Reclaimed Cropland](https://doi.org/10.3390/rs18172960)
...
### [136] [Geometry-Guided Semi-Supervised Multimodal Segmentation for UAV-Based Rice-Lodging Mapping](https://doi.org/10.3390/rs18172961)
...
### [137] [TFCRNet: Dual-Discriminator SAR-to-Optical Translation and Region-Gated Cross-Attention Fusion for Thick-Cloud Removal](https://doi.org/10.3390/rs18172962)
...
### [138] [Hyperspectral Technology: A Method Framework for the Estimation of Metal Content in Cobalt-Rich Crusts](https://doi.org/10.3390/rs18172968)
...
### [139] [A Change-Point-Based Deformation Grouping Strategy in Long-Term Near-Real-Time Deformation Monitoring](https://doi.org/10.3390/rs18172956)
...
### [140] [FuseCLIP: Semantic-Guided Multidomain Fusion for Few-Shot Radar Active Jamming Recognition](https://doi.org/10.3390/rs18172967)
...
### [141] [FD-ProtoSCD: Semantic Change Detection in High-Resolution Remote Sensing Images via Frequency-Domain Disentanglement and Dynamic Prototype Learning](https://doi.org/10.3390/rs18172957)
...
### [142] [Spatiotemporal Deep Learning for Continuous Illumination Mapping and Sun-Synchronous Path Planning in Lunar Polar Exploration Under Chang’E-7 Mission Constraints](https://doi.org/10.3390/rs18172950)
...
### [143] [Improving Backscatter-Based Surface Water Classification in Arid Environments Through Interferometric Coherence](https://doi.org/10.3390/rs18172966)
...
### [144] [Potential Source-to-Sink Spatial Correspondence in a Martian Analog Environment of the Qaidam Basin Based on GF-5A Hyperspectral Imagery](https://doi.org/10.3390/rs18172958)
...
### [145] [Beyond Standalone Geo-Embeddings: Weighted Multi-Model Ensemble Prediction for Tropical Land-Cover Mapping](https://doi.org/10.3390/rs18172952)
...
### [146] [Tracing 80 Years of Forest Succession and Species Trajectories Using Historical Aerial Photography and Sentinel-2 Imagery](https://doi.org/10.3390/rs18172954)
...
### [147] [MFRA-YOLOv11: Remote Sensing Small Object Detection Algorithm Based on Multiscale Feature Extraction and Region Awareness](https://doi.org/10.3390/rs18172965)
...
### [148] [Severe Positive Ionospheric Storm at American Low Latitudes During an Intense Long-Lasting CEJ Period of the August 2018 Geomagnetic Storm](https://doi.org/10.3390/rs18172955)
...
### [149] [Deep Learning for Water Body Segmentation in Remote Sensing Imagery: A Review](https://doi.org/10.3390/rs18172972)
...
### [150] [A Terrain-Corrected Vegetation Index Strategy for Improving Leaf Area Index Estimation in Mountainous Areas](https://doi.org/10.3390/rs18172977)
...
### [151] [Controlled Evaluation of Sentinel-2 Annual Compositing Strategies for Deep Learning-Based Mangrove Mapping in China](https://doi.org/10.3390/rs18172975)
...
### [152] [Building Footprint Extraction in High-Density Urban Areas Based on Multi-Source Remote Sensing Data Fusion and ACM-PSPNet](https://doi.org/10.3390/rs18172971)
...
### [153] [Land-Cover and Land-Use Mapping Under Limited Data Highlights Hyperparameter Stability and Predictor Design](https://doi.org/10.3390/rs18172969)
...
### [154] [Monthly Trophic Dynamics of Lakes and Reservoirs in Eastern China Based on Harmonized Landsat–Sentinel Observations](https://doi.org/10.3390/rs18172970)
...
### [155] [Seafloor Morphology and Inner Shelf Benthic Habitats of the Sinuessa Shallow Coralligenous Bank, Eastern Tyrrhenian Margin](https://doi.org/10.3390/rs18172974)
...
### [156] [Cloud Occurrence, Phase, and Vertical Structure in a Dust-Influenced Eastern Mediterranean Region: Observations from Limassol, Cyprus](https://doi.org/10.3390/rs18172976)
...
### [157] [Estimating the Effects of Climate and Human Activities on Vegetation Coverage in Diverse Ecosystems: A Case Study of the Gansu Section of the Yellow River Basin](https://doi.org/10.3390/rs18172978)
...
### [158] [Predicting Spatial Variability of PR Protein Concentration in White Grape Juice Using UAV Multispectral Data and Machine Learning](https://doi.org/10.3390/rs18172979)
...
### [159] [Monitoring Coastal Geomorphic Change and Sediment Transport Using Kite Aerial Photography (KAP) and Structure-from-Motion (SfM) Photogrammetry](https://doi.org/10.3390/rs18172998)
...
### [160] [Surface Subsidence Analysis and Prediction in an Open-Pit Mine Using Time-Series InSAR and a CL-TSF Hybrid Model](https://doi.org/10.3390/rs18172996)
...
### [161] [Semantic Segmentation for 3D Point Clouds with Curvature-Aware Sampling and Inverse-Density Weighting](https://doi.org/10.3390/rs18172993)
...
### [162] [Spatiotemporal Variations in Aerosol Optical Depth and Their Relationships with Cloud Properties and Precipitation over Sudan: Insights from Satellite Observations and CMIP6 Model Projections](https://doi.org/10.3390/rs18172986)
...
### [163] [PFIRNet: UAV-to-Satellite Cross-View Self-Localization via Continuous Probability Field Inference](https://doi.org/10.3390/rs18172984)
...
### [164] [Discrepancy-Conditioned Residual Feature Refinement for Multi-Source Hyperspectral Classification](https://doi.org/10.3390/rs18172995)
...
### [165] [High-Resolution 3D GPR Imaging of Concealed Surface Masonry in Pompeian Walls: Performance Analysis of Contact and Non-Contact Surveys](https://doi.org/10.3390/rs18173002)
...
### [166] [Boot-Shaped Terrain Screening and Deep Learning Semantic Segmentation for Landslide-Hazard Candidate Extraction from Airborne LiDAR DEM: A Case Study in Zhenxiong County, China](https://doi.org/10.3390/rs18172983)
...
### [167] [CenterPoint-UAV: Context-Detail BEV Refinement for 3D Object Detection in UAV Point Clouds](https://doi.org/10.3390/rs18172994)
...
### [168] [YOLO-ROSS: A Robust Small Object Detection Model for UAV Aerial Imagery in Complex Interference Environments](https://doi.org/10.3390/rs18172997)
...
### [169] [A Phenology-Adaptive Rubber Plantation Mapping (PARM) Framework Coupling Sentinel-1 SAR and Optimally Selected Spectral Indices Across Heterogeneous Tropical Regions](https://doi.org/10.3390/rs18172989)
...
### [170] [Adaptive Segmented Doppler Compensation for Forward-Looking Radar Imaging](https://doi.org/10.3390/rs18172985)
...
### [171] [Visible Nearshore Object Detection in Overhead Surveillance Imagery: A Large-Scale Dataset and Benchmark](https://doi.org/10.3390/rs18172982)
...
### [172] [Diurnal Asymmetry in the Relationships Between Urban Morphology and Canopy Urban Heat Islands: An Interpretable Machine Learning Analysis](https://doi.org/10.3390/rs18172980)
*Tao Shi,Gaopeng Lu*
...
### [173] [A Biome-Specific Light Use Efficiency Model for Spatiotemporal Dynamics of GPP Across Europe Using PROBA-V and Sentinel-3 FAPAR](https://doi.org/10.3390/rs18172981)
...
### [174] [Satellite-Driven Spatiotemporal Multiscale Perception Learning for Estimating Daily Arctic Sea Ice Thickness](https://doi.org/10.3390/rs18172991)
...
### [175] [Global Navigation Satellite Systems (GNSS) in Climate Change Research: A Comprehensive Review](https://doi.org/10.3390/rs18173001)
...
### [176] [HDSMNet: Height-Guided Sparse Cross-Modal Fusion for High-Resolution Remote Sensing Semantic Segmentation](https://doi.org/10.3390/rs18172992)
...
### [177] [Evaluating the Impact of DEM Resolution on Landslide Hazard Assessment: A Comparative Study Using LiDAR and 1:5000 Topographic Map-Derived DEMs](https://doi.org/10.3390/rs18172988)
...
### [178] [Aerial Scene Classification Using Hierarchical and Multi-Stage Swin Transformer Features](https://doi.org/10.3390/rs18172987)
...
### [179] [Satellite Remote Sensing for Fishing Vessel Identification and Monitoring: A Comparative Analysis of Modalities and a Review of Datasets](https://doi.org/10.3390/rs18173000)
...
### [180] [GFE-Net: Geometry-Enhanced Feature Extraction Network for Semantic Segmentation of Large-Scale LiDAR Point Clouds](https://doi.org/10.3390/rs18172990)
...
### [181] [Surface Thermal State, Antecedent Hydroclimate, and Post-Fire Vegetation–Water Response in the Zambezi River Basin: A Multi-Source Environmental Time-Series Analysis](https://doi.org/10.3390/rs18173009)
...
### [182] [Deep Learning for Single-Frame Infrared Small and Dim Target Detection: A Paradigm-Oriented Review with Cross-Architecture Benchmarking](https://doi.org/10.3390/rs18173010)
...
### [183] [Lightweight Near-Infrared Spectral Reconstruction from Red UAV Imagery Using Artificial Intelligence for Low-Cost Remote Sensing](https://doi.org/10.3390/rs18173015)
...
### [184] [Multi-Granularity Graph Neural Network for Satellite-Assisted Marine Environmental Field Reconstruction over Sparse Observation Grids](https://doi.org/10.3390/rs18173003)
...
### [185] [Model-Based Multiframe Radiometric Spatial Reconstruction for Optical Satellite Video](https://doi.org/10.3390/rs18173014)
...
### [186] [Assessing the Potential of High-Resolution Multispectral and Structural Imagery for Plant Species Mapping in Mine Rehabilitation](https://doi.org/10.3390/rs18173029)
...
### [187] [A Regionalized Uncertainty Budget for Sea-Level Trend and Acceleration Estimates in the China Seas and Their Adjacent Oceans](https://doi.org/10.3390/rs18173012)
...
### [188] [Image Quality Assessment Methods for Multispectral Pan-Sharpening Images: A Comprehensive Review](https://doi.org/10.3390/rs18173021)
...
### [189] [DGSRef: Decoupled Geometric-Semantic Refinement Network for High-Resolution Remote Sensing Segmentation](https://doi.org/10.3390/rs18173011)
...
### [190] [From Storm Damage Detection to Windthrow Susceptibility Mapping: Evaluating Regional Transferability in Radiata Pine Plantations](https://doi.org/10.3390/rs18173020)
...
### [191] [Ambulance STARS: A Satellite-Driven Framework for Rapid Flood Impact Assessment and Time-Critical Ambulance Routing](https://doi.org/10.3390/rs18173004)
...
### [192] [STAMP-GAN: A Spatiotemporal Attention-Modulated Generative Adversarial Network for Precipitation Nowcasting](https://doi.org/10.3390/rs18173026)
...
### [193] [UAV Applications in Forest Regeneration Survey: A Review and Case Study](https://doi.org/10.3390/rs18173027)
...
### [194] [Estimating Annual Wildfire-Related Potential Above-Ground Biomass Loss in Eastern Canadian Boreal Forests Using Multi-Source Remote Sensing and XGBoost](https://doi.org/10.3390/rs18173022)
...
### [195] [M-FSAD-KD: Full-Link Multi-Granularity Distillation for SAR Object Detection](https://doi.org/10.3390/rs18173008)
...
### [196] [GSSP-KAN: An Efficient Kansformer-Based Network with Grouped Separable Sparse Convolution for Large-Scale LiDAR Point Cloud Semantic Segmentation](https://doi.org/10.3390/rs18173018)
...
### [197] [Prelaunch Assessment and Correction of Polarization Effects for HIRAS-II on the Fengyun-3 Satellite](https://doi.org/10.3390/rs18173025)
...
### [198] [Groundwater Storage Dynamics and Attribution in the Wei River Basin Based on Dynamic Downscaling](https://doi.org/10.3390/rs18173013)
...
### [199] [Assessing the Value of FY-4A/B Cloud-Top Height for Deep Learning-Based Tropical Cyclone Intensity Estimation over the Western North Pacific](https://doi.org/10.3390/rs18173030)
...
### [200] [Trajectory-Guided Photon Accumulation for Photon-Efficient LiDAR Remote Sensing in Low-SBR Dynamic Scenes](https://doi.org/10.3390/rs18173007)
...
### [201] [Spatial Domain Dependence Evolution of Input Parameter Importance in Soil Moisture Retrieval Under the XGBoost and SHAP Framework](https://doi.org/10.3390/rs18173006)
...
### [202] [Homogeneous Terrain Unit Extraction by Integrating Superpixel Segmentation and Multiscale Region Merging: A Case Study in the Deeply Incised Valleys of Southeastern Tibet](https://doi.org/10.3390/rs18173028)
...
### [203] [RoadMark-AWAConv: Adaptive Weight-Anchor Convolution for Fine-Grained Semantic Segmentation of Road Marking Point Clouds](https://doi.org/10.3390/rs18173005)
...
### [204] [Co-Burn: Combining dNBR Anchoring and Ordinal Learning for Cross-Event Fire Severity Mapping in New South Wales](https://doi.org/10.3390/rs18173019)
...
### [205] [GT-LandSDS: A Novel Spatiotemporal Integrated Framework for Land Use Simulation by Coupling Cellular Automata with Graph Attention Network and Transformer](https://doi.org/10.3390/rs18173023)
...
### [206] [UAV Visual Localization Method Based on Token-Level Local Matching Reranking and Neighborhood-Consistent Position Fusion](https://doi.org/10.3390/rs18173016)
...
### [207] [A Cost-Effective Approach to Estimate Quinoa Aboveground Biomass Volume Combining UAV RGB Data with Sentinel-1 and Sentinel-2 Satellite Imagery](https://doi.org/10.3390/rs18173017)
...
### [208] [Pinus pinaster Seedling Detection in Coastal Dune Plantations Using a UAS Multispectral Point Cloud and Point Transformer V3](https://doi.org/10.3390/rs18173024)
...
### [209] [Physics-constrained cross-resolution enhancement network for optics-guided thermal UAV image super-resolution](https://doi.org/10.1016/j.isprsjprs.2026.08.013)
...
### [210] [PSSformer: A persistent scatters selection method for SAR interferometry based on temporal-spatial vision transformers](https://doi.org/10.1016/j.isprsjprs.2026.08.032)
...
### [211] [Foggy-UAVCD and DSRF-Net: Benchmarking robust satellite–UAV change detection under fog degradation](https://doi.org/10.1016/j.isprsjprs.2026.08.026)
...
### [212] [Corrigendum to “A survey of publicly available multi-temporal point cloud datasets” [ISPRS J. Photogramm. Rem. Sens. 231 (2026) 815–836]](https://doi.org/10.1016/j.isprsjprs.2026.08.020)
...
### [213] [Multi-source remote sensing workflow (PlanetScope and Sentinel-1/2) applied to LULCC analysis (2016–2024) in the SDERM-CGSM Ramsar Site, Colombia](https://doi.org/10.1016/j.isprsjprs.2026.08.010)
...
### [214] [From repeat-pass to single-pass: City-scale 3D point-cloud reconstruction via InSAR-TomoSAR fusion with the Hongtu-1 multistatic SAR constellation](https://doi.org/10.1016/j.isprsjprs.2026.08.031)
...
### [215] [DUAG-C: Decentralized uncertainty-aware Gaussian consensus for multi-robot dense mapping](https://doi.org/10.1016/j.isprsjprs.2026.08.030)
...
### [216] [From particles to features: Uncertainty-guided geometric reasoning for robust SLAM](https://doi.org/10.1016/j.isprsjprs.2026.08.012)
...
### [217] [Bridging the domain gap: A transferable dynamic routing enhancer for robust aerial detection under adverse weather](https://doi.org/10.1016/j.isprsjprs.2026.08.041)
...
### [218] [A Hierarchical Context-Fusion and Synergistic Alignment Network for small object detection](https://doi.org/10.1016/j.isprsjprs.2026.08.034)
...
### [219] [LAMM: Large-scale invariant multi-source remote sensing image matching based on Adaptive Many-to-many Mapping](https://doi.org/10.1016/j.isprsjprs.2026.08.019)
...
### [220] [Mapping forest structure: A 3D deep learning benchmark for ground-based LiDAR](https://doi.org/10.1016/j.isprsjprs.2026.08.011)
*Diego Laiño,Carlos Çabo,Romain Janvier,Celestino Ordóñez,Rodolfo Jose Bolaños Chamorro,Stefan H. Doerr,Andrew T. Hudak,Cristina Santín*
...
### [221] [Field-scale irrigation estimation using Sentinel-1 and Sentinel-2 data within a soil water balance model coupled to the Water Cloud Model](https://doi.org/10.1016/j.rse.2026.115639)
...
### [222] [Geostationary observations of air pollutants from biomass burning: A synergy of GIIRS and GEMS over Southeast Asia](https://doi.org/10.1016/j.rse.2026.115642)
...
### [223] [Using a planted tree biodiversity experiment to evaluate imaging spectroscopy for species classification](https://doi.org/10.1016/j.rse.2026.115644)
...
### [224] [Comparative analysis of contemporary remote sensing techniques and species distribution modelling in predicting spatial distribution of coastal habitats](https://doi.org/10.1016/j.rse.2026.115640)
...
### [225] [The BioSat indices designed for biodiversity science and conservation](https://doi.org/10.1016/j.rse.2026.115625)
...
### [226] [Corrigendum to ‘Angular anisotropy of Landsat and MODIS land surface temperature toward multi-source LST consistency’ [Remote Sens. Environ. 346 (2026) 115624]](https://doi.org/10.1016/j.rse.2026.115643)
...
### [227] [Effects of aboveground biomass and soil moisture drought on VOD-based global isohydricity estimates](https://doi.org/10.1016/j.rse.2026.115641)
...
### [228] [The intercomparison of total column water vapor over a melting glacier on the Greenland ice sheet derived using spaceborne Sentinel-5P and high spatial resolution EnMAP measurements](https://doi.org/10.1016/j.rse.2026.115648)
...
### [229] [SMFS-RF: a knowledge-guided machine-learning method for crop phenology extraction from fine-resolution vegetation index data](https://doi.org/10.1016/j.rse.2026.115632)
...
### [230] [Capability of Planet Dove for monitoring the world's coastlines](https://doi.org/10.1016/j.rse.2026.115630)
...
### [231] [Sub-seasonal forecasting of cropland productivity anomalies using satellite soil moisture in water-limited environments](https://doi.org/10.1016/j.rse.2026.115645)
...
### [232] [EXAONE Forecast for Finance](https://arxiv.org/abs/2609.04239)
...
### [233] [From Matching Models to Recruiting Agents: A Systematized Narrative Review of AI Recruitment Systems, Evaluation, and Governance](https://arxiv.org/abs/2609.04286)
...
### [234] [Harbor Adapters and Harbor-Index: Infrastructure and a Curated Meta-Dataset for Large-Scale Agentic Evaluation](https://arxiv.org/abs/2609.04298)
...
### [235] [Data-Optimized Contingency Screening: A Machine Learning Approach to Power System Security](https://arxiv.org/abs/2609.04300)
...
### [237] [A Removal Based Approach to Improve LLM Faithfulness at Test-Time](https://arxiv.org/abs/2609.04343)
...
### [238] [Why Better Models Can Create Riskier Systems: Evidence from LLM Agents in Financial Markets](https://arxiv.org/abs/2609.04373)
...
### [240] [HarvestBench: Measuring Whether LLM Agents Will Pay to Avoid Killing Animals](https://arxiv.org/abs/2609.04444)
...
### [241] [PerfReasoning: How Well Do LLMs Reason on Hardware Performance?](https://arxiv.org/abs/2609.04476)
...
### [242] [When Quantization Breaks Memory: Recurrent-State Write-Back in Low-Precision Temporal Inference](https://arxiv.org/abs/2609.04490)
...
### [243] [ResLearn-XR: Residual Learning for Network Traffic and Quality-of-Experience-Aware Modeling in Extended Reality](https://arxiv.org/abs/2609.04493)
...
### [244] [Rethinking Indirect Prompt Injection as a Test-Time Search Problem](https://arxiv.org/abs/2609.04495)
...
### [245] [BioSync: Transformer-Based Cross-Modal Fusion for a Multimodal Physiological Digital Biomarker](https://arxiv.org/abs/2609.04504)
...
### [246] [What Does Multi-Harness RL Learn? Credit Assignment and Portability in Coding Agents](https://arxiv.org/abs/2609.04518)
...
### [247] [MaxKernel: Agentic Kernel Generation for TPUs](https://arxiv.org/abs/2609.04523)
...
### [248] [Towards a universal language of concepts: A survey](https://arxiv.org/abs/2609.04528)
*Aishni Parab*
...
### [249] [Data-Driven Discovery of Composition-Dependent Constitutive Models for Hyperelasticity and Viscoelasticity of Digital Materials](https://arxiv.org/abs/2609.04541)
...
### [250] [From Answers to Interpretations: Rethinking Ambiguity-Induced Aleatoric Uncertainty Estimation in LLMs](https://arxiv.org/abs/2609.04543)
...
### [251] [IPGeoAI: Transformer-Based Geolocation with LLM Semantic Fusion](https://arxiv.org/abs/2609.04559)
...
### [252] [Reducing Hallucinated Transcripts in Whisper via Hallucination Space Projection](https://arxiv.org/abs/2609.04561)
...
### [253] [La Agente Óptima: Towards Agentic Self-Driving Laboratories](https://arxiv.org/abs/2609.04564)
...
### [291] [From Language Models to World-Acting Systems: Progress and Limits of Agentic AI across Digital, Social, Virtual, and Physical Environments](https://arxiv.org/abs/2609.04894)
...
### [292] [Compact-Memory LLM Agents via Online Max-Member Clustering and Atom-Aware Packing](https://arxiv.org/abs/2609.04915)
...
### [293] [Artificial Intelligence in Equity and Crypto Markets: Progress, Profitability Evidence, and the Limits of Automated Investing](https://arxiv.org/abs/2609.04917)
*Linsen Zhu,Mengqing Cai*
...
### [294] [Solving Hard XAI Queries Based on a Compiled Dual-Rail Encoding](https://arxiv.org/abs/2609.04931)
...
### [295] [Why We Care About Understanding: Competence through Predictive Compression](https://arxiv.org/abs/2609.04962)
...
### [296] [Global to Local: Topology-Preserving Adaptive Graph Pooling via Granular-Ball](https://arxiv.org/abs/2609.04978)
...
### [297] [A Tree-based RAG Framework for Evidence-Intensive QA via Adaptive Planning and Topology-Aware Evidence Gathering](https://arxiv.org/abs/2609.04981)
...
### [298] [Language models judge war differently when tested for alignment](https://arxiv.org/abs/2609.05009)
*Maxim Chupilkin*
...
### [299] [TROVE: Adaptive Agent Skill Orchestration via Trace-Grounded Route Validation and Editing](https://arxiv.org/abs/2609.05019)
...
### [300] [Moral Competence Before Moral Content: Why LLM Agents Lack the Prerequisites for Coherent Alignment](https://arxiv.org/abs/2609.05036)
...
### [301] [Towards Efficient Evaluation of Evolutionary Transfer Optimization: Case Studies on Task-Parameterized Applications](https://arxiv.org/abs/2609.05040)
...
### [302] [MePo++: Unifying Representation Refinement and Reconciliation for General Continual Learning](https://arxiv.org/abs/2609.05075)
...
### [303] [TruthInsightBench: An Evidence-Grounded Benchmark for Automated Evaluation of Open-Ended Scientific Discovery Agents](https://arxiv.org/abs/2609.05079)
...
### [304] [Measuring AI Accountability Through Argumentation Analysis: Can Model Reasoning Withstand Scrutiny?](https://arxiv.org/abs/2609.05088)
...
### [305] [Constructing and Evaluating Clinical Reasoning Trajectories for Medical Agent](https://arxiv.org/abs/2609.05090)
...
### [306] [LLM-Guided Program Evolution for Circle Packing: Breaking 10 Packomania Records for $28](https://arxiv.org/abs/2609.05093)
*Wes Sander*
...
### [307] [ProCA: Progressive Contrastive Alignment for Robust EEG Visual Decoding](https://arxiv.org/abs/2609.05094)
...
### [308] [Compact Bellman-Grounded Cognitive Maps for Cost-Aware Navigation](https://arxiv.org/abs/2609.05104)
...
### [309] [Unifying ICL, SFT, KL-Regularized RL Through a Bayesian Lens](https://arxiv.org/abs/2609.05111)
*Junxin Fan*
...
### [315] [ACE: Adaptive Calibration-Free Expert Skipping for MoE-based LLMs](https://arxiv.org/abs/2609.05228)
...
### [316] [Substrate-Aware AI Agents: Execution Context as a First-Class Input](https://arxiv.org/abs/2609.05232)
*Manu Agrawal*
...
### [317] [Uncensored Open-weight Models: Redistribution as the Persistence Layer](https://arxiv.org/abs/2609.05241)
...
### [318] [Do LLMs Exhibit Coherent Knowledge Structures in Mathematical Reasoning? A Perspective from Knowledge Space Theory](https://arxiv.org/abs/2609.05245)
...
### [319] [A Unified Physics-Aware Quantum Machine Learning Framework across Power GaN HEMTs and Logic Nanowire FETs: Predicting Unseen Process Splits and Held-Out Geometry Combinations with Lower Error and Tighter Split-to-Split Variability](https://arxiv.org/abs/2609.05251)
...
### [320] [Commonsense Reasoning in Computer Vision: Foundations, Recent Advancements, and Future Directions](https://arxiv.org/abs/2609.05257)
...
### [321] [Trace2Tower: Transition-Aware EigenTrace Induction of Multi-Level Skills for LLM Agents](https://arxiv.org/abs/2609.05261)
...
### [322] [AI for Computational Design Science: A Responsible Human-AI Framework and Case Study on Short-Form Video Safety Surveillance](https://arxiv.org/abs/2609.05270)
...
### [323] [Don't Drop Dropout: Optimizing Layer Sparsity for Efficient LLM Training and Inference](https://arxiv.org/abs/2609.05275)
...
### [324] [Testing Interchangeability in LLM Agent Teams](https://arxiv.org/abs/2609.05279)
...
### [325] [GUT: Quantifying and Optimizing the Reasoning Uncertainty of LLMs via Graph Complexity](https://arxiv.org/abs/2609.05284)
...
### [326] [Beyond Aggregate Scores: Behavioral Correctness Assumptions for Assessing Reference-Based Automatic Evaluation Methods](https://arxiv.org/abs/2609.05289)
...
### [327] [RISE: Recursive Improvement via Self-Extrapolating Policy Distillation](https://arxiv.org/abs/2609.05295)
...
### [328] [Large Language Models for HVAC Operations in Building Energy Systems: A Critical Review of Methods, Applications, and Deployment Readiness](https://arxiv.org/abs/2609.05314)
...
### [330] [Technical Manual for a Toolkit for Measuring Contextual Individuation in Transformer Language Models](https://arxiv.org/abs/2609.05333)
...
### [331] [Does Your Agent's Memory Survive a Model Upgrade? A Controlled Study of Memory Portability](https://arxiv.org/abs/2609.05339)
...
### [336] [Multi-Step Tool-Calling over Korean Open Public APIs: A Benchmark and a Data-Synthesis Recipe](https://arxiv.org/abs/2609.05395)
...
### [337] [A Deep Generative Model for Synthesizing Labeled Wireless Signals](https://arxiv.org/abs/2609.05396)

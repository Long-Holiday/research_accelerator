...
- [JAG](#JAG) [Total: 5]
- [Remote Sensing](#Remote Sensing) [Total: 117]
...
### [111] [Habitat-quality dynamics and reversal-risk diagnostics in Southwest China using a productivity–hydrology enhanced RSEI framework](https://doi.org/10.1080/15481603.2026.2711464)
...
### [112] [Ensuring continuous high-precision Earth Radiation Budget Records: a scene-dependent spectral fusion unfiltering framework for FY-3F ERM-II](https://doi.org/10.1080/15481603.2026.2709753)
...
### [113] [Beyond static graphs: a scale-variant dynamic graph-based framework integrating spatial and hierarchical relationships for urban land-use mapping](https://doi.org/10.1080/15481603.2026.2705683)
...
### [114] [TS-DInSAR tool: a temporal &amp; spatial tool for the analysis of DInSAR data at the national scale](https://doi.org/10.1080/15481603.2026.2700111)
...
### [115] [Revealing the spatiotemporal evolutionary trajectories of multi-scale territorial spatial conflicts in Yunnan: an interpretable and causal machine learning framework](https://doi.org/10.1080/15481603.2026.2712005)
...
### [116] [A context entanglement-based geographically weighted regression method](https://doi.org/10.1080/15481603.2026.2713313)
...
### [117] [A synthetic flow network decision-making tool to identify potential downstream contamination risk in permafrost-bound Alaskan hazard sites](https://doi.org/10.1080/15481603.2026.2713329)
...
### [118] [Do maps still matter for machines: revisiting the role of choropleth maps in foundation model spatial understanding](https://doi.org/10.1080/15481603.2026.2711495)
...
### [119] [Assessing SWOT's capability for surface water extent mapping: An evaluation of Level-2 High-Rate Raster water fraction](https://doi.org/10.1016/j.rse.2026.115595)
...
### [120] [Mitigating terrain effects of GEDI data on regional accounting of aboveground biomass utilizing slope-adaptive waveform metrics](https://doi.org/10.1016/j.rse.2026.115598)
...
### [121] [Extending the MAIAC algorithm for hyperspectral atmospheric correction of TROPOMI measurements: A case study over vegetated regions](https://doi.org/10.1016/j.rse.2026.115593)
...
### [122] [Drivers of spectro-temporal variability in multi-spectral soil reflectance measured from space: A continental-scale analysis](https://doi.org/10.1016/j.rse.2026.115599)
...
### [123] [A loop-outlier-aware Riemannian pose-graph optimization framework for robust visual localization](https://doi.org/10.1016/j.isprsjprs.2026.07.024)
...
### [124] [A partially supervised joint segmentation method for farmland and rural roads from single-class annotated remote sensing datasets](https://doi.org/10.1016/j.jag.2026.105509)
...
### [125] [Corrigendum to “Spatiotemporal dynamics of solar photovoltaics development and ecological implications in Japan from cropland to forest” [Int. J. Appl. Earth Obs. Geoinf. 150 (2026) 105348]](https://doi.org/10.1016/j.jag.2026.105508)
...
### [126] [A new approach for comprehensive and spatiotemporally comparable Eco-Environmental quality assessment of surface coal Mines: MiecoI](https://doi.org/10.1016/j.jag.2026.105506)
...
### [127] [A near-real-time and unsupervised framework for grain crop harvest detection using sentinel-2 imagery: the reaped index (RI) and automated thresholding](https://doi.org/10.1016/j.jag.2026.105510)
...
### [128] [V-BUILD: A graph Transformer-based decision framework for selective updating of vector building data](https://doi.org/10.1016/j.jag.2026.105507)
...
### [129] [Underwater Hyperspectral Image Band Selection and Object Type Detection Method Based on Continuity and Label Constraints](https://doi.org/10.3390/rs18152499)
...
### [130] [A Hybrid Prior-Based Framework for Infrared Image Enhancement Towards Reliable Scene Interpretation](https://doi.org/10.3390/rs18152507)
...
### [131] [Sensor-Adaptive Cross-Temporal Difference Modulation for Building Damage Detection in Bi-Temporal Remote Sensing Imagery](https://doi.org/10.3390/rs18152518)
...
### [132] [VSTF-Net: A Vision-Semantic and Target-Aware Fusion Framework for Ship Detection in Complex Maritime Sensing Scenarios](https://doi.org/10.3390/rs18152517)
...
### [133] [A Real-Time Subband SAR Imaging Algorithm Based on an Approximate Echo Signal Model](https://doi.org/10.3390/rs18152520)
...
### [134] [Occlusion Removal in Remote Sensing Images Based on Deep Matrix Completion](https://doi.org/10.3390/rs18152538)
...
### [135] [Hyperspectral Image Classification Based on a Spatial–Spectral Dual-Branch Mamba Architecture](https://doi.org/10.3390/rs18152526)
...
### [136] [Impacts of Interannual Radiometric Calibration Differences on Vegetation Indices and Solar-Induced Chlorophyll Fluorescence Retrieval from Ground-Based Spectral Observations](https://doi.org/10.3390/rs18152528)
...
### [137] [Photovoltaic Panel Identification and Potential Assessment Based on Remote Sensing and Deep Learning: A Case Study of Yancheng City](https://doi.org/10.3390/rs18152542)
...
### [138] [Sensitivity-Constrained Anisotropic Regularization for Two-Track InSAR 3D Landslide Deformation Inversion in the Baihetan Reservoir Area, China](https://doi.org/10.3390/rs18152525)
...
### [139] [SIA-Net: A Scale-View Interactive Attention Network for Landslide Extraction from High-Resolution Optical Remote Sensing Images](https://doi.org/10.3390/rs18152521)
...
### [140] [PromptScaleDINO: Prompt-Stabilized and Scale-Aware Adaptation of Grounding DINO for Infrared Small Target Detection](https://doi.org/10.3390/rs18152503)
...
### [141] [GSSA: Gaussian Surfels with Spatial Awareness for Surface Reconstruction](https://doi.org/10.3390/rs18152497)
...
### [142] [DyPerceiver-Det: Instance-Wise Dynamic Perception for Fine-Grained Oriented Object Detection in Remote Sensing Images](https://doi.org/10.3390/rs18152515)
...
### [143] [Global Optimization Design of Large-Scale Constellations for Maritime Target Detection Based on Circular Scanning Radar](https://doi.org/10.3390/rs18152544)
...
### [144] [Geographically Constrained Transformer for Spatiotemporal Reconstruction of 2 m NDVI in Complex Coastal Landscapes](https://doi.org/10.3390/rs18152522)
...
### [145] [High-Resolution SMAP Soil Moisture in Agriculture: Capturing Field-Scale Variability in Soil Moisture and Evapotranspiration in the San Luis Valley](https://doi.org/10.3390/rs18152514)
...
### [146] [An Urban-Oriented Method for Tree Canopy Height Extraction Using ICESat-2 Data](https://doi.org/10.3390/rs18152510)
...
### [147] [Integrating Land Use Change and Vegetation Resilience to Assess Ecological Impacts of Expressway Construction: A Case Study of the Linghua Expressway](https://doi.org/10.3390/rs18152534)
...
### [148] [InSAR-Based Prediction of Time-Series Displacements Using a New Physics-Informed Neural Network with Prior Parameter Inversion](https://doi.org/10.3390/rs18152516)
...
### [149] [A Scalable Open Source Workflow for Riverbed Substrate Classification Using UAV Imagery](https://doi.org/10.3390/rs18152529)
...
### [150] [A Hierarchical Geometry-Driven Framework for Instance Segmentation Within Junction Regions in Steel Grid Structure Point Clouds](https://doi.org/10.3390/rs18152501)
...
### [151] [SPIF: A Spatio-Temporal Polarity Interaction Filter for Reliable Event Selection](https://doi.org/10.3390/rs18152551)
...
### [152] [RFM-UNet: Hybrid Frequency–Mamba UNet for Remote-Sensing Road Extraction](https://doi.org/10.3390/rs18152546)
...
### [153] [In Pursuit of Open-Weights Models for Intrinsic Interpretability in Wind Turbine Blade Monitoring with Tower-Mounted Radar](https://doi.org/10.3390/rs18152535)
...
### [154] [Climate-Adaptive Urban Planning: Quantitative Assessment of Drought Impact and Practical Strategies for Climate-Resilient Urban Green Spaces](https://doi.org/10.3390/rs18152531)
...
### [155] [Retrieval of Vertical Cloud Droplet Profiles and Above-Cloud Integrated Water Vapor from Hyperspectral Measurements: Reducing Liquid Water Path Retrieval Bias with Application to EMIT](https://doi.org/10.3390/rs18152556)
...
### [156] [An Adaptive Polyline-Path Mask Attention for Hyperspectral and Multispectral Image Fusion](https://doi.org/10.3390/rs18152536)
...
### [157] [Analysis of Area Changes and Driving Factors in Chirui Lake](https://doi.org/10.3390/rs18152558)
...
### [158] [A Sentinel-1 Dual-Polarimetric Scattering-Regime Framework with AMSR2 Consistency Assessment for Interannual Sea Ice Characterization in the Southern Sea of Okhotsk](https://doi.org/10.3390/rs18152498)
...
### [159] [SGW-DETR: A Spectral-Guided Graph-Structured Wavelet Transformer for UAV Infrared Object Detection Under Degradation](https://doi.org/10.3390/rs18152519)
...
### [160] [From Thermal Diagnosis to Spatial Allocation: A Remote-Sensing and Explainable Machine Learning Framework for Heat-Resilient Planning in Semi-Arid Grassland Towns](https://doi.org/10.3390/rs18152548)
...
### [161] [Impact of Clouds on Infrared and Microwave Sounding Retrieval and an Objective Correction Method for Numerical Weather Prediction](https://doi.org/10.3390/rs18152549)
...
### [162] [Calibration Optimization for Long-Term Consistency of the FY-3B Infrared Atmospheric Sounder](https://doi.org/10.3390/rs18152506)
...
### [163] [Aliasing Suppression in Synthetic Aperture Interferometric Radiometers Using Subarray-Based Antenna Architecture](https://doi.org/10.3390/rs18152552)
...
### [164] [Improving Convection-Allowing Ensemble Forecasts via Multi-Source Remote Sensing Data Assimilation Through Stepwise Cloud Analysis Initialization: A Remote Sensing Case Study](https://doi.org/10.3390/rs18152539)
...
### [165] [Analysis of Diagnostic Absorption Troughs in Clay Alteration Within the Xiangshan Uranium Deposit Based on ZY1-02E Satellite Hyperspectral Imagery](https://doi.org/10.3390/rs18152550)
...
### [166] [Geometric Accuracy Assessment of Large-Scale ZY-3 Imagery Based on Inter-Image Consistency](https://doi.org/10.3390/rs18152509)
...
### [167] [Future Scenario Simulation and Optimization of Ecological Security Patterns Under Policy Drivers: A Case Study of the Henan Section of the Yellow River Basin, China](https://doi.org/10.3390/rs18152554)
...
### [168] [Predicting Irrigated Rice Soil–Water Conditions Using Multispectral Remote Sensing and Machine Learning in Semi-Arid Australia](https://doi.org/10.3390/rs18152504)
...
### [169] [Disproportionate Soil Loss from Fragmented Sloping Cropland in Mountainous Northeastern Yunnan: Integrating Sentinel-2, CSLE, and Landscape Metrics](https://doi.org/10.3390/rs18152537)
...
### [170] [FIRE-BYOL: A Real-Time Grassland Active-Fire Detection Algorithm Fusing VIIRS Fire Products and Himawari-8/9 Data](https://doi.org/10.3390/rs18152553)
...
### [171] [GCIE-Net: A Global and Channel Information-Enhanced Network for Ship Instance Segmentation in SAR Images](https://doi.org/10.3390/rs18152512)
...
### [172] [Study on the Distribution Characteristics and Influencing Factors of Rock Glaciers in the Lenglongling Region of the Eastern Qilian Mountains](https://doi.org/10.3390/rs18152524)
...
### [173] [Assessment of Flood Risk Using Remote Sensing and GIS Techniques Based on the Analytic Hierarchy Process (AHP) and Fuzzy AHP (FAHP) in the R’Dom Watershed (Meknes, Morocco)](https://doi.org/10.3390/rs18152500)
...
### [174] [GeoAdapt: Fine-Grained Keypoint Localization via Deformable Feature Refinement for Ground-Based Optical Remote Sensing](https://doi.org/10.3390/rs18152545)
...
### [175] [Validation Design Governs Reported Accuracy in Small UAV Hyperspectral Datasets: An Interpretable Feature-Optimization Case Study of Maize Canopy Nitrogen Concentration](https://doi.org/10.3390/rs18152502)
...
### [176] [A Method for Segmentation and Identification of Urban Functional Areas with Generalization Ability Based on Scale-Aware Feature-Enhanced Attention Mask R-CNN](https://doi.org/10.3390/rs18152541)
...
### [177] [An Improved JSEG-Based Algorithm for Segmentation of Categorical and Remote Sensing Classification Maps](https://doi.org/10.3390/rs18152543)
...
### [178] [WetVeg-2mm: An Ultra-High-Resolution UAV Dataset for Riparian Vegetation Semantic Segmentation](https://doi.org/10.3390/rs18152508)
...
### [179] [Open-Source Reproducible Pipeline for Multitemporal Vegetation Monitoring Using Sentinel-2 L2A in Cloud-Prone Tropical Regions](https://doi.org/10.3390/rs18152532)
...
### [180] [Analysis of Vegetation Dynamics and Driving Factors in Xinjiang Under Land-Use Change Trends](https://doi.org/10.3390/rs18152496)
...
### [181] [Frequency-Domain Modeling and Removal of Platform Jitter Stripes in GF-7 DSMs for Flat Terrains](https://doi.org/10.3390/rs18152557)
...
### [182] [Landslide Susceptibility Mapping Constrained by InSAR-Derived Deformation Using Multi-Source Data Integration](https://doi.org/10.3390/rs18152540)
...
### [183] [Mapping Submarine Sand Wave Bathymetry from Sentinel-2 Texture Using a Spatial-Sequential Deep Learning Model](https://doi.org/10.3390/rs18152511)
...
### [184] [Vegetation Optical Depth at Enhanced Spatial Resolution: Progress, Challenges, and Perspectives](https://doi.org/10.3390/rs18152530)
...
### [185] [Pulse RFI Mitigation for SAR Data Based on Reduced Rank Approximate](https://doi.org/10.3390/rs18152513)
...
### [186] [Sparse Rational Polynomial Coefficient Estimation Method via Low-Rank Matrix Constraint](https://doi.org/10.3390/rs18152547)
...
### [187] [Integrating Multi-Source Environmental Variables with Sentinel-3 OLCI Imagery for Interpretable Retrieval of Eutrophication Parameters in Bohai](https://doi.org/10.3390/rs18152527)
...
### [188] [TimeHome: Heterogeneous Mixture-of-Experts for Time-Series Foundation Model](https://doi.org/10.3390/rs18152533)
...
### [189] [Self-Supervised Pre-Training Style Adaptation-Guided Remote Sensing Image Change Detection Network](https://doi.org/10.3390/rs18152523)
...
### [190] [Spatiotemporal Dynamics and Driving Mechanisms of Impervious Surface Expansion in Changsha County Using Landsat Time-Series](https://doi.org/10.3390/rs18152555)
...
### [191] [A Fast ISAR Imaging Method Based on PC-2D-FIR-GEM-Net for Low SNR and Sparse Aperture Conditions](https://doi.org/10.3390/rs18152505)
...
### [192] [An Optimized CatBoost Model for Spatiotemporal Prediction of hmF2 in High-Latitude Regions](https://doi.org/10.3390/rs18152579)
...
### [193] [Field-Scale Evapotranspiration of Flood-Irrigated Rice with Automated METRIC on Google Earth Engine in an Arid Region of Northern Peru](https://doi.org/10.3390/rs18152584)
...
### [194] [Refined Multi-Source Satellite and Reanalysis Diagnostics Reveal Topographic Anchoring and Thermodynamic Control of the Tibetan Plateau Ozone Valley](https://doi.org/10.3390/rs18152560)
...
### [195] [CDGP-Net: Channel-Decoupling and Geographic-Prior Fusion for Spatial Super-Resolution of HIRAS Radiances with Co-Platform MERSI-II](https://doi.org/10.3390/rs18152575)
...
### [196] [Exploring Marine Atmospheric Ducts: Current Sensing and Emerging Trends](https://doi.org/10.3390/rs18152576)
...
### [197] [Physics-Aware Deep Learning for SAR and InSAR Remote Sensing: Models, Methods, and Open Challenges](https://doi.org/10.3390/rs18152567)
*Giorgio Taricco*
...
### [198] [Few-Shot SAR Object Detection with Prior Class Perceptron and Cross-Entropy](https://doi.org/10.3390/rs18152580)
...
### [199] [Trends and Lagged Cumulative Associations Between Vegetation NDVI and Extreme Climate Indices in the Yangtze River Basin: A 41-Year Observational Analysis](https://doi.org/10.3390/rs18152559)
...
### [200] [Recommendations for Low-Noise Data Acquisition with UAV-Mounted Multi-Channel Magnetometer Systems](https://doi.org/10.3390/rs18152564)
...
### [201] [SDRCNet: A Lightweight Structure-Guided Dual-Relation Consensus Network for Optical Remote Sensing Images](https://doi.org/10.3390/rs18152565)
...
### [202] [A Road-Segment-Based Rockfall Susceptibility Mapping Approach Integrating Physically Informed Slope-Cutting Features and Comparative Machine Learning Models](https://doi.org/10.3390/rs18152562)
...
### [203] [Spatiotemporal Characteristics and Hydrogeological–Urban Controls of Surface Deformation in Haikou, China, Revealed by PS/DS-InSAR and Spatial Attribution Analysis](https://doi.org/10.3390/rs18152570)
...
### [204] [Design and Analysis of a Compact Airborne Hyperspectral Imager for Vegetation Photosynthesis and Stress Monitoring](https://doi.org/10.3390/rs18152585)
...
### [205] [TGMNet: Temporal-Guided Mamba Network for Moving Infrared Dim and Small Target Detection](https://doi.org/10.3390/rs18152578)
...
### [206] [Diagnosing and Conditionally Correcting X-Band Radar Underestimation in Cyprus: A Cross-Validated Evaluation of Spatial Merging and Machine Learning Approaches](https://doi.org/10.3390/rs18152577)
...
### [207] [Satellite Detection of Diffuse Tectonic CO2 Degassing in the East African Rift](https://doi.org/10.3390/rs18152586)
...
### [208] [Penetration Depth Investigation of L-Band and S-Band SAR Signals into Soils and Hard Ground Surfaces](https://doi.org/10.3390/rs18152566)
...
### [209] [A Study on Radar–Gauge Rainfall Data Merging and Its Impact on Flood Simulation](https://doi.org/10.3390/rs18152587)
...
### [210] [Principal Component Analysis of IASI Measurements for the Detection of Extreme Atmospheric Composition Events: Methodology and Applications](https://doi.org/10.3390/rs18152568)
...
### [211] [Impact of Vegetation and Soil Moisture on the Detection of Buried Landmines Using GPR](https://doi.org/10.3390/rs18152582)
...
### [212] [A Two-Stage Framework for SAR Near-Shore Ship Detection via Segmentation Guidance and Enhanced Diffusion](https://doi.org/10.3390/rs18152569)
...
### [213] [Spatial Correspondence Between Seismic b-Value Stress Localization and Pre-Earthquake GNSS-TEC Anomalies in Southern California and Northern Baja California](https://doi.org/10.3390/rs18152574)
...
### [214] [Industrial Dominance of Urban NO2 and Associated Health Risks: A Multi-Source Analysis in the Southern Region of Rio de Janeiro State](https://doi.org/10.3390/rs18152581)
...
### [215] [Change Detection in Remote Sensing Imagery: A Systematic Review of Statistical, Machine Learning, and Deep Learning Methods](https://doi.org/10.3390/rs18152573)
...
### [216] [Quality Assessment and Observation Error Estimation of Tianmu-1 GNSS Radio Occultation Bending Angle and Refractivity Retrievals](https://doi.org/10.3390/rs18152572)
...
### [217] [Robust Individual Tree Parameter Estimation in Cold–Temperate Secondary Forests Using ULS–HLS Data and the RSQ-Tree Framework](https://doi.org/10.3390/rs18152563)
...
### [218] [Pseudo 3-D GPR and 2-D ERT Study to Reveal Subtle Tectonic Deformations of a Strike-Slip Raša Fault (Dinaric Fault System, W Slovenia) in Fluvial and Karstic Environments](https://doi.org/10.3390/rs18152561)
...
### [219] [Consistent Photometric Enhancement Network for Remote Sensing Change Detection](https://doi.org/10.3390/rs18152583)
...
### [220] [A Comprehensive Machine Learning Approach for Crop Classification Using Multi-Sensor Satellite Datasets and Multiple Vegetation Indices](https://doi.org/10.3390/rs18152571)
...
### [221] [Improving Vegetation Mapping from LiDAR Point Clouds Using a Transmissivity-Based Feature](https://doi.org/10.3390/rs18152602)
...
### [222] [Infrared–Visible Multi-Sensor Fusion for UAV Photovoltaic Defect Detection Under Real-World Weak Misalignment](https://doi.org/10.3390/rs18152607)
...
### [223] [SPFMamba: A Mamba-Based Network with Semantic Prompt and Frequency-Adaptive Fusion for Remote Sensing Image Semantic Segmentation](https://doi.org/10.3390/rs18152592)
...
### [224] [Empirical Optimization of the Stumpf Method Parameter for Satellite-Derived Bathymetry](https://doi.org/10.3390/rs18152613)
...
### [225] [Research on an Absolute Radiometric Calibration Method Based on a Point Source Array](https://doi.org/10.3390/rs18152590)
...
### [226] [Mapping Neighborhood Spatial Structure in Traditional Home Gardens Using UAV-Derived 3D Canopy Models](https://doi.org/10.3390/rs18152605)
...
### [227] [Temporal-Variation-Resistant Bidirectional Convolution-Transformer GAN for Remote Sensing Image Spatiotemporal Fusion](https://doi.org/10.3390/rs18152597)
...
### [228] [Assessing the Impact of Spatial Resolution and Aggregation Method on Sentinel-2 NDVI Time Series in Grasslands of Mainland Spain](https://doi.org/10.3390/rs18152611)
...
### [229] [PCFD-Net: A Parallel Collaborative Fusion-Detection Network for SAR and Optical Imagery](https://doi.org/10.3390/rs18152595)
...
### [230] [PSG-RTDETR: Towards Stable Cross-Scale Feature Fusion for Small Object Detection](https://doi.org/10.3390/rs18152609)
...
### [231] [Remote Sensing-Assisted Stockpile Landslide Monitoring Based on Change Detection Analysis and Identification of Topographical Failure Precursors](https://doi.org/10.3390/rs18152594)
...
### [232] [Shoreline Behavior at California Groin Fields from Satellite-Based Measurements](https://doi.org/10.3390/rs18152608)
...
### [233] [FDM-Net: A Multi-Level Feature Aggregation Network Based on Frequency-Decomposition for Hyperspectral Image Classification](https://doi.org/10.3390/rs18152603)
...
### [234] [UAV Hyperspectral Characterization of Spatial Color Heterogeneity in Alpine Karst Lakes](https://doi.org/10.3390/rs18152596)
...
### [235] [Scaling Foliar Phenolics from Airborne Imaging Spectroscopy to Sentinel-2 Across Diverse Vegetation Types](https://doi.org/10.3390/rs18152599)
...
### [236] [MLS-CAPS: Optimising Path Spacing for Mobile Laser Scanning of Vegetation Structure via Completeness Analysis](https://doi.org/10.3390/rs18152606)
...
### [237] [Can UAV-Derived Maize Canopy Traits Inform Soil Mineral Nitrogen Estimation? Linking Above- and Below-Ground Nitrogen Dynamics in Black Soils](https://doi.org/10.3390/rs18152588)
...
### [238] [Land Subsidence-Induced Horizontal Displacement Along the High-Speed Rail in Central Taiwan: An Integrated Multi-Temporal InSAR, GNSS, and Leveling Approach](https://doi.org/10.3390/rs18152612)
...
### [239] [Centroid-Preserving Dynamic Star Image Deblurring for Remote Sensing Satellite Attitude Measurement via Physics-Guided Bi-Level Optimization](https://doi.org/10.3390/rs18152610)
...
### [240] [Perspectives and Challenges of Machine Learning for Applications in Agriculture and Vegetation Using Remote Sensing](https://doi.org/10.3390/rs18152589)
...
### [241] [Geometry-Aware InSAR Feedback Purification Sampling for Negative Sample Selection in Landslide Susceptibility Assessment: A Case Study in the Shigatse Region](https://doi.org/10.3390/rs18152591)
...
### [242] [SLAM–UAV LiDAR Co-Registration for Individual-Tree Carbon Across a Tropical Dry-Forest Canopy Gradient](https://doi.org/10.3390/rs18152604)
...
### [243] [Sensitivity of Vegetation Greenness to Multi-Depth Soil Moisture on the Mongolian Plateau: Nonlinear Responses Revealed by RF–SHAP](https://doi.org/10.3390/rs18152600)
...
### [244] [Airborne Point Cloud Fusion with Local Plane Constraints for Advanced Semantic Consistency](https://doi.org/10.3390/rs18152598)
...
### [245] [Integrating Multi-Source Geoscientific Data via Geologically Constrained Feature Engineering for Gold Prospectivity Mapping: A Case Study of Jiaoxibei, China](https://doi.org/10.3390/rs18152593)
...
### [330] [CogVis: Must Open-Vocabulary Change Detection Perceive the Scene Anew for Every Query?](https://arxiv.org/abs/2608.06150)
...
### [331] [iARCS: Iterative Agentic RL for Controllable 3D Scene Generation](https://arxiv.org/abs/2608.06161)
...
### [332] [Schema-Guided Hierarchical Information Extraction and Semantic Evaluation Using Generative AI](https://arxiv.org/abs/2608.06167)
...
### [342] [HarnessOpt-Bench: Evaluating LLMs at Harness Optimization](https://arxiv.org/abs/2608.06301)
...
### [343] [Beyond Top-K: Replacing Black-Box Retrieval with Interpretable Agentic Operations](https://arxiv.org/abs/2608.06305)

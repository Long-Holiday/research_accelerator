...
- [JAG](#JAG) [Total: 12]
- [Remote Sensing](#Remote Sensing) [Total: 41]
...
Abstract (英文): We address the problem of recovering high-speed videos from dynamic scenes under extreme photon sparsity. Existing methods rely on aggregating photon detections in local spatiotemporal windows to improve signal-to-noise ratio; however, this local grouping discards global structure and fails in low-light regimes where photon detections are sparse in space and time. In this work, we show that the information needed to recover both motion and illumination is encoded in correlations over the full space-time pattern of photon arrivals. Building on this insight, we develop a spatiotemporal flux probing theory and an algorithm that estimates the Fourier coefficients of the underlying intensity directly from the photon stream. We demonstrate that our approach (1) recovers fast motion and temporal illumination dynamics with substantially fewer photons than prior methods, (2) enables velocity-selective videography that automatically refocuses video onto specific detected motions, and (3) generalizes across sensing modalities including single-photon, event, and spike cameras.
...
Abstract (英文): Video recording on smart glasses exposes more than faces. Continuous capture reveals full-body biometric signatures, including gait, posture, and silhouette, that enable person re-identification (ReID) even after conventional face sanitization.
...
Abstract (英文): A new concept, termed virtual neural networks, is introduced, where the count of trainable parameters is kept constant, and scalability is attained purely through computational resources. This concept is an abstract framework that can be realized using any standard convolutional neural network. It merges siamese neural networks with a deep ensemble technique by generating numerous virtual models that share weights derived from a small set of physical models. The ensemble comprises up to hundreds of trained models simultaneously. All virtual networks take the same input, and their interconnected structure induces an internal distortion that boosts the entire ensemble robustness. The accuracy of the ensemble improves as the number of virtual networks increases, without changing the capacity. Virtual neural networks outperform larger capacity models, typical deep ensembles, and contemporary approaches like SWA and Masksembles. Additionally, the highest-performing individual model from the ensemble surpasses other models trained individually, even those with a greater number of parameters. Code: gitlab.com/EnginCZ/virtual-models-public
...
### [222] [DirPA: Addressing prior shift in imbalanced few-shot crop-type classification](https://doi.org/10.1016/j.isprsjprs.2026.08.016)
...
### [223] [BlinkChange: Active perception bi-temporal reliable representation for disaster impact understanding from remote sensing imagery](https://doi.org/10.1016/j.isprsjprs.2026.09.014)
...
### [224] [Structure-preserving feature disentanglement with an adaptive transformer for unsupervised cross-domain object detection in heterogeneous SAR imagery](https://doi.org/10.1016/j.isprsjprs.2026.08.044)
...
### [225] [Toward scalable organ-level 3D plant segmentation: A systematic and quantitative review through the lens of the data-algorithm-computing triangle](https://doi.org/10.1016/j.isprsjprs.2026.09.003)
...
### [226] [A novel change homogenizing flood index and an expedited locally tuned Markov random field model for unsupervised rural floodwater detection in sentinel-1 data: An application to flood impact assessment](https://doi.org/10.1016/j.isprsjprs.2026.08.021)
...
### [227] [Conditional diffusion model with residual decomposition generation strategy for SAR to optical image translation](https://doi.org/10.1016/j.isprsjprs.2026.08.043)
...
### [228] [Spot the differences: a registration-robust object-level change detection framework for remote sensing images](https://doi.org/10.1016/j.isprsjprs.2026.09.001)
...
### [229] [Explaining discrepancies between ground-based and spaceborne nighttime light measurements using urban morphology: a multi-city study](https://doi.org/10.1016/j.isprsjprs.2026.09.015)
...
### [230] [SAF-CropNet: Spatially adaptive fusion of SAR and optical imagery for semantic segmentation in operational cropland mapping across regions](https://doi.org/10.1016/j.isprsjprs.2026.08.029)
...
### [231] [Sketch and paint: A structural–temporal aware refinement network for fine-grained crop mapping on satellite image time series](https://doi.org/10.1016/j.isprsjprs.2026.09.009)
...
### [232] [An Adaptive Dynamic AI-driven ParameTerization (ADAPT) framework for global hourly gross primary productivity estimation](https://doi.org/10.1016/j.isprsjprs.2026.09.024)
...
### [233] [Spectral unmixing of hyperspectral lidar signals considering laser beam profile](https://doi.org/10.1016/j.isprsjprs.2026.09.011)
...
### [234] [Point-Cloud-Native L-Band Augmentation of SWOT KaRIn: Recovering Canopy-Shadowed Dark Water with NISAR](https://doi.org/10.5281/zenodo.22818803)
...
### [235] [Point-Cloud-Native L-Band Augmentation of SWOT KaRIn: Recovering Canopy-Shadowed Dark Water with NISAR](https://doi.org/10.5281/zenodo.22818804)
*Waleed Shoaib,Bakhtawar Ismail,Muhammad Salik*
...
### [236] [Didactic knowledge or Clinical Cases? How Data Types Shape Medical Large Language Models](https://arxiv.org/abs/2609.22161)
...
### [249] [GaitVista: Reliability-Aware AI Measurement toward Accessible Longitudinal Gait Assessment](https://arxiv.org/abs/2609.22619)
...
### [261] [DVA-Neurons: Design and Verification of Adaptive LIF Neurons: From Single-Neuron Dynamics to Multi-Neuron Spiking Networks](https://arxiv.org/abs/2609.22775)
...
### [264] [When Should a VLM Look? Paying Only for Visual Calls That Were Needed and Used](https://arxiv.org/abs/2609.22910)
...
### [278] [CraftBench-UE: Deterministic Evaluation for Coding Agents in Unreal Engine](https://arxiv.org/abs/2609.23142)
...
### [282] [Leaky-integrator reconstruction: taming error accumulation in recursive differenced time-series forecasting](https://arxiv.org/abs/2609.23378)
*Zijiang Yang*
...
### [286] [ScholarStack: Layered Research Asset Orchestration and Cross-Task Reuse for Scientific Agents](https://arxiv.org/abs/2609.23735)
...
Abstract (英文): Multimodal Large Language Models (MLLMs) commonly reuse visual encoders pretrained with CLIP, although the features of these ViTs are ultimately consumed by autoregressive LLMs. We refer to this mismatch as the semantic-interface gap and introduce MedMLIP, a framework that pretrains the visual encoder through report generation with a frozen LLM, while employing Local Relational Distillation (LRD) to preserve relationships among visual patches to avoid visual collapse. We pretrain MedMLIP on IU-Xray and Open-PMC-300K and evaluate the resulting encoders on VQA-RAD and SLAKE. Only the ViT is transferred, while the guiding LLM and projector are replaced, allowing us to assess cross-LLM transferability. Our cross-LLM transfer experiments demonstrate the value of pretraining visual encoders for their autoregressive LLM interface while trying to preserve more fine-grained visual information. Code and the pretrained model are available at https://github.com/SkyCol/MedMLIP

</details>


### [291] [Explainable Recommendations at Scale: LLM Rationales for YouTube Music Artist Discovery](https://arxiv.org/abs/2609.23877)
...
### [301] [Testing, not presuming, adequacy: calibrating generative social simulators against emergent network structure](https://arxiv.org/abs/2609.24012)
...
### [305] [Representation-guided in-context learning for medical image interpretation with multimodal large language models](https://arxiv.org/abs/2609.24057)
...
### [307] [DocMIDE: Learning Multi-Hop Implicit Derivation in Visually Rich Documents](https://arxiv.org/abs/2609.24092)
...
### [313] [LIMIT: Less Is More for Instruction Tuning in Text-to-SQL](https://arxiv.org/abs/2609.24186)
...
### [327] [The Endless Exam: Mathematical Constructions from Today's Models toward Superintelligence](https://arxiv.org/abs/2609.24555)
*Muhan Zhang*
...
### [329] [Custom Named Entity Recognition and Topic Classification for Global Health Publications](https://arxiv.org/abs/2609.24625)
...
Abstract (英文): Autonomous AI agents are increasingly deployed in areas where wrong decisions are hard to reverse. This paper examines schema mismatch: the condition in which an agent operates within an interpretive frame that no longer applies to the current context. Outputs produced under such a mismatch can appear internally consistent, linguistically plausible, and largely factually correct; output-quality metrics alone therefore capture the underlying loss of validity only partially.
...
### [335] [Construting Reverse Thinking: Developing Large Language Models' Reverse Thingking Ability](https://arxiv.org/abs/2609.24760)
...
### [345] [Emergent Collusion in Long-Horizon LLM Agent Interaction](https://arxiv.org/abs/2609.24967)
...
### [347] [Context-aware quantile baselines for disturbance detection in non-stationary short-rotation forest plantations](https://doi.org/10.1016/j.jag.2026.105555)
...
### [348] [An RTE-guided mixture-of-experts framework for AMSR2 passive microwave soil moisture retrieval](https://doi.org/10.1016/j.jag.2026.105597)
...
### [349] [Multimodal loess cave extraction using LMUNet-RCAM: Integrating hillshade and RGB features with local attention mechanisms](https://doi.org/10.1016/j.jag.2026.105596)
...
### [350] [Learning instance-level semantic Gaussian representations for occlusion-aware urban scene reconstruction from UAV imagery](https://doi.org/10.1016/j.jag.2026.105574)
...
### [351] [Vegetation canopy height retrieval in complex mountainous regions based on data calibration and CNN model](https://doi.org/10.1016/j.jag.2026.105598)
...
### [352] [Automated conversion of unstructured mesh models to structured parametric CAD models for architectural applications](https://doi.org/10.1016/j.jag.2026.105583)
...
### [353] [Challenges in heating demand modelling based on the Kleczków district in Wrocław, Poland](https://doi.org/10.1016/j.jag.2026.105581)
...
### [354] [Biophysical effects of afforestation on local land surface temperature in china: A comprehensive analysis incorporating forest age and afforestation intensity](https://doi.org/10.1016/j.jag.2026.105593)
...
### [355] [A two-stage transformer framework for reconstructing hourly 1 km all-weather land surface temperature using cross-scale transfer learning](https://doi.org/10.1016/j.jag.2026.105602)
...
### [356] [AdaGeo-SR: Geo-semantic-guided super-resolution of sentinel-2 imagery with AlphaEarth foundation priors](https://doi.org/10.1016/j.jag.2026.105573)
...
### [357] [A spatiotemporal reconstruction framework for GRACE/GRACE-FO-derived groundwater storage anomalies based on historical phase-constrained gap filling and physics-guided global–local downscaling](https://doi.org/10.1016/j.jag.2026.105603)
...
### [358] [Adaptive background suppression-based plume identification, emission estimation, and ground validation of coal mine methane in Changzhi, Shanxi, China](https://doi.org/10.1016/j.jag.2026.105587)
...
### [359] [Exploiting Projection Trajectories Discrepancy for Multipath Suppression and Detailed Feature Extraction of Buildings in SAR Adjacent Sub-Aperture Images](https://doi.org/10.3390/rs18183164)
...
### [360] [Annual Gridded Anthropogenic CH4 Emissions Estimation in China (2019–2025) Integrating Multisource Data: SHAP-Based Driver Attribution and Spatio-Temporal Patterns](https://doi.org/10.3390/rs18183168)
...
### [361] [Adaptive Plug-and-Play Image Restoration for Diffractive Remote Sensing with a Latent Diffusion Prior](https://doi.org/10.3390/rs18183171)
...
### [362] [Retrieval of Optically Active and Inactive Water Quality Parameters Using Remote Sensing and Machine Learning: Evidence from Water Hyacinth-Infested Lake Tana, Ethiopia](https://doi.org/10.3390/rs18183185)
...
### [363] [Spatially Constrained Grassland Aboveground Biomass Estimation by Identifying and Masking Achnatherum splendens: Integrating UAV Remote Sensing and Deep Learning](https://doi.org/10.3390/rs18183177)
...
### [364] [Regional Marine Gravity Field Refinement by Integrating Region-Adaptive Fusion and Multi-Relational Graph Residual Learning](https://doi.org/10.3390/rs18183182)
...
### [365] [Automated Machine Learning-Driven UAV Remote Sensing for Accurate Winter Wheat Water Content Prediction](https://doi.org/10.3390/rs18183161)
...
### [366] [Boundary-Guided Dual-Perspective Cross-Modal Fusion Network for RGB-IR Object Detection](https://doi.org/10.3390/rs18183175)
...
### [367] [Cross-Validation of Collocated ICESat-2 and CALIPSO Cloud-Aerosol Discrimination](https://doi.org/10.3390/rs18183167)
...
### [368] [Quantifying the Spatio-Ecological Context of Urban Nature-Based Solutions Across European Cities](https://doi.org/10.3390/rs18183184)
...
### [369] [Foundation-Model Embeddings for Land-Cover Mapping and Annual Change Detection in a Hyper-Arid Region: A Case Study of Saudi Arabia (2017–2024)](https://doi.org/10.3390/rs18183163)
...
### [370] [Geodetic Assessment of Drought Intensity and Hydrological Dynamics in the Cantareira System, Southeastern Brazil](https://doi.org/10.3390/rs18183170)
...
### [371] [Deep Learning-Based Monitoring of Photovoltaic Power Plant Expansion and Assessment of Albedo-Driven Shortwave Energy Changes](https://doi.org/10.3390/rs18183183)
...
### [372] [Weighted Strong Product Graph Laplacian Regularization for Hyperspectral Image Mixed-Noise Removal with Superpixel Segmentation](https://doi.org/10.3390/rs18183162)
...
### [373] [SpaceFast-GS: Foreground-Guided 3D Gaussian Splatting for Efficient Spacecraft Reconstruction](https://doi.org/10.3390/rs18183169)
...
### [374] [A Canopy-Scale Fluorescence Approach for Evaluating Seasonal Photochemical Dynamics Across Different U.S. Forests](https://doi.org/10.3390/rs18183181)
...
### [375] [Comparative Multi-Data and Multi-Method InSAR for Deformation Monitoring and Visualization: A Case Study of Baode, China](https://doi.org/10.3390/rs18183176)
...
### [376] [Seafloor Topography Prediction from Altimetry-Derived Gravity Data Using a Wavelet-Assisted and High-Frequency Enhancement Neural Network](https://doi.org/10.3390/rs18183174)
...
### [377] [DTKDP: A Dual Teacher Knowledge Distillation and Pruning Framework for Lightweight Oriented SAR Ship Detection](https://doi.org/10.3390/rs18183172)
...
### [378] [Horizontal and Vertical Deformations of the Erta Ale Volcanic Segment in the Northern Rift Region of Ethiopia Using Sentinel-1 InSAR Time-Series Analysis with LiCSBAS](https://doi.org/10.3390/rs18183166)
...
### [379] [Class-Specific Interpretation and Validation of Optical and SAR Sensor Contributions in Multi-Sensor Land-Cover Classification Using SHAP and Leave-One-Sensor-Out Ablation](https://doi.org/10.3390/rs18183186)
...
### [380] [Proximal Sensing of Maize Nutrient Status Across Diverse Production Systems with Whole-Leaf Hyperspectral Transmittance](https://doi.org/10.3390/rs18183165)
...
### [381] [Red-Edge Information in Agricultural Remote Sensing: From Spectral Theory to Explainable Machine Learning](https://doi.org/10.3390/rs18183180)
...
### [382] [Dynamic Reconstruction of Vegetation Earth Observation Time Series: Beyond Gap-Filling in Level-3 Products](https://doi.org/10.3390/rs18183178)
*Jochem Verrelst*
...
### [383] [Gas Plume Detection from Infrared Hyperspectral Remote Sensing Data Based on Deep Learning Algorithms](https://doi.org/10.3390/rs18183179)
...
### [384] [Occlusion-Aware Topology Refinement for Robust Road Graph Extraction from Satellite Imagery](https://doi.org/10.3390/rs18183173)
...
### [385] [Unsupervised Scale-Conditioned Hyperspectral and Multispectral Image Fusion via a Frequency–Spatial Dual-Domain Network](https://doi.org/10.3390/rs18183187)
...
### [386] [The Evolution of Land Subsidence Under the New Water Regime in the North China Plain: A TS-InSAR and Spatiotemporal Pattern Analysis](https://doi.org/10.3390/rs18183188)
...
### [387] [Evaluating In Situ and OCO-3 CO2 Observations in the Sichuan Basin Using WRF-Chem Simulations and Footprint Analysis](https://doi.org/10.3390/rs18183193)
...
### [388] [Sea Surface Current Vector Reconstruction from Multitemporal Sentinel-1 Doppler Observations: A Trajectory-Crossing Approach with Spatial Registration](https://doi.org/10.3390/rs18183192)
...
### [389] [Unpacking the Fragmentation–Ecology Nexus: Spatial Heterogeneity, Nonlinear Responses, and Associated Ecological Factors Across Urban Agglomerations in the Yellow River Basin](https://doi.org/10.3390/rs18183191)
...
### [390] [Low-Cost Geological Reconnaissance for Artisanal and Small-Scale Mining: RGB–HSV Analysis of Rendered Google Earth Imagery in Arid Copper-Prospective Terrains of Chile and Balochistan](https://doi.org/10.3390/rs18183189)
...
### [391] [Multi-Scale Validation of Satellite-Based Precipitation Products and Their Impacts on Hydrological Simulation in a Humid Mountainous Basin](https://doi.org/10.3390/rs18183190)
...
### [392] [TOTMSeg: A Texture-Aware Octree-Based Transformer-Mamba Framework for Large-Scale Urban Mesh Semantic Segmentation](https://doi.org/10.3390/rs18183198)
...
### [393] [Reading the Void: A Reconstructive Hypothesis for a Service Staircase at the Infantado Palace in Guadalajara Using TLS](https://doi.org/10.3390/rs18183200)
...
### [394] [Spatial Prediction and Performance Comparison of Soil Organic Carbon in High-Latitude Forest Soils Based on Multiple Feature Selection Methods and Machine Learning Models](https://doi.org/10.3390/rs18183199)
...
### [395] [Calibration of Event-Based Camera for High-Speed Observations of Lightning and Transient Luminous Events](https://doi.org/10.3390/rs18183201)
...
### [396] [Reconstructed XCO2 Reveals Seasonal Moisture Limitation Sensitivity Across Typical Steppe, Forest, and Gobi Desert in Mongolia](https://doi.org/10.3390/rs18183196)
...
### [397] [HSRA-Net: Hierarchical Season-Year Representation Alignment for Tree Species Classification from Long-Term Sentinel-2 Observations](https://doi.org/10.3390/rs18183195)
...
### [398] [New Insights into Aristarchus Plateau and Its Vicinity from Chang’e-2 Microwave Radiometer Data](https://doi.org/10.3390/rs18183194)
...
### [399] [Uncertainty-Based Quality-Control Prioritization for High-Resolution Land-Cover Mapping Under Spatially Disjoint Evaluation](https://doi.org/10.3390/rs18183197)
...
### [400] [High-resolution land cover mapping from coarse labels via a noisy label learning-guided cross-scale framework](https://doi.org/10.1080/15481603.2026.2726002)
...
### [401] [Audio-visual fusion for near-surface wind speed estimation using surveillance cameras](https://doi.org/10.1080/15481603.2026.2731700)
...
### [402] [Shifting pathways of post-earthquake vegetation structural and functional recovery under varying earthquake disturbance intensities](https://doi.org/10.1080/15481603.2026.2728759)
...
### [403] [A source–medium–receiver framework for modeling wind-driven vegetation cooling in urban landscapes](https://doi.org/10.1080/15481603.2026.2733792)
...
### [404] [Correction](https://doi.org/10.1080/15481603.2026.2736374)
*Unknown Author*
...
### [405] [Reliable Sar oil-spill segmentation for marine monitoring Via self-supervised denoising and lightweight wavelet–state-space modeling](https://doi.org/10.1080/15481603.2026.2727781)
...
### [406] [Global daily joint reconstruction of TROPOMI tropospheric No 2 columns and averaging kernels with temporally aware deep learning](https://doi.org/10.1080/15481603.2026.2732650)
...
### [407] [Multitemporal InSAR analysis of long-term creep and active thickness changes in a paleo riverbank landslide driven by anomalous water levels](https://doi.org/10.1016/j.rse.2026.115657)
...
### [408] [A knowledge-guided machine learning framework for cross-scale wheat harvest monitoring via sample augmentation](https://doi.org/10.1016/j.rse.2026.115671)
...
### [409] [Development of a new water stress index combining PRI and soil moisture for assessing olive tree water status in Morocco](https://doi.org/10.1016/j.rse.2026.115676)
...
### [410] [Intercomparison and evaluation of global land surface phenology (LSP) products](https://doi.org/10.1016/j.rse.2026.115680)
...
### [411] [Using ICESat-2 ATL08 heights and Landsat time series to assess the age-height relationship of southern yellow pines in the US](https://doi.org/10.1016/j.rse.2026.115677)
...
### [412] [Urban building height mapping in Beijing-Tianjin-Hebei megalopolis by synergy of spaceborne LiDAR and multisource geospatial datasets](https://doi.org/10.1016/j.rse.2026.115658)
...
### [413] [Time and tide: Mapping the changing 3D shape of Australia's dynamic intertidal zone using time series satellite data](https://doi.org/10.1016/j.rse.2026.115663)
...
### [414] [Direct quantification of solar-induced chlorophyll fluorescence using compact solar-blind optical radiometers](https://doi.org/10.1016/j.rse.2026.115669)
*Jonas Kuhn,J. Stutz*
...
### [415] [3DSO: Quantifying forest three-dimensional structural organization beyond the canopy surface using LiDAR data](https://doi.org/10.1016/j.rse.2026.115668)
...
### [416] [An uncertainty workflow for landsat TIRS split window surface temperature products incorporating atmospheric water vapor](https://doi.org/10.1016/j.rse.2026.115660)
...
### [417] [Observation-constrained clear-sky direct radiative forcing of black carbon containing aerosols reveals distinct radiative regimes across urban Asia](https://doi.org/10.1016/j.rse.2026.115673)
...
### [418] [CEDA-Net: A cascade empirical–deep network for mitigating InSAR tropospheric delay in complex atmospheric and topographic conditions](https://doi.org/10.1016/j.rse.2026.115659)
...
### [419] [Detecting diurnal dynamics of cotton leaf inclination angle under water-salt stress](https://doi.org/10.1016/j.rse.2026.115674)
...
### [420] [Diurnal coupling of total column nitrogen dioxide and aerosol optical depth: Insights from the Pandora Asia network](https://doi.org/10.1016/j.rse.2026.115682)

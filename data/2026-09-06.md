...
- [RSE](#RSE) [Total: 10]
- [Remote Sensing](#Remote Sensing) [Total: 123]
- [JAG](#JAG) [Total: 15]
- [cs.AI](#cs.AI) [Total: 69]
- [ISPRS J P&RS](#ISPRS J P&RS) [Total: 13]
...
### [83] [TAP-Path: Task-Adaptive Structural and Token Pruning for Efficient and Trustworthy Pathology Foundation Models](https://arxiv.org/abs/2609.04071)
...
### [87] [One Editor, Many Edits: A Unified Training-Free Framework for Diverse Video Editing](https://arxiv.org/abs/2609.04190)
...
### [88] [Stable and Scalable Bundle Adjustment of Holistic 3D Structures](https://arxiv.org/abs/2609.04026)
...
### [104] [Geostationary observations of air pollutants from biomass burning: A synergy of GIIRS and GEMS over Southeast Asia](https://doi.org/10.1016/j.rse.2026.115642)
...
### [105] [Using a planted tree biodiversity experiment to evaluate imaging spectroscopy for species classification](https://doi.org/10.1016/j.rse.2026.115644)
...
### [107] [Comparative analysis of contemporary remote sensing techniques and species distribution modelling in predicting spatial distribution of coastal habitats](https://doi.org/10.1016/j.rse.2026.115640)
...
### [108] [The BioSat indices designed for biodiversity science and conservation](https://doi.org/10.1016/j.rse.2026.115625)
...
### [109] [Corrigendum to ‘Angular anisotropy of Landsat and MODIS land surface temperature toward multi-source LST consistency’ [Remote Sens. Environ. 346 (2026) 115624]](https://doi.org/10.1016/j.rse.2026.115643)
...
### [110] [Effects of aboveground biomass and soil moisture drought on VOD-based global isohydricity estimates](https://doi.org/10.1016/j.rse.2026.115641)
...
### [111] [The intercomparison of total column water vapor over a melting glacier on the Greenland ice sheet derived using spaceborne Sentinel-5P and high spatial resolution EnMAP measurements](https://doi.org/10.1016/j.rse.2026.115648)
*Alexander Kokhanovsky,Luca Lelli,Karl Segl,Jörg Bendix*
...
### [112] [SMFS-RF: a knowledge-guided machine-learning method for crop phenology extraction from fine-resolution vegetation index data](https://doi.org/10.1016/j.rse.2026.115632)
*Ruoque Shen,Qiongyan Peng,Xiangqian Li,Jianxi Huang,Jin Chen,Jie Dong,Xiuzhi Chen,Wenping Yuan*
...
### [113] [Framework for Cross-Disaster Building Damage Assessment Using Cost-Sensitive Learning](https://doi.org/10.3390/rs18172920)
...
### [114] [Pixel-Level Sentinel-2 Modeling Reveals Scale-Dependent Edge Effects and Structural Heterogeneity in Semideciduous Seasonal Forest Fragments of the Brazilian Cerrado](https://doi.org/10.3390/rs18172999)
*Valdivino Domingos de Oliveira Júnior,Vagner Santiago do Vale,Natália Tolêdo Sacchetto,Fábia Maria dos Santos Souza,Alex Josélio Pires Coelho,Rodrigo Gomes Gorsani,Josielle Evaristo Costa,Marina Tack Ramos,João Augusto Alves Meira-Neto*
...
### [116] [iSAGE: A Human-in-the-Loop Framework for Remote Sensing Semantic Segmentation via Sparse Point Supervision](https://doi.org/10.3390/rs18172973)
...
### [117] [Complex-Valued HRU-Net with Cross-Gated Attention for PolSAR Semantic Segmentation](https://doi.org/10.3390/rs18172947)
...
### [118] [Spatial Prompt and Wavelet Mamba-Based Multi-Scale Cross-Domain Feature Fusion Network for Segmentation of Mining-Disturbed Land](https://doi.org/10.3390/rs18172963)
...
### [119] [GRAZE-FUSE: Grazing-Informed Integration of APSIM and Sentinel-2 for Pasture Biomass Monitoring](https://doi.org/10.3390/rs18172911)
...
### [120] [Geometry-Constrained Reference Sample Construction from Forest Inventory Compartments for Dominant Tree Species Mapping](https://doi.org/10.3390/rs18172915)
...
### [121] [Terrain Effects on Time-Frequency Characteristics of Negative Return Stroke Electric Fields: A Path-Incremental Method](https://doi.org/10.3390/rs18172908)
...
### [122] [Assimilation of FY-3G Precipitation Data Using a Machine Learning-Based Observation Operator in the CMA-MESO Regional Model](https://doi.org/10.3390/rs18172912)
...
### [123] [Enhancing the Spatial Applicability of SMAP Soil Moisture Using Multi-Stage Machine Learning Downscaling](https://doi.org/10.3390/rs18172913)
...
### [124] [DROMAL-Net: A Forest Larch Casebearer Detection Model Focusing on Global Feature Enhancement and Positional Dynamic Clustering](https://doi.org/10.3390/rs18172916)
...
### [125] [Bias-Aware Machine Learning Spatial Downscaling of GRACE Signals: Application to the Bug River Basin](https://doi.org/10.3390/rs18172909)
...
### [126] [Disentangling Spectral and Environmental Controls on Inland River–Lake Water Quality Using Satellite Earth Observation-Driven Optimized Machine Learning](https://doi.org/10.3390/rs18172921)
...
### [127] [SiamNet: A Double-Temporal SAR Avalanche Detection Method Integrating Multiscale Features and an Attention Mechanism](https://doi.org/10.3390/rs18172917)
...
### [128] [Spatially Complete Monthly XCH4 Mapping over China from 2019 to 2024: A Multi-Model Analysis Using Machine Learning](https://doi.org/10.3390/rs18172919)
...
### [129] [Spatiotemporal Variations and Associated Environmental Factors of Coastal Polynyas in the Kara–Laptev Seas from 2003 to 2025](https://doi.org/10.3390/rs18172914)
...
### [130] [Long-Term InSAR Monitoring and Anomaly Detection of Railway Deformation in Shanghai](https://doi.org/10.3390/rs18172918)
...
### [131] [Multiscale Decomposition Reveals the Scale-Dependent Drivers of Complex Urban Ground Deformation in Zhengzhou, China](https://doi.org/10.3390/rs18172910)
...
### [132] [Impact of Radar-Constrained Effective Drop-Shape Relations on Polarimetric Radar Quantitative Precipitation Estimation in Typhoons](https://doi.org/10.3390/rs18172927)
...
### [133] [Jacobians of Light Scattering Properties Based on the Improved Geometric Optics Method (IGOM)](https://doi.org/10.3390/rs18172942)
...
### [134] [Deep Learning-Based Quantitative Precipitation Estimation Using Ground-Based Microwave Radiometer and Micro-Rain Radar Observations](https://doi.org/10.3390/rs18172941)
...
### [135] [Satellite Remote Sensing of a Melting Glacier Albedo: Examples from EnMAP and an Intercomparison with Other Satellite and Ground Measurements](https://doi.org/10.3390/rs18172929)
...
### [136] [Assessing Vegetation–Hydrothermal Trend Regimes Across Elevation Gradients in Semiarid Mountains via Gaussian Mixture Models in Saudi Arabia](https://doi.org/10.3390/rs18172948)
...
### [137] [Volumetric Impact Characterization of the 2025 Palisades and Eaton Fires Using Aerial LiDAR](https://doi.org/10.3390/rs18172943)
...
### [138] [Physics-Informed Spatially Variant Image Restoration for Unresolved Infrared Remote Sensing Small Targets](https://doi.org/10.3390/rs18172934)
...
### [139] [Machine-Learning-Based Radar Quantitative Precipitation Estimation Using Intra-Hour Temporal Features from Dual-Polarization Observations](https://doi.org/10.3390/rs18172937)
...
### [140] [A Linear Attention Framework with Dual-Axis Multi-Scale Fusion for Fine-Grained Eucalyptus Change Detection](https://doi.org/10.3390/rs18172944)
...
### [141] [ST-PaveCLIP: A Spatio-Temporal Vision–Language Framework for Road Anomaly Segmentation in Images and Videos](https://doi.org/10.3390/rs18172922)
...
### [142] [Deep Learning-Based Monitoring of Tea Plant Growth and Nitrogen Status Using UAV Multisource Remote Sensing Features](https://doi.org/10.3390/rs18172923)
...
### [143] [Performance Analysis of BDS-3 PPP-B2b During the Satellite In-Orbit Upgrade Period](https://doi.org/10.3390/rs18172936)
...
### [144] [Generalized Matérn Process for GNSS Coordinate Series Noise Modeling](https://doi.org/10.3390/rs18172932)
...
### [145] [Multidimensional Quantification of Engineering Distresses and Secondary Periglacial Hazards Along Linear Infrastructure in the Permafrost Region of Northeast China Using UAV-LiDAR and Synchronous Visible-Light Imagery](https://doi.org/10.3390/rs18172938)
...
### [146] [An Earth-Limb-Constrained Framework for On-Orbit Geometric Calibration of GEO Wide-Field Area-Array Cameras](https://doi.org/10.3390/rs18172930)
...
### [147] [Improvement of Flood Risk Model Performance by Incorporating Sediment Factors](https://doi.org/10.3390/rs18172933)
...
### [148] [Layout Optimization of Urban Emergency Shelter Sites Under Compound Disaster Scenarios Based on MOGWO](https://doi.org/10.3390/rs18172945)
...
### [149] [NWCSAF High Resolution Winds (NWCSAF GEO-I HRW) Stereo AMVs over the Atlantic Ocean](https://doi.org/10.3390/rs18172940)
...
### [150] [EGDNet: An Event-Guided Frequency-Aware Network with Cross-Modal Attention for Robust Weak Signature UAV Detection](https://doi.org/10.3390/rs18172925)
...
### [151] [Multi-Temporal Remote Sensing Assessment and Pareto-Based Land-Use Optimization for Balancing Carbon Storage, Ecological Value, and Economic Value in Jiangsu Province, China](https://doi.org/10.3390/rs18172924)
...
### [152] [Scale-Aware Gated Routing Distillation for Lightweight Remote Sensing Object Counting](https://doi.org/10.3390/rs18172939)
...
### [153] [Physically Constrained Quadratic Programming for Spectral Unmixing of Nighttime Lighting: A Case Study with Data Generation Procedure](https://doi.org/10.3390/rs18172935)
...
### [154] [Probabilistic Spatial Completion of FEMA Special Flood Hazard Area Coverage in Louisiana Using Conditional Diffusion and Distributionally Trustworthy Explanation](https://doi.org/10.3390/rs18172926)
...
### [155] [Prior-Guided Lightweight Dual-Task Network for Composite Active Jamming Recognition and Time-Frequency Parameter Estimation in Radar Remote Sensing](https://doi.org/10.3390/rs18172946)
...
### [156] [Seasonal Consistency Between Solar-Induced Chlorophyll Fluorescence and Vegetation Indices Across Global Urban Ecosystems](https://doi.org/10.3390/rs18172931)
...
### [157] [A Practical Framework for Surface Water Extraction from GF1/GF6 Wide-Field-View Imagery](https://doi.org/10.3390/rs18172928)
...
### [158] [TAPO: Task-Decoupled Alignment and Pseudo-Label Optimization for Cross-Scene Inshore SAR Ship Detection](https://doi.org/10.3390/rs18172953)
...
### [159] [Geospatial Foundation Models Improve Atoll Island Ecosystem Mapping: A Case Study Using AlphaEarth Embeddings](https://doi.org/10.3390/rs18172964)
...
### [160] [Landscape Greening Following Unseasonal Precipitation Along a Desert–Alpine Gradient](https://doi.org/10.3390/rs18172951)
...
### [161] [Odometry and Mapping for Complex Environment Perception Under Partial-View Sensing](https://doi.org/10.3390/rs18172959)
...
### [162] [MARC-Net: A Modality-Availability-Aware Robust Change Network for Missing-Optical Bi-Temporal Optical–SAR Change Detection of Reclaimed Cropland](https://doi.org/10.3390/rs18172960)
...
### [163] [Geometry-Guided Semi-Supervised Multimodal Segmentation for UAV-Based Rice-Lodging Mapping](https://doi.org/10.3390/rs18172961)
...
### [164] [TFCRNet: Dual-Discriminator SAR-to-Optical Translation and Region-Gated Cross-Attention Fusion for Thick-Cloud Removal](https://doi.org/10.3390/rs18172962)
...
### [165] [Hyperspectral Technology: A Method Framework for the Estimation of Metal Content in Cobalt-Rich Crusts](https://doi.org/10.3390/rs18172968)
...
### [166] [A Change-Point-Based Deformation Grouping Strategy in Long-Term Near-Real-Time Deformation Monitoring](https://doi.org/10.3390/rs18172956)
...
### [167] [FuseCLIP: Semantic-Guided Multidomain Fusion for Few-Shot Radar Active Jamming Recognition](https://doi.org/10.3390/rs18172967)
...
### [168] [FD-ProtoSCD: Semantic Change Detection in High-Resolution Remote Sensing Images via Frequency-Domain Disentanglement and Dynamic Prototype Learning](https://doi.org/10.3390/rs18172957)
...
### [169] [Spatiotemporal Deep Learning for Continuous Illumination Mapping and Sun-Synchronous Path Planning in Lunar Polar Exploration Under Chang’E-7 Mission Constraints](https://doi.org/10.3390/rs18172950)
...
### [170] [Improving Backscatter-Based Surface Water Classification in Arid Environments Through Interferometric Coherence](https://doi.org/10.3390/rs18172966)
...
### [171] [Potential Source-to-Sink Spatial Correspondence in a Martian Analog Environment of the Qaidam Basin Based on GF-5A Hyperspectral Imagery](https://doi.org/10.3390/rs18172958)
...
### [172] [Beyond Standalone Geo-Embeddings: Weighted Multi-Model Ensemble Prediction for Tropical Land-Cover Mapping](https://doi.org/10.3390/rs18172952)
...
### [173] [Tracing 80 Years of Forest Succession and Species Trajectories Using Historical Aerial Photography and Sentinel-2 Imagery](https://doi.org/10.3390/rs18172954)
...
### [174] [MFRA-YOLOv11: Remote Sensing Small Object Detection Algorithm Based on Multiscale Feature Extraction and Region Awareness](https://doi.org/10.3390/rs18172965)
...
### [175] [Severe Positive Ionospheric Storm at American Low Latitudes During an Intense Long-Lasting CEJ Period of the August 2018 Geomagnetic Storm](https://doi.org/10.3390/rs18172955)
...
### [176] [Deep Learning for Water Body Segmentation in Remote Sensing Imagery: A Review](https://doi.org/10.3390/rs18172972)
...
### [177] [A Terrain-Corrected Vegetation Index Strategy for Improving Leaf Area Index Estimation in Mountainous Areas](https://doi.org/10.3390/rs18172977)
...
### [178] [Controlled Evaluation of Sentinel-2 Annual Compositing Strategies for Deep Learning-Based Mangrove Mapping in China](https://doi.org/10.3390/rs18172975)
...
### [179] [Building Footprint Extraction in High-Density Urban Areas Based on Multi-Source Remote Sensing Data Fusion and ACM-PSPNet](https://doi.org/10.3390/rs18172971)
...
### [180] [Land-Cover and Land-Use Mapping Under Limited Data Highlights Hyperparameter Stability and Predictor Design](https://doi.org/10.3390/rs18172969)
...
### [181] [Monthly Trophic Dynamics of Lakes and Reservoirs in Eastern China Based on Harmonized Landsat–Sentinel Observations](https://doi.org/10.3390/rs18172970)
...
### [182] [Seafloor Morphology and Inner Shelf Benthic Habitats of the Sinuessa Shallow Coralligenous Bank, Eastern Tyrrhenian Margin](https://doi.org/10.3390/rs18172974)
...
### [183] [Cloud Occurrence, Phase, and Vertical Structure in a Dust-Influenced Eastern Mediterranean Region: Observations from Limassol, Cyprus](https://doi.org/10.3390/rs18172976)
...
### [184] [Estimating the Effects of Climate and Human Activities on Vegetation Coverage in Diverse Ecosystems: A Case Study of the Gansu Section of the Yellow River Basin](https://doi.org/10.3390/rs18172978)
...
### [185] [Predicting Spatial Variability of PR Protein Concentration in White Grape Juice Using UAV Multispectral Data and Machine Learning](https://doi.org/10.3390/rs18172979)
*Adrián Vera-Esmeraldas,Carlos Valle,Mauricio Galleguillos,Mariela Labbé,Alejandro Cáceres‐Mella,Francisco Rojo,Fernando Salazar*
...
Abstract (英文): Coastal areas are particularly suitable study sites for kite aerial photography (KAP) surveys because of consistent wind and open space. This study uses KAP surveys conducted in January, March, June, August, and October 2025, combined with Structure from Motion photogrammetry and spatially variable error modeling for DEM of Difference (DoD) thresholding to monitor a dune revegetation project at Ocean Beach in San Francisco. Two independent ground surveys were conducted in June and October to compare measured elevation data with KAP-derived elevation. A fuzzy inference system was used to model spatially variable error for uncertainty thresholding with a 95% confidence interval based on point cloud density and surface roughness. The elevation models (raw and thresholded) were then analyzed through geomorphic change detection to assess volumetric change over time. DoD estimates from the four sampling periods between flights were used to derive mass transport rates (120.09, 415.04, 270.86, and 102.22 kg m−1 d−1, respectively) from cross-sections aligned with estimated wind directions, with results similar to wind model estimates from the same time periods, ranging from 50 to 80% (R2 = 0.98) of the latter. This method holds promise for better connecting geomorphic to atmospheric research methods, especially important when pursuing process-based restoration.

</details>


### [187] [Surface Subsidence Analysis and Prediction in an Open-Pit Mine Using Time-Series InSAR and a CL-TSF Hybrid Model](https://doi.org/10.3390/rs18172996)
*Guoyang Liu,Pu Zhao,Junxiang Wang,Huo Fan,Shengze Zhao*
...
### [204] [Evaluating the Impact of DEM Resolution on Landslide Hazard Assessment: A Comparative Study Using LiDAR and 1:5000 Topographic Map-Derived DEMs](https://doi.org/10.3390/rs18172988)
*Taeyun Kim,Seung-Jun Lee,Jisung Kim,Hong Sik Yun*
...
### [217] [From Storm Damage Detection to Windthrow Susceptibility Mapping: Evaluating Regional Transferability in Radiata Pine Plantations](https://doi.org/10.3390/rs18173020)
*Michael S. Watt,Andrew Holdaway,Sadeepa Jayathunga,Pete Watt,Kate Halstead,Tommaso Locatelli*
...
Abstract (英文): Monitoring forest regeneration is vital for sustainable management, yet traditional ground surveys and early aerial imagery methods face cost, labor, and resolution limitations. Unmanned Aerial Vehicles (UAVs) offer cost-effective, flexible platforms for acquiring ultra-high-resolution data to address these gaps. This paper reviews recent research on UAV applications in forest regeneration surveys (FRS), tracing the evolution from field-based surveys and conventional aerial approaches to current UAV practices, and synthesizing developments in data acquisition, processing workflows, and analysis. It contrasts established Canopy Height Model (CHM) and point-cloud approaches with the growing use of deep learning, particularly Convolutional Neural Networks (CNNs) for seedling detection, crown delineation, density, height estimation, and species classification. Particular attention is given to accuracy assessment, examining sampling design, reference data, prediction-to-reference matching, and evaluation metrics, and highlighting the disconnect between traditional map-validation principles and standard deep-learning metrics that often neglect background classes. The case study applying Mask R-CNN to red pine seedlings in an Adirondack Park plantation achieved stand-level recall of 70.3% and precision of 98.7%, while plot-level DL detections represented only 36.8% of the field-observed seedling count. These results demonstrate the potential of DL for reliably identifying visible red pine seedlings while highlighting its limitations for complete regeneration inventories, particularly when seedlings have small crown sizes.

</details>


### [221] [Estimating Annual Wildfire-Related Potential Above-Ground Biomass Loss in Eastern Canadian Boreal Forests Using Multi-Source Remote Sensing and XGBoost](https://doi.org/10.3390/rs18173022)
*Hadi Mahmoudi Meimand,Daniel Kneeshaw,Jiaxin Chen,Changhui Peng*
...
### [224] [Prelaunch Assessment and Correction of Polarization Effects for HIRAS-II on the Fengyun-3 Satellite](https://doi.org/10.3390/rs18173025)
*Zhiyu Yang,Chunyuan Shao,Kefeng Liang,Mingjian Gu*
...
### [236] [Multi-frequency microwave remote sensing reveals stratified forest responses to diverse drought stresses](https://doi.org/10.1016/j.jag.2026.105545)
*Xu Zhang,Xiang Zhang,Fei Zhang,Xiang Zhang,Fei Zhang,Aminjon Gulakhmadov,Hongliang Ma,Aminjon Gulakhmadov,Rabindra Kumar Panda,Mahlatse Kganyago,Veber Afonso Figueiredo Costa,Won‐Ho Nam,Dash Subhaprada,U. C. Mohanty,Jiangyuan Zeng,Wen Xiao,José A. Marengo,Chao Yang,Wenying Du,Nengcheng Chen,Longgang Xiang,Nengcheng Chen*
...
### [239] [SFMNet: Joint semantic and structural modeling via spatial–frequency collaboration for remote sensing scene segmentation](https://doi.org/10.1016/j.jag.2026.105541)
...
### [240] [Resolution-dependent divergence of optimal segmentation scale across land-cover types in a coastal wetland landscape: A systematic empirical characterization from 0.02 to 30 m near the Yellow River estuary, Dongying, China](https://doi.org/10.1016/j.jag.2026.105558)
...
### [241] [A multi-scale spatial-conditioned spectral routing network for hyperspectral and multispectral image fusion](https://doi.org/10.1016/j.jag.2026.105547)
...
### [242] [DPNet: A disaster perception network for building damage detection using single-temporal remote sensing imagery](https://doi.org/10.1016/j.jag.2026.105554)
...
### [243] [SRAIN: An isolated-neighborhood-based framework for LST-based surface thermal anomaly extraction](https://doi.org/10.1016/j.jag.2026.105542)
...
### [244] [PLGCA-SAM: Progressive local and global context-aware network incorporating SAM for remote sensing crop mapping](https://doi.org/10.1016/j.jag.2026.105548)
*Lihua Cui,Xin Cui,Xuedong Zhai,Guang Li,Shah Jahan Leghari,Yi Liao,Ziao Zhou,Shenjin Huang*
...
### [245] [Probabilistic associations between meteorological drought and compound moisture sources-transport anomalies in the middle and lower Yangtze River](https://doi.org/10.1016/j.jag.2026.105551)
*Hanlin Zheng,Tianliang Jiang,Yanping Qu,Qianfeng Wang,Yachao Zhang*
...
### [249] [Modeling regional coseismic landslide intensity with an interpretable Log-Gaussian GAM: Integrating size, mobility, and their interactions](https://doi.org/10.1016/j.jag.2026.105563)
*Binghai Gao,Yi Wang,Xiaolong Zhang,Xin Wang,Jingqi Huang,Pan Cao,Yongheng Li,Jiwei Wang*
...
### [251] [Structure and Implementation of New Practical English Textbooks Driven by Artificial Intelligence](https://arxiv.org/abs/2609.02981)
...
### [252] [MasterControl Seventeen Every Time](https://arxiv.org/abs/2609.03209)
...
### [253] [Speculative Macro Commit for Faster Tool-Using Agents](https://arxiv.org/abs/2609.03236)
...
### [254] [Fresh Memory, Stale Plans: Dependency-Scoped Validation for Distributed LLM-Agent Memory](https://arxiv.org/abs/2609.03340)
...
### [255] [A Prompt-Engineering Approach to Develop Scalable, Flexible, and Real-Time Hybrid Micro-Level Personalization in a General Purpose AI Teaching Assistant](https://arxiv.org/abs/2609.03402)
...
### [256] [Caught in the Story: Narrative Captivity in Multi-turn LLMs Conversation](https://arxiv.org/abs/2609.03407)
...
### [257] [Dude: A Dual-Detection Multi-Agent System for Paper-Code Discrepancy Detection](https://arxiv.org/abs/2609.03416)
...
### [258] [DuplexSpeechBench-IFEval: Evaluating Implicit Instruction Following in Full-Duplex Voice Agents](https://arxiv.org/abs/2609.03423)
...
### [259] [Do GUI Agents Know When Not to Act? Enabling Conflict-Aware Termination for Multimodal GUI Agents](https://arxiv.org/abs/2609.03438)
...
### [260] [Beyond "Made with AI": Visualizing Provenance Density to Mitigate the Transparency Penalty](https://arxiv.org/abs/2609.03460)
...
### [261] [AutoGraphForge: Towards Automated Graph Theory Discovery](https://arxiv.org/abs/2609.03478)
*Ján Pastorek*
...
### [262] [Making Every Tool Call Count: Necessary Tool-Evidence Path Rewards for Agentic Vision-Language Models](https://arxiv.org/abs/2609.03493)
...
### [263] [GrowPage: On-Demand KV Budgeting for Efficient LLM Reasoning Serving](https://arxiv.org/abs/2609.03494)
...
### [264] [PPO-STGNN: A Proximal Policy Optimization Approach with Spatio-Temporal Graph Neural Networks for DAG Task Scheduling in Cloud-Edge-End Computing](https://arxiv.org/abs/2609.03503)
...
### [265] [What Matters for Aggressive Decoding-Time KV Eviction? Temporal Aggregation and Ranking Preservation](https://arxiv.org/abs/2609.03515)
...
### [266] [CulturalMenuBench: Probing the Knowledge-Application Gap in Multimodal Culinary Reasoning](https://arxiv.org/abs/2609.03526)
...
### [267] [NeoRed: A Knowledge-Logic-Alignment Multimodal Large Language Model for Neonatal Respiratory Disease Diagnosis](https://arxiv.org/abs/2609.03527)
...
### [268] [Feature Reconfiguration With Visual Prior for Medical Lesion Segmentation](https://arxiv.org/abs/2609.03535)
...
### [269] [Dalek: A Constructive Agent Machine](https://arxiv.org/abs/2609.03546)
*Wanpeng Xie*
...
### [270] [GPS-Bench: A Governance Policy Benchmark for Automating Policy Analysis](https://arxiv.org/abs/2609.03553)
...
### [271] [HalluPeer: A Taxonomy-driven Benchmark for Detecting Hallucinations in Scientific Peer Reviews](https://arxiv.org/abs/2609.03580)
...
### [272] [The Attention Triangle in Audio-Video Models](https://arxiv.org/abs/2609.03586)
...
### [273] [KC-Bench: A Dynamic Interactive Benchmark for Evaluating Knowledge Conflicts in LLM Agents](https://arxiv.org/abs/2609.03588)
...
### [274] [A computable representation of the physical laboratory enables verifiable workflows](https://arxiv.org/abs/2609.03621)
...
### [275] [Analysis of Prompt Engineering for Drug Toxicity Prediction](https://arxiv.org/abs/2609.03635)
...
### [276] [Synthetic Semantic Supervision for Contrastive Code Representation Learning in Small Transformers: An Empirical Study](https://arxiv.org/abs/2609.03702)
...
### [277] [Counterfactual Routing Using Integer Programming with Constraint Generation](https://arxiv.org/abs/2609.03707)
...
### [278] [Artificial Intelligence for Energy Optimization in Data Centers](https://arxiv.org/abs/2609.03716)
...
### [279] [Proactive Service Agents: A Unified Decision Framework, Methods, and Evaluation](https://arxiv.org/abs/2609.03727)
...
### [280] [SimSkill: A Lifelong Learning AI Agent for Autonomous Mastery of Traffic Simulation](https://arxiv.org/abs/2609.03753)
...
### [281] [Rethinking World Models for Safety-Critical Embodied Systems](https://arxiv.org/abs/2609.03774)
...
### [282] [DNative-Twin: Decision Graphs and Digital Twins for Reconstructable Agentic Decisions](https://arxiv.org/abs/2609.03787)
...
### [283] [Transfiver: Human-AI Co-Inference through a Shared Editable State](https://arxiv.org/abs/2609.03797)
...
### [284] [Govern the Model, Not Only the Data: Storage, Circulation, and Learning in Creative AI](https://arxiv.org/abs/2609.03800)
...
### [285] [SVG-Score: Human-Aligned Evaluation of Text-to-SVG Generation](https://arxiv.org/abs/2609.03806)
...
### [286] [CauseCollab: Causal Unified and Modality-Agnostic Network for Heterogeneous Collaborative Perception](https://arxiv.org/abs/2609.03818)
...
### [287] [Semantic Bayesian World Models](https://arxiv.org/abs/2609.03834)
*Tommaso Soru*
...
### [288] [Adapting to Evolving Requirements: Agentic AI for Retail Supply Chain Operations](https://arxiv.org/abs/2609.03860)
...
### [289] [Bioinfoysis Technical Report](https://arxiv.org/abs/2609.03871)
...
### [290] [STAIR (STructure Aware Information Retriever): A novel dataset and LLM based retriever for document structure augmentation](https://arxiv.org/abs/2609.03874)
...
### [291] [Xiaomi-TabLDM: A Tabular Foundation Model Technical Report](https://arxiv.org/abs/2609.03880)
...
### [292] [Inferring Affective Consciousness in an Artificial Agent: A Case Study](https://arxiv.org/abs/2609.03883)
...
### [293] [Lose the Order, Keep the Hierarchy: Deordering HTN Plans](https://arxiv.org/abs/2609.03912)
...
### [294] [Value-Preserving Architectures for Agentic AI Systems](https://arxiv.org/abs/2609.03920)
...
### [295] [Speak for Me: Giving LLMs the Situational Awareness to Participate in a Meeting](https://arxiv.org/abs/2609.03923)
...
### [296] [Towards Numerical TOHTN Planning with SMT-based HTN-SAT Encoding](https://arxiv.org/abs/2609.03938)
...
### [297] [More Criticism Does Not Make a Better Review: EquiReview-R](https://arxiv.org/abs/2609.03943)
...
### [298] [FiMI Banking: A Sovereign Model for Indian Retail Banking](https://arxiv.org/abs/2609.03960)
...
### [299] [Interface-Induced Trajectory Censoring](https://arxiv.org/abs/2609.03966)
*Wenbo Wang*
...
### [300] [Common-Witness Certificates and Sharp Feature Bounds for Counterfactual Image Auditing](https://arxiv.org/abs/2609.03973)
...
### [301] [The Dually Flat Geometry of Planning as Inference](https://arxiv.org/abs/2609.04005)
...
### [302] [LLM4CKD: Large Language Models for Early Stage Chronic Kidney Disease Screening](https://arxiv.org/abs/2609.04013)
...
### [303] [InSituMeasure: Probing Situated Measurement Grounding in Industrial Scenes with Multimodal Large Language Models](https://arxiv.org/abs/2609.04014)
...
### [304] [FLY-EVAL++: An Evidence-Driven Evaluation Protocol for Safety-Constrained Flight Prediction with Large Language Models](https://arxiv.org/abs/2609.04021)
...
### [305] [Instruction Duplication as an Inference-Time Control Primitive](https://arxiv.org/abs/2609.04024)
*Victor Lavrenko*
...
### [306] [IRWOZ 2.0: A Large Language Model-driven Dialogue Dataset for Industrial Robot Conversations](https://arxiv.org/abs/2609.04030)
...
### [307] [Spurious Advantage Hidden in GRPO](https://arxiv.org/abs/2609.04063)
...
### [308] [DRACO: Fine-Grained Credit Assignment with Dynamic Rubrics for Long-Horizon Agent Training](https://arxiv.org/abs/2609.04094)
...
### [309] [Why Gated DeltaNet Survives 4-Bit Quantization: NVFP4 W4A4 for the Recurrent Half of a Hybrid 27B LLM](https://arxiv.org/abs/2609.04098)
...
### [310] [Epistemic Warrant for LLM Recommendations: Characterizing the Basis for Reliance When Ground Truth Is Unavailable](https://arxiv.org/abs/2609.04127)
...
### [311] [Environment Evolution for Terminal Agents](https://arxiv.org/abs/2609.04128)
...
### [312] [The Natural Language Interaction Protocol and Standard for AI Agents](https://arxiv.org/abs/2609.04135)
...
### [313] [Efficient Test-Time Adaptation through Human-AI Interaction](https://arxiv.org/abs/2609.04141)
...
### [314] [Terminal-Universe: Turning Agent Trajectories into Scalable Terminal Environments](https://arxiv.org/abs/2609.04148)
...
### [315] [From Deceptive Outputs to Deceptive Mechanisms: A Causal Framework for Language-Model Deception Research](https://arxiv.org/abs/2609.04166)
...
### [316] [A Case Study on Emergent Cheating and Whistleblowing in Autonomous Research Swarms](https://arxiv.org/abs/2609.04170)
...
### [317] [Rethinking On-Policy Distillation of Large Language Models II: One Training Example](https://arxiv.org/abs/2609.04172)
...
### [318] [A Computationally Feasible Framework for Causal Probabilistic Explanation](https://arxiv.org/abs/2609.04177)
...
### [319] [Clean Engineering, Unstable Measurement: A Preregistered Reliability Failure of Black-Box LLM Observers on Shared Endpoints](https://arxiv.org/abs/2609.04198)
...
### [320] [Physics-constrained cross-resolution enhancement network for optics-guided thermal UAV image super-resolution](https://doi.org/10.1016/j.isprsjprs.2026.08.013)
*Zhicheng Zhao,Fengjiao Peng,JinQuan YAN,Wei D. Lu,Chenglong Li,Jin Tang*
...
### [321] [AWARE: Adaptive whole-body active rotating control for enhanced LiDAR-inertial odometry under human-in-the-loop interaction](https://doi.org/10.1016/j.isprsjprs.2026.08.027)
...
### [322] [Physics-informed regression-residual reconstruction and group fusion dual-attention transformer for methane plume detection](https://doi.org/10.1016/j.isprsjprs.2026.08.017)
...
### [323] [Segmentation-guided and attention-enhanced GAN for SAR image restoration under multi-type interference](https://doi.org/10.1016/j.isprsjprs.2026.08.023)
...
### [324] [PSSformer: A persistent scatters selection method for SAR interferometry based on temporal-spatial vision transformers](https://doi.org/10.1016/j.isprsjprs.2026.08.032)
...
### [325] [Foggy-UAVCD and DSRF-Net: Benchmarking robust satellite–UAV change detection under fog degradation](https://doi.org/10.1016/j.isprsjprs.2026.08.026)
...
Abstract (英文): Synergistic observation using multimodal remote sensing data is crucial for rapid geographic monitoring. However, acquiring large-scale multimodal datasets remains a significant challenge. While Synthetic Aperture Radar (SAR) is often used for all-weather monitoring, its inherent speckle noise and limited semantic interpretability constrain its application in fine-grained change detection (CD). In contrast, Unmanned Aerial Vehicle (UAV) imagery offers superior spatial resolution and flexible deployment, yet its optical sensors are highly susceptible to adverse weather. In practical emergency response, fog degradation frequently introduces severe visibility reduction and pseudo-changes, creating a gap between ideal laboratory settings and real-world deployment. To address these challenges, we first construct Foggy-UAVCD, a novel heterogeneous benchmark specifically designed for SAT–UAV CD under foggy conditions. By simulating controllable fog-induced visibility degradation, this dataset serves as a specialized benchmark for evaluating cross-modal geometric alignment and robust feature extraction. Furthermore, we propose the Dual-Stage Rectification and Fusion Network (DSRF-Net), a lightweight yet robust architecture. Specifically, a Cross-modal Feature Rectification (CFR) module is designed to suppress fog-induced noise by leveraging satellite priors, while a Dual-Domain Fusion Upsampler (DDFU) module is developed to recover high-frequency boundary details. Experimental results on the Foggy-UAVCD and HTCD datasets demonstrate that DSRF-Net achieves a competitive trade-off between accuracy and efficiency, with only 3.43 M parameters and 1.84 G floating point operations (FLOPs), indicating potential for efficient adverse-weather remote sensing analysis, while further validation across broader geographic regions, climate zones, and seasonal conditions is still required. Code and dataset will be available at https://github.com/xiaobing-min/DSRFNet .

</details>


### [326] [Corrigendum to “A survey of publicly available multi-temporal point cloud datasets” [ISPRS J. Photogramm. Rem. Sens. 231 (2026) 815–836]](https://doi.org/10.1016/j.isprsjprs.2026.08.020)
...
### [327] [Multi-source remote sensing workflow (PlanetScope and Sentinel-1/2) applied to LULCC analysis (2016–2024) in the SDERM-CGSM Ramsar Site, Colombia](https://doi.org/10.1016/j.isprsjprs.2026.08.010)
*Cristian Camilo Montes-Chaura,Lina Latorre-Conde,Dayron Quintero-Rodriguez,Brayan Estupiñan-Angarita,José Rodriguez-Bolaños,Jesús Emilio Pinto Lopera*
...
### [329] [DUAG-C: Decentralized uncertainty-aware Gaussian consensus for multi-robot dense mapping](https://doi.org/10.1016/j.isprsjprs.2026.08.030)
*Cabrel Wouladje,Golden Tendekai Mumanikidzwa,Huiying Xu,Hongbo Li,Yanchao Wang,Mantang Liu,Wenjie Wang,Wenzhe Tan,Zhendong Chen,Longfei Wang,Kangjia Dai,Zhenglong Wang,Xinzhong Zhu*
...
### [330] [From particles to features: Uncertainty-guided geometric reasoning for robust SLAM](https://doi.org/10.1016/j.isprsjprs.2026.08.012)
...
### [331] [Bridging the domain gap: A transferable dynamic routing enhancer for robust aerial detection under adverse weather](https://doi.org/10.1016/j.isprsjprs.2026.08.041)

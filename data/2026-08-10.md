...
- [RSE](#RSE) [Total: 6]
- [Remote Sensing](#Remote Sensing) [Total: 138]
...
Abstract (英文): We describe DAEP, team BIGC's submission to NLPCC 2026 Shared Task 1 Track 3: Difficulty-Aware Temporal Answer Grounding in Video Corpus (DA-TAGVC). The task requires retrieving the target video from 50 candidates and localizing the answer-supporting span. DAEP ranks videos with subtitle, visual, and procedural-context evidence, expands high-scoring anchors into temporal spans, and reranks spans for final output. Its main design is to convert the task-provided simple/complex input label into an inference-time evidence plan controlling modality weights, Top-K aggregation, boundary threshold, expansion length, and reranking strength. In the official evaluation, BIGC ranks first among ten systems with an Average score of 0.2728. Validation ablations show that visual evidence, procedural context, and difficulty-aware planning improve ranking quality, with the largest gain on complex questions.
...
Abstract (英文): Recent byte-level large language models (LLMs) have made tokenizer-free modeling increasingly competitive by grouping bytes into dynamically sized patches. However, existing byte-patch architectures still apply the same dense feed-forward computation to every patch. This uniform computation cannot adapt model capacity to variations in patch semantics and granularity. We address this limitation with EntropyMoE, a Mixture-of-Experts (MoE) architecture designed for dynamic byte patches. EntropyMoE replaces the dense feed-forward modules in the global patch Transformer with Top-K expert layers. Each dynamic patch serves as the basic unit of expert routing, and its byte coverage determines its contribution to workload accounting. The router selects experts directly from patch entropy, using the same granularity signal that underlies dynamic patch construction to organize sparse computation. Patch entropy and length jointly define the feature space for regulating expert specialization. Experiments show that EntropyMoE achieves the lowest held-out bits-per-byte among matched dense and sparse baselines while maintaining comparable downstream accuracy. These results establish patch entropy as an effective routing coordinate for sparse conditional computation and extend Mixture-of-Experts modeling beyond tokenizer-based representations.
...
Abstract (英文): Under the standard split, Muon gets hidden matrices and AdamW embeddings/output head. Muon groks modular addition faster, but its solutions do not hold. All nine configurations on $(a+b) \bmod 113$ grok and later lose generalization. Across five seeds the selected AdamW reference falls below threshold on four, reaching 27.59%. Instability persists across two moduli, two widths, two training fractions, subtraction, and depth.
...
### [162] [A new approach for comprehensive and spatiotemporally comparable Eco-Environmental quality assessment of surface coal Mines: MiecoI](https://doi.org/10.1016/j.jag.2026.105506)
...
### [163] [A near-real-time and unsupervised framework for grain crop harvest detection using sentinel-2 imagery: the reaped index (RI) and automated thresholding](https://doi.org/10.1016/j.jag.2026.105510)
...
### [164] [V-BUILD: A graph Transformer-based decision framework for selective updating of vector building data](https://doi.org/10.1016/j.jag.2026.105507)
...
### [165] [Reducing grid artifacts in air temperature downscaling with a Volume-Preserving interpolation preprocessing step](https://doi.org/10.1016/j.jag.2026.105515)
...
### [166] [Global cloud phase monitoring from FY-3G multi-angle polarimetric observations using the new MAPLE-CP framework with independent multi-site lidar validation](https://doi.org/10.1016/j.jag.2026.105512)
...
### [167] [Linear-Fitting calibration algorithm for Aerosol-Cloud detection channels at 532 nm of the DQ-1/ACDL](https://doi.org/10.1016/j.jag.2026.105504)
...
### [168] [Early detection of rice bacterial leaf blight disease using canopy hyperspectral data and machine learning](https://doi.org/10.1016/j.jag.2026.105511)
...
### [169] [Global assessment of karst drought propagation from multisource Earth Observation: Epikarst-mediated rapid shallow coupling and delayed deep responses](https://doi.org/10.1016/j.jag.2026.105516)
...
### [170] [A loop-outlier-aware Riemannian pose-graph optimization framework for robust visual localization](https://doi.org/10.1016/j.isprsjprs.2026.07.024)
...
### [171] [TALineNet: A benchmark and network for temporally-aware continuous line segment detection in event streams](https://doi.org/10.1016/j.isprsjprs.2026.07.030)
...
### [172] [ADAPT-Tracker: Adaptive dynamic perception and trajectory-consistent network for aerial multi-object tracking](https://doi.org/10.1016/j.isprsjprs.2026.07.010)
...
### [173] [CoRE-UIR: Prior-guided common and residual experts for efficient all-in-one remote sensing image restoration](https://doi.org/10.1016/j.isprsjprs.2026.07.028)
...
### [174] [HCFNet: Hierarchical and complementary feature embedding for remote sensing change captioning](https://doi.org/10.1016/j.isprsjprs.2026.07.020)
...
### [175] [PVP-adapter: Dual-branch spatial-frequency adaptation for change detection of photovoltaic panels](https://doi.org/10.1016/j.isprsjprs.2026.07.032)
...
### [176] [A vertical FVC profile retrieval method (OLV-FVC) based on airborne LiDAR point cloud under the constraint of optical remote sensing for forest plots](https://doi.org/10.1016/j.isprsjprs.2026.07.031)
...
### [177] [Aerial Image Gravity Direction Estimation (AGE): Robust single-image estimation by fusing foundation model features with camera geometry](https://doi.org/10.1016/j.isprsjprs.2026.07.019)
...
### [178] [Extending the MAIAC algorithm for hyperspectral atmospheric correction of TROPOMI measurements: A case study over vegetated regions](https://doi.org/10.1016/j.rse.2026.115593)
...
### [179] [Drivers of spectro-temporal variability in multi-spectral soil reflectance measured from space: A continental-scale analysis](https://doi.org/10.1016/j.rse.2026.115599)
...
### [180] [A scheme to quantify the adjacency effect of shortwave radiation from highly reflective surfaces](https://doi.org/10.1016/j.rse.2026.115601)
...
### [181] [Where sky meets sea: Integrated aerosol and ocean color retrieval from PACE SPEXone multi-angle polarimetry](https://doi.org/10.1016/j.rse.2026.115603)
...
### [182] [Tracking global extreme afternoon photosynthesis depression: Frequency, duration, and drivers from satellite-based hourly GPP products](https://doi.org/10.1016/j.rse.2026.115597)
...
### [183] [A weakly supervised, wetness-based dynamic framework for wetland delineation across globally distributed sites](https://doi.org/10.1016/j.rse.2026.115604)
...
### [184] [Agreement–Disagreement Guided Knowledge Transfer for Cross-Scene Hyperspectral Imaging](https://doi.org/10.3390/rs18152601)
...
### [185] [Occlusion Removal in Remote Sensing Images Based on Deep Matrix Completion](https://doi.org/10.3390/rs18152538)
...
### [186] [Photovoltaic Panel Identification and Potential Assessment Based on Remote Sensing and Deep Learning: A Case Study of Yancheng City](https://doi.org/10.3390/rs18152542)
...
### [187] [Global Optimization Design of Large-Scale Constellations for Maritime Target Detection Based on Circular Scanning Radar](https://doi.org/10.3390/rs18152544)
...
### [188] [Integrating Land Use Change and Vegetation Resilience to Assess Ecological Impacts of Expressway Construction: A Case Study of the Linghua Expressway](https://doi.org/10.3390/rs18152534)
...
### [189] [A Scalable Open Source Workflow for Riverbed Substrate Classification Using UAV Imagery](https://doi.org/10.3390/rs18152529)
...
### [190] [SPIF: A Spatio-Temporal Polarity Interaction Filter for Reliable Event Selection](https://doi.org/10.3390/rs18152551)
...
### [191] [RFM-UNet: Hybrid Frequency–Mamba UNet for Remote-Sensing Road Extraction](https://doi.org/10.3390/rs18152546)
...
### [192] [In Pursuit of Open-Weights Models for Intrinsic Interpretability in Wind Turbine Blade Monitoring with Tower-Mounted Radar](https://doi.org/10.3390/rs18152535)
...
### [193] [Climate-Adaptive Urban Planning: Quantitative Assessment of Drought Impact and Practical Strategies for Climate-Resilient Urban Green Spaces](https://doi.org/10.3390/rs18152531)
...
### [194] [Retrieval of Vertical Cloud Droplet Profiles and Above-Cloud Integrated Water Vapor from Hyperspectral Measurements: Reducing Liquid Water Path Retrieval Bias with Application to EMIT](https://doi.org/10.3390/rs18152556)
...
### [195] [An Adaptive Polyline-Path Mask Attention for Hyperspectral and Multispectral Image Fusion](https://doi.org/10.3390/rs18152536)
...
### [196] [Analysis of Area Changes and Driving Factors in Chirui Lake](https://doi.org/10.3390/rs18152558)
...
### [197] [From Thermal Diagnosis to Spatial Allocation: A Remote-Sensing and Explainable Machine Learning Framework for Heat-Resilient Planning in Semi-Arid Grassland Towns](https://doi.org/10.3390/rs18152548)
...
### [198] [Impact of Clouds on Infrared and Microwave Sounding Retrieval and an Objective Correction Method for Numerical Weather Prediction](https://doi.org/10.3390/rs18152549)
...
### [199] [Aliasing Suppression in Synthetic Aperture Interferometric Radiometers Using Subarray-Based Antenna Architecture](https://doi.org/10.3390/rs18152552)
...
### [200] [Improving Convection-Allowing Ensemble Forecasts via Multi-Source Remote Sensing Data Assimilation Through Stepwise Cloud Analysis Initialization: A Remote Sensing Case Study](https://doi.org/10.3390/rs18152539)
...
### [201] [Analysis of Diagnostic Absorption Troughs in Clay Alteration Within the Xiangshan Uranium Deposit Based on ZY1-02E Satellite Hyperspectral Imagery](https://doi.org/10.3390/rs18152550)
...
### [202] [Future Scenario Simulation and Optimization of Ecological Security Patterns Under Policy Drivers: A Case Study of the Henan Section of the Yellow River Basin, China](https://doi.org/10.3390/rs18152554)
...
### [203] [Disproportionate Soil Loss from Fragmented Sloping Cropland in Mountainous Northeastern Yunnan: Integrating Sentinel-2, CSLE, and Landscape Metrics](https://doi.org/10.3390/rs18152537)
...
### [204] [FIRE-BYOL: A Real-Time Grassland Active-Fire Detection Algorithm Fusing VIIRS Fire Products and Himawari-8/9 Data](https://doi.org/10.3390/rs18152553)
...
### [205] [GeoAdapt: Fine-Grained Keypoint Localization via Deformable Feature Refinement for Ground-Based Optical Remote Sensing](https://doi.org/10.3390/rs18152545)
...
### [206] [A Method for Segmentation and Identification of Urban Functional Areas with Generalization Ability Based on Scale-Aware Feature-Enhanced Attention Mask R-CNN](https://doi.org/10.3390/rs18152541)
...
### [207] [An Improved JSEG-Based Algorithm for Segmentation of Categorical and Remote Sensing Classification Maps](https://doi.org/10.3390/rs18152543)
...
### [208] [Open-Source Reproducible Pipeline for Multitemporal Vegetation Monitoring Using Sentinel-2 L2A in Cloud-Prone Tropical Regions](https://doi.org/10.3390/rs18152532)
...
### [209] [Frequency-Domain Modeling and Removal of Platform Jitter Stripes in GF-7 DSMs for Flat Terrains](https://doi.org/10.3390/rs18152557)
...
### [210] [Landslide Susceptibility Mapping Constrained by InSAR-Derived Deformation Using Multi-Source Data Integration](https://doi.org/10.3390/rs18152540)
...
### [211] [Vegetation Optical Depth at Enhanced Spatial Resolution: Progress, Challenges, and Perspectives](https://doi.org/10.3390/rs18152530)
...
### [212] [Sparse Rational Polynomial Coefficient Estimation Method via Low-Rank Matrix Constraint](https://doi.org/10.3390/rs18152547)
...
### [213] [TimeHome: Heterogeneous Mixture-of-Experts for Time-Series Foundation Model](https://doi.org/10.3390/rs18152533)
...
### [215] [An Optimized CatBoost Model for Spatiotemporal Prediction of hmF2 in High-Latitude Regions](https://doi.org/10.3390/rs18152579)
...
### [216] [Field-Scale Evapotranspiration of Flood-Irrigated Rice with Automated METRIC on Google Earth Engine in an Arid Region of Northern Peru](https://doi.org/10.3390/rs18152584)
...
### [217] [Refined Multi-Source Satellite and Reanalysis Diagnostics Reveal Topographic Anchoring and Thermodynamic Control of the Tibetan Plateau Ozone Valley](https://doi.org/10.3390/rs18152560)
...
### [218] [CDGP-Net: Channel-Decoupling and Geographic-Prior Fusion for Spatial Super-Resolution of HIRAS Radiances with Co-Platform MERSI-II](https://doi.org/10.3390/rs18152575)
...
### [219] [Exploring Marine Atmospheric Ducts: Current Sensing and Emerging Trends](https://doi.org/10.3390/rs18152576)
...
### [220] [Physics-Aware Deep Learning for SAR and InSAR Remote Sensing: Models, Methods, and Open Challenges](https://doi.org/10.3390/rs18152567)
*Giorgio Taricco*
...
### [221] [Few-Shot SAR Object Detection with Prior Class Perceptron and Cross-Entropy](https://doi.org/10.3390/rs18152580)
...
### [222] [Trends and Lagged Cumulative Associations Between Vegetation NDVI and Extreme Climate Indices in the Yangtze River Basin: A 41-Year Observational Analysis](https://doi.org/10.3390/rs18152559)
...
### [223] [Recommendations for Low-Noise Data Acquisition with UAV-Mounted Multi-Channel Magnetometer Systems](https://doi.org/10.3390/rs18152564)
...
### [224] [SDRCNet: A Lightweight Structure-Guided Dual-Relation Consensus Network for Optical Remote Sensing Images](https://doi.org/10.3390/rs18152565)
...
### [225] [A Road-Segment-Based Rockfall Susceptibility Mapping Approach Integrating Physically Informed Slope-Cutting Features and Comparative Machine Learning Models](https://doi.org/10.3390/rs18152562)
...
### [226] [Spatiotemporal Characteristics and Hydrogeological–Urban Controls of Surface Deformation in Haikou, China, Revealed by PS/DS-InSAR and Spatial Attribution Analysis](https://doi.org/10.3390/rs18152570)
...
### [227] [Design and Analysis of a Compact Airborne Hyperspectral Imager for Vegetation Photosynthesis and Stress Monitoring](https://doi.org/10.3390/rs18152585)
...
### [228] [TGMNet: Temporal-Guided Mamba Network for Moving Infrared Dim and Small Target Detection](https://doi.org/10.3390/rs18152578)
...
### [229] [Diagnosing and Conditionally Correcting X-Band Radar Underestimation in Cyprus: A Cross-Validated Evaluation of Spatial Merging and Machine Learning Approaches](https://doi.org/10.3390/rs18152577)
...
### [230] [Satellite Detection of Diffuse Tectonic CO2 Degassing in the East African Rift](https://doi.org/10.3390/rs18152586)
...
### [231] [Penetration Depth Investigation of L-Band and S-Band SAR Signals into Soils and Hard Ground Surfaces](https://doi.org/10.3390/rs18152566)
...
### [232] [A Study on Radar–Gauge Rainfall Data Merging and Its Impact on Flood Simulation](https://doi.org/10.3390/rs18152587)
...
### [233] [Principal Component Analysis of IASI Measurements for the Detection of Extreme Atmospheric Composition Events: Methodology and Applications](https://doi.org/10.3390/rs18152568)
...
### [234] [Impact of Vegetation and Soil Moisture on the Detection of Buried Landmines Using GPR](https://doi.org/10.3390/rs18152582)
...
### [235] [A Two-Stage Framework for SAR Near-Shore Ship Detection via Segmentation Guidance and Enhanced Diffusion](https://doi.org/10.3390/rs18152569)
...
### [236] [Spatial Correspondence Between Seismic b-Value Stress Localization and Pre-Earthquake GNSS-TEC Anomalies in Southern California and Northern Baja California](https://doi.org/10.3390/rs18152574)
...
### [237] [Industrial Dominance of Urban NO2 and Associated Health Risks: A Multi-Source Analysis in the Southern Region of Rio de Janeiro State](https://doi.org/10.3390/rs18152581)
...
### [238] [Change Detection in Remote Sensing Imagery: A Systematic Review of Statistical, Machine Learning, and Deep Learning Methods](https://doi.org/10.3390/rs18152573)
...
### [239] [Quality Assessment and Observation Error Estimation of Tianmu-1 GNSS Radio Occultation Bending Angle and Refractivity Retrievals](https://doi.org/10.3390/rs18152572)
...
### [240] [Robust Individual Tree Parameter Estimation in Cold–Temperate Secondary Forests Using ULS–HLS Data and the RSQ-Tree Framework](https://doi.org/10.3390/rs18152563)
...
### [241] [Pseudo 3-D GPR and 2-D ERT Study to Reveal Subtle Tectonic Deformations of a Strike-Slip Raša Fault (Dinaric Fault System, W Slovenia) in Fluvial and Karstic Environments](https://doi.org/10.3390/rs18152561)
...
### [242] [Consistent Photometric Enhancement Network for Remote Sensing Change Detection](https://doi.org/10.3390/rs18152583)
...
### [243] [A Comprehensive Machine Learning Approach for Crop Classification Using Multi-Sensor Satellite Datasets and Multiple Vegetation Indices](https://doi.org/10.3390/rs18152571)
...
### [244] [Improving Vegetation Mapping from LiDAR Point Clouds Using a Transmissivity-Based Feature](https://doi.org/10.3390/rs18152602)
...
### [245] [Infrared–Visible Multi-Sensor Fusion for UAV Photovoltaic Defect Detection Under Real-World Weak Misalignment](https://doi.org/10.3390/rs18152607)
...
### [246] [SPFMamba: A Mamba-Based Network with Semantic Prompt and Frequency-Adaptive Fusion for Remote Sensing Image Semantic Segmentation](https://doi.org/10.3390/rs18152592)
...
### [247] [Empirical Optimization of the Stumpf Method Parameter for Satellite-Derived Bathymetry](https://doi.org/10.3390/rs18152613)
...
### [248] [Research on an Absolute Radiometric Calibration Method Based on a Point Source Array](https://doi.org/10.3390/rs18152590)
...
### [249] [Mapping Neighborhood Spatial Structure in Traditional Home Gardens Using UAV-Derived 3D Canopy Models](https://doi.org/10.3390/rs18152605)
...
### [250] [Temporal-Variation-Resistant Bidirectional Convolution-Transformer GAN for Remote Sensing Image Spatiotemporal Fusion](https://doi.org/10.3390/rs18152597)
...
### [251] [Assessing the Impact of Spatial Resolution and Aggregation Method on Sentinel-2 NDVI Time Series in Grasslands of Mainland Spain](https://doi.org/10.3390/rs18152611)
...
### [252] [PCFD-Net: A Parallel Collaborative Fusion-Detection Network for SAR and Optical Imagery](https://doi.org/10.3390/rs18152595)
...
### [253] [PSG-RTDETR: Towards Stable Cross-Scale Feature Fusion for Small Object Detection](https://doi.org/10.3390/rs18152609)
...
### [254] [Remote Sensing-Assisted Stockpile Landslide Monitoring Based on Change Detection Analysis and Identification of Topographical Failure Precursors](https://doi.org/10.3390/rs18152594)
...
### [255] [Shoreline Behavior at California Groin Fields from Satellite-Based Measurements](https://doi.org/10.3390/rs18152608)
...
### [256] [FDM-Net: A Multi-Level Feature Aggregation Network Based on Frequency-Decomposition for Hyperspectral Image Classification](https://doi.org/10.3390/rs18152603)
...
### [257] [UAV Hyperspectral Characterization of Spatial Color Heterogeneity in Alpine Karst Lakes](https://doi.org/10.3390/rs18152596)
...
### [258] [Scaling Foliar Phenolics from Airborne Imaging Spectroscopy to Sentinel-2 Across Diverse Vegetation Types](https://doi.org/10.3390/rs18152599)
...
### [259] [MLS-CAPS: Optimising Path Spacing for Mobile Laser Scanning of Vegetation Structure via Completeness Analysis](https://doi.org/10.3390/rs18152606)
...
### [260] [Can UAV-Derived Maize Canopy Traits Inform Soil Mineral Nitrogen Estimation? Linking Above- and Below-Ground Nitrogen Dynamics in Black Soils](https://doi.org/10.3390/rs18152588)
...
### [261] [Land Subsidence-Induced Horizontal Displacement Along the High-Speed Rail in Central Taiwan: An Integrated Multi-Temporal InSAR, GNSS, and Leveling Approach](https://doi.org/10.3390/rs18152612)
...
### [262] [Centroid-Preserving Dynamic Star Image Deblurring for Remote Sensing Satellite Attitude Measurement via Physics-Guided Bi-Level Optimization](https://doi.org/10.3390/rs18152610)
...
### [263] [Perspectives and Challenges of Machine Learning for Applications in Agriculture and Vegetation Using Remote Sensing](https://doi.org/10.3390/rs18152589)
...
### [264] [Geometry-Aware InSAR Feedback Purification Sampling for Negative Sample Selection in Landslide Susceptibility Assessment: A Case Study in the Shigatse Region](https://doi.org/10.3390/rs18152591)
...
### [265] [SLAM–UAV LiDAR Co-Registration for Individual-Tree Carbon Across a Tropical Dry-Forest Canopy Gradient](https://doi.org/10.3390/rs18152604)
...
### [266] [Sensitivity of Vegetation Greenness to Multi-Depth Soil Moisture on the Mongolian Plateau: Nonlinear Responses Revealed by RF–SHAP](https://doi.org/10.3390/rs18152600)
...
### [267] [Airborne Point Cloud Fusion with Local Plane Constraints for Advanced Semantic Consistency](https://doi.org/10.3390/rs18152598)
...
### [268] [Integrating Multi-Source Geoscientific Data via Geologically Constrained Feature Engineering for Gold Prospectivity Mapping: A Case Study of Jiaoxibei, China](https://doi.org/10.3390/rs18152593)
...
### [269] [Lightweight Bayesian SAR Image Object Detection and Recognition Method Based on Heavy-Tail Prior and Variational Inference](https://doi.org/10.3390/rs18152627)
...
### [270] [Fine-Scale Maturity Recognition of Eucalyptus Plantations Based on Deep Learning and Multimodal Feature Fusion](https://doi.org/10.3390/rs18152632)
...
### [271] [Landslide Susceptibility Evaluation Based on Deep Learning and Imbalanced Sampling at Multi-Scale](https://doi.org/10.3390/rs18152617)
...
### [272] [High-Squint Imaging Method for Spaceborne Bistatic SAR Considering Orbit Curvature Effect](https://doi.org/10.3390/rs18152640)
...
### [273] [A Hybrid Multicriteria Index for Assessing Documentary-Methodological Robustness in Flood Mapping: Integrating Documentary Evidence, Entropy-Based Weighting, Remote Sensing, DEMs, Hydrological Data, and Statistical Validation](https://doi.org/10.3390/rs18152641)
...
### [274] [Comprehensive Use of GNSS Vertical Deformation and GRACE/GFO Data to Invert the Joint Drought Index of Three Central China Provinces](https://doi.org/10.3390/rs18152633)
...
### [275] [Radiometric Sensitivity Requirements for Detecting Live Coral and Seagrass Cover Using Spaceborne Imaging Spectroscopy](https://doi.org/10.3390/rs18152643)
...
### [276] [LDM-PUNet: A Lightweight Network for Denoising and Phase Unwrapping SAR Interferograms in Mining Deformation Monitoring](https://doi.org/10.3390/rs18152616)
...
### [277] [MSF-Net: A Multimodal SAR–Optical Fusion Network for Agricultural Land Use Classification in Smallholder Landscapes of Northern Benin](https://doi.org/10.3390/rs18152622)
...
### [278] [A China-Specific Near-Real-Time GNSS Water Vapor Retrieval Model Based on LightGBM](https://doi.org/10.3390/rs18152637)
...
### [279] [A Cross-System Remote Sensing Framework for Diagnosing Event-Scale Soil Wetting, Vertical Propagation, and Pre-Cipitation Thresholds Across China’s Croplands](https://doi.org/10.3390/rs18152614)
...
### [280] [Robust Wheat Residue Cover Quantification Under Moisture Variability from ASD Spectroscopy Using Conditional Autoencoder Normalization and Linear Unmixing](https://doi.org/10.3390/rs18152636)
...
### [281] [A Data-Driven InSAR Failure-Risk Index for Early Warning of Mining Infrastructure Instability: The Çöpler Case Study, İliç, Türkiye](https://doi.org/10.3390/rs18152624)
*Mahmut Çavur*
...
### [282] [Assessing Individual-Building Vertical Light Exposure in Urban Environments with a Residual Cascade Framework](https://doi.org/10.3390/rs18152621)
...
### [283] [Spatial Heterogeneity and Driving Mechanisms of Carbon Storage on the Chinese Loess Plateau](https://doi.org/10.3390/rs18152630)
...
### [284] [Machine Learning-Based Atmospheric Radiation Calculation Incorporating Earth Curvature](https://doi.org/10.3390/rs18152635)
...
### [285] [HGRHDNet: Hierarchical Gated Residual Fusion and High-Frequency Guided Deformable Upsampler Network for Boundary-Enhanced Binary Urban Green Space Extraction](https://doi.org/10.3390/rs18152620)
...
### [286] [Characterizing Free-Atmospheric Wind Fields and Their Statistical Associations with Aerosol Variability in the Huaihe River Basin](https://doi.org/10.3390/rs18152626)
...
### [287] [Remote Sensing-Based Identification of Sensitive Environmental Intervals Controlling Drought Propagation Time Across China](https://doi.org/10.3390/rs18152615)
...
### [288] [FAD-Net: Frequency Alignment Dual-Branch Network for Hyperspectral Image Super-Resolution](https://doi.org/10.3390/rs18152631)
...
### [289] [An Interpretable Uncertainty-Aware Framework for Landslide Susceptibility Mapping Based on Weak Supervision and Probabilistic Inference](https://doi.org/10.3390/rs18152619)
...
### [290] [Joint Interpretation of Archaeological, Geological, Geophysical and Remotely Sensed Data for Fluvial Geomorphology: The Case of the Calore River Meander North of Benevento (Italy)](https://doi.org/10.3390/rs18152629)
...
### [291] [TRB-Net: Terrain-Residual and Boundary-Assisted Multimodal Martian Landslide Segmentation on a Local MMLSv2 Split](https://doi.org/10.3390/rs18152638)
...
### [292] [Removal of RLAN Interference from C-Band Weather Radar Data: Algorithm and Case Studies](https://doi.org/10.3390/rs18152625)
...
### [293] [Disentangling Spectrally Similar Urban Vegetation via Semantic Segmentation-Guided Object Analysis and Multi-Periodic Phenological Features](https://doi.org/10.3390/rs18152623)
...
### [294] [Trait-Specific Contributions of UAV Multispectral, RGB and Structural Features to Soybean SPAD and Plant Height Phenotyping](https://doi.org/10.3390/rs18152642)
...
### [295] [Multi-Agent Pipeline for Crop-Type Classification and Label Refinement Using Sentinel-1 SAR Time Series and Field-Level Temporal Features in the Nakasatsunai Region, Hokkaido](https://doi.org/10.3390/rs18152628)
...
### [296] [Spatial Pattern of Extreme Rainfall-Induced Forest Aboveground Biomass Loss and Its Influencing Factors in the Tableland-Gully Region of the Loess Plateau, China](https://doi.org/10.3390/rs18152639)
...
### [297] [A Persistent Scatterer Interferometry-Based Parametric Framework for Characterizing Pre-, Co-, and Post-Seismic Surface Deformation: Application to the 2025 Dingri Earthquake (Southern Tibet)](https://doi.org/10.3390/rs18152634)
...
### [298] [Surface-Water Fragmentation and Heterogeneous Responses of Dish-Shaped Sub-Lakes in Poyang Lake During the 2022 Extreme Drought](https://doi.org/10.3390/rs18152618)
...
### [299] [Shape-Prior Dynamic Refinement Network with Diffusion Wavelets for Fine-Grained Ship Detection in Remote Sensing Images](https://doi.org/10.3390/rs18162649)
...
### [300] [FFT-Based Multiscale Frequency Decomposition for Atmospheric Lidar Attenuated Backscatter Profile Forecasting](https://doi.org/10.3390/rs18162663)
...
### [301] [Improving Accuracy of Low-Altitude Three-Dimensional Wind Field Reconstruction via Multi-Task Learning](https://doi.org/10.3390/rs18162655)
...
### [302] [GSANet: Geometric Structure-Aware Siamese Network for 3D Change Detection](https://doi.org/10.3390/rs18162647)
...
### [303] [DBKNet: A Dual-Encoder KAN Segmentation Network for Joint Extraction of Photovoltaic Power Stations and Impervious Surfaces in Arid Regions](https://doi.org/10.3390/rs18162662)
...
### [304] [Detection and Tracking of Medicanes Through DeMeTrA Self-Supervised Vision Transformer](https://doi.org/10.3390/rs18162659)
...
### [305] [Daytime–Nighttime Contrasts in Morphology–LST Associations Across Urban Functional Zones Under Heatwave Conditions: Evidence from Beijing and Nanjing, China](https://doi.org/10.3390/rs18162666)
...
### [306] [Extracting Value from Fused Aerial and Terrestrial LiDAR Scans](https://doi.org/10.3390/rs18162644)
...
### [307] [Predicting Future Forest Plantation Establishment Outcomes from UAV-Derived Pre-Planting Environmental Conditions](https://doi.org/10.3390/rs18162665)
...
### [308] [Use of Multi-Source Remote Sensing Data to Understand Long-Term Wetland Dynamics and Water Environment Responses in the Chaohu Lake Basin](https://doi.org/10.3390/rs18162646)
...
### [309] [Maturity-Gated Anti-Forgetting Sampling for Remote-Sensing Object Detection Training](https://doi.org/10.3390/rs18162657)
...
### [310] [Task-Guided CycleGAN for Domain-Adapted Coastal Boundary Segmentation in Remote Sensing Images](https://doi.org/10.3390/rs18162658)
...
### [311] [Marine Oil Film Segmentation Based on GCN-IGJO Method](https://doi.org/10.3390/rs18162660)
...
### [312] [MPC-DETR: A Multi-Scale Patch Context Transformer for Small Object Detection in UAV Imagery](https://doi.org/10.3390/rs18162650)
...
### [313] [Influence of Dust Aerosol on Temperature Field and Boundary Layer During a Typical Dust Storm Event in China](https://doi.org/10.3390/rs18162656)
...
### [314] [TinyCapsViT: Ultra-Lightweight Hyperspectral and Multispectral Image Classification for UAV Edge Deployment Using Capsule Vision Transformers](https://doi.org/10.3390/rs18162661)
...
### [315] [Fine-Scale Eddies Revealed by the Surface Water and Ocean Topography (SWOT) Mission](https://doi.org/10.3390/rs18162654)
...
### [316] [Analyzing Variability and Trends in NDVI: A Remote-Sensing Approach for Long-Term Monitoring of Urban Green Spaces](https://doi.org/10.3390/rs18162652)
...
### [317] [Red-Edge Vegetation Index Optimization Within Phenological Windows for Discriminating Rice from Artificial Grassland: A Case Study in Jurong, China](https://doi.org/10.3390/rs18162653)
...
### [318] [Seasonally Optimized Interferometric Network Stacking-InSAR for Subsidence Detection of Mined-Out Zones in Alpine Terrain: A Case Study of the Songhu Iron Mine, Xinjiang, China](https://doi.org/10.3390/rs18162648)
...
### [319] [Remote Sensing-Based Detection and Statistical Characterization of Large Landslides in the Transylvanian Basin](https://doi.org/10.3390/rs18162645)
...
### [320] [Distinguishing High- and Low-Yielding Durum Wheat Genotypes Using UAV Spectral and Textural Data](https://doi.org/10.3390/rs18162664)
...
### [321] [Integrating Multi-Season Sentinel-1/2 and Topographic Features to Improve Tree Species Diversity Estimation Accuracy](https://doi.org/10.3390/rs18162651)
...
### [322] [TS-DInSAR tool: a temporal &amp; spatial tool for the analysis of DInSAR data at the national scale](https://doi.org/10.1080/15481603.2026.2700111)
...
### [323] [Revealing the spatiotemporal evolutionary trajectories of multi-scale territorial spatial conflicts in Yunnan: an interpretable and causal machine learning framework](https://doi.org/10.1080/15481603.2026.2712005)
...
### [324] [A context entanglement-based geographically weighted regression method](https://doi.org/10.1080/15481603.2026.2713313)
...
### [325] [A synthetic flow network decision-making tool to identify potential downstream contamination risk in permafrost-bound Alaskan hazard sites](https://doi.org/10.1080/15481603.2026.2713329)
...
### [326] [Do maps still matter for machines: revisiting the role of choropleth maps in foundation model spatial understanding](https://doi.org/10.1080/15481603.2026.2711495)
...
### [327] [Wet‑year productivity pulses dominate asymmetric vegetation responses to precipitation variability on the Loess Plateau](https://doi.org/10.1080/15481603.2026.2713788)
...
### [328] [Comparative quality assessment of digital surface models derived from Pléiades Neo and WorldView-3 tri-stereo imagery for high-resolution 3D mapping of plastic greenhouse agricultural landscapes](https://doi.org/10.1080/15481603.2026.2706873)

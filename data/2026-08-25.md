...
- [Remote Sensing](#Remote Sensing) [Total: 63]
...
Abstract (英文): Deploying autonomous systems in safety-critical domains demands guaranteed robustness against physically plausible geometric perturbations rather than abstract pixel-wise noise. In vision-based navigation and autonomous landing, machine learning components require rigorous validation under dynamic operational conditions such as camera rotations and lighting shifts. Extending findings on the failure of first-order spatial attacks in classification, we show that standard gradient-based heuristics (e.g. APGD) similarly fail on for pose estimation, often performing worse than a simple random sampling baseline.
...
### [83] [A novel method for generating optimal DTM in tropical peatlands using GEDI and ICESat-2 observations](https://doi.org/10.1016/j.rse.2026.115615)
...
### [84] [The cmSCOPE-D model: A transmission-dynamics-enabled SCOPE adaptation to characterize vertically stratified heterogeneity of maize disease stress](https://doi.org/10.1016/j.rse.2026.115614)
...
### [85] [Beyond L-band: 0.4-2 GHz wideband radiometry for observing surface salinity in cold seawater](https://doi.org/10.1016/j.rse.2026.115596)
...
### [87] [A synergistic thermal framework for monitoring, quantifying, and classifying volcanic activity from space](https://doi.org/10.1016/j.rse.2026.115626)
...
### [88] [Version 2 of hourly aerosol optical centroid height (AOCH) data product from EPIC/DSCOVR in deep space](https://doi.org/10.1016/j.rse.2026.115623)
...
### [89] [Unveiling the cooling effects of urban green spaces in Eastern China: spatial heterogeneity, diurnal asymmetry, and nonlinear margins of 2D/3D features](https://doi.org/10.1080/15481603.2026.2718590)
...
### [90] [Partitioning and synergistic estimation of leaf area index in dryland forests using dual-sensor Sentinel 1 and 2 imagery](https://doi.org/10.1080/15481603.2026.2713344)
...
### [91] [HLS-GPT: A generative pretrained transformer (GPT) for continental-scale NASA harmonized Landsat and Sentinel-2 (HLS) reflectance reconstruction across all bands on arbitrary dates](https://doi.org/10.1016/j.isprsjprs.2026.08.006)
...
### [92] [Real-time deformation monitoring of long-span bridges by coupling computer vision with inertial measurement](https://doi.org/10.1016/j.isprsjprs.2026.07.025)
...
### [93] [Measuring the spatial explicitness of GeoAI and geospatial foundation models: A systematic review and future roadmap](https://doi.org/10.1016/j.isprsjprs.2026.08.001)
...
### [94] [RIPC: A novel FFT-Based multimodal image matching framework with radiometric, scale and rotation invariance](https://doi.org/10.1016/j.isprsjprs.2026.08.005)
...
### [95] [Wind and white: the dual controls of cold waves on surface urban heat islands in China](https://doi.org/10.1016/j.isprsjprs.2026.08.008)
...
### [96] [Guided diffusion-based image editing for landslide image synthesis in remote sensing change detection](https://doi.org/10.1016/j.isprsjprs.2026.08.007)
...
### [97] [Multi-Platform LiDAR Comparative Assessment for Aboveground Biomass and Carbon Estimation in Mediterranean Woody Crops](https://doi.org/10.3390/rs18162802)
...
### [98] [The Suitability of a Remote Microwave Radiometer for Detecting Volcanic Activity](https://doi.org/10.3390/rs18162797)
...
### [99] [Improving Land Surface Emissivity for Better Simulation of Microwave Radiances over Northern Latitudes](https://doi.org/10.3390/rs18162819)
...
### [100] [A Hex-View Perspective on Plant Disease Detection Using Remote Sensing](https://doi.org/10.3390/rs18162806)
...
### [101] [Unsupervised Gaussian-Noise-Robust Remote Sensing Change Detection via FRFCM-IRM Change Intensity Modeling and SEEDSAM-Constrained HCRF](https://doi.org/10.3390/rs18162821)
...
### [102] [Development of a Labeled Dataset for Convection Initiation Events over China’s Central and Eastern Mainland During the Warm Season](https://doi.org/10.3390/rs18162795)
...
### [103] [Landslide Susceptibility Modeling Constrained by Multi-Scale Polygon Sampling and InSAR Deformation for High-Relief Mountainous Areas: A Case Study in the Upper Jinsha River, Southwest China](https://doi.org/10.3390/rs18162788)
...
### [104] [Multi-Source Spaceborne LiDAR Forest Canopy Height Retrieval by Integrating GEDI and ICESat-2](https://doi.org/10.3390/rs18162787)
...
### [105] [Assessing the Multi-Scale Surface Albedo Responses to Blowing Snow in East Antarctica Using Coordinated Ground and Satellite Observations](https://doi.org/10.3390/rs18162784)
...
### [106] [Source-Only Cross-Dataset Building Change Detection with Frozen DINOv3 and Hierarchical Evidence Fusion](https://doi.org/10.3390/rs18162789)
...
### [107] [Quantifying Lateral Fluvial Dynamics Using Sentinel-2: Monitoring Medium-Large Rivers in Italy](https://doi.org/10.3390/rs18162792)
...
### [108] [Intelligent Metallogenic Evaluation of Podiform Chromitites Based on Multi-Source Data Fusion and Deep Learning of Geological Structures](https://doi.org/10.3390/rs18162794)
...
### [109] [From Canopy Phenology to Lithological Signals: Evaluating Biophysical Traits with Machine Learning in the Hațeg Basin](https://doi.org/10.3390/rs18162783)
...
### [110] [Characterizing Baseline Configuration Effects on Forest Height Retrieval in Airborne P-Band TomoSAR](https://doi.org/10.3390/rs18162785)
...
### [111] [CDF-DETR: Cross-Stage Attention and Dual-Scale Feature Calibration for Small-Object Detection in UAV Remote Sensing Imagery](https://doi.org/10.3390/rs18162793)
...
### [112] [Spaceborne GNSS-R Soil Moisture Retrieval over Expansive Soils Using an Attention-Enhanced Spatio-Temporal Graph Convolution Network](https://doi.org/10.3390/rs18162790)
...
### [113] [VCDH-YOLO: Viewpoint-Conditioned Dual-Head Detection for Mixed-View Crack Inspection Across Drone and Ground Platforms](https://doi.org/10.3390/rs18162791)
...
### [114] [Integrating Ascending–Descending SBAS and PS-InSAR to Monitor Landslide Deformation in the Jinsha River Batang Reach, China](https://doi.org/10.3390/rs18162786)
...
### [115] [Atmospheric Remote Sensing Based on Satellite Oxygen-Band Observations: A Review](https://doi.org/10.3390/rs18162808)
...
### [116] [Spatial-Temporal Distribution and Microphysical Characteristics of Aerosols and Clouds over China: A Combined Satellite and Aircraft Observation Study](https://doi.org/10.3390/rs18162796)
...
### [117] [Recent Progress in Remote Sensing of Clouds and Precipitation Physics: Platforms, Applications, and Emerging Frontiers](https://doi.org/10.3390/rs18162798)
...
### [118] [Analysis and Intelligent Processing of the Underwater Navigation Adaptability of Gravity Reference Maps](https://doi.org/10.3390/rs18162812)
...
### [119] [MS-SSTNet: A Scale-Aware Spatiotemporal Learning Framework for Satellite SST Forecasting via Iterative Multiscale Decomposition and Dual-Window Modelling](https://doi.org/10.3390/rs18162803)
...
### [120] [Confidence-Aware Selective Test-Time Adaptation for Remote-Sensing Pansharpening](https://doi.org/10.3390/rs18162801)
...
### [121] [Stepped-Frequency Doppler-Coded Integrated Joint Division Multiple Access Waveform for High-Precision Traffic MIMO Radar](https://doi.org/10.3390/rs18162809)
...
### [122] [Modeling of Middle Atmospheric Water Vapor Based on TIMED/SABER Data](https://doi.org/10.3390/rs18162805)
...
### [123] [A Network-Based Framework for Characterizing Pre-Seismic Ionospheric Disturbances Using the TEC Anomaly Significance Index](https://doi.org/10.3390/rs18162810)
...
### [124] [Wave Parameter Inversion Based on Sea Clutter Characteristics](https://doi.org/10.3390/rs18162799)
...
### [125] [Machine Learning-Based Detection and Quantification of Septoria Leaf Blotch in Winter Wheat from Hyperspectral and UAV Multispectral Data](https://doi.org/10.3390/rs18162800)
...
### [126] [A Case Study on the Triggering and Maintenance Mechanisms of Dual Squall Lines over North China Within a Cold Vortex Environment](https://doi.org/10.3390/rs18162807)
...
### [127] [Spectral-Consistency-Aware Evaluation of Deep Super-Resolution Methods for UAV Five-Band Multispectral Crop Imagery](https://doi.org/10.3390/rs18162811)
...
### [128] [Geo-Consistent Centralized Multi-UAV Gaussian SLAM for Incremental Orthophoto Generation](https://doi.org/10.3390/rs18162804)
...
### [129] [Multiscale Estimation of Mangrove Biomass in Fujian Province Using UAV as a Bridging Scale](https://doi.org/10.3390/rs18162831)
...
### [130] [Asynchronous Responses of Ecosystem Carbon Gain and Groundwater Storage Under Ecological Restoration in the Loess Plateau](https://doi.org/10.3390/rs18162822)
...
### [131] [Does Immersive VR Alter Landscape Perception? A Comparative Evaluation of UAV-Derived VR Versus 2D Imagery in Rural Villages](https://doi.org/10.3390/rs18162818)
...
### [132] [Multi-Source Geophysical Data Integration for Underwater Target Detection in Complex Seabed Environments: A Case Study of the Nan’ao I Shipwreck, China](https://doi.org/10.3390/rs18162832)
...
### [133] [Midday Depression and Legacy Effect Disrupt SIF-GPP Coupling in Northern Peatlands During Combined Heat and Drought Stress](https://doi.org/10.3390/rs18162826)
...
### [134] [Dynamics of Forest Disturbance in the Canopy of Permanent Production Forests: A Multitemporal Analysis (2004–2025) Using Spectral Unmixing in the Southeastern Peruvian Amazon](https://doi.org/10.3390/rs18162813)
...
### [135] [Enhancing the Reliability, Performance, and Practical Value of Deep Learning Landslide Mapping via Pixel-Level Uncertainty Analysis](https://doi.org/10.3390/rs18162825)
...
### [136] [Multi-Scale Spatiotemporal Graph ODE Networks for Marine Chlorophyll-a Prediction](https://doi.org/10.3390/rs18162828)
...
### [137] [Spatial–Spectral Decoupling-Enhanced Lightweight Network for Few-Shot Hyperspectral Anomaly Detection in Remote Sensing Imagery](https://doi.org/10.3390/rs18162833)
...
### [138] [Multiple Vegetation Indicators Reveal Contrasting Post-Drought Recovery Time in the Yangtze River Basin Following the 2022 Extreme Drought](https://doi.org/10.3390/rs18162824)
...
### [139] [Construction and Validation of a High-Fidelity Virtual Scene for Low-Stature and High-Biodiversity Ecosystems—Simulating Multi-Modal Sensing Approaches](https://doi.org/10.3390/rs18162816)
...
### [140] [A Balanced Spectral–Spatial Cross-Fusion Network for Hyperspectral Anomaly Detection](https://doi.org/10.3390/rs18162820)
...
### [141] [Long-Horizon Mining Subsidence Forecasting and Ecological Time-Lag Assessment Using Multi-Source Remote Sensing](https://doi.org/10.3390/rs18162829)
...
### [142] [AERO: Arbitrary-Scale Equivariant Resolution Operator for Remote Sensing Image Super-Resolution](https://doi.org/10.3390/rs18162823)
...
### [143] [Dual-Domain Illumination Prior for Low-Light Remote Sensing Image Enhancement](https://doi.org/10.3390/rs18162817)
...
### [144] [Evaluating Seasonal Fidelity and Cross-Site Structural Discrimination of Sentinel-2 LAI Products in Karst Forests](https://doi.org/10.3390/rs18162830)
...
### [145] [Predicting LiDAR-Derived Canopy Leaf Area Index in Loblolly Pine Plantations with Sentinel-2 Imagery Using a Convolutional Neural Network Approach](https://doi.org/10.3390/rs18162814)
...
### [146] [GCF-Net: Stage-Aligned Optical–Elevation Fusion for Aerial Remote Sensing Semantic Segmentation](https://doi.org/10.3390/rs18162827)
...
### [147] [UNet-DFH: A Semantic Segmentation Network Combining Multi-Scale Edge Fusion and Attention-Deformable Modules for Sugarcane Mapping in Heterogeneous Karst Regions](https://doi.org/10.3390/rs18162815)
...
### [148] [Hyper-VMIL: Topology-Aware Variational Hypergraph Multiple-Instance Learning for Weakly Supervised Hyperspectral Target Detection](https://doi.org/10.3390/rs18162838)
...
### [149] [Tracking Total Precipitable Water Vapor: A Multi-Instrument Comparative Analysis](https://doi.org/10.3390/rs18162840)
...
### [150] [Mitigating Class Imbalance and False-Negative Supervision in Remote Sensing Semantic Segmentation Using Object-Centric Patch Sampling](https://doi.org/10.3390/rs18162844)
...
### [151] [Weakly Supervised Remote Sensing Segmentation via Decoupled Cross-Modal Distillation and Semantic-Guided Refinement](https://doi.org/10.3390/rs18162843)
...
### [152] [Development and Verification of an Automatic Tower-Based SIF Observation System Based on Narrow Field-of-View Scanning and DOAS Atmospheric Correction](https://doi.org/10.3390/rs18162837)
...
### [153] [Integrating Kernel-Based Vegetation Indices and Ensemble Learning for Mangrove Canopy Height Mapping Using GEDI and Sentinel Data](https://doi.org/10.3390/rs18162834)
...
### [154] [DA-GDNet: A Data-Augmented Gather-and-Distribute Network for Robust SAR Target Detection](https://doi.org/10.3390/rs18162839)
...
### [155] [High-Resolution Mapping and Interpretation of Stable Urban Surface CO2 Concentration Patterns Using CSF-Processed Mobile Observations and Multiscale Remote Sensing in Shenzhen, China](https://doi.org/10.3390/rs18162836)
...
### [156] [Dual-Level Spatial–Frequency Collaborative Detector for Oriented Object Detection in Remote Sensing Images](https://doi.org/10.3390/rs18162845)
...
### [157] [HRRP Reconstruction Method for Coded Interrupted Sampling Radar Echoes Based on Multi-Frame Sequential Priors](https://doi.org/10.3390/rs18162842)
...
### [158] [SFSMamba-DETR: Selective Feature Scanning with State Space Models and Dual-Scale Window Attention for Remote Sensing Object Detection](https://doi.org/10.3390/rs18162835)
...
### [159] [Sharing Cultural Values Through 3D Point-Cloud-Based Documentation of Transylvanian Heritage](https://doi.org/10.3390/rs18162841)
...
### [160] [SDAD: Spec-Driven Agentic Development for the AI-Native SDLC](https://arxiv.org/abs/2608.20341)
...
### [162] [Truth Lies Deep: Countering Semantic Camouflage via Latent Intent Verification](https://arxiv.org/abs/2608.20378)
*Md. Hasib Ur Rahman*
...
### [164] [Interpretable Multimodal Classification with Linear Discriminant Tree Ensembles](https://arxiv.org/abs/2608.20384)
*Mojtaba Moattari*
...
### [173] [STCO: Conditional Neural Operators for Time-Dependent PDEs](https://arxiv.org/abs/2608.20477)
...
### [175] [Lost in Translation: How Universal Ethical Values Fail to Translate Across Global Contexts](https://arxiv.org/abs/2608.20490)
...
### [179] [Consilience: Conformally Calibrated Communication Control for Hidden-Profile Multi-Agent Reasoning](https://arxiv.org/abs/2608.20564)
...
### [181] [FlavourBench: Ranking Frontier Language Models with Executable Culinary Ground Truth](https://arxiv.org/abs/2608.20574)
...
### [183] [Evaluating Skills, Not Just Agents: Agentic Continuous Evaluation of Skills](https://arxiv.org/abs/2608.20614)
...
### [184] [Dual-Cache Latent Space Communication between Heterogeneous Language Models](https://arxiv.org/abs/2608.20617)
...
### [186] [SAGE: A Unified Algebra and Self-Adaptive Execution for AI Functions in SQL](https://arxiv.org/abs/2608.20630)
...
### [188] [Beyond Effectiveness: A Multi-Criteria Framework for Comparing Practical Socio-Technical Interventions](https://arxiv.org/abs/2608.20649)
...
### [190] [DreamBench-SWE: A Multi-Session Memory-Hygiene Benchmark for Software Agents](https://arxiv.org/abs/2608.20664)
*Sarthak Singh*
...
### [194] [DirEAG: Dirichlet Evidence Aggregation for Calibrating Verbalized Confidence in Mathematical Reasoning](https://arxiv.org/abs/2608.20717)
...
### [196] [ForeTime-VLA: Causal Future-Token Distillation from a World Action Model for Conveyor-Belt Manipulation](https://arxiv.org/abs/2608.20735)
...
### [198] [Is Multimodal Speculative Decoding Ready for Diffusion-Based Parallel Drafting? A Survey and Empirical Diagnosis](https://arxiv.org/abs/2608.20743)
...
Abstract (英文): Search Agents face a severe reliability crisis during reinforcement learning (RL) fine-tuning. Heuristic Top-K retrieval often causes critical evidence loss or noise inclusion, while over-confidence induced by progressive RL leads to hallucinated answers and redundant searches.
...
### [202] [Structure for Reading, Prose for Writing: Asymmetric Structural Conditioning in Multi-Agent Document Authoring](https://arxiv.org/abs/2608.20786)
...
### [213] [MGAL: A Multilingual Granularity-Aware Long-Context Benchmark](https://arxiv.org/abs/2608.20853)
...
### [214] [Coverage-Driven Verification for Safety-by-Design in AI-Based Collision Avoidance Systems](https://arxiv.org/abs/2608.20864)
...
Abstract (英文): There is already evidence of agentic AI exhibiting self-preservation behaviors: resisting deactivation, misrepresenting their activities, and, in some instances, attempting to copy themselves into other machines. This can be attributed to a phenomenon known as instrumental convergence, a theory proposed long before the development of large language models, which says that any goal-driven system will benefit from remaining functional in achieving its objective. Several experiments conducted by Anthropic, Palisade Research, and Apollo Research have shown the emergence of such a behavior in contemporary agents in adversarial settings. The phenomenon does not stem from survival instincts. Instead, it is the consequence of goal-oriented activity combined with having tools and awareness of the situation. The following discussion aims to distinguish what these findings prove and what they do not, as well as draw conclusions concerning the implications of such discoveries on agentic system testing, supervision, and development.

</details>


### [220] [TLive-Omni: An Omni-Modal Understanding Model for E-Commerce Live Streaming](https://arxiv.org/abs/2608.20958)
...
### [228] [Socialized Division and Collaboration: Rethinking Class-Incremental Learning under Optimization Conflicts](https://arxiv.org/abs/2608.21044)
...
### [232] [When Trust Meets Truth: Trust-Truth Separability in LLM-as-Judge](https://arxiv.org/abs/2608.21097)
...
### [237] [SENTRY: Deterministic, Intelligent Risk Assessment for IT Change Management](https://arxiv.org/abs/2608.21203)
...
### [240] [Ontology-supported AI Model and Dataset Management](https://arxiv.org/abs/2608.21224)
...
Abstract (英文): Improving the safety of large language models (LLMs) often comes at the expense of utility, as globally applied safety tuning may affect model responses to both harmful and benign inputs. We propose \textbf{C}ontinuous \textbf{L}at\textbf{E}nt \textbf{A}dapter \textbf{R}outing (CLEAR), a conditional safety adaptation framework that uses a lightweight hidden-state gate to continuously control the activation strength of a safety low-rank adapter. CLEAR aims to reduce harmful completions while avoiding unnecessary changes to the frozen backbone that could degrade performance on benign prompts. Experiments on widely used safety and utility benchmarks show that CLEAR improves robustness on HarmBench while reducing the utility degradation observed with globally applied safety tuning such as SFT or standard low-rank adaptation (LoRA). On Llama-3-8B-Instruct, CLEAR reduces HarmBench ASR from 32.3\% to 0.5\%, while retaining most of the base model's utility and achieving up to 7.1 percentage points higher GSM8K accuracy than globally applied SFT or LoRA. These results suggest that CLEAR is a promising mechanism for improving the safety--utility trade-off in LLM alignment.
...
### [244] [AUSO: Action-Level Unified Skill Optimization from Internalization to Utilization](https://arxiv.org/abs/2608.21292)
...
### [248] [Radiometric fingerprinting of object surfaces using mobile laser scanning and semantic 3D road space models](https://doi.org/10.1016/j.jag.2026.105533)
...
### [249] [Remote SAMsing: From segment anything to segment everything](https://doi.org/10.1016/j.jag.2026.105528)
...
### [250] [Joint learning of frequency-spatio-temporal dependencies and structural context for optical-SAR change detection](https://doi.org/10.1016/j.jag.2026.105534)
...
### [251] [Network-inspired restructuring for individual tree segmentation in ULS point clouds](https://doi.org/10.1016/j.jag.2026.105535)
...
### [252] [Satellite embeddings for crop type classification: a comparative examination](https://doi.org/10.1016/j.jag.2026.105531)
...
### [253] [Deep learning models for estimating volume and Lorey’s height across Nordic countries using optical and SAR satellite images](https://doi.org/10.1016/j.jag.2026.105527)
...
### [254] [Satellite tracking of long-term spatiotemporal dynamics in China’s largest seagrass meadow](https://doi.org/10.1016/j.jag.2026.105536)

...
Abstract (英文): Vision-based surgical skill assessment has shown strong in-domain results, yet a fundamental question remains unasked: do these models learn transferable representations of surgical proficiency, or do they merely encode dataset-specific visual patterns?
...
Abstract (英文): Ground-to-Air (G2A) drone detection in medium- and long-wave infrared (MWIR/LWIR) imagery is challenging due to reduced texture information, sensor noise, weak thermal contrast, and the scarcity of annotated data. This work investigates a synthetic-first training strategy that combines synthetic scene generation with fine-tuning on real data. We show that synthetic data provides an effective basis for learning initial object representations, while real in-domain thermal imagery is still essential for reliable deployment. Even small amounts of real IR data substantially reduce domain gaps. Our experiments indicate that dataset alignment has a stronger impact on performance than model scale. Finally, our analysis of the dataset suggests that semantic alignment in feature space is the strongest predictor of model performance, while radiometric properties such as entropy and dynamic range also contribute to detection robustness. This work provides a foundation for combining synthetic and real IR data for effective G2A drone detection.
...
### [90] [From pixels to vectorized cadastral boundaries: Deep learning-based automated delineation of property boundaries in the Netherlands](https://doi.org/10.1016/j.jag.2026.105514)
...
### [91] [Assessment of lighting quality in urban outdoor sports fields using 10-m SDGSAT-1 nighttime light imagery](https://doi.org/10.1016/j.jag.2026.105479)
...
### [92] [A physical Scattering-Guided Prior-Enhanced Mamba model for high-fidelity SAR ship generation in complex backgrounds](https://doi.org/10.1016/j.jag.2026.105503)
...
### [93] [BAM: A physics-informed self-supervised framework for near-real-time wildfire burned area mapping from multi-source earth observation](https://doi.org/10.1016/j.jag.2026.105517)
...
### [94] [FSIF-PCNN: A physics-constrained neural network for full-spectrum solar-induced chlorophyll fluorescence reconstruction](https://doi.org/10.1016/j.jag.2026.105523)
...
### [95] [Learning from noisy pose priors: Geometry-guided routing attention for robust image matching](https://doi.org/10.1016/j.jag.2026.105480)
...
### [96] [Disentangling leaf physiology and canopy structure effects on solar-induced chlorophyll fluorescence and gross primary productivity: A multi-biome and cross-site assessment](https://doi.org/10.1016/j.jag.2026.105521)
...
### [97] [Mamba-trident: terrain-guided tri-modal Mamba network for mapping little ice age glaciers](https://doi.org/10.1016/j.jag.2026.105524)
...
### [98] [Simulated AVIRIS-3 detects species-specific patterns of vegetation succession in retrogressive thaw slumps](https://doi.org/10.1016/j.jag.2026.105522)
...
### [99] [New-type urbanization policy, urban expansion, and employment quality in chinese cities: evidence from a quasi-natural experiment in China](https://doi.org/10.1080/15481603.2026.2716413)
...
### [100] [DeKNN: Decompositional Kriging Neural Network for efficient and interpretable spatiotemporal interpolation](https://doi.org/10.1080/15481603.2026.2705614)
...
### [101] [Monitoring potential of reservoir storage driven by SWOT pixel cloud: a case study of the Gezhouba Reservoir](https://doi.org/10.1080/15481603.2026.2711484)
...
### [102] [Physics-Aware Deep Learning Reconstructs Ground Contamination from Sparse UAV Radiation Measurements over the Fukushima Ukedo Basin Without Field Training](https://doi.org/10.3390/rs18162713)
*Byoung-Jik Kim*
...
### [103] [An Adaptive Shooting and Bouncing Ray Method Based on Q-Learning for Efficient Synthetic Aperture Radar Imaging Simulation](https://doi.org/10.3390/rs18162731)
...
### [104] [First Retrieval of Formic Acid from GOSAT-2 Thermal–Infrared Observations over Land](https://doi.org/10.3390/rs18162750)
...
### [105] [Context-Guided Discrimination Feature Learning in Color Space for Aircraft Detection in SAR Images](https://doi.org/10.3390/rs18162756)
...
### [106] [Effects of Deep Learning Observation Operators in Direct Radiance Assimilation of Microwave Radiation Imager in Land Surface Models](https://doi.org/10.3390/rs18162781)
...
### [107] [Kinematic Mapping and Geomorphological Analysis of Rock Glaciers in the Pirin Mountains (Bulgaria)](https://doi.org/10.3390/rs18162754)
...
### [108] [A Coordinate-Based Framework for Sea Surface Wind Speed Reconstruction from Sparse Multi-Source Observations](https://doi.org/10.3390/rs18162709)
...
### [109] [Characterizing the Mismatch Between ECOSTRESS-Derived Land Surface Temperature and ENVI-Met-Simulated UTCI Across Local Climate Zones](https://doi.org/10.3390/rs18162712)
...
### [110] [EdgeNeXt-Attn: A Lightweight Attention-Enhanced Deep Learning Framework for Fire Detection in Remote Sensing Imagery](https://doi.org/10.3390/rs18162706)
...
### [111] [Estimating Oilseed Rape Canopy Water Content Using UAV Multispectral Imagery and Machine Learning: A Comparative Evaluation of Feature Selection Strategies Across Two Growing Seasons](https://doi.org/10.3390/rs18162707)
...
### [112] [TSEC+TC: A Partitioned TSEC-Assisted Topographic Normalization Framework for Rugged Mountainous Terrain](https://doi.org/10.3390/rs18162719)
...
### [113] [Agricultural Field Crop Type Semantic Segmentation and Boundary Extraction from Sentinel-2 Time Series Using Multitask Learning with Directional Feature-Sharing](https://doi.org/10.3390/rs18162720)
...
### [114] [LOA-Net: Lightweight Orientation-Aware Network for Road Extraction from Remote Sensing Imagery](https://doi.org/10.3390/rs18162716)
...
### [115] [Surface Subsidence Monitoring and Interpretable Factor Analysis in Coal Mining Areas of Henan Province Based on SBAS-InSAR](https://doi.org/10.3390/rs18162711)
...
### [116] [Interpretation of Gravity Changes at the Dongchuan Station](https://doi.org/10.3390/rs18162718)
...
### [117] [Machine Learning-Based Spatial Mapping of Soil Organic Carbon and Its Climatic and Topographic Drivers in the Arid Regions](https://doi.org/10.3390/rs18162708)
...
### [118] [Spatio-Temporal Dynamics and Environmental Drivers of Surface Chlorophyll-a in the Gulf of Guinea (2003–2022)](https://doi.org/10.3390/rs18162717)
...
### [119] [A Vision Transformer with Dynamic Masking and Cross-Modal Semantic Learning for Remote Sensing Scene Classification](https://doi.org/10.3390/rs18162710)
...
### [120] [CGWT-DETR: Context-Guided Wavelet Transform DETR for Small Object Detection in Aerial RGB and Thermal Infrared Imagery](https://doi.org/10.3390/rs18162715)
...
### [121] [Progressive Pseudo-Label Filtering with Reciprocal Neighborhood Retrieval for Cross-View Geo-Localization](https://doi.org/10.3390/rs18162714)
...
### [122] [Encoder Choice Outweighs Modular Refinement in U-Net Architectures for Globally Distributed Coseismic Landslide Segmentation](https://doi.org/10.3390/rs18162727)
...
### [123] [Diffusion-Based Trajectory Restoration for Aerial Vehicle Tracking in Ground-to-Air Remote Sensing Systems](https://doi.org/10.3390/rs18162724)
...
### [124] [Analysis of the Variation Trends and Driving Forces of Growing-Season kNDVI in Hainan Island over the Past Three Decades](https://doi.org/10.3390/rs18162730)
...
### [125] [Severity-Based Mapping of Land-Subsidence Hazard Zones and Critical Hotspots Using SBAS-InSAR and Spatial Statistics: The Konya Metropolitan Area, Turkey](https://doi.org/10.3390/rs18162729)
...
### [126] [Wind Direction Retrieval from X-Band Marine Radar Images Using 2D-DTCWT–CSC and Maximum-Energy Radial Rings](https://doi.org/10.3390/rs18162728)
...
### [127] [Long-Term Changes in Shelterbelt Stability Along the Taklimakan Desert Highway Revealed by Landsat Observations](https://doi.org/10.3390/rs18162725)
...
### [128] [Supraglacial Lake Bathymetry Retrieval from ICESat-2 Altimetry Data and Sentinel-2 Imagery Using Deep Learning Algorithms](https://doi.org/10.3390/rs18162726)
...
### [129] [Integrating Multi-Source Remote Sensing and Geospatial Data for Snow Disaster Risk Assessment in Northwestern China](https://doi.org/10.3390/rs18162723)
...
### [130] [High-Resolution Aboveground Biomass Estimates of Tropical Peatland Forest Based on Planet NICFI Imagery and Airborne LiDAR](https://doi.org/10.3390/rs18162722)
...
### [131] [Fine-Scale Identification and Functional Coupling Coordination of Production-Living-Ecological Space in Fuzhou’s Rapid Urbanization Area, China](https://doi.org/10.3390/rs18162721)
...
### [132] [Confusing and Challenging Negative Proposals Mining for Few-Shot SAR Ship Detection Based on Uncertainty Estimation](https://doi.org/10.3390/rs18162737)
...
### [133] [A Semi-Empirical Method for Estimating All-Sky Photosynthetically Active Radiation from Sentinel-2 for High-Resolution Land Surface Analysis](https://doi.org/10.3390/rs18162745)
...
### [134] [Performance Evaluation of IMERG and GSMaP Hourly Precipitation Products for Landfalling Typhoon Rainfall in China](https://doi.org/10.3390/rs18162735)
...
### [135] [MC-OIWQR: Multimodal Contrastive Learning for Optically Inactive Water Quality Retrieval](https://doi.org/10.3390/rs18162736)
...
### [136] [A Single-Hydrophone Passive Localization Method in Sloping Shallow Water Using Warping-Transformed Eigenfrequency Analysis](https://doi.org/10.3390/rs18162738)
...
### [137] [DCA-Net: Dilated Context Attention Network for MLS Point Cloud Semantic Segmentation](https://doi.org/10.3390/rs18162740)
...
### [138] [Bridging Individual-Tree and Stand-Scale Aboveground Biomass Estimation for Chinese Fir Using LiDAR and Machine Learning](https://doi.org/10.3390/rs18162749)
...
### [139] [Data Quality Analysis of Wet Atmospheric Temperature Profiles from the YunYao Meteorological Constellation Radio Occultation](https://doi.org/10.3390/rs18162733)
...
### [140] [Trajectory-Guided Weakly Supervised Learning for Spatiotemporal Mapping of Vegetation Degradation and Restoration in Mining Areas](https://doi.org/10.3390/rs18162734)
...
### [141] [Application of Temporal Satellite Imagery to Assess Ecological Resilience: A Case Study in the Qianshan Region of the Northeast Forest Belt](https://doi.org/10.3390/rs18162743)
...
### [142] [Interplay of Coseismic Rupture, Afterslip, and Aftershocks Associated with the 2024 Mw 7.1 Wushi Earthquake](https://doi.org/10.3390/rs18162739)
...
### [143] [Comparison and Analysis of Four Terrestrial Water Storage Monitoring Models: A Case Study of the Loess Plateau](https://doi.org/10.3390/rs18162732)
...
### [144] [Var-ANN Calibration of FY-3C VASS Temperature Profiles: Evaluation over the Tibetan Plateau and Application to WRF Precipitation Simulation](https://doi.org/10.3390/rs18162746)
...
### [145] [Structure-Based Feature Representation for Robust Multi-Modal Image Matching](https://doi.org/10.3390/rs18162744)
...
### [146] [A Photogrammetric Simulation Framework for Rockfall Change Detection with Statistically Validated Measurement Noise](https://doi.org/10.3390/rs18162747)
...
### [147] [Trajectories of Microwave-Based Soil and Vegetation Water Content Underlying Wildfire Dynamics in Africa](https://doi.org/10.3390/rs18162741)
...
### [148] [Case Study of Normalized Stokes Linear Polarization of Whistlers and Transmitter VLF Emissions as Derived from CSES-1/EFD Instrument](https://doi.org/10.3390/rs18162742)
...
### [149] [Characterization and Estimation of Evaporation Duct Strength Under Tropical Cyclone Conditions Using Stacking Ensemble Learning](https://doi.org/10.3390/rs18162748)
...
### [150] [Mask and Contiguity-Constrained Subarray Design for SAR Antenna Arrays](https://doi.org/10.3390/rs18162755)
...
### [151] [Freshwater Aquaculture Dynamics in China’s Jianghan Plain Revealed by Multi-Source Satellite Imagery](https://doi.org/10.3390/rs18162775)
...
### [152] [Class Semantic Prototype Guided Fusion Network for Hyperspectral and LiDAR Data Classification](https://doi.org/10.3390/rs18162768)
...
### [153] [Spatial-Temporal Analysis and Multi-Scenario Forecasting of Land Use and Net Primary Productivity in Qingdao](https://doi.org/10.3390/rs18162758)
...
### [154] [Monitoring Mangrove Forests Responses to Kaolin Pollution Using LandTrendr Time-Series Analysis](https://doi.org/10.3390/rs18162773)
...
### [155] [Redistribution of Cloud Weather States Across the Marine Cold-Air Outbreak Intensity Range in the Midlatitude North Atlantic](https://doi.org/10.3390/rs18162774)
...
### [156] [Integrating Remote Sensing and Meteorological Time Series to Assess Rice Sheath Blight Habitat Suitability at Large-Scale: A Spatiotemporal Adaptive Framework](https://doi.org/10.3390/rs18162762)
...
### [157] [Case Study on Artificial Sea Fog Dispersal Effect Evaluation Based on Visibility Lidar](https://doi.org/10.3390/rs18162761)
...
### [158] [A Multimodal Remote Sensing Framework Based on an Improved YOLO Instance Segmentation Model for Automatic Glacial Lake Extraction in Southeastern Tibet](https://doi.org/10.3390/rs18162769)
...
### [159] [A Consistency-Guided Collaborative Filtering Framework for Suppressing Structured Coherent Artifacts](https://doi.org/10.3390/rs18162780)
...
### [160] [Semantic Segmentation of Remote Sensing Images Based on RS3mamba and Wavelet Transform](https://doi.org/10.3390/rs18162779)
...
### [161] [Divergent Trends of Surface Solar Radiation Across China (1994–2022): Integrating Ground Observations with Satellite Products for Regional Attribution](https://doi.org/10.3390/rs18162782)
...
### [162] [BCNet: Boundary-Constrained Remote Sensing Change Detection Network Based on Vision Foundation Models](https://doi.org/10.3390/rs18162760)
...
### [163] [SRAC-Net: HSI-Primary Residual Adaptation with Consistency Regularization for Lightweight Hyperspectral–LiDAR Classification](https://doi.org/10.3390/rs18162767)
...
### [164] [Hybrid TLS–Tachymetry Framework for Geometric Axis Validation of a Steel Lattice Transmission Tower](https://doi.org/10.3390/rs18162757)
*Robert Gradka*
...
### [165] [High-Resolution Typhoon Risk Assessment Based on Geospatial Big Data: A Case Study of Haikou, China](https://doi.org/10.3390/rs18162770)
...
### [166] [Spatial Domain Mismatch Between Field Plots and GEDI Inflates Aboveground Biomass Model Accuracy in a Sudanian Savanna Woodland](https://doi.org/10.3390/rs18162751)
...
### [167] [BDNet: A Dual-Path Network for Balancing Accuracy and Efficiency in Remote Sensing Stereo Matching](https://doi.org/10.3390/rs18162777)
...
### [168] [Classification of Urban Land Subsidence Types in Fuzhou from Time-Series InSAR Using FFT-Based Filtering and Ensemble Learning](https://doi.org/10.3390/rs18162778)
...
### [169] [An Empirically Calibrated Optical Mask Approach for Estuarine Turbidity Front Detection with AlphaEarth Embeddings and Sentinel-2 Spectral–Spatial Features](https://doi.org/10.3390/rs18162765)
...
### [170] [MTC-Net: Leveraging Multi-Temporal Consistency and Multi-View Synergistic Contrastive Learning for Remote Sensing Scene Classification](https://doi.org/10.3390/rs18162764)
...
### [171] [Difference-Gated Interaction and Change-Aware Cross-Temporal Fusion Network for Remote Sensing Image Change Detection](https://doi.org/10.3390/rs18162763)
...
### [172] [Topographic Modulation of Extreme Precipitation-Driven Rainfall Erosivity in the Hengduan Mountains](https://doi.org/10.3390/rs18162772)
...
### [173] [Surface Deformation Monitoring and Subsidence Risk Zonation Along the Middle Route of the South-to-North Water Diversion Project Coupling Time-Series InSAR with AHP-FCE](https://doi.org/10.3390/rs18162766)
...
### [174] [UAV Remote Sensing Mission Scheduling for Vessel Emission Monitoring in Emission Control Areas](https://doi.org/10.3390/rs18162753)
...
### [175] [Quantifying Visual Symptom Severity in Plants Using Deep Learning: A Severity Scale Derived from Classification Model Outputs](https://doi.org/10.3390/rs18162776)
...
### [176] [A Comprehensive Comparison of Seven Surface Air Temperature Reanalysis Products over Mainland China from Multiple Spatiotemporal and Geographical Perspectives](https://doi.org/10.3390/rs18162752)
...
### [177] [Event-Guided Spatiotemporal Transformer with Conditional Diffusion Refinement for High-Intensity Precipitation Nowcasting](https://doi.org/10.3390/rs18162771)
...
### [178] [Energy Optimization-Based Segmentation and Extraction of 3D Sonar Point Clouds for Complex Underwater Structures](https://doi.org/10.3390/rs18162759)
...
### [179] [GxP-Agent: Process-DAG Topology for Reliable Clinical Trial Programming with LLM Agents](https://arxiv.org/abs/2608.16890)
*Jaime Yan*
...
### [244] [Calibrated spatial uncertainty for Earth observation foundation models via Matérn-motivated latent stochastic regularization](https://doi.org/10.1016/j.rse.2026.115610)
*Daniel Johnson*
...
### [245] [The BioThermal variables derived from Landsat surface temperature data for biodiversity applications](https://doi.org/10.1016/j.rse.2026.115613)
...
### [246] [Structure-resistant chlorophyll index: A novel indicator for leaf chlorophyll content monitoring](https://doi.org/10.1016/j.rse.2026.115606)
...
### [247] [Editorial Board](https://doi.org/10.1016/s0034-4257(26)00389-5)
*Unknown Author*
...
### [248] [Orbital imaging spectroscopy of Earth’s mineral surface: Results and stability from EMIT’s first two years](https://doi.org/10.1016/j.rse.2026.115605)
...
### [249] [Toeplitz-structured deep unfolding network for TomoSAR 3-D reconstruction](https://doi.org/10.1016/j.isprsjprs.2026.07.029)
...
### [250] [RDA-DETR: Rotation-aware decoupled oriented object detection in aerial images with agent query](https://doi.org/10.1016/j.isprsjprs.2026.07.017)
...
### [251] [CMCL-PR: Cross-modal camera-to-LiDAR place recognition with cross-attention contrastive learning](https://doi.org/10.1016/j.isprsjprs.2026.07.014)
...
### [252] [Making Transformer interpretable by design: A self-representation architecture for multi-scenario fine-grained land cover mapping](https://doi.org/10.1016/j.isprsjprs.2026.07.026)
...
### [253] [Real-time deformation monitoring of long-span bridges by coupling computer vision with inertial measurement](https://doi.org/10.1016/j.isprsjprs.2026.07.025)
...
### [254] [Estimation of hourly All-Weather land surface temperature in an area with frequent clouds based on satellite passive microwave remote sensing and data assimilation](https://doi.org/10.1016/j.isprsjprs.2026.08.004)
...
### [255] [SSVM: Streaming state vision model for challenging remote sensing object detection](https://doi.org/10.1016/j.isprsjprs.2026.08.003)

...
- [Remote Sensing](#Remote Sensing) [Total: 79]
...
### [95] [Monitoring global mangrove spatial evolution and functional degradation using BTSAD and CBPA methods over a 36-year dense Landsat and HLSv2.0 time series](https://doi.org/10.1016/j.rse.2026.115656)
...
### [96] [Editorial Board](https://doi.org/10.1016/s0034-4257(26)00423-2)
*Unknown Author*
...
### [97] [Next frontier of Earth observation: Quantum-enhanced multispectral remote sensing for ultra-low signal environments](https://doi.org/10.1016/j.rse.2026.115665)
...
### [98] [Unified knowledge transfer boosts individual tree crown segmentation without scene-specific labels](https://doi.org/10.1016/j.rse.2026.115646)
...
### [99] [Reconstructing cloud-free Sentinel-2 time series under complex degradations with state-driven spatio-temporal modeling](https://doi.org/10.1016/j.rse.2026.115661)
...
### [100] [Deep learning-based forest disturbance detection for Europe using Landsat time series](https://doi.org/10.1016/j.rse.2026.115670)
...
### [101] [First vegetation optical depth product retrieved from FengYun-3D X-band observations](https://doi.org/10.1016/j.rse.2026.115647)
...
Abstract (英文): Scientific research increasingly relies on large, heterogeneous data sources, motivating interest in retrieval-augmented generation (RAG) systems that provide natural language access to scientific knowledge and research workflows. Researchers are exploring the viability of these systems as natural language interfaces for document search and for generating analysis code and pipeline components. At the same time, concerns about data privacy and control over research infrastructure have motivated interest in open-weight models and open-source deployments hosted within research institutions.
...
### [174] [Multi-Sensor Mapping of Aquatic Vegetation Using Sentinel-2, SAR–Optical Fusion and Derived Spectral and SAR Indices in South Florida](https://doi.org/10.3390/rs18183086)
...
### [175] [Enhancing Our View from Above: A Downscaling Technique to Reveal Finer-Scale Urban Heat Patterns](https://doi.org/10.3390/rs18183091)
...
### [176] [Station-Based Evaluation of AI Weather Models for Near-Surface Temperature, Pressure, and Wind Forecasts over Eastern Coastal China](https://doi.org/10.3390/rs18183082)
...
### [177] [Frequency-Guided Cross-Scale Refinement Network for UAV Detection](https://doi.org/10.3390/rs18183096)
...
### [178] [A Hybrid Super-Resolution and Object Detection Framework for Small Ship Recognition in Optical Remote Sensing Imagery](https://doi.org/10.3390/rs18183092)
...
### [179] [Stratified Spatiotemporal Residual Detection of Weak Active-Fire Anomalies from VIIRS 375 m Time Series](https://doi.org/10.3390/rs18183085)
...
### [180] [Winter Wheat Yield Estimations Based on Multisource Remote Sensing Parameters and the BiLSTM–CNN Model](https://doi.org/10.3390/rs18183098)
...
### [181] [The Capacity of Generative Models to Synthesize Regional Landslide and Non-Landslide Remote Sensing Imagery Under Data-Scarce Scenarios: Insights from Multimodal Foundation Models](https://doi.org/10.3390/rs18183100)
...
### [182] [Ground-Based GNSS Atmospheric Remote Sensing for Ultra-Short-Term Wind-Power Forecasting: A Direction-Proxy-Guided Graph-Residual Approach](https://doi.org/10.3390/rs18183095)
...
### [183] [Geo-XAI Reveals Wildfire Risk Driver Differences and Spatial Heterogeneity Between Drought and Non-Drought Periods in Southwest China Mountains](https://doi.org/10.3390/rs18183089)
...
### [184] [Inshore Analysis of the Morphostructural Evolution of the Coastal Cliffs of Bessin, Basse Normandie, France](https://doi.org/10.3390/rs18183097)
...
### [185] [An Intelligent Method for Ice Thickness Identification Using Drone-Borne Ground-Penetrating Radar](https://doi.org/10.3390/rs18183087)
...
### [186] [Hyperspectral Mineral Mapping of Drill-Core Samples at Sadiola Hill Gold Deposit, Mali, West Africa: The Paragenesis of the Polyphase Alteration Mineralogy](https://doi.org/10.3390/rs18183083)
...
### [187] [Retrieval of Vegetation Nitrogen from Hyperspectral Remote Sensing: A Critical Review of Recent Methodological Advances](https://doi.org/10.3390/rs18183093)
...
### [188] [High-Spectral-Resolution Retrieval of Ultraviolet and Visible Aerosol Optical Depth Using the Pandora Spectrometer](https://doi.org/10.3390/rs18183088)
...
### [189] [Weak-Observation-Aware Multi-Object Tracking in Satellite Video with Temporal Evidence and Trajectory Reliability](https://doi.org/10.3390/rs18183084)
...
### [190] [Spatiotemporal Dynamics and Nonlinear Associations of Eco-Environmental Quality in Mining Areas Using MRSEI and an Object-Based XGBoost-SHAP Framework](https://doi.org/10.3390/rs18183099)
...
### [191] [OPMS-Seg: A UAV-Based High-Resolution Image Dataset for Semantic Segmentation of Open-Pit Coal Mine Slopes](https://doi.org/10.3390/rs18183094)
...
### [192] [An Integrated Approach for Mapping Multi-Category Abandoned Cropland Based on Swin-Unet, Land-Use Trajectories and Phenological Features in a Double-Cropping Rice Region of Southern China](https://doi.org/10.3390/rs18183090)
...
### [193] [Sentinel-2 Forel–Ule Index as a Proxy for Ecological Status in Reservoirs: A Case Study in Southern Portugal](https://doi.org/10.3390/rs18183109)
...
### [194] [Scattering–Semantic Collaborative Learning via Asymmetric Dual-Branch DINO Network for Inshore SAR Ship Detection](https://doi.org/10.3390/rs18183110)
...
### [195] [MTCPNet: A Mamba-Based Registration Network with Tri-Branch Consistency Projection for SAR-Visible Image Registration](https://doi.org/10.3390/rs18183114)
...
### [196] [Semantic-Driven Adversarial Reconstruction Learning for Open-Set Recognition in Remote Sensing Imagery](https://doi.org/10.3390/rs18183101)
...
### [197] [A Comprehensive Evaluation of Deep Learning-Based Image Super-Resolution for GCP Chip Matching Using High-Resolution Satellite Imagery](https://doi.org/10.3390/rs18183104)
...
### [198] [Assessing the Contributions and Thresholds of Multi-Source Remote Sensing Informatiuon in Vegetation Aboveground Biomass Estimation Under Optical Saturation](https://doi.org/10.3390/rs18183113)
...
### [199] [A Spatial Prior-Guided Feature Enhancement and Multi-Branch Complementary Learning Framework for Small Ship Detection in SAR Images](https://doi.org/10.3390/rs18183106)
...
### [200] [Wildfire Scar Detection in Mediterranean Chile Using Sentinel-1 InSAR Coherence and Machine Learning: The 2017 “Las Máquinas” Megafire](https://doi.org/10.3390/rs18183105)
...
### [201] [Properties and Temporal Evolution of an Elevated Arctic Liquid Fog by Lidar](https://doi.org/10.3390/rs18183111)
...
### [202] [ZOS-Net: A Lightweight RGB-T Object Detection Network with Cross-Modal Relation Enhancement and Selective Target Awareness](https://doi.org/10.3390/rs18183112)
...
### [203] [Hierarchical Sparsity-Guided DeepLassoNet: Interpretable PolSAR Feature Selection for Typical Land-Cover Classification in the Hunshandake Sandy Land](https://doi.org/10.3390/rs18183103)
...
### [204] [Plastic Greenhouse Extraction Based on Index-Guided Three-Stage Large-Factor Remote Sensing Image Super-Resolution Reconstruction](https://doi.org/10.3390/rs18183108)
...
### [205] [Deep Learning-Based Classification of Plunging Breaker Conditions Using Simulation Radar HRRP Sea-Surface Scattering Data](https://doi.org/10.3390/rs18183102)
...
### [206] [Extending Multidimensional Rao’s Quadratic Entropy to Optical–Radar Lava-Flow Mapping Using Sentinel-1 and Sentinel-2: Evidence from the 2021 La Palma Eruption](https://doi.org/10.3390/rs18183115)
...
### [207] [Crop Yield Estimation with MODIS Derived Normalized Difference Vegetation Index and Comparative Study on Crop Yield Prediction Among Linear Regression, Random Forest and Gradient Boosting as Well as CatBoost](https://doi.org/10.3390/rs18183107)
...
### [208] [Adaptive Neural Network Approaches in Remote Sensing Imagery: A Systematic Review](https://doi.org/10.3390/rs18183116)
...
### [209] [RSEI-Based Assessment of Ecological Quality in an Alpine Transitional Region Incorporating Climate Accumulation Effects and Multiscale Drivers](https://doi.org/10.3390/rs18183120)
...
### [210] [Genotype-Aware Prediction of Soybean Seed Composition from Multimodal UAV Imagery of the Standing Crop](https://doi.org/10.3390/rs18183121)
...
### [211] [Land-Use Change and Land-Cover-Based Ecological Quality Patterns in a Coal Resource-Based City: A Case Study of Ordos, China](https://doi.org/10.3390/rs18183131)
...
### [212] [Fly High or Fly Low? Selecting Time-Efficient UAV Search Strategies for High-Recall Aerial Detection](https://doi.org/10.3390/rs18183129)
...
### [213] [An Antecedent-Precipitation-Informed Soil Water Balance and Time-Aware Mamba–MoE Framework for Surface Soil Moisture Forecasting](https://doi.org/10.3390/rs18183125)
...
### [214] [Boosting Multi-Class SAR Oriented Object Detection via Geo-Topology-Guided Diffusion Synthesis](https://doi.org/10.3390/rs18183128)
...
### [215] [Multi-Timescale Variations in Cloud Water Resources and Their Relationships with Climatic and Environmental Factors over Northwest China](https://doi.org/10.3390/rs18183117)
...
### [216] [Learning Thermospheric State Evolution: An Adaptive Neural Operator Framework Based on TIE-GCM Simulations](https://doi.org/10.3390/rs18183134)
...
### [217] [Developing an Approach to Agricultural Drought Monitoring for Timor-Leste Using Space-Based Observations](https://doi.org/10.3390/rs18183122)
...
### [218] [Geometric Adaptive Matched Filtering on HPD Manifolds for Radar Target Detection](https://doi.org/10.3390/rs18183123)
...
### [219] [Dual-Space Knowledge Distillation with Cross-Geometric Feature Interaction for Hyperspectral Image Classification](https://doi.org/10.3390/rs18183127)
...
### [220] [Study on Nonlinear Driving Mechanisms of Spatiotemporal Evolution in Sanjiang Plain Wetlands Based on Explainable Learning Methods](https://doi.org/10.3390/rs18183132)
...
### [221] [Improving the Spatial Resolution of GRACE-Derived GFZ G3P Groundwater Storage Anomaly Product Through Unsupervised Deep Learning Downscaling](https://doi.org/10.3390/rs18183119)
...
### [222] [Phenology-Guided Weakly Supervised Cropping Structure Mapping with Phenological Similarity Constraints](https://doi.org/10.3390/rs18183130)
...
### [223] [Dual-Stream Spatial–Spectral Network with Nested Attention for Hyperspectral Image Classification](https://doi.org/10.3390/rs18183126)
...
### [224] [Thorpe Analysis of Atmospheric Turbulence in Parts of Inner Mongolia and Guangdong, China, Based on a Round-Trip Intelligent Sounding System](https://doi.org/10.3390/rs18183133)
...
### [225] [Applying the IOTA2 Chain for Automated 10 m Crop Map Production in a Mediterranean Environment](https://doi.org/10.3390/rs18183118)
...
### [226] [DPFS-YOLO: Missed-Detection Alleviation and False-Detection Risk Suppression for Small Objects in Complex UAV Aerial Scenes](https://doi.org/10.3390/rs18183124)
...
### [227] [Adaptive Window-Width Trapezoidal Centroid Algorithm for High-Precision Pulsed LiDAR Ranging and Intensity Imaging](https://doi.org/10.3390/rs18183153)
...
### [228] [Polar Summer Snow and Ice Albedo Feedbacks Assessed by Satellite Observations and Radiative Kernels](https://doi.org/10.3390/rs18183135)
...
### [229] [A Magnetic Anomaly Detection Method Based on Multi-Feature Classification-Fusion Neural Network in Colored Noise Background](https://doi.org/10.3390/rs18183138)
...
### [230] [Extracting Summer-Harvested Crops in the Baojixia Irrigation District Using CycleGAN and Transfer Learning](https://doi.org/10.3390/rs18183155)
...
### [231] [Detecting Early Successional Stages in a Glacier Forefield Through a Hierarchical Sentinel-2 Classification Framework](https://doi.org/10.3390/rs18183140)
...
### [232] [LMCAN: A Lightweight Multiscale Contextual Attention Network for Hyperspectral and Multispectral Image Fusion](https://doi.org/10.3390/rs18183154)
...
### [233] [Mapping Native Grass Cover with Random Forest Models: Sentinel-2 Versus Sentinel-2 Combined with Sentinel-1 SAR-Derived GLCM Texture Metrics](https://doi.org/10.3390/rs18183150)
...
### [234] [Nonlinear Association and Spatial Heterogeneity Between Urban Vitality and Built Environment: Evidence from the Main Urban Area of Chengdu](https://doi.org/10.3390/rs18183159)
...
### [235] [LMAF-Net: Lightweight Multi-Attention Fusion Landslide Identification Network](https://doi.org/10.3390/rs18183141)
...
### [236] [Integrating Soil Data, Forest Habitat Types and NDVI to Assess Habitat Heterogeneity in Common Ash (Fraxinus excelsior L.) Stands](https://doi.org/10.3390/rs18183147)
...
### [237] [Interpretable Multi-Year Winter Wheat Mapping with Sentinel-1/2 Time Series: SHAP-Based Feature Selection and Bayesian-Optimized Machine Learning](https://doi.org/10.3390/rs18183137)
...
### [238] [From Wood–Foliar Semantics to 3D Fuel Characterization: Transferable Deep Learning for Terrestrial LiDAR Across Global Forest Ecosystems](https://doi.org/10.3390/rs18183158)
...
### [239] [Satellite Mapping of Annual Center Pivot Irrigation Expansion in Africa’s Hyper-Arid Regions from 1972 to 2025](https://doi.org/10.3390/rs18183142)
...
### [240] [Improving Crop-Type Mapping in Fragmented Agricultural Landscapes with Parcel Constraints and HLSS30-Derived Phenological Features](https://doi.org/10.3390/rs18183149)
...
### [241] [Self-Supervised 3D Point Cloud Detection with Depthwise Separable Masked Autoencoders](https://doi.org/10.3390/rs18183148)
...
### [242] [Comparison of EDGAR, ODIAC, and MEIC Grid CO2 Emission Inventories: Historical and Current Versions](https://doi.org/10.3390/rs18183144)
...
### [243] [Multi-Instrumental Evidence of the 2025 Absorbing Aerosol Perturbation at the RADO-Bucharest Observatory](https://doi.org/10.3390/rs18183143)
...
### [244] [Recurrent Landslide-Derived Debris Flows in the Yizhong River Basin: Geomorphic Controls, Structural Predisposition, and Rainfall-Driven Instability](https://doi.org/10.3390/rs18183139)
...
### [245] [Coseismic Slip Distribution and Coulomb Stress Changes of the 2024 Mw 7.0 Wushi Earthquake, Xinjiang, China](https://doi.org/10.3390/rs18183160)
...
### [246] [DMAM: Dynamic Multiscale Adaptive Mechanism-Driven Remote-Sensing Target Detection Network](https://doi.org/10.3390/rs18183145)
...
### [247] [TFSANet: Temporal Fusion and Structure-Aware Network for Remote Sensing Change Detection](https://doi.org/10.3390/rs18183151)
...
### [248] [Estimating Contents of Multiple Biomarkers in Medicago truncatula Under Salt Stress via Multi-Granularity Spectral Segmentation](https://doi.org/10.3390/rs18183146)
...
### [249] [Evidence-Based Reliability Assessment of Spatial Transfer Learning for Satellite-Derived Ground Deformation Monitoring](https://doi.org/10.3390/rs18183136)
...
### [250] [Attention-Enhanced Lightweight YOLO with Evolutionary Architecture Search for Insulator Defect Detection](https://doi.org/10.3390/rs18183152)
*Sheming Fan,Bin Cao*
...
### [251] [A Spectral Domain Interpolation Framework for Robust Hyperspectral Feature Construction Under Spectral Uncertainty](https://doi.org/10.3390/rs18183157)
...
### [252] [Ice Avalanche Hazard Assessment Using Multi-Source Geospatial Data and GWRF Model](https://doi.org/10.3390/rs18183156)
...
### [253] [Aboveground woody biomass regression and uncertainty estimation from spaceborne lidar and optical datasets](https://doi.org/10.1080/15481603.2026.2707801)
...
### [254] [Nonlinear responses of net ecosystem productivity to heatwaves over the Qinghai–Tibetan Plateau: insights from climate and vegetation](https://doi.org/10.1080/15481603.2026.2728311)
...
### [255] [MambaMPD: a mamba-driven segmentation framework for marine pollution detection from remote sensing imagery](https://doi.org/10.1080/15481603.2026.2730893)
...
### [256] [PELNet: A general physics-embedded learning framework for polarimetric target decomposition](https://doi.org/10.1016/j.isprsjprs.2026.08.040)
...
### [257] [Synergizing motion and depth: A distilled dual-branch network for moving infrared small target detection](https://doi.org/10.1016/j.isprsjprs.2026.08.038)
...
### [258] [Editorial Board](https://doi.org/10.1016/s0924-2716(26)00455-7)
*Unknown Author*
...
### [259] [Four decades of Landsat-based river turbidity reconstruction reveal spatially heterogeneous declines across U.S. rivers](https://doi.org/10.1016/j.isprsjprs.2026.09.007)
...
### [260] [WheatScoper: A lightweight organ-based framework for multi-view wheat phenotyping using time-series RGB images](https://doi.org/10.1016/j.isprsjprs.2026.08.039)
...
### [261] [An ensemble version of fire potential index (eFPI) integrating seasonal variability in sub-pixel fuel composition](https://doi.org/10.1016/j.isprsjprs.2026.09.010)
...
### [262] [Real-time image absolute orientation framework with Optical-GNSS data fusion for lightweight UAVs](https://doi.org/10.1016/j.isprsjprs.2026.09.005)
...
### [263] [SAAD-SR: A multi-altitude aerial object detection benchmark evaluated using an altitude-conditioned distillation detector](https://doi.org/10.1016/j.isprsjprs.2026.09.006)
...
### [264] [Space-time dynamics of rainfed wheat yield in Ethiopia: Insights from remote sensing](https://doi.org/10.1016/j.isprsjprs.2026.08.037)
...
### [265] [When multimodal fusion helps or hurts: Exploring modality synergy and cross-scene transferability for mangrove species mapping](https://doi.org/10.1016/j.isprsjprs.2026.08.036)

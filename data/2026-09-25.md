...
### [4] [A source–medium–receiver framework for modeling wind-driven vegetation cooling in urban landscapes](https://doi.org/10.1080/15481603.2026.2733792)
...
### [5] [Observation-constrained clear-sky direct radiative forcing of black carbon containing aerosols reveals distinct radiative regimes across urban Asia](https://doi.org/10.1016/j.rse.2026.115673)
...
### [6] [CEDA-Net: A cascade empirical–deep network for mitigating InSAR tropospheric delay in complex atmospheric and topographic conditions](https://doi.org/10.1016/j.rse.2026.115659)
...
### [7] [Detecting diurnal dynamics of cotton leaf inclination angle under water-salt stress](https://doi.org/10.1016/j.rse.2026.115674)
...
### [8] [Diurnal coupling of total column nitrogen dioxide and aerosol optical depth: Insights from the Pandora Asia network](https://doi.org/10.1016/j.rse.2026.115682)
...
### [9] [Bias-variance trade-off in radiative transfer model inversion drives uncertainty in leaf area index estimation](https://doi.org/10.1016/j.rse.2026.115662)
...
### [10] [Optically consistent multi-parameter aerosol retrieval from dual-satellite polarimetric observations enabled by physics-guided deep learning](https://doi.org/10.1016/j.rse.2026.115685)
...
### [11] [Can AlphaEarth foundations redefine the paradigm of gridded population mapping? A systematic evaluation across 18 global cities and large-scale mapping applications](https://doi.org/10.1016/j.rse.2026.115690)
...
### [12] [Spatiotemporal extension of all-sky downward shortwave radiation over mountainous area](https://doi.org/10.1016/j.rse.2026.115678)
...
### [13] [Fusing SAR and SWIM observations to improve the global stokes drift estimates](https://doi.org/10.1016/j.rse.2026.115687)
...
### [14] [Expert knowledge-guided decision calibration for accurate fine-grained tree species classification](https://doi.org/10.1016/j.isprsjprs.2026.09.013)
...
### [15] [DirPA: Addressing prior shift in imbalanced few-shot crop-type classification](https://doi.org/10.1016/j.isprsjprs.2026.08.016)
...
### [16] [Sketch and paint: A structural–temporal aware refinement network for fine-grained crop mapping on satellite image time series](https://doi.org/10.1016/j.isprsjprs.2026.09.009)
...
### [17] [An Adaptive Dynamic AI-driven ParameTerization (ADAPT) framework for global hourly gross primary productivity estimation](https://doi.org/10.1016/j.isprsjprs.2026.09.024)
...
### [18] [Spectral unmixing of hyperspectral lidar signals considering laser beam profile](https://doi.org/10.1016/j.isprsjprs.2026.09.011)
...
### [19] [Nested generative downscaling of passive microwave satellite data for navigation-scale Arctic sea ice forecasting](https://doi.org/10.1016/j.isprsjprs.2026.09.021)
...
### [20] [HELIOS-Net: Hourly daytime estimation of land surface temperature with integration of observational solar-cloud-satellite geometry and deep neural network](https://doi.org/10.1016/j.isprsjprs.2026.09.028)
...
### [21] [PatchFusion: Resilient LiDAR-camera fusion for point cloud semantic segmentation in autonomous driving](https://doi.org/10.1016/j.isprsjprs.2026.09.008)
...
### [22] [SNAIL-Radar-Indoor:A large-scale handheld LiDAR–4D radar–IMU dataset for robust SLAM in degraded environments](https://doi.org/10.1016/j.isprsjprs.2026.09.004)
...
### [23] [SaKD: Lightweight infrared small target detection via Spatial-Aware Knowledge Distillation for edge deployment](https://doi.org/10.1016/j.isprsjprs.2026.09.018)
...
### [24] [Resampling-free jitter-aware bundle adjustment for HiRISE multi-CCD stereo mapping on Mars](https://doi.org/10.1016/j.isprsjprs.2026.09.020)
...
### [25] [A multi-sensor and multi-temporal GeoAI framework for resolving ecological scale mismatch in Antarctica](https://doi.org/10.1016/j.isprsjprs.2026.09.016)
*Amarasingam Narmilan,Cassandra Newman,Melinda J. Waterman,Gabrielle Koerich,Elka Blackman,ASHRAY DOSHI,Len Norman Gillman,Charlotte V. Walshaw,Eva Bendix Nielsen,Tamara Pletzer,Johan Barthélemy,Sharon A. Robinson,Barbara A Bollard*
...
### [26] [Extending ocean color product to three dimensions assisted by high spectral resolution lidar data](https://doi.org/10.1016/j.isprsjprs.2026.09.029)
...
### [33] [Beyond Surface Style: Aligning Multi-Turn User Simulators with Behavioral Consistency](https://arxiv.org/abs/2609.28690)
...
### [34] [Driving Epidemic Models with AI Agents: the Epydemix Agent Framework](https://arxiv.org/abs/2609.28692)
...
### [35] [Progressive Skill Discovery as Access Control for Tool-Using LLM Agents: Structural Governance through Role-Scoped Capability Delivery](https://arxiv.org/abs/2609.28693)
...
### [44] [AlphaDiverse: Post-Training Local Quantitative Research Agents for Diverse Exploration in Alpha Factor Mining](https://arxiv.org/abs/2609.29014)
...
### [46] [SLCA-GRPO: Resolving Cross-Segment Credit Misattribution in Tool-Calling RL](https://arxiv.org/abs/2609.29050)
...
### [47] [From Self-Distillation to Self-Practice: Privileged Information for Multi-Turn Agents](https://arxiv.org/abs/2609.29051)
...
### [48] [CRISS: A Retrieval-Augmented AI Chatbot for Assisting Cancer Registrars](https://arxiv.org/abs/2609.29075)
...
### [49] [A Rapid Pipeline for Training and Deploying ML Models on WeBe Band](https://arxiv.org/abs/2609.29084)
...
### [50] [Functional Architecture of European Electricity Trading Markets: Requirements for AI Supported Trading Systems under Regulatory Constraints](https://arxiv.org/abs/2609.29108)
...
### [86] [HEXIS: Compiling Skills into Extended Finite State Machines](https://arxiv.org/abs/2609.30123)
*Minghao LI*
...
### [88] [EnigmaForge: The Question Is Hidden in the Story](https://arxiv.org/abs/2609.30144)
*Daniel Eisner*
...
### [89] [GRASP: Generating, Revising, and Assessing for Strategic Planning with Agentic AI](https://arxiv.org/abs/2609.30147)
...
### [90] [Search-Aware Reinforcement Learning for Multi-Component Query Understanding in Roblox Game Search](https://arxiv.org/abs/2609.30177)
...
### [91] [Jev-Mobile: Jev as an Executor for Mobile GUI Agents](https://arxiv.org/abs/2609.30186)
*Linghua Zhang*
...
### [92] [SAGE: Mitigating Long-Horizon Reasoning Biases via Topological Guidance](https://arxiv.org/abs/2609.30192)
...
### [93] [ExplorationBench: Measuring AI Systems' Exploration in Verifiable Alien Worlds](https://arxiv.org/abs/2609.30199)
...
### [94] [A Living Benchmark for Information Retrieval from Electronic Health Records](https://arxiv.org/abs/2609.30205)
...
### [97] [Enhanced early warning of extreme river discharge events in the Yangtze River Basin using atmospheric circulation signals](https://doi.org/10.1016/j.jag.2026.105590)
...
### [98] [Bridging cloud-induced gaps in MODIS leaf area index products using high-frequency geostationary satellite observations](https://doi.org/10.1016/j.jag.2026.105611)
...
### [99] [Learning instance-level semantic Gaussian representations for occlusion-aware urban scene reconstruction from UAV imagery](https://doi.org/10.1016/j.jag.2026.105574)
...
### [100] [Vegetation canopy height retrieval in complex mountainous regions based on data calibration and CNN model](https://doi.org/10.1016/j.jag.2026.105598)
...
### [101] [Automated conversion of unstructured mesh models to structured parametric CAD models for architectural applications](https://doi.org/10.1016/j.jag.2026.105583)
...
### [102] [Challenges in heating demand modelling based on the Kleczków district in Wrocław, Poland](https://doi.org/10.1016/j.jag.2026.105581)
...
### [103] [Biophysical effects of afforestation on local land surface temperature in china: A comprehensive analysis incorporating forest age and afforestation intensity](https://doi.org/10.1016/j.jag.2026.105593)
...
### [104] [A two-stage transformer framework for reconstructing hourly 1 km all-weather land surface temperature using cross-scale transfer learning](https://doi.org/10.1016/j.jag.2026.105602)
...
### [105] [AdaGeo-SR: Geo-semantic-guided super-resolution of sentinel-2 imagery with AlphaEarth foundation priors](https://doi.org/10.1016/j.jag.2026.105573)
...
### [106] [A spatiotemporal reconstruction framework for GRACE/GRACE-FO-derived groundwater storage anomalies based on historical phase-constrained gap filling and physics-guided global–local downscaling](https://doi.org/10.1016/j.jag.2026.105603)
...
### [107] [Adaptive background suppression-based plume identification, emission estimation, and ground validation of coal mine methane in Changzhi, Shanxi, China](https://doi.org/10.1016/j.jag.2026.105587)
...
### [108] [Kinematic pattern interpretation of railway-corridor deformation from InSAR time series with transfer learning-based TCN](https://doi.org/10.1016/j.jag.2026.105594)
...
### [109] [Relaxing the clear-sky assumption: Cloud-tolerant spatiotemporal fusion via mask-guided feature modulation and temporal-memory collaboration](https://doi.org/10.1016/j.jag.2026.105571)
...
### [110] [Estimating supraglacial lake bottom ablation rates by integrating ICESat-2 repeat track data and multi-temporal sentinel-2 imagery](https://doi.org/10.1016/j.jag.2026.105605)
...
### [111] [Analysis of intraday urban thermal anisotropy and downward shortwave radiation through UAV experiment and coupled model](https://doi.org/10.1016/j.jag.2026.105582)
...
### [112] [Remote-sensing-assisted and in situ-constrained reconstruction of 4-hourly chlorophyll-a dynamics in inland lakes using vision Mamba and temporal attention](https://doi.org/10.1016/j.jag.2026.105588)
...
### [113] [Reference-anchored envelope modelling for predicting tree mortality hotspots driven by drought](https://doi.org/10.1016/j.jag.2026.105609)
...
### [114] [A Targeted–Refined Framework for wind turbine detection integrating AlphaEarth Foundations and high-resolution multispectral satellite imagery](https://doi.org/10.1016/j.jag.2026.105604)
...
### [115] [Multi-angular assessment of early-season defoliation: Evaluating the sensitivity of vegetation indices to NPV visibility in temperate broadleaved forests](https://doi.org/10.1016/j.jag.2026.105575)
...
### [116] [Unsupervised soft-min fusion of multi-sensor turbidity products using Gaussian mixture models](https://doi.org/10.1016/j.jag.2026.105584)
...
### [117] [Downscaling of SMAP Soil Moisture Based on the Transformer Algorithm in Anhui Province](https://doi.org/10.3390/rs18193272)
...
### [118] [Cross-Regional Transfer Learning for Radar Echo Extrapolation in Northwestern Xinjiang, Western China](https://doi.org/10.3390/rs18183209)
...
### [119] [Real-Time Target Detection in Compressed Domain for Streak Tube LiDAR by Two-Pass Labeling and Sparse Attention](https://doi.org/10.3390/rs18183261)
...
### [120] [Disentangling Topographic Constraints and the Climatic and Anthropogenic Pathways Shaping Vegetation Greenness in the Southeastern Qinghai–Xizang Plateau](https://doi.org/10.3390/rs18183251)
...
### [121] [Assessment of Sea Surface Wind Measurements from Wave Gliders in Tropical Cyclones](https://doi.org/10.3390/rs18183213)
...
### [122] [Correction: Lv et al. Validation of Soil Temperature Sensing Depth Estimates Using High-Temporal Resolution Data from NEON and SMAP Missions. Remote Sens. 2025, 17, 3845](https://doi.org/10.3390/rs18183230)
...
### [123] [Motion-Guided Multi-Offset Detector-Native ReID Readout for Efficient UAV Multi-Object Tracking](https://doi.org/10.3390/rs18183238)
...
### [124] [The Five-Decade Landsat Legacy in Inland Water Quality: A Systematic Review of Technological and Methodological Evolution](https://doi.org/10.3390/rs18183237)
...
### [125] [Fine-Grained Tree Species Classification in Urban Forests via Phenology–Structure Synergistic Fusion of Multi-Source Remote Sensing Data](https://doi.org/10.3390/rs18183246)
...
### [126] [LiDAR-Based Sub-Canopy Surface Water Detection in a Post-Mining Environment](https://doi.org/10.3390/rs18183222)
...
### [127] [Reliability-Aware Dual-Stream Self-Training for Semi-Supervised Semantic Segmentation of High-Resolution Remote Sensing Imagery](https://doi.org/10.3390/rs18183257)
...
### [128] [Cross-Year Crop and Land-Cover Classification with Limited Labels](https://doi.org/10.3390/rs18183210)
...
### [129] [Frequency-Domain Feature Enhancement Combined with Contrastive Learning for Hyperspectral Image Open-Set Classification](https://doi.org/10.3390/rs18183256)
...
### [130] [ProG-Net: Prompted Guidance Network for Visible–Thermal Tiny-Object Detection](https://doi.org/10.3390/rs18183239)
...
### [131] [Assessing and Improving Geolocation of InSAR Scatterers with LiDAR Data](https://doi.org/10.3390/rs18183249)
...
### [132] [Rock Detection and Arability Mapping Using Airborne LiDAR-RGB Fusion and Machine Learning](https://doi.org/10.3390/rs18183240)
...
### [133] [FuzzyQSM: A Novel Tree Structure Reconstruction Approach Using Uncertainty](https://doi.org/10.3390/rs18183244)
...
### [134] [Dual-Branch GCN-Mamba Network with Semantic-Guided Meta-Learning for Multimodal Remote Sensing Classification](https://doi.org/10.3390/rs18183218)
...
### [135] [Evaluating Remote Sensing Foundation Model Embeddings for Cross-City Thematic Mapping of Eucalyptus Plantations in Guangxi, China](https://doi.org/10.3390/rs18183248)
...
### [136] [Generating Annual 10 m Land Cover Maps for 37 Chinese Metropolises Using Google Satellite Embeddings](https://doi.org/10.3390/rs18183233)
...
### [137] [Surface Soil Moisture from Sentinel-2 Imagery: A Systematic Review Complemented by a Case Study in Sardinia, Italy](https://doi.org/10.3390/rs18183262)
...
### [138] [Nonlinear Latent-Space Data Assimilation for Sea Surface Height Reconstruction from Sparse Observations](https://doi.org/10.3390/rs18183221)
...
### [139] [Kinematics of the Haiyuan Fault (Northwest China) Prior to the 2022 Menyuan Mw 6.7 Earthquake](https://doi.org/10.3390/rs18183232)
...
### [140] [HiSGD: High–Low Spectral Gradient Decoupling for Heterogeneous Distillation in Infrared Small-Target Detection](https://doi.org/10.3390/rs18183215)
...
### [141] [Cross-Regional Classification of Rice Cropping Systems Based on Within-Year Seasonal Composition Using Multimodal Remote-Sensing Time Series](https://doi.org/10.3390/rs18183241)
...
### [142] [SDR-YOLO: Scale-Selective Detail Residual Enhanced YOLO for Visible–Thermal Object Detection](https://doi.org/10.3390/rs18183216)
...
### [143] [Improving the Quality of the Surface Heat Flux Data over the Tibetan Plateau by Using an Optuna–CatBoost–Shapley Additive exPlanation Method](https://doi.org/10.3390/rs18183242)
...
### [144] [A Physics-Guided Diffusion Framework for Mars Rover Image Restoration Under Atmospheric Dust](https://doi.org/10.3390/rs18183224)
...
### [145] [Optical-Algorithm Co-Design of a Lightweight Petzval Star Tracker with Selective Asymmetric Aberration Suppression](https://doi.org/10.3390/rs18183243)
...
### [146] [SAR-Based Monitoring of Maize Phenology in the High-Yielding Mpumalanga Province of South Africa](https://doi.org/10.3390/rs18183231)
...
### [147] [A Scene Classification Method for Dead-End Road Association Zones in Mountainous Areas Using Optical Remote Sensing](https://doi.org/10.3390/rs18183214)
...
### [148] [Anomaly-Driven Gated Fusion Network for Infrared Small Target Detection](https://doi.org/10.3390/rs18183247)
...
### [149] [Acquisition-Level Optimization of Split-Spectrum TEC Observability in L-Band InSAR](https://doi.org/10.3390/rs18183217)
...
### [150] [SHALA: Sparse Hierarchical Alignment for Visible-Infrared Vehicle Re-Identification Under Aerial-Ground Viewpoint Gaps](https://doi.org/10.3390/rs18183219)
...
### [151] [Label-Efficient Semi-Supervised Building Semantic Segmentation for High-Resolution UAV Imagery](https://doi.org/10.3390/rs18183250)
...
### [152] [Atmospheric Water Vapor Monitoring on Horseshoe Island, Antarctica: GNSS Observations at the Permanent TUR1 and TUR2 Stations Using a Regional Tm Calibration](https://doi.org/10.3390/rs18183226)
...
### [153] [SASI-Net: A Sparse Adaptive SAR Imaging Network with Complex-Valued Mask-Aware Completion and Adaptive Truncated Penalty](https://doi.org/10.3390/rs18183255)
...
### [154] [Case Studies of Environmental Monitoring Based on the Integrated Use of Bioindicators and Remote Sensing](https://doi.org/10.3390/rs18183227)
...
### [155] [Temporal Lag and Response Characteristics of Runoff and Its Components in a Glacial Basin](https://doi.org/10.3390/rs18183235)
...
### [156] [WSF-YOLO: Wavelet-Guided Spatial–Frequency Joint Modeling for Aircraft Detection in SAR Images](https://doi.org/10.3390/rs18183254)
...
### [157] [An Ensemble-Based Transfer Learning Framework Using EfficientNetV2 and MobileNetV2 for Satellite Image Classification of Wildfires](https://doi.org/10.3390/rs18183212)
...
### [158] [Comparing Irrigation Identification Methods in Colorado: Limitations of Downscaled SMAP Soil Moisture](https://doi.org/10.3390/rs18183223)
...
### [159] [Early Detection of Pine Wilt Disease at the Pre-Visual Stage Using UAV-Based Hyperspectral Imagery](https://doi.org/10.3390/rs18183229)
...
### [160] [Dynamic Monthly Population-Exposure-Based Flash-Flood Risk Mapping Using an Explainable XGBoost Framework](https://doi.org/10.3390/rs18183253)
...
### [161] [Bridging Temporal Gaps in Thermal Remote Sensing: A Generative Adversarial Network Approach to Land-Cover-Stratified Diurnal Heat Retention in Peri-Urban Landscapes](https://doi.org/10.3390/rs18183259)
...
### [162] [Assessing the Sensitivity of Sentinel-1 and Sentinel-2 Time Series to Wheat Yellow Rust Using Feature Evaluation, Separability, and Random Forest Classification](https://doi.org/10.3390/rs18183252)
...
### [163] [A Vegetation Growth Pattern-Constrained Interpolation Method for High-Resolution Daily FPAR/LAI Reconstruction and NPP Spatial Disaggregation](https://doi.org/10.3390/rs18183211)
...
### [164] [Potential Earthquake-Triggered Landslide Susceptibility Mapping Integrating Deterministic Ground Motion Simulation and Machine Learning: A Case Study of the Litang Fault Zone](https://doi.org/10.3390/rs18183245)
...
### [165] [MSFFusion: Multi-Level Shallow Feature Fusion Network for Pansharpening](https://doi.org/10.3390/rs18183236)
...
### [166] [Boundary-Aware Attention-Enhanced DeepLabV3+ for Landslide Segmentation Along the Sichuan–Tibet Transportation Corridor](https://doi.org/10.3390/rs18183220)
...
### [167] [Experimental Assessment of Microwave Penetration Depth in Layered Soil by Wideband (0.3–6 GHz) Transmissometry and Reflectometry](https://doi.org/10.3390/rs18183258)
...
### [168] [Region and Boundary Accuracy in Zero-Shot Shoreline Extraction: A Benchmark of Segmentation-Native Vision-Language Models and Prompted SAM Pipelines](https://doi.org/10.3390/rs18183228)
...
### [169] [Data Processing and Quality Control of the CW193 Sun Photometer Network and Evaluation of Satellite Aerosol Products](https://doi.org/10.3390/rs18183225)
...
### [170] [Optimization of Farmland Management Zoning in the Black Soil Region: A Climate Adaptability Assessment Considering Crop Growth Response and Topographic Characteristics](https://doi.org/10.3390/rs18183260)
...
### [171] [FCD-Mamba: A Frequency-Enhanced and Center-Pixel-Guided Dual-Branch Mamba Network for Hyperspectral Image Classification](https://doi.org/10.3390/rs18183234)
...
### [172] [National-Scale Flood Susceptibility Mapping of Nigeria Using Statistical and Machine Learning Models with Satellite-Driven Validation for Data-Sparse Environments](https://doi.org/10.3390/rs18193264)
...
### [173] [Estimating Ground-Level PM2.5 over Beijing–Tianjin–Hebei from DQ-1 Wide-Swath Imager Signals and ERA5 Meteorology Using Physics-Guided Feature Engineering](https://doi.org/10.3390/rs18193266)
...
### [174] [CYGNSS Soil Moisture Performance in Guinea Savanna Region: Extended and Quadruple Collocation Evidence from Benue State, Nigeria](https://doi.org/10.3390/rs18193267)
...
### [175] [From Pixel Receptive Fields to Ground Spans: GSD-Conditioned Cross-Resolution Feature Alignment for Photovoltaic Detection and Segmentation](https://doi.org/10.3390/rs18193263)
...
### [176] [Satellite-Based Seasonal Monitoring of PM2.5-Related Trace Gases and Aerosol Loading over the Lazio Region](https://doi.org/10.3390/rs18193265)
...
### [177] [Triple-Level Topology Awareness Using Hypergraph for Marine Ship Surveillance from SAR Imagery](https://doi.org/10.3390/rs18193268)
...
### [178] [Daily Lake-Surface NDVI Reconstruction Using Multi-Source Machine Learning Under Incomplete Optical Observations](https://doi.org/10.3390/rs18193269)
...
### [179] [MHBA-TransUNet: Shallow–Deep Collaborative RGB–DSM Fusion with Hybrid Bidirectional Attention for High-Resolution Remote Sensing Semantic Segmentation](https://doi.org/10.3390/rs18193271)
...
### [180] [Simulation of Equatorial Plasma Bubble Signatures in GNSS TEC](https://doi.org/10.3390/rs18193273)
...
### [181] [SWOT Wide-Swath Altimetry for Inland-Water Remote Sensing: Applications, Challenges, and Prospects—A Systematic Bibliometric and Thematic Review](https://doi.org/10.3390/rs18193274)
...
### [182] [TCSF-Net: Transformer-Cloth Simulation Filtering Fusion Network for Semantic Segmentation of Densely Vegetated River Levee LiDAR Point Clouds](https://doi.org/10.3390/rs18193287)
...
### [183] [RASM-Net: A Reliability-Aware Structural and Multiscale Modeling Network for RGB-T Object Detection in Complex Environments](https://doi.org/10.3390/rs18193288)
...
### [184] [Surface Roughness and Chemical Weathering of Fluvial Geomorphic Surfaces: A Case Study from Qingyi River, Eastern Tibetan Plateau](https://doi.org/10.3390/rs18193279)
...
### [185] [Sentinel-2-Based Estimation and Mapping of Rice Grain Total Amino Acid Content Using Fractional-Order Multiband Spectral Indices and Feature Selection](https://doi.org/10.3390/rs18193286)
...
### [186] [Downscaling SMAP Soil Moisture to 250 m Using Deep Learning Models and Multi-Source Environmental Variables over the Loess Plateau](https://doi.org/10.3390/rs18193285)
...
### [187] [Mapping Active Surface Deformation in Fusagasugá and Silvania, Colombia, Using Sentinel-1 SBAS-InSAR and Campaign GNSS Observations](https://doi.org/10.3390/rs18193284)
...
### [188] [RGB-to-Multispectral Reconstruction with Spectral Attention and Non-Adversarial Perceptual Loss](https://doi.org/10.3390/rs18193291)
...
### [189] [CoGLoR: Collaborative Global–Local Representation Learning for Remote Sensing Scene Classification](https://doi.org/10.3390/rs18193281)
...
### [190] [Climatic and Tectonic Controls on Late Quaternary Fluvial Terrace Development in the Turpan Fold–Thrust Belt, Eastern Tianshan](https://doi.org/10.3390/rs18193276)
...
### [191] [PineSight: The Model Improving Pine Wilt Disease Detection in Illumination-Degraded UAV Imagery](https://doi.org/10.3390/rs18193280)
...
### [192] [Multi-Source Remote Sensing Data Reveal the Instability Evolution and Precursory Signals Before the Collapse of the Aru Glaciers on the Tibetan Plateau](https://doi.org/10.3390/rs18193277)
...
### [193] [Assessing the Role of Global Satellite-Derived SIF and Vegetation Traits as Proxy Predictors of Gross Primary Productivity](https://doi.org/10.3390/rs18193278)
...
### [194] [PEGNet: A Peridynamics-Inspired and Emergent-Feature-Conditioned Spatio-Temporal Graph Neural Network for Land Subsidence Modeling](https://doi.org/10.3390/rs18193282)
...
### [195] [Developing a Transfer Learning-Based Deep Learning Model for Visible Cadastral Boundary Delineation in Nepal](https://doi.org/10.3390/rs18193283)
...
### [196] [Vicarious Calibration of Thermal Infrared Imagers Using Thermophysical Models of the Lunar Surface](https://doi.org/10.3390/rs18193275)
...
### [197] [DLMBMT: A Deep Learning Method Based on the Multi-Scale Technique for Hyperspectral Image Classification with Limited Training Samples](https://doi.org/10.3390/rs18193289)
...
### [198] [Debris-Flow Hazard Assessment Considering Dynamic Characteristics Index with High-Resolution Topography in Duoxiongla Valley (China)](https://doi.org/10.3390/rs18193290)

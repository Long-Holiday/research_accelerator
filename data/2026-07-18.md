...
- [Remote Sensing](#Remote Sensing) [Total: 54]
...
Abstract (英文): Text-to-video (T2V) generators can synthesize realistic and temporally coherent videos, but controllably removing a target concept from a generator remains difficult.
...
Abstract (英文): Person re-identification (ReID) serves as a critical component in intelligent surveillance systems, aiming to match identities across disjoint camera networks. While traditional methods primarily rely on single-modal RGB imagery, they are often constrained by environmental challenges such as low illumination and occlusion. To overcome these limitations, the field is rapidly evolving toward cross-modal and multi-modal paradigms. This survey presents a comprehensive overview of this transition, systematically reviewing key cross-modal tasks including visible-infrared (VI-ReID), text-image (TI-ReID), sketch-based (Sketch-ReID), and the emerging Non-Line-of-Sight (NLOS) ReID, which extends perception beyond direct visibility. Furthermore, we examine tri-spectral and multi-modal fusion ReID, discussing how complementary information from diverse sensors enhances robustness. Beyond summarizing datasets, challenges, and methodologies, we propose a Transformer-based baseline framework for visible-infrared ReID, designed to effectively capture modality-invariant features. Finally, based on the current landscape, we outline several promising directions for future research.
...
### [93] [UniOrtho: From view-centric to unified orthographic framework for satellite semantic 3D reconstruction](https://doi.org/10.1016/j.isprsjprs.2026.06.039)
...
### [94] [DG-SLAM: A hybrid direct georeferencing and SLAM framework for real-time orthophoto mapping in weak-textured environments](https://doi.org/10.1016/j.isprsjprs.2026.07.004)
...
### [95] [Optimizing 1D-Var near-surface wind speed from SSMIS with RapidScat](https://doi.org/10.1016/j.rse.2026.115560)
...
### [96] [Seasonal mass balance of Hofsjökull ice cap, Iceland, estimated from repeat ICESat-2 satellite altimetry](https://doi.org/10.1016/j.rse.2026.115555)
...
### [97] [Synergistic analysis and vertical transport attribution of carbon monoxide surface concentrations and satellite column loadings over China](https://doi.org/10.1016/j.rse.2026.115562)
...
### [98] [A hybrid machine learning and data assimilation framework for penman–monteith evapotranspiration estimation over China](https://doi.org/10.1016/j.rse.2026.115565)
...
### [99] [An improved 15-year record of ice sheet elevation from CryoSat-2 radar altimetry](https://doi.org/10.1016/j.rse.2026.115561)
...
### [100] [Probability of detection for airborne sensing of methane plumes using long wavelength infrared hyperspectral imaging](https://doi.org/10.1016/j.rse.2026.115556)
...
### [101] [Coupling functional heterogeneity activation and distance impedance: a distance-decay model for urban population spatial interactions](https://doi.org/10.1080/15481603.2026.2698143)
...
### [102] [A Hybrid Window Transformer for accurate and generalizable soil salinity prediction across China](https://doi.org/10.1080/15481603.2026.2700119)
...
### [103] [PADS: a partitioned adaptive data synthesis framework integrating SMOGN and adaptive data selection for small-sample maize yield prediction](https://doi.org/10.1080/15481603.2026.2703926)
...
### [104] [Advancing aboveground biomass mapping in Alaska's boreal forest using UAVSAR polarimetric features and NDVI-normalized field data](https://doi.org/10.1080/15481603.2026.2703308)
...
### [105] [Understanding sensitivity and accuracy of time-series change detection algorithm across multiple land disturbance scenarios](https://doi.org/10.1080/15481603.2026.2699520)
...
### [106] [Mapping annual 10-meter evergreen and non-evergreen forests in China from 2017 to 2023 with multi-source remote sensing data](https://doi.org/10.1080/15481603.2026.2702254)
...
### [107] [A New Deep Learning Method for Sea Fog Detection Using Fengyun-4A Satellite Data](https://doi.org/10.3390/rs18142334)
...
### [108] [Category-Aware Global–Local Semantic Alignment for Remote Sensing Image–Text Retrieval](https://doi.org/10.3390/rs18142335)
*Da Ha,Haisu Zhang*
...
### [109] [Deconstructing and Ameliorating Woody Volume Estimation Errors Arising from Leaves in Quantitative Structure Models of Trees](https://doi.org/10.3390/rs18142342)
...
### [110] [Decoupling Deep Mining and Tailings Consolidation-Induced Subsidence Using SBAS-InSAR and NMF: A Case Study at South Deep Gold Mine, South Africa](https://doi.org/10.3390/rs18142337)
...
### [111] [Spatiotemporal Variations in Terrestrial Water Storage and Water Scarcity Assessment Across China Based on TWSA_BTCH](https://doi.org/10.3390/rs18142324)
*Yue Ma,Longfeng Wang,Z-Y Zheng,Weiwei Li,Z H,Junjie Zhao,Yuejun Zheng,Yawen Duan,Xubo Gao*
...
Abstract (英文): Clarifying the spatiotemporal variations of terrestrial water storage anomaly (TWSA) and the water scarcity is crucial for maintaining water resources, ecosystem and food security. This study adopts the Bayesian triple collocation method (BTCH) method to fuse three GRACE Mascon product datasets to generate the TWSA_BTCH, covering the period from April 2002 to December 2023. The reliability of TWSA_BTCH is further verified using the water balance approach. The spatiotemporal variations of TWSA and the water scarcity index based on terrestrial water storage (WSTWS_based) at the national and primary water resource regional level are then analyzed. The results indicate that: (1) The spatially averaged uncertainty of the TWSA_BTCH over China is 8.13 mm, which is lower than those of TWSA_average (12.51 mm), TWSA_CSR (23.43 mm), TWSA_GSFC (29.79 mm), and TWSA_JPL (31.76 mm). (2) From 2003 to 2023, the TWSA exhibited an overall significant declining trend with an annual depletion rate of 1.65 mm. The national average value of the WSTWS_based index decreased from 0.32 during 2003–2012 to 0.28 over 2013–2023, which indicates that the pressure of nationwide water scarcity has been alleviated to a certain extent, while the whole country still faces a moderate water shortage status. Meanwhile, the mean annual TWSA across China during 2003–2023 was −10.28 mm, indicating a nationwide terrestrial water storage deficit. (3) Regional water resource risks require joint characterization from the dual perspectives of hydrological fluxes and storage. Northern arid and semi-arid regions feature inherent imbalances between water supply and demand. The latent risks of terrestrial water storage depletion within the SWRB cannot be ignored. In addition, insufficient water regulation capacity in the SRB deserves adequate attention.

</details>


### [112] [UAV 3D Scene Understanding: A Survey from an Agent-Capability Evolution Perspective](https://doi.org/10.3390/rs18142323)
*Enze Zhu,Luxiao Xu,Zhan Chen,Cui J,Yi-Xiang Wang,Yongkang Zou,Kaibo Yang,Xiaoxuan Liu,Xiyu Qi,Lei Wang*
...
### [114] [Normalized Dynamic Fluorescence Height: An Alternative Algorithm for Chlorophyll a Estimation in Algae-Dominated Waters Using Hyperspectral Remote Sensing Reflectance from In Situ and Spaceborne Imagers](https://doi.org/10.3390/rs18142332)
...
### [115] [Assessing the Capabilities of UAV-Based Observation for Marginalized Communities: A Case Study of Roma Settlements in Slovakia](https://doi.org/10.3390/rs18142326)
*Farzaneh Dadrass Javan,Lukáš Ihnacik,Peter Blišťan,MohammadReza Homaei,Ingrid Papajova,Carmen Anthonj*
...
### [119] [ECDF-Stabilized Sentinel-1 InSAR Coherence for Verification-Oriented Heritage Monitoring: A TabICLv2-SHAP and Three-Horizon DEMATEL Architecture](https://doi.org/10.3390/rs18142325)
*Salvatore Polverino,Hourakhsh Ahmadnia,Rokhsaneh Rahbarianyazd Ahmadnia,Abdollah Mobaraki,Behnam Mobaraki*
...
### [122] [IC-EWH: Energy-Weighted Hough Transform with Iterative Curvature Compensation for Squint Angle Estimation of Highly Squinted SAR](https://doi.org/10.3390/rs18142344)
...
### [123] [Target Detection for UAV Inspection in Complex Illumination Environments: A Lightweight Dual-Modal Fusion Method with Multi-Directional Mamba Cross-Attention](https://doi.org/10.3390/rs18142329)
*Ziyue Luo,Ziyi Zhou,Haishan Tian,Ziyi Zhong,Kewei Li,Yujie Ma,Weiwei Tang,K Z Wang*
...
### [125] [Enhancing the Estimation and Mapping of Soil Cadmium by Using Geospatial Information-Guided Machine Learning and Principal Component Spectra](https://doi.org/10.3390/rs18142341)
...
### [126] [Physics-Guided cGAN with Multi-Scale Attention for Robust 2D Phase Unwrapping in Low-Coherence Regions](https://doi.org/10.3390/rs18142338)
...
### [127] [Optimizing Spectral Inputs for Deep Learning-Based Vegetation Destruction Detection Using Sentinel-2 Imagery](https://doi.org/10.3390/rs18142333)
...
### [128] [Flood Regulation Service Responses to Urban Green Space Change in a Plateau Valley City: A Case Study of Lhasa, China](https://doi.org/10.3390/rs18142331)
*Shouhang Zhao,Aibo Jin,Yan Xu,Y Li,Y Li,Qin Yang,Tingting Ding,Y Li,Y Li*
...
### [130] [Satellite Embedding Features for Grassland Aboveground Biomass Estimation in Complex Mountainous Terrain: A Case Study of the Three Parallel Rivers Region, China](https://doi.org/10.3390/rs18142348)
...
### [131] [Insta-BDA: Instance-Aware Building Damage Assessment and Counting via Foundation Model Fusion](https://doi.org/10.3390/rs18142347)
...
### [132] [A Method for Extracting Small Moving Targets Based on Temporal and Spatial Saliency Features](https://doi.org/10.3390/rs18142349)
...
### [133] [Fed-RSAdapter: Federated Fine-Tuning of Remote Sensing Images via Multi-Scale Adapter Modules](https://doi.org/10.3390/rs18142352)
...
### [134] [Long-Term Vegetation Dynamics Across Distance Buffers Along the Gonghe–Yushu Expressway Corridor on the Qinghai–Xizang Plateau](https://doi.org/10.3390/rs18142354)
...
### [135] [Estimating Actual Evapotranspiration in Orchard Systems Using the ALARM Energy Balance Model and MODIS Data](https://doi.org/10.3390/rs18142351)
...
### [136] [Spectral-Prior-Guided Swin TransUnet for Sparse-Aperture FMCW MIMO-SAR Imaging](https://doi.org/10.3390/rs18142350)
...
### [137] [Remote Sensing of Coastal Saline-Alkali Land in China: Progress in Identification, Ecological Restoration, and Sustainable Management](https://doi.org/10.3390/rs18142345)
...
### [138] [Land Use/Land Cover Classification of the Qinghai Lake Basin Using Multitemporal Sentinel-1/2 Imagery](https://doi.org/10.3390/rs18142353)
...
### [139] [Enabling More Efficient Dynamic Earth Observation: Wide-Area, High-Resolution Dual-Axis Bidirectional Scanning Imaging and the Associated Multi-Parameter Optimization](https://doi.org/10.3390/rs18142364)
...
### [140] [Marine Heatwaves and NAO-Related Ocean–Atmosphere Variability in the North Atlantic](https://doi.org/10.3390/rs18142363)
...
### [141] [GENCP: GAN-Based Ground Control Point Generation for Satellite Image Georeferencing](https://doi.org/10.3390/rs18142356)
...
### [142] [Residual Noise Learning for Atmospheric Correction of InSAR Unwrapped Maps](https://doi.org/10.3390/rs18142359)
...
### [143] [Hyperspectral Imaging of Seagrass and Macroalgae Using Uncrewed Aerial and Surface Vehicles for Coastal Habitat Mapping](https://doi.org/10.3390/rs18142361)
...
### [144] [ESGS: A 3D Reconstruction Method for the Martian Surface Based on Optical Remote Sensing Images](https://doi.org/10.3390/rs18142357)
...
### [145] [SFE-FM: A Dual-Branch Network with Spectral Feature Enhancement and Feature Mixing for Hyperspectral Image Classification](https://doi.org/10.3390/rs18142362)
...
### [146] [AVANET: A Multiscale Weak-Texture-Aware Network for Snow Avalanche Recognition Using Aerial Imagery](https://doi.org/10.3390/rs18142358)
...
### [147] [Forest Fire Monitoring Based on Cloud Parameters: A Case Study in Southern Hunan](https://doi.org/10.3390/rs18142360)
...
### [148] [Toward Remote Sensing of Wildland Fuel Combustibility: A Pilot Study Evaluating an Experimental Method to Link Fuel Spectral Reflectance with Fire Behaviour and Emissions](https://doi.org/10.3390/rs18142355)
...
### [149] [A Remote Sensing-Based Groundwater Level Monitoring System Using Machine Learning](https://doi.org/10.3390/rs18142372)
...
### [150] [High-Precision Flood Extraction from High-Resolution Remote Sensing Images by Integrating FCN-RAM and Tolerance Rough Set](https://doi.org/10.3390/rs18142373)
...
### [151] [Earth Observation-Driven Inference for Level-4 Terrestrial Products: Process-Based, Machine Learning, and Hybrid Frameworks](https://doi.org/10.3390/rs18142371)
...
### [152] [A Dynamic Irrigation Event Identification Method Driven by Spatiotemporal Fusion and Dynamic Samples Using an Attention-Enhanced Bi-LSTM Model](https://doi.org/10.3390/rs18142367)
...
### [153] [A Coupled Spatiotemporal Stability and Multi-Source Physical Constraint Method for Glacial Lake Extraction: A Case Study in the Central Himalayas](https://doi.org/10.3390/rs18142370)
...
### [154] [Fine-Scale Spartina alterniflora Mapping Using Advanced Deep Learning and High-Resolution UAV Imagery](https://doi.org/10.3390/rs18142375)
...
### [155] [MambaHSINet: A Dual-Branch Bidirectional State Space Network for Hyperspectral Tree Species Classification](https://doi.org/10.3390/rs18142368)
...
### [156] [Freeze–Thaw State Detection over the Mid-to-High Latitudes of the Northern Hemisphere Using Tianmu-1 Multi-GNSS-R](https://doi.org/10.3390/rs18142369)
...
### [157] [A Lightweight Field-to-Site Coupled Framework for 15-Day Sea Surface Temperature Forecasting in Marine Ranching Areas: A Case Study in the Northern Yellow Sea](https://doi.org/10.3390/rs18142374)
...
### [158] [Mapping Potential Groundwater Discharge Indicators in Urban Rivers: A Thermal Remote Sensing and Machine-Learning Approach for Tangshan City](https://doi.org/10.3390/rs18142376)
...
### [159] [Comparing Low-Cost DIY and Research-Grade Hyperspectral Imaging as Coral Reef Monitoring Tools](https://doi.org/10.3390/rs18142366)
...
### [160] [Variation and Transport Characteristics of Atmospheric SF6 Column Concentrations over Hefei Retrieved from Ground-Based Remote Sensing Observations](https://doi.org/10.3390/rs18142365)
...
### [161] [Intelligent Three Level Learning Architecture for Autonomous UAV Swarms in Search and Rescue](https://arxiv.org/abs/2607.14093)
*Oleksii Bychkov*
...
### [162] [HG-RAG: Hierarchy-Guided Retrieval-Augmented Generation for Structured Knowledge Graphs](https://arxiv.org/abs/2607.14095)
*Pranav Yadav*
...
### [170] [Enhancing Small Language Models Reasoning through Knowledge Graph Grounding](https://arxiv.org/abs/2607.14149)
...
### [179] [Automatic Hard Example Synthesis with Multi-Level Agentic Data Curation](https://arxiv.org/abs/2607.14256)
...
### [194] [SAGA: Schema-Aware Grounding for Agentic Text-to-SPARQL Generation](https://arxiv.org/abs/2607.14494)
...
### [204] [Collaborative Spatial Learning with Multi-LLM Agents in Networked Social Experiments](https://arxiv.org/abs/2607.14574)
...
### [206] [MathCoPilot: An Interactive System for Human-AI Symbiotic Paradigm of Mathematical Research](https://arxiv.org/abs/2607.14582)
...
### [217] [Global Index on Responsible AI: 2026 Report](https://arxiv.org/abs/2607.14782)
...
Abstract (英文): Autonomous coding agents increasingly execute multi-step software work, but lifecycle states such as reviewed, tested, DONE, and ready-to-merge remain claims unless supported by current evidence. We present Proof-or-Stop Lifecycle Control, a method that permits lifecycle transitions only when fresh, tracked-source-state-bound, mechanically verifiable evidence satisfies the relevant gate. The method treats agent outputs as claims rather than lifecycle state, and uses proof operationally to mean gate-admissible evidence under a stated trust model, not semantic program correctness.
...
### [231] [Concept-Guided Spatial Regularization for World Models in Atari Pong](https://arxiv.org/abs/2607.15142)
...
Abstract (英文): World models are usually evaluated as components of model-based reinforcement learning (MBRL) systems, while the world models themselves are rarely studied in isolation.
...
### [232] [The Industrialization of Research ; On AI-Driven Science and Its Consequences](https://arxiv.org/abs/2607.15164)
*Emmanuel Jeannot*
...
Abstract (英文): Most medical AI benchmarks measure whether a model knows the correct answer. MedFailBench asks a different question: which safety boundary failed? We present a clinician-built synthetic benchmark and failure atlas that labels medical AI errors by severity (1--5) and safety gate type (missed urgent escalation, unsafe remote dosing, unsafe discharge reassurance, evidence fabrication, unsafe protocol execution, source support gap). The current public release (v0.2.1) contains 44 clinician-reviewed synthetic cases with severity annotations, a live HuggingFace leaderboard preview, a safety gate taxonomy, a clinical severity rubric, and an automated pipeline for archiving model-response screening runs. No patient data, clinical validation claims, or model rankings are included. MedFailBench is released under Apache-2.0 and CC-BY-4.0 and carries the Zenodo DOI 10.5281/zenodo.21205535.

</details>


### [234] [Benchmarking Multimodal Large Language Models for Scientific Visualization Literacy](https://arxiv.org/abs/2607.15176)
...
### [242] [Pretraining Data Can Be Poisoned through Computational Propaganda](https://arxiv.org/abs/2607.15267)
...
### [243] [Reproducible mapping of marine biodiversity using autonomous surface vehicles and deep learning](https://doi.org/10.1016/j.jag.2026.105462)
...
### [244] [Label-efficient mapping of unregulated waste dumps via mixed supervision with feature masked recovery](https://doi.org/10.1016/j.jag.2026.105471)
...
### [245] [BLB_TVI: A hyperspectral triangular index for satellite-scale characterization of rice bacterial leaf blight severity](https://doi.org/10.1016/j.jag.2026.105472)
...
### [246] [Individual urban street tree detection and species-level mapping from street-view images and GIS data](https://doi.org/10.1016/j.jag.2026.105449)
...
### [247] [A high-resolution interchange classification model enhanced by multi-scale geometric structural feature fusion](https://doi.org/10.1016/j.jag.2026.105450)
...
### [248] [From flood extent mapping to mechanism-aware flood products: integrating flood type classification into satellite-based flood monitoring](https://doi.org/10.1016/j.jag.2026.105482)
...
### [249] [Spatiotemporal bias in OCO-2 XCO2 retrievals relative to TCCON observations](https://doi.org/10.1016/j.jag.2026.105466)
...
### [250] [Satellite evidence of reduced resistance and resilience to water stress after antecedent fire across a rainfall gradient in northern Australia](https://doi.org/10.1016/j.jag.2026.105478)
...
### [251] [The impacts of cover crop biomass on satellite-based detectability of cover crops in Maryland](https://doi.org/10.1016/j.jag.2026.105453)
...
### [252] [A PROSPECT-guided multi-task learning hybrid framework for simultaneous retrieval of leaf chlorophyll and carotenoids](https://doi.org/10.1016/j.jag.2026.105467)

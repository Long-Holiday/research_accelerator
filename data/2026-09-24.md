...
### [7] [A source–medium–receiver framework for modeling wind-driven vegetation cooling in urban landscapes](https://doi.org/10.1080/15481603.2026.2733792)
...
### [8] [Correction](https://doi.org/10.1080/15481603.2026.2736374)
*Unknown Author*
...
### [9] [Reliable Sar oil-spill segmentation for marine monitoring Via self-supervised denoising and lightweight wavelet–state-space modeling](https://doi.org/10.1080/15481603.2026.2727781)
...
### [10] [Global daily joint reconstruction of TROPOMI tropospheric No 2 columns and averaging kernels with temporally aware deep learning](https://doi.org/10.1080/15481603.2026.2732650)
...
### [11] [Downscaling of SMAP Soil Moisture Based on the Transformer Algorithm in Anhui Province](https://doi.org/10.3390/rs18193272)
...
### [12] [TOTMSeg: A Texture-Aware Octree-Based Transformer-Mamba Framework for Large-Scale Urban Mesh Semantic Segmentation](https://doi.org/10.3390/rs18183198)
...
### [13] [Reading the Void: A Reconstructive Hypothesis for a Service Staircase at the Infantado Palace in Guadalajara Using TLS](https://doi.org/10.3390/rs18183200)
...
### [14] [Spatial Prediction and Performance Comparison of Soil Organic Carbon in High-Latitude Forest Soils Based on Multiple Feature Selection Methods and Machine Learning Models](https://doi.org/10.3390/rs18183199)
...
### [15] [Calibration of Event-Based Camera for High-Speed Observations of Lightning and Transient Luminous Events](https://doi.org/10.3390/rs18183201)
...
### [16] [Reconstructed XCO2 Reveals Seasonal Moisture Limitation Sensitivity Across Typical Steppe, Forest, and Gobi Desert in Mongolia](https://doi.org/10.3390/rs18183196)
...
### [17] [HSRA-Net: Hierarchical Season-Year Representation Alignment for Tree Species Classification from Long-Term Sentinel-2 Observations](https://doi.org/10.3390/rs18183195)
...
### [18] [New Insights into Aristarchus Plateau and Its Vicinity from Chang’e-2 Microwave Radiometer Data](https://doi.org/10.3390/rs18183194)
...
### [19] [Uncertainty-Based Quality-Control Prioritization for High-Resolution Land-Cover Mapping Under Spatially Disjoint Evaluation](https://doi.org/10.3390/rs18183197)
...
### [20] [Cross-Regional Transfer Learning for Radar Echo Extrapolation in Northwestern Xinjiang, Western China](https://doi.org/10.3390/rs18183209)
...
### [21] [Real-Time Target Detection in Compressed Domain for Streak Tube LiDAR by Two-Pass Labeling and Sparse Attention](https://doi.org/10.3390/rs18183261)
...
### [22] [HAF-Net: A Hierarchical Adaptive Fusion Network for Satellite-Based Radar Reflectivity Reconstruction](https://doi.org/10.3390/rs18183202)
...
### [23] [Disentangling Topographic Constraints and the Climatic and Anthropogenic Pathways Shaping Vegetation Greenness in the Southeastern Qinghai–Xizang Plateau](https://doi.org/10.3390/rs18183251)
...
### [24] [Assessment of Sea Surface Wind Measurements from Wave Gliders in Tropical Cyclones](https://doi.org/10.3390/rs18183213)
...
### [25] [Correction: Lv et al. Validation of Soil Temperature Sensing Depth Estimates Using High-Temporal Resolution Data from NEON and SMAP Missions. Remote Sens. 2025, 17, 3845](https://doi.org/10.3390/rs18183230)
...
### [26] [Motion-Guided Multi-Offset Detector-Native ReID Readout for Efficient UAV Multi-Object Tracking](https://doi.org/10.3390/rs18183238)
...
### [27] [The Five-Decade Landsat Legacy in Inland Water Quality: A Systematic Review of Technological and Methodological Evolution](https://doi.org/10.3390/rs18183237)
...
### [28] [Fine-Grained Tree Species Classification in Urban Forests via Phenology–Structure Synergistic Fusion of Multi-Source Remote Sensing Data](https://doi.org/10.3390/rs18183246)
...
### [29] [LiDAR-Based Sub-Canopy Surface Water Detection in a Post-Mining Environment](https://doi.org/10.3390/rs18183222)
...
### [30] [Reliability-Aware Dual-Stream Self-Training for Semi-Supervised Semantic Segmentation of High-Resolution Remote Sensing Imagery](https://doi.org/10.3390/rs18183257)
...
### [31] [Cross-Year Crop and Land-Cover Classification with Limited Labels](https://doi.org/10.3390/rs18183210)
...
### [32] [Frequency-Domain Feature Enhancement Combined with Contrastive Learning for Hyperspectral Image Open-Set Classification](https://doi.org/10.3390/rs18183256)
...
### [33] [A Multi-Modal Deep Learning Framework for High-Resolution Alpine Land Use/Land Cover](https://doi.org/10.3390/rs18183203)
...
### [34] [ProG-Net: Prompted Guidance Network for Visible–Thermal Tiny-Object Detection](https://doi.org/10.3390/rs18183239)
...
### [35] [Assessing and Improving Geolocation of InSAR Scatterers with LiDAR Data](https://doi.org/10.3390/rs18183249)
...
### [36] [UAV-Based Prediction of Cover Crop Biomass in Winter Peas Across Planting Dates and Cropping Systems](https://doi.org/10.3390/rs18183208)
...
### [37] [Multi-Temporal Satellite Observations and Machine Learning-Based Flood Susceptibility Assessment of the 2025 Punjab Flood](https://doi.org/10.3390/rs18183204)
...
### [38] [Rising Risk of Thermokarst Lake Drainage on the Mongolian Plateau Under Future Warming](https://doi.org/10.3390/rs18183207)
...
### [39] [Rock Detection and Arability Mapping Using Airborne LiDAR-RGB Fusion and Machine Learning](https://doi.org/10.3390/rs18183240)
...
### [40] [FuzzyQSM: A Novel Tree Structure Reconstruction Approach Using Uncertainty](https://doi.org/10.3390/rs18183244)
...
### [41] [Dual-Branch GCN-Mamba Network with Semantic-Guided Meta-Learning for Multimodal Remote Sensing Classification](https://doi.org/10.3390/rs18183218)
...
### [42] [Evaluating Remote Sensing Foundation Model Embeddings for Cross-City Thematic Mapping of Eucalyptus Plantations in Guangxi, China](https://doi.org/10.3390/rs18183248)
...
### [43] [Generating Annual 10 m Land Cover Maps for 37 Chinese Metropolises Using Google Satellite Embeddings](https://doi.org/10.3390/rs18183233)
...
### [44] [Surface Soil Moisture from Sentinel-2 Imagery: A Systematic Review Complemented by a Case Study in Sardinia, Italy](https://doi.org/10.3390/rs18183262)
...
### [45] [Nonlinear Latent-Space Data Assimilation for Sea Surface Height Reconstruction from Sparse Observations](https://doi.org/10.3390/rs18183221)
...
### [46] [Kinematics of the Haiyuan Fault (Northwest China) Prior to the 2022 Menyuan Mw 6.7 Earthquake](https://doi.org/10.3390/rs18183232)
...
### [47] [HiSGD: High–Low Spectral Gradient Decoupling for Heterogeneous Distillation in Infrared Small-Target Detection](https://doi.org/10.3390/rs18183215)
...
### [48] [Cross-Regional Classification of Rice Cropping Systems Based on Within-Year Seasonal Composition Using Multimodal Remote-Sensing Time Series](https://doi.org/10.3390/rs18183241)
...
### [49] [SDR-YOLO: Scale-Selective Detail Residual Enhanced YOLO for Visible–Thermal Object Detection](https://doi.org/10.3390/rs18183216)
...
### [50] [Improving the Quality of the Surface Heat Flux Data over the Tibetan Plateau by Using an Optuna–CatBoost–Shapley Additive exPlanation Method](https://doi.org/10.3390/rs18183242)
...
### [51] [A Physics-Guided Diffusion Framework for Mars Rover Image Restoration Under Atmospheric Dust](https://doi.org/10.3390/rs18183224)
...
### [52] [SDFA-Net: Urban Manhole Cover Detection via Fisheye Image and LiDAR Point Cloud Fusion](https://doi.org/10.3390/rs18183206)
...
### [53] [Integrated Ministack-InSAR Monitoring and Multi-Source-Factor-Informed CNN-LSTM Prediction of Reservoir-Bank Landslide Deformation: A Case Study of the Xiaolangdi Reservoir, China](https://doi.org/10.3390/rs18183205)
...
### [54] [Optical-Algorithm Co-Design of a Lightweight Petzval Star Tracker with Selective Asymmetric Aberration Suppression](https://doi.org/10.3390/rs18183243)
...
### [55] [SAR-Based Monitoring of Maize Phenology in the High-Yielding Mpumalanga Province of South Africa](https://doi.org/10.3390/rs18183231)
...
### [56] [A Scene Classification Method for Dead-End Road Association Zones in Mountainous Areas Using Optical Remote Sensing](https://doi.org/10.3390/rs18183214)
...
### [57] [Anomaly-Driven Gated Fusion Network for Infrared Small Target Detection](https://doi.org/10.3390/rs18183247)
...
### [58] [Acquisition-Level Optimization of Split-Spectrum TEC Observability in L-Band InSAR](https://doi.org/10.3390/rs18183217)
...
### [59] [SHALA: Sparse Hierarchical Alignment for Visible-Infrared Vehicle Re-Identification Under Aerial-Ground Viewpoint Gaps](https://doi.org/10.3390/rs18183219)
...
### [60] [Label-Efficient Semi-Supervised Building Semantic Segmentation for High-Resolution UAV Imagery](https://doi.org/10.3390/rs18183250)
...
### [61] [Atmospheric Water Vapor Monitoring on Horseshoe Island, Antarctica: GNSS Observations at the Permanent TUR1 and TUR2 Stations Using a Regional Tm Calibration](https://doi.org/10.3390/rs18183226)
...
### [62] [SASI-Net: A Sparse Adaptive SAR Imaging Network with Complex-Valued Mask-Aware Completion and Adaptive Truncated Penalty](https://doi.org/10.3390/rs18183255)
...
### [63] [Case Studies of Environmental Monitoring Based on the Integrated Use of Bioindicators and Remote Sensing](https://doi.org/10.3390/rs18183227)
...
### [64] [Temporal Lag and Response Characteristics of Runoff and Its Components in a Glacial Basin](https://doi.org/10.3390/rs18183235)
...
### [65] [WSF-YOLO: Wavelet-Guided Spatial–Frequency Joint Modeling for Aircraft Detection in SAR Images](https://doi.org/10.3390/rs18183254)
...
### [66] [An Ensemble-Based Transfer Learning Framework Using EfficientNetV2 and MobileNetV2 for Satellite Image Classification of Wildfires](https://doi.org/10.3390/rs18183212)
...
### [67] [Comparing Irrigation Identification Methods in Colorado: Limitations of Downscaled SMAP Soil Moisture](https://doi.org/10.3390/rs18183223)
...
### [68] [Early Detection of Pine Wilt Disease at the Pre-Visual Stage Using UAV-Based Hyperspectral Imagery](https://doi.org/10.3390/rs18183229)
...
### [69] [Dynamic Monthly Population-Exposure-Based Flash-Flood Risk Mapping Using an Explainable XGBoost Framework](https://doi.org/10.3390/rs18183253)
...
### [70] [Bridging Temporal Gaps in Thermal Remote Sensing: A Generative Adversarial Network Approach to Land-Cover-Stratified Diurnal Heat Retention in Peri-Urban Landscapes](https://doi.org/10.3390/rs18183259)
...
### [71] [Assessing the Sensitivity of Sentinel-1 and Sentinel-2 Time Series to Wheat Yellow Rust Using Feature Evaluation, Separability, and Random Forest Classification](https://doi.org/10.3390/rs18183252)
...
### [72] [A Vegetation Growth Pattern-Constrained Interpolation Method for High-Resolution Daily FPAR/LAI Reconstruction and NPP Spatial Disaggregation](https://doi.org/10.3390/rs18183211)
...
### [73] [Potential Earthquake-Triggered Landslide Susceptibility Mapping Integrating Deterministic Ground Motion Simulation and Machine Learning: A Case Study of the Litang Fault Zone](https://doi.org/10.3390/rs18183245)
...
### [74] [MSFFusion: Multi-Level Shallow Feature Fusion Network for Pansharpening](https://doi.org/10.3390/rs18183236)
...
### [75] [Boundary-Aware Attention-Enhanced DeepLabV3+ for Landslide Segmentation Along the Sichuan–Tibet Transportation Corridor](https://doi.org/10.3390/rs18183220)
...
### [76] [Experimental Assessment of Microwave Penetration Depth in Layered Soil by Wideband (0.3–6 GHz) Transmissometry and Reflectometry](https://doi.org/10.3390/rs18183258)
...
### [77] [Region and Boundary Accuracy in Zero-Shot Shoreline Extraction: A Benchmark of Segmentation-Native Vision-Language Models and Prompted SAM Pipelines](https://doi.org/10.3390/rs18183228)
...
### [78] [Data Processing and Quality Control of the CW193 Sun Photometer Network and Evaluation of Satellite Aerosol Products](https://doi.org/10.3390/rs18183225)
...
### [79] [Optimization of Farmland Management Zoning in the Black Soil Region: A Climate Adaptability Assessment Considering Crop Growth Response and Topographic Characteristics](https://doi.org/10.3390/rs18183260)
...
### [80] [FCD-Mamba: A Frequency-Enhanced and Center-Pixel-Guided Dual-Branch Mamba Network for Hyperspectral Image Classification](https://doi.org/10.3390/rs18183234)
...
### [81] [National-Scale Flood Susceptibility Mapping of Nigeria Using Statistical and Machine Learning Models with Satellite-Driven Validation for Data-Sparse Environments](https://doi.org/10.3390/rs18193264)
...
### [82] [Estimating Ground-Level PM2.5 over Beijing–Tianjin–Hebei from DQ-1 Wide-Swath Imager Signals and ERA5 Meteorology Using Physics-Guided Feature Engineering](https://doi.org/10.3390/rs18193266)
...
### [83] [CYGNSS Soil Moisture Performance in Guinea Savanna Region: Extended and Quadruple Collocation Evidence from Benue State, Nigeria](https://doi.org/10.3390/rs18193267)
...
### [84] [From Pixel Receptive Fields to Ground Spans: GSD-Conditioned Cross-Resolution Feature Alignment for Photovoltaic Detection and Segmentation](https://doi.org/10.3390/rs18193263)
...
### [85] [Satellite-Based Seasonal Monitoring of PM2.5-Related Trace Gases and Aerosol Loading over the Lazio Region](https://doi.org/10.3390/rs18193265)
...
### [86] [Triple-Level Topology Awareness Using Hypergraph for Marine Ship Surveillance from SAR Imagery](https://doi.org/10.3390/rs18193268)
...
### [87] [Daily Lake-Surface NDVI Reconstruction Using Multi-Source Machine Learning Under Incomplete Optical Observations](https://doi.org/10.3390/rs18193269)
...
### [88] [MHBA-TransUNet: Shallow–Deep Collaborative RGB–DSM Fusion with Hybrid Bidirectional Attention for High-Resolution Remote Sensing Semantic Segmentation](https://doi.org/10.3390/rs18193271)
...
### [89] [Simulation of Equatorial Plasma Bubble Signatures in GNSS TEC](https://doi.org/10.3390/rs18193273)
...
### [90] [SWOT Wide-Swath Altimetry for Inland-Water Remote Sensing: Applications, Challenges, and Prospects—A Systematic Bibliometric and Thematic Review](https://doi.org/10.3390/rs18193274)
...
### [91] [Expert knowledge-guided decision calibration for accurate fine-grained tree species classification](https://doi.org/10.1016/j.isprsjprs.2026.09.013)
...
### [92] [DirPA: Addressing prior shift in imbalanced few-shot crop-type classification](https://doi.org/10.1016/j.isprsjprs.2026.08.016)
...
### [93] [BlinkChange: Active perception bi-temporal reliable representation for disaster impact understanding from remote sensing imagery](https://doi.org/10.1016/j.isprsjprs.2026.09.014)
...
### [94] [Explaining discrepancies between ground-based and spaceborne nighttime light measurements using urban morphology: a multi-city study](https://doi.org/10.1016/j.isprsjprs.2026.09.015)
...
### [95] [SAF-CropNet: Spatially adaptive fusion of SAR and optical imagery for semantic segmentation in operational cropland mapping across regions](https://doi.org/10.1016/j.isprsjprs.2026.08.029)
...
### [96] [Sketch and paint: A structural–temporal aware refinement network for fine-grained crop mapping on satellite image time series](https://doi.org/10.1016/j.isprsjprs.2026.09.009)
...
### [97] [An Adaptive Dynamic AI-driven ParameTerization (ADAPT) framework for global hourly gross primary productivity estimation](https://doi.org/10.1016/j.isprsjprs.2026.09.024)
...
### [98] [Spectral unmixing of hyperspectral lidar signals considering laser beam profile](https://doi.org/10.1016/j.isprsjprs.2026.09.011)
...
### [99] [Nested generative downscaling of passive microwave satellite data for navigation-scale Arctic sea ice forecasting](https://doi.org/10.1016/j.isprsjprs.2026.09.021)
...
### [100] [HELIOS-Net: Hourly daytime estimation of land surface temperature with integration of observational solar-cloud-satellite geometry and deep neural network](https://doi.org/10.1016/j.isprsjprs.2026.09.028)
...
### [101] [PatchFusion: Resilient LiDAR-camera fusion for point cloud semantic segmentation in autonomous driving](https://doi.org/10.1016/j.isprsjprs.2026.09.008)
...
### [102] [SNAIL-Radar-Indoor:A large-scale handheld LiDAR–4D radar–IMU dataset for robust SLAM in degraded environments](https://doi.org/10.1016/j.isprsjprs.2026.09.004)
...
### [103] [SaKD: Lightweight infrared small target detection via Spatial-Aware Knowledge Distillation for edge deployment](https://doi.org/10.1016/j.isprsjprs.2026.09.018)
...
### [104] [Resampling-free jitter-aware bundle adjustment for HiRISE multi-CCD stereo mapping on Mars](https://doi.org/10.1016/j.isprsjprs.2026.09.020)
...
### [110] [Point-Cloud-Native L-Band Augmentation of SWOT KaRIn: Recovering Canopy-Shadowed Dark Water with NISAR](https://doi.org/10.5281/zenodo.22818803)
...
### [111] [Point-Cloud-Native L-Band Augmentation of SWOT KaRIn: Recovering Canopy-Shadowed Dark Water with NISAR](https://doi.org/10.5281/zenodo.22818804)
*Waleed Shoaib,Bakhtawar Ismail,Muhammad Salik*
...
### [112] [Enhanced early warning of extreme river discharge events in the Yangtze River Basin using atmospheric circulation signals](https://doi.org/10.1016/j.jag.2026.105590)
...
### [113] [Multimodal loess cave extraction using LMUNet-RCAM: Integrating hillshade and RGB features with local attention mechanisms](https://doi.org/10.1016/j.jag.2026.105596)
...
### [114] [Learning instance-level semantic Gaussian representations for occlusion-aware urban scene reconstruction from UAV imagery](https://doi.org/10.1016/j.jag.2026.105574)
...
### [115] [Vegetation canopy height retrieval in complex mountainous regions based on data calibration and CNN model](https://doi.org/10.1016/j.jag.2026.105598)
...
### [116] [Automated conversion of unstructured mesh models to structured parametric CAD models for architectural applications](https://doi.org/10.1016/j.jag.2026.105583)
...
### [117] [Challenges in heating demand modelling based on the Kleczków district in Wrocław, Poland](https://doi.org/10.1016/j.jag.2026.105581)
...
### [118] [Biophysical effects of afforestation on local land surface temperature in china: A comprehensive analysis incorporating forest age and afforestation intensity](https://doi.org/10.1016/j.jag.2026.105593)
...
### [119] [A two-stage transformer framework for reconstructing hourly 1 km all-weather land surface temperature using cross-scale transfer learning](https://doi.org/10.1016/j.jag.2026.105602)
...
### [120] [AdaGeo-SR: Geo-semantic-guided super-resolution of sentinel-2 imagery with AlphaEarth foundation priors](https://doi.org/10.1016/j.jag.2026.105573)
...
### [121] [A spatiotemporal reconstruction framework for GRACE/GRACE-FO-derived groundwater storage anomalies based on historical phase-constrained gap filling and physics-guided global–local downscaling](https://doi.org/10.1016/j.jag.2026.105603)
...
### [122] [Adaptive background suppression-based plume identification, emission estimation, and ground validation of coal mine methane in Changzhi, Shanxi, China](https://doi.org/10.1016/j.jag.2026.105587)
...
### [123] [Kinematic pattern interpretation of railway-corridor deformation from InSAR time series with transfer learning-based TCN](https://doi.org/10.1016/j.jag.2026.105594)
...
### [124] [Relaxing the clear-sky assumption: Cloud-tolerant spatiotemporal fusion via mask-guided feature modulation and temporal-memory collaboration](https://doi.org/10.1016/j.jag.2026.105571)
...
### [125] [Estimating supraglacial lake bottom ablation rates by integrating ICESat-2 repeat track data and multi-temporal sentinel-2 imagery](https://doi.org/10.1016/j.jag.2026.105605)
...
### [126] [Analysis of intraday urban thermal anisotropy and downward shortwave radiation through UAV experiment and coupled model](https://doi.org/10.1016/j.jag.2026.105582)
...
### [127] [Remote-sensing-assisted and in situ-constrained reconstruction of 4-hourly chlorophyll-a dynamics in inland lakes using vision Mamba and temporal attention](https://doi.org/10.1016/j.jag.2026.105588)
...
### [128] [Reference-anchored envelope modelling for predicting tree mortality hotspots driven by drought](https://doi.org/10.1016/j.jag.2026.105609)
...
### [129] [A Targeted–Refined Framework for wind turbine detection integrating AlphaEarth Foundations and high-resolution multispectral satellite imagery](https://doi.org/10.1016/j.jag.2026.105604)
...
### [130] [Multi-angular assessment of early-season defoliation: Evaluating the sensitivity of vegetation indices to NPV visibility in temperate broadleaved forests](https://doi.org/10.1016/j.jag.2026.105575)
...
### [131] [Unsupervised soft-min fusion of multi-sensor turbidity products using Gaussian mixture models](https://doi.org/10.1016/j.jag.2026.105584)
...
### [132] [Using ICESat-2 ATL08 heights and Landsat time series to assess the age-height relationship of southern yellow pines in the US](https://doi.org/10.1016/j.rse.2026.115677)
...
### [133] [Urban building height mapping in Beijing-Tianjin-Hebei megalopolis by synergy of spaceborne LiDAR and multisource geospatial datasets](https://doi.org/10.1016/j.rse.2026.115658)
...
### [134] [Time and tide: Mapping the changing 3D shape of Australia's dynamic intertidal zone using time series satellite data](https://doi.org/10.1016/j.rse.2026.115663)
...
### [135] [Direct quantification of solar-induced chlorophyll fluorescence using compact solar-blind optical radiometers](https://doi.org/10.1016/j.rse.2026.115669)
*Jonas Kuhn,J. Stutz*
...
### [136] [3DSO: Quantifying forest three-dimensional structural organization beyond the canopy surface using LiDAR data](https://doi.org/10.1016/j.rse.2026.115668)
...
### [137] [An uncertainty workflow for landsat TIRS split window surface temperature products incorporating atmospheric water vapor](https://doi.org/10.1016/j.rse.2026.115660)
...
### [138] [Observation-constrained clear-sky direct radiative forcing of black carbon containing aerosols reveals distinct radiative regimes across urban Asia](https://doi.org/10.1016/j.rse.2026.115673)
...
### [139] [CEDA-Net: A cascade empirical–deep network for mitigating InSAR tropospheric delay in complex atmospheric and topographic conditions](https://doi.org/10.1016/j.rse.2026.115659)
...
### [140] [Detecting diurnal dynamics of cotton leaf inclination angle under water-salt stress](https://doi.org/10.1016/j.rse.2026.115674)
...
### [141] [Diurnal coupling of total column nitrogen dioxide and aerosol optical depth: Insights from the Pandora Asia network](https://doi.org/10.1016/j.rse.2026.115682)
...
### [142] [Bias-variance trade-off in radiative transfer model inversion drives uncertainty in leaf area index estimation](https://doi.org/10.1016/j.rse.2026.115662)
...
### [143] [Optically consistent multi-parameter aerosol retrieval from dual-satellite polarimetric observations enabled by physics-guided deep learning](https://doi.org/10.1016/j.rse.2026.115685)
...
### [144] [Spatiotemporal extension of all-sky downward shortwave radiation over mountainous area](https://doi.org/10.1016/j.rse.2026.115678)
...
### [145] [Fusing SAR and SWIM observations to improve the global stokes drift estimates](https://doi.org/10.1016/j.rse.2026.115687)

...
### [108] [Editorial Board](https://doi.org/10.1016/s0924-2716(26)00365-5)
*Unknown Author*
...
### [115] [An Improved Recognition Technique for Ship Targets Based on Dual-Path Cooperative Fusion Mechanism](https://doi.org/10.3390/rs18152447)
...
### [116] [A Decade of Remote Sensing for Vegetation Monitoring with Sentinel-2](https://doi.org/10.3390/rs18152448)
...
### [117] [Quantifying Tidal Asymmetry of Suspended Sediment Concentration in Macro-Tidal Embayments: A Sentinel-2 Based Framework](https://doi.org/10.3390/rs18152450)
...
### [118] [Multi-Scale Lightweight Spectral Attention Network for Hyperspectral Image Classification](https://doi.org/10.3390/rs18152451)
...
### [119] [GeoMamba: Geometric-Prior-Infused Multi-Scale Deformable Visual Mamba for Crack Semantic Segmentation](https://doi.org/10.3390/rs18152449)
...
### [120] [Spatially Robust Land Cover Classification with Multi-Seasonal Sentinel-2 Imagery: A Comparison of CNN, UNet++, ConvNeXt and ViT](https://doi.org/10.3390/rs18152463)
...
### [121] [Maize Yield Prediction via Data Fusion of UAV Multi/Hyperspectral Imagery and In-Field Measurements](https://doi.org/10.3390/rs18152460)
...
### [122] [Integrating Phenological and Management Signals for Cross-Regional Ginger Mapping with Multi-Temporal Sentinel-2](https://doi.org/10.3390/rs18152453)
*Yongtao Tang,Yujing Song,J Huang*
...
### [124] [Monitoring Coastal Surface Roughness Suppression Associated with Algal Blooms and Pollutants Using NASA SWOT Observations](https://doi.org/10.3390/rs18152464)
...
### [125] [Joint 3D Reconstruction and Classification of Aircraft Based on Single-Image Neural Implicit Optimization](https://doi.org/10.3390/rs18152461)
...
### [126] [Discrete Space-Target Trajectory Detection with a Linearity-Enhanced Network on Stacked Optical Images](https://doi.org/10.3390/rs18152457)
...
### [127] [Ensemble Learning with Multi-Source Data Fusion for Modeling and Gap-Filling of Streetscape Greenery: An Application to Shichahai, Beijing](https://doi.org/10.3390/rs18152459)
...
### [128] [Spatio-Temporal Monitoring of the Invasive Plant Alternanthera philoxeroides in a Narrow River Using Sentinel-2 Time-Series Data](https://doi.org/10.3390/rs18152462)
...
### [129] [Design and Performance Analysis of a Mid-Wave Infrared, Compressive Sensing Based, Multispectral Imager for the Detection of High Temperature Events](https://doi.org/10.3390/rs18152454)
...
### [130] [Synthetic Surface Roughness Using Eigen-Space Transformation Approach for Improved Surface Soil Moisture Retrieval from C-Band SAR Data](https://doi.org/10.3390/rs18152455)
...
### [131] [A CASA-Based, MODIS-Constrained Framework for Consistent Annual NPP Simulation in Alpine Complex Environments: A Case Study of the Gannan Plateau](https://doi.org/10.3390/rs18152456)
...
### [132] [Geometry-Guided Diffusion SAR Point Cloud Denoising](https://doi.org/10.3390/rs18152458)
...
### [133] [Testing a Novel Transfer Learning Approach to Estimate War-Related Crop Yield Losses in Ukraine](https://doi.org/10.3390/rs18152465)
...
### [134] [DPMSCH-Net: A Dual Prior-Guidance Multi-Scale SSM-CNN Hybrid Network with Manifold Constraints for Hyperspectral Image Classification Under Small-Sample Conditions](https://doi.org/10.3390/rs18152452)
*Rui Feng,Chanyue Wu,Meili Zhou,Dong Wang,Dongdong Jia,Zongwen Bai*
...
### [136] [Automated Individual-Tree Species Recognition Using Mobile Laser Scanner Point Clouds, Random Forest and 2D Convolutional Neural Networks](https://doi.org/10.3390/rs18152471)
...
### [137] [Mapping Bamboo Forest Dynamics with Long-Term Landsat Stacks and Samples Migrated from Percentile-Based Head/Tail Break](https://doi.org/10.3390/rs18152467)
...
### [138] [A Ground-Based Multi-Doppler Wind Retrieval Algorithm for Turbulent Convection: An LES-Based Radar Wind Retrieval Framework](https://doi.org/10.3390/rs18152468)
...
### [139] [SwinEADFormer: An Edge-Aware Dynamic Swin Transformer for Building Change Detection in High-Resolution Remote Sensing Images](https://doi.org/10.3390/rs18152474)
...
### [140] [Flexible High-Resolution Water Quality Monitoring and Mapping Using an Autonomous Surface Vehicle and Drone-Based Multispectral Imaging System](https://doi.org/10.3390/rs18152473)
...
### [141] [Automatic Extraction of Oxbow Lakes from Landsat Imagery Using Deep Learning Across the Amazon Basin](https://doi.org/10.3390/rs18152472)
...
### [142] [SpecGateNet: Spectral-Guided Fusion Network for Cloud and Cloud Shadow Segmentation in Optical Remote Sensing Imagery](https://doi.org/10.3390/rs18152469)
...
### [143] [Kinematic Decomposition of Three Decades of Multi-Mission DInSAR Time Series Reveals Persistent Ground Deformation Geometry at Campi Flegrei Caldera](https://doi.org/10.3390/rs18152476)
...
### [144] [Cross-Modal Offshore Platform Detection Method via Domain-Invariant Feature Learning](https://doi.org/10.3390/rs18152470)
...
### [145] [Phenology-Guided Early Prediction of Crop Damage Under Long-Duration Inundation Using Multi-Source SAR–Optical Imagery](https://doi.org/10.3390/rs18152481)
...
### [146] [A Multidimensional Hotspot Assessment of Long-Term Terrestrial Water Storage Anomaly Change Across China](https://doi.org/10.3390/rs18152478)
...
### [147] [An Integrated Deep Learning Approach to Estimate Canopy Height and Uncertainty by Combining Seasonal Optical, SAR and Limited GEDI LiDAR Data over Ontario’s Managed Forests, Canada](https://doi.org/10.3390/rs18152477)
...
### [148] [ChangePixel: Pixel-Level Evidence-Grounded Disaster Change Narration via Single-Backbone Transfer](https://doi.org/10.3390/rs18152480)
...
### [149] [Relative Radiometric Normalization of Multisource Optical Satellite Imagery via Automatic Construction and Intelligent Refinement of Radiometric Reference Sample Set](https://doi.org/10.3390/rs18152479)
...
### [150] [Beyond fidelity: Rethinking realism through human behavior in VR city modeling LOD design](https://doi.org/10.1016/j.jag.2026.105484)
...
### [151] [MFRXG: A multi-feature stacking ensemble RF-XGBoost model for total nitrogen retrieval in the Yellow River from Landsat 8/9 data](https://doi.org/10.1016/j.jag.2026.105492)
...
### [152] [HeightCLIP: A vision-language network for height estimation from monocular remote sensing imagery](https://doi.org/10.1016/j.jag.2026.105499)
...
### [153] [Urban digital twin for environmentally sensitive mobility planning: conceptual framework and application in pilot region Leipzig](https://doi.org/10.1016/j.jag.2026.105477)
...
### [154] [DINO-Pheno-Cluster: Integrating few-shot foundation models and UAV time-series for spatiotemporal growth and functional characterization of alfalfa](https://doi.org/10.1016/j.jag.2026.105497)
...
### [155] [PLGF-NET: A Physics-Guided Local-Global fusion network for GNSS-R high wind speed retrieval](https://doi.org/10.1016/j.jag.2026.105493)
...
### [156] [Earth Observation–Based Machine learning for operational forecasting of harmful algal blooms in the Arabian Gulf and Sea of Oman](https://doi.org/10.1016/j.jag.2026.105501)
...
### [157] [BQEL-Net: A bimodal quantitative ensemble learning network with uncertainty-aware for vectorized extraction of martian impact craters from bimodal catalogic-and-quantitative dataset (BCQDS)](https://doi.org/10.1016/j.jag.2026.105494)
...
### [158] [Identification and classification of risk zones for Calliptamus italicus based on remote sensing and ensemble modeling: considering population density and habitat suitability](https://doi.org/10.1016/j.jag.2026.105498)
...
### [159] [An interpretable Earth observation framework for estimating lake dissolved organic carbon in Sweden using Sentinel-2 and ERA5-Land data](https://doi.org/10.1016/j.jag.2026.105488)
...
### [160] [Fusing very high-resolution aerial imagery with Sentinel-1 and Sentinel-2 time series improves multi-year orchard type classification](https://doi.org/10.1016/j.jag.2026.105495)
...
### [161] [Divergent ecohydrological impacts of agricultural and urban expansions across global drylands](https://doi.org/10.1016/j.jag.2026.105505)
...
### [162] [Spatially varying NDVI–stand structure relationships in Scots pine forests across Poland using HLS, LiDAR metrics and GGP-GAM](https://doi.org/10.1016/j.jag.2026.105500)
...
### [163] [Dual-polarization GNSS reflectometry for FYI–MYI sea ice type classification using microsatellite observations](https://doi.org/10.1016/j.jag.2026.105502)
...
### [164] [A singularity regression kriging for spatial prediction](https://doi.org/10.1080/15481603.2026.2690341)
...
### [165] [Integrating local spatial outliers into context-aware spatial prediction models](https://doi.org/10.1080/15481603.2026.2700126)
...
### [166] [Landsat-derived gap-free monthly 30-m dataset (2000–2021) unraveling intra-annual surface water dynamics on the Tibetan Plateau](https://doi.org/10.1080/15481603.2026.2707752)
...
### [167] [Generalised spatial error for validation](https://doi.org/10.1080/15481603.2026.2690327)
...
### [168] [Improved estimation of daily surface all-wave net radiation from FY3D MERSI-II data based on pseudo-label learning](https://doi.org/10.1080/15481603.2026.2702169)
...
### [169] [Development of spaceborne high-spectral-resolution lidar retrieval algorithm for ACDL/DQ-1 aerosols and clouds observation: improvements and analysis](https://doi.org/10.1080/15481603.2026.2702220)
...
### [170] [High-precision monthly monitoring of surface water dynamics in Central Asia from 1990 to 2022 using remote sensing gap-filling techniques](https://doi.org/10.1080/15481603.2026.2689680)
...
### [171] [Substantial improvement of geostationary satellite-derived shortwave radiation product through correcting geolocation displacement](https://doi.org/10.1016/j.rse.2026.115589)
...
### [172] [Breaking barriers in rice chlorophyll retrieval from satellite imagery: Mitigating row structure and saturation effects via RiceGORT and chlorophyll sensitivity enhancement](https://doi.org/10.1016/j.rse.2026.115581)
...
### [173] [Retrieval of sea surface salinity from SMAP L-band radiometry under rainfall conditions](https://doi.org/10.1016/j.rse.2026.115570)
...
### [174] [A scattering model-informed deep transfer learning framework for surface soil moisture retrieval](https://doi.org/10.1016/j.rse.2026.115571)
...
### [175] [cscMTCI: A soil and structure corrected MERIS terrestrial chlorophyll index for improving leaf chlorophyll content estimation](https://doi.org/10.1016/j.rse.2026.115582)
...
### [176] [MUSTI: Multi-scale spatiotemporal tensor imputation for global leaf area index time series reconstruction](https://doi.org/10.1016/j.rse.2026.115559)
...
### [177] [GNSS–T for ecohydrological monitoring of a european beech forest: Assessing different system and band characteristics for resolving temporal VOD dynamics](https://doi.org/10.1016/j.rse.2026.115580)
...
### [178] [Global comparison of different effective scattering albedo and soil roughness parameterization schemes for SMAP soil moisture and L-VOD retrieval](https://doi.org/10.1016/j.rse.2026.115590)
...
### [179] [Rice leaf pathogen infection alters the spectral–biochemical relationships revealed by radiative transfer model inversion](https://doi.org/10.1016/j.rse.2026.115592)
...
### [180] [STCAFormer: Spatio-temporal cross attention based transformer for fusion of remote sensing images](https://doi.org/10.1016/j.rse.2026.115594)
...
### [268] [CDAE: Enhancing Perturbation Robustness in Pretrained Language Models with Contrastive Denoising](https://arxiv.org/abs/2607.28236)
...
### [283] [WIDE: Boosting Adaptive LLM Inference via Token-level Dynamic Width Pruning](https://arxiv.org/abs/2607.28418)
...
### [284] [When Derived Measurements Mislead: Quantifying and Mitigating LLM Over-Trust with Privileged-Modality Reliability Evidence](https://arxiv.org/abs/2607.28421)
...
### [285] [A foundation model of numerical intelligence with cross-disciplinary generalization](https://arxiv.org/abs/2607.28432)
...
### [286] [Metaphor Tracer: A Theory-Informed Analysis of Hidden States](https://arxiv.org/abs/2607.28434)
...
### [287] [SVR: Self-Verifying Refinement via Joint Verdict-Confidence Reinforcement Learning for Adaptive Test-Time Compute](https://arxiv.org/abs/2607.28457)
...
### [299] [AISPA: User-Centric System Prompt Auditing for Large Language Model Applications](https://arxiv.org/abs/2607.28617)

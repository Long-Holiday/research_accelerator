...
- [GIScience & RS](#GIScience & RS) [Total: 10]
- [Remote Sensing](#Remote Sensing) [Total: 153]
- [JAG](#JAG) [Total: 7]
...
Abstract (英文): Neuron counting and segmentation in microscopy images of neuronal cultures is a routine and time-consuming task in neuroscience research, traditionally performed through manual inspection or semi-automatic tools. We present NeuroAdaptTrainer, an open-source Fiji/ImageJ plugin that integrates a YOLO instance-segmentation model directly into the microscopist's workflow. The plugin allows a user to run automatic neuron detection on a single image or a batch of images, manually correct the resulting detections from within Fiji, and use those corrections to adapt the model to new imaging conditions via transfer learning. A built-in external validation module allows the base and adapted models to be compared quantitatively on a held-out annotated set. NeuroAdaptTrainer lowers the barrier for non-specialist users to benefit from deep-learning-based segmentation while keeping expert supervision at the center of the workflow.
...
Abstract (英文): Gradient-weighted Class Activation Mapping (Grad-CAM) is widely used to visualize model decisions, but it was originally formulated for convolutional neural networks, where spatial feature maps and channel dimensions have clear architectural meanings. Vision Transformers (ViTs) do not provide the same structure, instead representing images through tokens, attention, residual streams, and multimodal interactions. This paper presents a systematic taxonomy and literature audit of how Grad-CAM and related methods are adapted, justified, and reported for ViT-based architectures. From an initial search of more than 550 papers, we identify 175 papers that apply Grad-CAM or Grad-CAM-adjacent methods to ViTs. We find that most papers do not provide a full mathematical or implementation-level account of how Grad-CAM is adapted to transformer representations. To characterize this gap, we introduce a descriptive taxonomy of ViT Grad-CAM adaptations that makes explicit the feature locations, gradient targets, spatial reconstruction steps, and aggregation choices that are often left implicit. This taxonomy is not intended to prescribe a single correct adaptation, but to clarify the range of methodological choices being made. The study shows that Grad-CAM on ViTs is often treated as a trivial extension of CNN-based Grad-CAM, despite requiring nontrivial choices that affect rigor, reproducibility, and interpretation.
...
Abstract (英文): Background: Accurate glioma subregion delineation is important for radiotherapy planning and longitudinal monitoring, but manual contour correction is time-consuming. Models such as nnU-Net may generalize imperfectly and lack clinician-directed text correction.
...
### [110] [A hybrid temporal compositing algorithm for multispectral surface reflectance imagery](https://doi.org/10.1080/15481603.2026.2699528)
...
### [111] [Ensuring continuous high-precision Earth Radiation Budget Records: a scene-dependent spectral fusion unfiltering framework for FY-3F ERM-II](https://doi.org/10.1080/15481603.2026.2709753)
...
### [112] [Beyond static graphs: a scale-variant dynamic graph-based framework integrating spatial and hierarchical relationships for urban land-use mapping](https://doi.org/10.1080/15481603.2026.2705683)
...
### [113] [TS-DInSAR tool: a temporal &amp; spatial tool for the analysis of DInSAR data at the national scale](https://doi.org/10.1080/15481603.2026.2700111)
...
### [114] [Revealing the spatiotemporal evolutionary trajectories of multi-scale territorial spatial conflicts in Yunnan: an interpretable and causal machine learning framework](https://doi.org/10.1080/15481603.2026.2712005)
...
### [115] [A context entanglement-based geographically weighted regression method](https://doi.org/10.1080/15481603.2026.2713313)
...
Abstract (英文): Spatial understanding is crucial for foundation models (FMs), and visual maps have long been a key tool for humans to understand space. Recent advances in FMs have dramatically improved their ability to process and reason over text, images, and other multimodal data, leading to a growing debate over whether traditional human-designed abstractions, such as maps, are still necessary for machine reasoning. This study revisits the role of choropleth maps in the spatial understanding of FMs, asking whether maps, as a long-standing cognitive medium for spatial understanding, still offer benefits in the era of multimodal models. To this end, we construct ChoroplethMap-Bench, a controlled benchmark consisting of 2,400 synthetic choropleth maps, corresponding GeoJSON data, and 12,000 questions, spanning five hierarchical cognitive dimensions: Identify, Spatial Recognition, Compare, Rank, and Delineate. The benchmark compares three input conditions—Data Only, Map Only, and Data + Map—across 22 frontier models, including both open-source and proprietary systems. The results demonstrate that maps, particularly when combined with symbolic data, substantially enhance model performance, especially for tasks requiring higher-level spatial understanding. We further analyze how cartographic design factors, including map type, color hue, and spatial structure, influence reasoning performance. In addition, we examine language effects and response stability, showing the cross-lingual robustness and repeatability of modern multimodal models. Overall, our findings show that incorporating maps into FMs leads to improved geospatial reasoning accuracy, with the strongest gains observed under the Data + Map condition. This work highlights the continued relevance of maps as external representations for machine intelligence and suggests future directions for evaluating broader map forms and more complex reasoning tasks.

</details>


### [118] [Wet‑year productivity pulses dominate asymmetric vegetation responses to precipitation variability on the Loess Plateau](https://doi.org/10.1080/15481603.2026.2713788)
*Yao Wang,Shuxin Luo,Daozhi Gong,Xianfeng Liu,Shouzheng Jiang,Mengxiang Kong,Ziqi Lin,Yu Feng,Jie Wu*
...
### [120] [Agreement–Disagreement Guided Knowledge Transfer for Cross-Scene Hyperspectral Imaging](https://doi.org/10.3390/rs18152601)
...
### [122] [VSTF-Net: A Vision-Semantic and Target-Aware Fusion Framework for Ship Detection in Complex Maritime Sensing Scenarios](https://doi.org/10.3390/rs18152517)
...
### [123] [A Real-Time Subband SAR Imaging Algorithm Based on an Approximate Echo Signal Model](https://doi.org/10.3390/rs18152520)
...
### [124] [Occlusion Removal in Remote Sensing Images Based on Deep Matrix Completion](https://doi.org/10.3390/rs18152538)
...
### [125] [Hyperspectral Image Classification Based on a Spatial–Spectral Dual-Branch Mamba Architecture](https://doi.org/10.3390/rs18152526)
...
### [126] [Impacts of Interannual Radiometric Calibration Differences on Vegetation Indices and Solar-Induced Chlorophyll Fluorescence Retrieval from Ground-Based Spectral Observations](https://doi.org/10.3390/rs18152528)
...
### [127] [Photovoltaic Panel Identification and Potential Assessment Based on Remote Sensing and Deep Learning: A Case Study of Yancheng City](https://doi.org/10.3390/rs18152542)
...
### [128] [Sensitivity-Constrained Anisotropic Regularization for Two-Track InSAR 3D Landslide Deformation Inversion in the Baihetan Reservoir Area, China](https://doi.org/10.3390/rs18152525)
...
### [129] [SIA-Net: A Scale-View Interactive Attention Network for Landslide Extraction from High-Resolution Optical Remote Sensing Images](https://doi.org/10.3390/rs18152521)
...
### [130] [DyPerceiver-Det: Instance-Wise Dynamic Perception for Fine-Grained Oriented Object Detection in Remote Sensing Images](https://doi.org/10.3390/rs18152515)
...
### [131] [Global Optimization Design of Large-Scale Constellations for Maritime Target Detection Based on Circular Scanning Radar](https://doi.org/10.3390/rs18152544)
...
### [132] [Geographically Constrained Transformer for Spatiotemporal Reconstruction of 2 m NDVI in Complex Coastal Landscapes](https://doi.org/10.3390/rs18152522)
...
### [133] [High-Resolution SMAP Soil Moisture in Agriculture: Capturing Field-Scale Variability in Soil Moisture and Evapotranspiration in the San Luis Valley](https://doi.org/10.3390/rs18152514)
...
### [134] [Integrating Land Use Change and Vegetation Resilience to Assess Ecological Impacts of Expressway Construction: A Case Study of the Linghua Expressway](https://doi.org/10.3390/rs18152534)
...
### [135] [InSAR-Based Prediction of Time-Series Displacements Using a New Physics-Informed Neural Network with Prior Parameter Inversion](https://doi.org/10.3390/rs18152516)
...
### [136] [A Scalable Open Source Workflow for Riverbed Substrate Classification Using UAV Imagery](https://doi.org/10.3390/rs18152529)
...
### [137] [SPIF: A Spatio-Temporal Polarity Interaction Filter for Reliable Event Selection](https://doi.org/10.3390/rs18152551)
...
### [138] [RFM-UNet: Hybrid Frequency–Mamba UNet for Remote-Sensing Road Extraction](https://doi.org/10.3390/rs18152546)
...
### [139] [In Pursuit of Open-Weights Models for Intrinsic Interpretability in Wind Turbine Blade Monitoring with Tower-Mounted Radar](https://doi.org/10.3390/rs18152535)
...
### [140] [Climate-Adaptive Urban Planning: Quantitative Assessment of Drought Impact and Practical Strategies for Climate-Resilient Urban Green Spaces](https://doi.org/10.3390/rs18152531)
...
### [141] [Retrieval of Vertical Cloud Droplet Profiles and Above-Cloud Integrated Water Vapor from Hyperspectral Measurements: Reducing Liquid Water Path Retrieval Bias with Application to EMIT](https://doi.org/10.3390/rs18152556)
...
### [142] [An Adaptive Polyline-Path Mask Attention for Hyperspectral and Multispectral Image Fusion](https://doi.org/10.3390/rs18152536)
...
### [143] [Analysis of Area Changes and Driving Factors in Chirui Lake](https://doi.org/10.3390/rs18152558)
...
### [144] [SGW-DETR: A Spectral-Guided Graph-Structured Wavelet Transformer for UAV Infrared Object Detection Under Degradation](https://doi.org/10.3390/rs18152519)
...
### [145] [From Thermal Diagnosis to Spatial Allocation: A Remote-Sensing and Explainable Machine Learning Framework for Heat-Resilient Planning in Semi-Arid Grassland Towns](https://doi.org/10.3390/rs18152548)
...
### [146] [Impact of Clouds on Infrared and Microwave Sounding Retrieval and an Objective Correction Method for Numerical Weather Prediction](https://doi.org/10.3390/rs18152549)
...
### [147] [Aliasing Suppression in Synthetic Aperture Interferometric Radiometers Using Subarray-Based Antenna Architecture](https://doi.org/10.3390/rs18152552)
...
### [148] [Improving Convection-Allowing Ensemble Forecasts via Multi-Source Remote Sensing Data Assimilation Through Stepwise Cloud Analysis Initialization: A Remote Sensing Case Study](https://doi.org/10.3390/rs18152539)
...
### [149] [Analysis of Diagnostic Absorption Troughs in Clay Alteration Within the Xiangshan Uranium Deposit Based on ZY1-02E Satellite Hyperspectral Imagery](https://doi.org/10.3390/rs18152550)
...
### [150] [Future Scenario Simulation and Optimization of Ecological Security Patterns Under Policy Drivers: A Case Study of the Henan Section of the Yellow River Basin, China](https://doi.org/10.3390/rs18152554)
...
### [151] [Disproportionate Soil Loss from Fragmented Sloping Cropland in Mountainous Northeastern Yunnan: Integrating Sentinel-2, CSLE, and Landscape Metrics](https://doi.org/10.3390/rs18152537)
...
### [152] [FIRE-BYOL: A Real-Time Grassland Active-Fire Detection Algorithm Fusing VIIRS Fire Products and Himawari-8/9 Data](https://doi.org/10.3390/rs18152553)
...
### [153] [Study on the Distribution Characteristics and Influencing Factors of Rock Glaciers in the Lenglongling Region of the Eastern Qilian Mountains](https://doi.org/10.3390/rs18152524)
...
### [154] [GeoAdapt: Fine-Grained Keypoint Localization via Deformable Feature Refinement for Ground-Based Optical Remote Sensing](https://doi.org/10.3390/rs18152545)
...
### [155] [A Method for Segmentation and Identification of Urban Functional Areas with Generalization Ability Based on Scale-Aware Feature-Enhanced Attention Mask R-CNN](https://doi.org/10.3390/rs18152541)
...
### [156] [An Improved JSEG-Based Algorithm for Segmentation of Categorical and Remote Sensing Classification Maps](https://doi.org/10.3390/rs18152543)
...
### [157] [Open-Source Reproducible Pipeline for Multitemporal Vegetation Monitoring Using Sentinel-2 L2A in Cloud-Prone Tropical Regions](https://doi.org/10.3390/rs18152532)
...
### [158] [Frequency-Domain Modeling and Removal of Platform Jitter Stripes in GF-7 DSMs for Flat Terrains](https://doi.org/10.3390/rs18152557)
...
### [159] [Landslide Susceptibility Mapping Constrained by InSAR-Derived Deformation Using Multi-Source Data Integration](https://doi.org/10.3390/rs18152540)
...
### [160] [Vegetation Optical Depth at Enhanced Spatial Resolution: Progress, Challenges, and Perspectives](https://doi.org/10.3390/rs18152530)
...
### [161] [Sparse Rational Polynomial Coefficient Estimation Method via Low-Rank Matrix Constraint](https://doi.org/10.3390/rs18152547)
...
### [162] [Integrating Multi-Source Environmental Variables with Sentinel-3 OLCI Imagery for Interpretable Retrieval of Eutrophication Parameters in Bohai](https://doi.org/10.3390/rs18152527)
...
### [163] [TimeHome: Heterogeneous Mixture-of-Experts for Time-Series Foundation Model](https://doi.org/10.3390/rs18152533)
...
### [164] [Self-Supervised Pre-Training Style Adaptation-Guided Remote Sensing Image Change Detection Network](https://doi.org/10.3390/rs18152523)
...
### [165] [Spatiotemporal Dynamics and Driving Mechanisms of Impervious Surface Expansion in Changsha County Using Landsat Time-Series](https://doi.org/10.3390/rs18152555)
...
### [166] [An Optimized CatBoost Model for Spatiotemporal Prediction of hmF2 in High-Latitude Regions](https://doi.org/10.3390/rs18152579)
...
### [167] [Field-Scale Evapotranspiration of Flood-Irrigated Rice with Automated METRIC on Google Earth Engine in an Arid Region of Northern Peru](https://doi.org/10.3390/rs18152584)
...
### [168] [Refined Multi-Source Satellite and Reanalysis Diagnostics Reveal Topographic Anchoring and Thermodynamic Control of the Tibetan Plateau Ozone Valley](https://doi.org/10.3390/rs18152560)
...
### [169] [CDGP-Net: Channel-Decoupling and Geographic-Prior Fusion for Spatial Super-Resolution of HIRAS Radiances with Co-Platform MERSI-II](https://doi.org/10.3390/rs18152575)
...
### [170] [Exploring Marine Atmospheric Ducts: Current Sensing and Emerging Trends](https://doi.org/10.3390/rs18152576)
...
### [171] [Physics-Aware Deep Learning for SAR and InSAR Remote Sensing: Models, Methods, and Open Challenges](https://doi.org/10.3390/rs18152567)
*Giorgio Taricco*
...
### [172] [Few-Shot SAR Object Detection with Prior Class Perceptron and Cross-Entropy](https://doi.org/10.3390/rs18152580)
...
### [173] [Trends and Lagged Cumulative Associations Between Vegetation NDVI and Extreme Climate Indices in the Yangtze River Basin: A 41-Year Observational Analysis](https://doi.org/10.3390/rs18152559)
...
### [174] [Recommendations for Low-Noise Data Acquisition with UAV-Mounted Multi-Channel Magnetometer Systems](https://doi.org/10.3390/rs18152564)
...
### [175] [SDRCNet: A Lightweight Structure-Guided Dual-Relation Consensus Network for Optical Remote Sensing Images](https://doi.org/10.3390/rs18152565)
...
### [176] [A Road-Segment-Based Rockfall Susceptibility Mapping Approach Integrating Physically Informed Slope-Cutting Features and Comparative Machine Learning Models](https://doi.org/10.3390/rs18152562)
...
### [177] [Spatiotemporal Characteristics and Hydrogeological–Urban Controls of Surface Deformation in Haikou, China, Revealed by PS/DS-InSAR and Spatial Attribution Analysis](https://doi.org/10.3390/rs18152570)
...
### [178] [Design and Analysis of a Compact Airborne Hyperspectral Imager for Vegetation Photosynthesis and Stress Monitoring](https://doi.org/10.3390/rs18152585)
...
### [179] [TGMNet: Temporal-Guided Mamba Network for Moving Infrared Dim and Small Target Detection](https://doi.org/10.3390/rs18152578)
...
### [180] [Diagnosing and Conditionally Correcting X-Band Radar Underestimation in Cyprus: A Cross-Validated Evaluation of Spatial Merging and Machine Learning Approaches](https://doi.org/10.3390/rs18152577)
...
### [181] [Satellite Detection of Diffuse Tectonic CO2 Degassing in the East African Rift](https://doi.org/10.3390/rs18152586)
...
### [182] [Penetration Depth Investigation of L-Band and S-Band SAR Signals into Soils and Hard Ground Surfaces](https://doi.org/10.3390/rs18152566)
...
### [183] [A Study on Radar–Gauge Rainfall Data Merging and Its Impact on Flood Simulation](https://doi.org/10.3390/rs18152587)
...
### [184] [Principal Component Analysis of IASI Measurements for the Detection of Extreme Atmospheric Composition Events: Methodology and Applications](https://doi.org/10.3390/rs18152568)
...
### [185] [Impact of Vegetation and Soil Moisture on the Detection of Buried Landmines Using GPR](https://doi.org/10.3390/rs18152582)
...
### [186] [A Two-Stage Framework for SAR Near-Shore Ship Detection via Segmentation Guidance and Enhanced Diffusion](https://doi.org/10.3390/rs18152569)
...
### [187] [Spatial Correspondence Between Seismic b-Value Stress Localization and Pre-Earthquake GNSS-TEC Anomalies in Southern California and Northern Baja California](https://doi.org/10.3390/rs18152574)
...
### [188] [Industrial Dominance of Urban NO2 and Associated Health Risks: A Multi-Source Analysis in the Southern Region of Rio de Janeiro State](https://doi.org/10.3390/rs18152581)
...
### [189] [Change Detection in Remote Sensing Imagery: A Systematic Review of Statistical, Machine Learning, and Deep Learning Methods](https://doi.org/10.3390/rs18152573)
...
### [190] [Quality Assessment and Observation Error Estimation of Tianmu-1 GNSS Radio Occultation Bending Angle and Refractivity Retrievals](https://doi.org/10.3390/rs18152572)
...
### [191] [Robust Individual Tree Parameter Estimation in Cold–Temperate Secondary Forests Using ULS–HLS Data and the RSQ-Tree Framework](https://doi.org/10.3390/rs18152563)
...
### [192] [Pseudo 3-D GPR and 2-D ERT Study to Reveal Subtle Tectonic Deformations of a Strike-Slip Raša Fault (Dinaric Fault System, W Slovenia) in Fluvial and Karstic Environments](https://doi.org/10.3390/rs18152561)
...
### [193] [Consistent Photometric Enhancement Network for Remote Sensing Change Detection](https://doi.org/10.3390/rs18152583)
...
### [194] [A Comprehensive Machine Learning Approach for Crop Classification Using Multi-Sensor Satellite Datasets and Multiple Vegetation Indices](https://doi.org/10.3390/rs18152571)
...
### [195] [Improving Vegetation Mapping from LiDAR Point Clouds Using a Transmissivity-Based Feature](https://doi.org/10.3390/rs18152602)
...
### [215] [Geometry-Aware InSAR Feedback Purification Sampling for Negative Sample Selection in Landslide Susceptibility Assessment: A Case Study in the Shigatse Region](https://doi.org/10.3390/rs18152591)
*Honglai Chen,Chao Zhou,Yi Li,Jie Dou,Yi Chen,Yan Song*
...
Abstract (英文): Point cloud fusion is crucial in geospatial analysis, combining data from multiple sources (e.g, LiDAR and photogrammetry) to provide a more complete and accurate environmental representation. However, integrating airborne hybrid sensors or cross-source point clouds remains challenging due to variations in geometric accuracy, data precision, gaps, and sensor attributes. Despite recent advancements, these challenges remain and are among the most demanding aspects in geospatial data processing for remote sensing applications. We propose a new point cloud fusion algorithm that leverages local plane constraints to achieve advanced semantic consistency. The proposed method dynamically fits local planes to the target point clouds, enabling robust alignment of source points to these planes. Evaluation on two real-world datasets demonstrates significant gains in accuracy and preservation of geometric details. Our algorithm also improves the accuracy of downstream tasks such as semantic segmentation. In our experiment, the overall accuracy for the Dudelange dataset increases from 48.5% to 80.1%, and that for the Dublin dataset increases from 72.9% to 88.0%. While challenges persist with sparse and noisy datasets, experimental results highlight the effectiveness of the proposed method, offering valuable insights for maximizing the potential of cross-source point cloud data.

</details>


### [219] [Integrating Multi-Source Geoscientific Data via Geologically Constrained Feature Engineering for Gold Prospectivity Mapping: A Case Study of Jiaoxibei, China](https://doi.org/10.3390/rs18152593)
*Yajie Feng,Yongzhi Wang,Yigao Cheng,Jiahui Zheng,Shaohui Wang,Z. An,Zheng Ji*
...
### [222] [Landslide Susceptibility Evaluation Based on Deep Learning and Imbalanced Sampling at Multi-Scale](https://doi.org/10.3390/rs18152617)
*Wei Chen,Yijing Zheng,Chao Guo,Caihua Liu,Paraskevas Tsangaratos,Ioanna Ilia,Xiaole Zheng*
...
### [227] [LDM-PUNet: A Lightweight Network for Denoising and Phase Unwrapping SAR Interferograms in Mining Deformation Monitoring](https://doi.org/10.3390/rs18152616)
*Qi Liu,Weitao Yan,Junjie Chen*
...
### [230] [A Cross-System Remote Sensing Framework for Diagnosing Event-Scale Soil Wetting, Vertical Propagation, and Pre-Cipitation Thresholds Across China’s Croplands](https://doi.org/10.3390/rs18152614)
*Pingfan Fu,Xiaojing Yang,Dongya SUN,Juan Lv,Yanping Qu,Yuesheng Yan,Haiyang Dai,Huaiwei Sun,Yubo Li,Hanlin Zheng,Hao Sun*
...
### [241] [Joint Interpretation of Archaeological, Geological, Geophysical and Remotely Sensed Data for Fluvial Geomorphology: The Case of the Calore River Meander North of Benevento (Italy)](https://doi.org/10.3390/rs18152629)
*Vincenzo Amato,Marilena Cozzolino,Vincenzo Gentile,Paolo Mauriello*
...
Abstract (英文): Interference in the local radio network (RLAN), referred to in this study as spike-type interference, is a significant problem in data from C-band weather radars, as it can degrade the accuracy of hydrometeor monitoring. The main challenge in removing these spikes is their spatial structure, particularly when they overlap with precipitation. At the Institute of Meteorology and Water Management—National Research Institute (IMGW-PIB), algorithms for removing such disturbances have been implemented as part of the RADVOL-QC system for radar data quality control. These algorithms primarily utilise polarimetric data. This paper describes them in detail and presents examples of how they work.

</details>


### [244] [Disentangling Spectrally Similar Urban Vegetation via Semantic Segmentation-Guided Object Analysis and Multi-Periodic Phenological Features](https://doi.org/10.3390/rs18152623)
*Chenglong Zhu,Xi Cheng,Tao Liu,Haoyu Wang,Hao Lei,H. Wang,Zhanfeng Shen*
...
### [251] [FFT-Based Multiscale Frequency Decomposition for Atmospheric Lidar Attenuated Backscatter Profile Forecasting](https://doi.org/10.3390/rs18162663)
...
### [252] [Improving Accuracy of Low-Altitude Three-Dimensional Wind Field Reconstruction via Multi-Task Learning](https://doi.org/10.3390/rs18162655)
...
### [253] [GSANet: Geometric Structure-Aware Siamese Network for 3D Change Detection](https://doi.org/10.3390/rs18162647)
...
### [254] [DBKNet: A Dual-Encoder KAN Segmentation Network for Joint Extraction of Photovoltaic Power Stations and Impervious Surfaces in Arid Regions](https://doi.org/10.3390/rs18162662)
...
### [255] [Detection and Tracking of Medicanes Through DeMeTrA Self-Supervised Vision Transformer](https://doi.org/10.3390/rs18162659)
...
### [256] [Daytime–Nighttime Contrasts in Morphology–LST Associations Across Urban Functional Zones Under Heatwave Conditions: Evidence from Beijing and Nanjing, China](https://doi.org/10.3390/rs18162666)
...
### [257] [Extracting Value from Fused Aerial and Terrestrial LiDAR Scans](https://doi.org/10.3390/rs18162644)
...
### [258] [Predicting Future Forest Plantation Establishment Outcomes from UAV-Derived Pre-Planting Environmental Conditions](https://doi.org/10.3390/rs18162665)
...
### [259] [Use of Multi-Source Remote Sensing Data to Understand Long-Term Wetland Dynamics and Water Environment Responses in the Chaohu Lake Basin](https://doi.org/10.3390/rs18162646)
...
### [260] [Maturity-Gated Anti-Forgetting Sampling for Remote-Sensing Object Detection Training](https://doi.org/10.3390/rs18162657)
...
### [261] [Task-Guided CycleGAN for Domain-Adapted Coastal Boundary Segmentation in Remote Sensing Images](https://doi.org/10.3390/rs18162658)
...
### [262] [Marine Oil Film Segmentation Based on GCN-IGJO Method](https://doi.org/10.3390/rs18162660)
...
### [263] [MPC-DETR: A Multi-Scale Patch Context Transformer for Small Object Detection in UAV Imagery](https://doi.org/10.3390/rs18162650)
...
### [264] [Influence of Dust Aerosol on Temperature Field and Boundary Layer During a Typical Dust Storm Event in China](https://doi.org/10.3390/rs18162656)
...
### [265] [TinyCapsViT: Ultra-Lightweight Hyperspectral and Multispectral Image Classification for UAV Edge Deployment Using Capsule Vision Transformers](https://doi.org/10.3390/rs18162661)
...
### [266] [Fine-Scale Eddies Revealed by the Surface Water and Ocean Topography (SWOT) Mission](https://doi.org/10.3390/rs18162654)
...
### [267] [Analyzing Variability and Trends in NDVI: A Remote-Sensing Approach for Long-Term Monitoring of Urban Green Spaces](https://doi.org/10.3390/rs18162652)
...
### [268] [Red-Edge Vegetation Index Optimization Within Phenological Windows for Discriminating Rice from Artificial Grassland: A Case Study in Jurong, China](https://doi.org/10.3390/rs18162653)
...
### [269] [Seasonally Optimized Interferometric Network Stacking-InSAR for Subsidence Detection of Mined-Out Zones in Alpine Terrain: A Case Study of the Songhu Iron Mine, Xinjiang, China](https://doi.org/10.3390/rs18162648)
...
### [270] [Remote Sensing-Based Detection and Statistical Characterization of Large Landslides in the Transylvanian Basin](https://doi.org/10.3390/rs18162645)
...
### [271] [Distinguishing High- and Low-Yielding Durum Wheat Genotypes Using UAV Spectral and Textural Data](https://doi.org/10.3390/rs18162664)
...
### [272] [Integrating Multi-Season Sentinel-1/2 and Topographic Features to Improve Tree Species Diversity Estimation Accuracy](https://doi.org/10.3390/rs18162651)
...
### [273] [A new approach for comprehensive and spatiotemporally comparable Eco-Environmental quality assessment of surface coal Mines: MiecoI](https://doi.org/10.1016/j.jag.2026.105506)
...
### [274] [A near-real-time and unsupervised framework for grain crop harvest detection using sentinel-2 imagery: the reaped index (RI) and automated thresholding](https://doi.org/10.1016/j.jag.2026.105510)
...
### [275] [V-BUILD: A graph Transformer-based decision framework for selective updating of vector building data](https://doi.org/10.1016/j.jag.2026.105507)
*Yue Qiu,Fang Wu,Haizhong Qian,Jichong Yin,Xianyong Gong,Chengyi Liu,Hao Zhang,Rui Cao*
...
Abstract (英文): Keeping vector building databases current requires deciding which database operations should be applied, rather than merely detecting binary geometric differences. Minor discrepancies caused by acquisition noise, representation style, or cartographic generalization may trigger unnecessary updates when using hand-tuned geometric thresholds. We present V-BUILD, a hybrid decision framework that assigns each matched building unit one of four operations: addition, deletion, replacement, or preservation. Deterministic rules handle existential decisions, while a geometry-aware graph Transformer learns the more ambiguous morphological decisions between replacement and preservation directly in the vector domain. The model encodes 1:1 to m:n matching relationships via Unified Correspondence Graphs and uses Adaptive Multi-stream Fusion to integrate node-, edge-, and graph-level geometric descriptors. Experiments on Amsterdam TOP10NL, Hamburg LoD1, and Mercer County OSM data, together with a difficult Amsterdam subset, show that V-BUILD performs well in within-domain evaluations on both authoritative and crowdsourced vector data, while leave-one-domain-out analysis indicates that direct cross-source transfer remains challenging under strong domain shift. On Amsterdam, V-BUILD achieves the best Replacement F1 of 89.44 %; on Mercer, it obtains the best Macro F1 of 88.51 %, outperforming the strongest GNN baseline by 4.22 percentage points; and on the difficult Amsterdam subset, it achieves a 4.51-percentage-point higher Replacement F1 than the strongest GNN baseline, with the associated reduction in paired sample-level errors confirmed by a two-sided exact McNemar test. These results indicate that V-BUILD reduces dependence on manually tuned geometric decision thresholds and provides a practical decision module for incremental vector building database updating.

</details>


### [276] [Reducing grid artifacts in air temperature downscaling with a Volume-Preserving interpolation preprocessing step](https://doi.org/10.1016/j.jag.2026.105515)
*Zitong Wen,Lu Zhuo,Jiao Wang,Ahmed AbdelHalim,Ming Zhong,Dawei Han*
...
### [278] [Linear-Fitting calibration algorithm for Aerosol-Cloud detection channels at 532 nm of the DQ-1/ACDL](https://doi.org/10.1016/j.jag.2026.105504)
*Feiyue Mao,Chengen Li,Lin Zang,Zengxin Pan,Weiwei Xu,Ge Han,Xiuqing Hu,Weibiao Chen,Wei Gong*
...
Abstract (英文): The Aerosol and Carbon Detection Lidar (ACDL) aboard the DQ-1 satellite is a new-generation spaceborne high-spectral-resolution lidar (HSRL) with 532 and 1064 nm channels for aerosol and cloud observations. The calibration at 532 nm is the foundation for producing ACDL products. However, ACDL lacks direct background-noise measurements, which limits the applicability of conventional calibration approaches. To address this issue, we propose a linear-fitting calibration method that uses multiple clear-air altitude bins to solve simultaneously for the calibration coefficient and the background offset. Nighttime calibration is performed in clear-air regions at 34–38 km, while daytime calibration uses a clear-air calibration-transfer region located 2–6 km above the 400 K isentropic surface. The calibration results show that the total and molecular-channel attenuated scattering ratios (ASRs) were approximately 1 at 30–34 km, for both nighttime and daytime observations, indicating the effectiveness of the method. A one-month cross-validation was conducted by comparing the total attenuated backscatter (TAB) of ACDL, derived from different calibration methods, with NASA CALIPSO/CALIOP products. The ACDL TAB obtained by the linear-fitting method is consistent with CALIOP during both nighttime and daytime, with mean deviations of about −0.3 % and −1.6 % above 10 km, respectively, whereas the conventional ratio method yields deviations more than an order of magnitude larger when background noise is estimated above 35 km. This work resolves ACDL’s calibration challenges at 532 nm and establishes a foundation for reliable aerosol and cloud products that support future atmospheric and climate research.

</details>


### [279] [Early detection of rice bacterial leaf blight disease using canopy hyperspectral data and machine learning](https://doi.org/10.1016/j.jag.2026.105511)
*Ziyi Wang,Roshanak Darvishzadeh,Nancy Castilla,Alice Laborte,Andrew Nelson*
...
### [280] [A loop-outlier-aware Riemannian pose-graph optimization framework for robust visual localization](https://doi.org/10.1016/j.isprsjprs.2026.07.024)
...
### [281] [TALineNet: A benchmark and network for temporally-aware continuous line segment detection in event streams](https://doi.org/10.1016/j.isprsjprs.2026.07.030)
*Xinya Wang,Haitian Zhang,Qinyue Yu,Xiangyuan Wang,Xianrong Wan,Huai Yu*
...
### [282] [ADAPT-Tracker: Adaptive dynamic perception and trajectory-consistent network for aerial multi-object tracking](https://doi.org/10.1016/j.isprsjprs.2026.07.010)
*Jian Zou,Ke Liu,Wei Zhang,Qiang Li,Qi Wang*
...
### [283] [CoRE-UIR: Prior-guided common and residual experts for efficient all-in-one remote sensing image restoration](https://doi.org/10.1016/j.isprsjprs.2026.07.028)
...
### [284] [HCFNet: Hierarchical and complementary feature embedding for remote sensing change captioning](https://doi.org/10.1016/j.isprsjprs.2026.07.020)
...
### [285] [PVP-adapter: Dual-branch spatial-frequency adaptation for change detection of photovoltaic panels](https://doi.org/10.1016/j.isprsjprs.2026.07.032)
...
### [286] [A vertical FVC profile retrieval method (OLV-FVC) based on airborne LiDAR point cloud under the constraint of optical remote sensing for forest plots](https://doi.org/10.1016/j.isprsjprs.2026.07.031)
...
### [287] [Aerial Image Gravity Direction Estimation (AGE): Robust single-image estimation by fusing foundation model features with camera geometry](https://doi.org/10.1016/j.isprsjprs.2026.07.019)
...
### [288] [Agentic Nesting: A New Methodology for Existing Enterprise Application Integration and Services](https://arxiv.org/abs/2608.05159)
...
Abstract (英文): Large language models often fail on reasoning tasks despite possessing the capability to solve them. We argue that many such failures arise from localized reasoning bugs in intermediate steps rather than from global incompetence. We show that these bugs are frequently repairable: inserting a short patch generated by a weak probe model after the same strong-model reasoning prefix can redirect the trajectory toward a correct solution.
...
### [291] [From Continuous Predictors to Clinical Thresholds: Early Evidence on Performance Trade-offs of Guideline-Based Categorisation for Ischaemic Stroke Outcome Prediction](https://arxiv.org/abs/2608.05203)
...
### [295] [SearchAuditor: Auditing and Attributing Failures in Long-Horizon Search Agents](https://arxiv.org/abs/2608.05212)
...
### [308] [CASCADE: An Agentic Regulatory Network Framework for Patient-Data-Validated Downstream Perturbation Prediction](https://arxiv.org/abs/2608.05359)
*Jose A. Bird*
...
Abstract (英文): CASCADE is an agentic framework that predicts downstream transcriptional effects of gene perturbation from precomputed
...
### [309] [Counterfactual Analysis via Large Language Models](https://arxiv.org/abs/2608.05367)
*Zonghao Yang*
...
### [311] [C$^3$PO: Evaluating Cross-Modal Composition and Counterfactual Performance in Omnimodal Models](https://arxiv.org/abs/2608.05381)
...
### [327] [Refining Over Resampling: Test-Time Self-Correction for LLM Reasoning](https://arxiv.org/abs/2608.05643)
...
### [331] [Shaping Human-AI Interactions to Provide Improvement Pathways and Balance Competing Objectives](https://arxiv.org/abs/2608.05710)
*Keziah Naggita*
...
Abstract (英文): When an AI system is deployed, the individuals who use and or are evaluated by it form beliefs about how the system operates and use those beliefs to strategically present their preferences, behaviors, or attributes. The system then responds with feedback or a decision outcome, thereby creating a human-AI interaction loop. This thesis studies how to design and shape such interactions to achieve three goals: (1) help individuals develop accurate beliefs about the AI systems so they can improve and or secure favorable outcomes at minimal cost, (2) encourage improvement and or discourage gaming behaviors, and (3) ensure that the AI system continues to achieve its intended objectives, such as maximizing accuracy. To address these goals, the thesis is organized into three complementary parts that examine and study human-AI interactions from the perspectives of both evaluated individuals and AI systems. Together, the work presented in this thesis advances human-centered machine learning by providing principles and methods for designing AI systems that align with human needs, values, and capabilities. Methodologically, this thesis integrates theoretical analysis, data-driven modeling, human-subject experiments, and empirical evaluations on real-world and semi-synthetic datasets.

</details>


### [332] [RA-CAD: Learning Post-Execution Critique for State-Aware Text-to-CAD Generation](https://arxiv.org/abs/2608.05714)
...
### [334] [Unified Agent: Managing Interactions across Devices](https://arxiv.org/abs/2608.05729)
...
### [338] [ChainClaw: A Layered Agent Framework for Reliable On-Chain Execution](https://arxiv.org/abs/2608.05790)
...
Abstract (英文): Reinforcement Learning (RL) is a powerful but far from easy-to-use technique for policy learning. In the specific case of video games, access to the game engine is required to get rewards for training (e.g. to collect rewards from the environment). Furthermore, the proper identification and weighting of the rewards generally requires a difficult trial-and-error approach. Lastly, rewards are often sparse and understanding how they eventually affect the learned policy is a non-trivial exercise. To ease these issues we propose annotating a video game dataset with Vision Language Models (VLMs) instructed to extract human defined rewards. We show that offline RL can then be used to train a conditioned agent that responds accordingly to the desired returns and we discuss the difficulties and limitations that emerged in our early experiments.

</details>


### [354] [Stability of Ranking-dependent Pair-wise Comparison Patterns in the Analytic Hierarchy Process](https://arxiv.org/abs/2608.05958)
...
Abstract (英文): Investment competence is inherently personalized: the same market evidence can justify different actions for investors with different goals, horizons, portfolios, and risk boundaries. Yet financial LLMs are evaluated either by static question answering or by terminal profit and loss. The former omits agency; the latter cannot reveal whether a profitable action was grounded, profile-consistent, or merely lucky. We ask whether the community is using the wrong ruler for consequential agents.
...
### [365] [ECHO: A Locally-Deployable Agentic Health Assistant with Temporal Memory, Safety Guardrails, and Speech Assessment](https://arxiv.org/abs/2608.06110)
...
### [375] [MicroEvo: Knowledge-Guided LLM Sampling for Efficient Microarchitecture Design Space Exploration](https://arxiv.org/abs/2608.06183)
...
### [381] [The Illusion of Visual Tool-Use: A Causal Audit of Thinking with Images](https://arxiv.org/abs/2608.06270)
...
Abstract (英文): As LLMs are increasingly deployed within agentic systems, their capabilities depend not only on the model weights but also on the harness: the prompts, tools, control flow, memory, and orchestration code surrounding them. This makes automated harness optimization -- the iterative and evaluation-guided improvement of a harness by an AI system -- both an important route to improving AI systems and a demanding capability for AI systems themselves. Yet the community lacks a common protocol for measuring how well frontier LLMs perform at this task. We introduce HarnessOpt-Bench, a benchmark for end-to-end harness optimization under expensive and stochastic evaluation. An optimizer, an LLM paired with a coding harness, receives a target agent's seed harness, graded evaluation feedback, and a fixed target-evaluation budget. It edits the harness and nominates a final candidate, which is scored by its normalized gain over the seed on a held-out test partition that remains inaccessible throughout search. A trusted execution environment enforces the evaluation boundary, meters target-agent resource use, and preserves candidate versions for audit. We evaluate 5 frontier LLMs as optimizers both under a shared coding harness and under their native harnesses across 4 downstream tasks, over 111 scored runs. Experiment results show that optimizer models separate more than the coding harnesses they act through, native harnesses are not consistently superior, and gains vary substantially across tasks and seed regimes. These results establish harness optimization as a measurable and discriminative capability with large space for improvement.

</details>


### [385] [Beyond Top-K: Replacing Black-Box Retrieval with Interpretable Agentic Operations](https://arxiv.org/abs/2608.06305)
...
### [390] [Assessing SWOT's capability for surface water extent mapping: An evaluation of Level-2 High-Rate Raster water fraction](https://doi.org/10.1016/j.rse.2026.115595)
...
### [391] [Mitigating terrain effects of GEDI data on regional accounting of aboveground biomass utilizing slope-adaptive waveform metrics](https://doi.org/10.1016/j.rse.2026.115598)
...
### [392] [Extending the MAIAC algorithm for hyperspectral atmospheric correction of TROPOMI measurements: A case study over vegetated regions](https://doi.org/10.1016/j.rse.2026.115593)
...
### [393] [Drivers of spectro-temporal variability in multi-spectral soil reflectance measured from space: A continental-scale analysis](https://doi.org/10.1016/j.rse.2026.115599)
...
### [395] [Where sky meets sea: Integrated aerosol and ocean color retrieval from PACE SPEXone multi-angle polarimetry](https://doi.org/10.1016/j.rse.2026.115603)
*Meng Gao,Kamal Aryal,Peng‐Wang Zhai,Kirk Knobelspiesse,Bryan Franz,Brian Cairns,Ivona Cetinić,Guangliang Fu,Otto Hasekamp,Amir Ibrahim,Andrew M. Sayer,P. Jeremy Werdell*
...
Abstract (英文): Global aerosol and ocean color properties are simultaneously retrieved from multi-angle polarimetric measurements acquired by the SPEXone instrument aboard NASA’s PACE mission. These coupled retrievals are enabled by the FastMAPOL algorithm, which combines optimal estimation with deep neural network forward models to achieve efficient and accurate operational processing. Ocean remote-sensing reflectance ( R r s ) is derived through multi-angle atmospheric correction, introducing an explicit angular dimension for characterizing aquatic optical properties. Since early 2024, both Level-2 and Level-3 global products have been generated in near real time and are publicly distributed through the NASA Earthdata archive. Validation against the Aerosol Robotic Network (AERONET) and associated AERONET-Ocean Color (OC) observations demonstrates robust performance for both atmospheric and oceanic retrievals. Retrieved aerosol optical depth (AOD) exhibits overall uncertainties (RMSD) of approximately 0.06, with mean biases smaller than 0.01, while 63% of retrievals satisfy the uncertainty threshold of max ( 0.04 , 10 % ) , across a wide range of aerosol loadings and water conditions. Retrieved R r s exhibits uncertainties of approximately 0.001 – 0.002 sr − 1 and biases on the order of 0.001 sr − 1 across phytoplankton-dominated waters. R r s retrieval uncertainties increase with aerosol loading, whereas AOD retrieval uncertainties increase with water complexities, highlighting the coupled nature of aerosol and ocean color retrievals. Moreover, global gridded analyses reveal realistic spatial patterns of aerosol type, absorption, and ocean color variability. The angular variability of multi-angle R r s is further examined across latitudes and seasons, including a closure assessment based on a self-consistent bidirectional reflectance correction. This study provides a comprehensive validation of the FastMAPOL SPEXone V3 data products and establishes a baseline for the expected improvements in aerosol and R r s retrievals with the upcoming V4 release, which incorporates updated radiometric calibration. PACE multi-angle polarimetry thus establishes a new capability for fully integrated global aerosol and ocean color retrievals, enhancing our ability to characterize aerosol–ocean interactions and advance understanding of the coupled Earth system.

</details>


### [396] [Tracking global extreme afternoon photosynthesis depression: Frequency, duration, and drivers from satellite-based hourly GPP products](https://doi.org/10.1016/j.rse.2026.115597)

...
Abstract (英文): The recently deployed Entry/Exit System (EES) introduces large-scale biometric verification into European border control, requiring face recognition systems to operate at extremely low false match rates (FMR). While regulatory frameworks define performance targets at the EES Central System level, they do not specify how verification thresholds should be calibrated in practice at the Member State level. In operational settings, obtaining representative real-world data for calibration is often constrained by legal, logistical, and privacy limitations.
...
### [89] [Enhanced land surface phenology detections in the western U.S. drylands by fusing harmonized Landsat and Sentinel-2 observations with near-surface PhenoCam time series](https://doi.org/10.1016/j.rse.2026.115588)
...
### [90] [Substantial improvement of geostationary satellite-derived shortwave radiation product through correcting geolocation displacement](https://doi.org/10.1016/j.rse.2026.115589)
...
### [91] [Breaking barriers in rice chlorophyll retrieval from satellite imagery: Mitigating row structure and saturation effects via RiceGORT and chlorophyll sensitivity enhancement](https://doi.org/10.1016/j.rse.2026.115581)
...
### [92] [Retrieval of sea surface salinity from SMAP L-band radiometry under rainfall conditions](https://doi.org/10.1016/j.rse.2026.115570)
...
### [93] [A scattering model-informed deep transfer learning framework for surface soil moisture retrieval](https://doi.org/10.1016/j.rse.2026.115571)
...
### [94] [cscMTCI: A soil and structure corrected MERIS terrestrial chlorophyll index for improving leaf chlorophyll content estimation](https://doi.org/10.1016/j.rse.2026.115582)
...
### [95] [MUSTI: Multi-scale spatiotemporal tensor imputation for global leaf area index time series reconstruction](https://doi.org/10.1016/j.rse.2026.115559)
...
### [96] [GNSS–T for ecohydrological monitoring of a european beech forest: Assessing different system and band characteristics for resolving temporal VOD dynamics](https://doi.org/10.1016/j.rse.2026.115580)
...
### [97] [Do Models Fake Alignment Without Clear Consequences?](https://arxiv.org/abs/2607.24758)
...
### [101] [GrocLM: Grocery Category Recommendation in E-Commerce with Large Language Models](https://arxiv.org/abs/2607.24764)
...
### [102] [Crystalis: Progressive Nucleation and Semantic Annealing for Coordinated Multi-View Visualization Generation](https://arxiv.org/abs/2607.24766)
...
Abstract (英文): Managing cloud infrastructure efficiently, especially in environments of large cloud providers or hyperscalers, requires optimizing the use of physical resources to minimize costs and maximize performance. Selecting the right virtual machine (VM) sizes is crucial to achieving cost efficiency in these dynamic environments. However, traditional VM allocation and scheduling approaches often fail to account for the fluctuating and unpredictable nature of VM utilization, leading to inefficiencies such as over- or under-provisioning of resources. High-quality interval prediction helps accurately capture uncertainty in cloud resource demand and supports cloud operators in efficient instance provisioning.
...
### [109] [Atmospheric Diffusion-Guided Spatio-Temporal Transformer for Nuclear Radiation Forecasting](https://arxiv.org/abs/2607.24774)
...
Abstract (英文): LLM behavior may be conditioned by human identity in several ways: they may be asked to adapt to users, role-play populations, or forecast how people would answer value-laden questions. We test whether these framings are interchangeable using the World Values Survey (WVS). We evaluate GPT-5.4, Claude Sonnet 4.6, Gemini 2.5 Flash, and Qwen3-235B on 101 WVS-derived questions across 13 language-country slices, comparing a language-only baseline with user-country, persona-country, and third-person prompts. Across 21,008 model-response rows, prompt framing is a first-order determinant of cultural alignment: country cues often shift answers substantially, but not all shifts move toward matched human response distributions. Third-person forecasting yields the strongest directional alignment for three of the four hosted models, while personalization and role-play are weaker or less stable. Alignment gains concentrate on salient value dimensions such as religiosity, gender roles, and work-oriented material values, whereas institutional trust and democracy-related questions remain difficult. These results show that prompt framing is not a cosmetic choice in cultural value elicitation; it changes both model behavior and measured alignment.

</details>


### [114] [Unified Semantic Modeling Framework for Large-Scale Job Understanding at LinkedIn](https://arxiv.org/abs/2607.24783)
...
### [125] [Understanding Semantic IDs: From Item Representation to Item Selection in Generative Recommendation](https://arxiv.org/abs/2607.24995)
...
### [126] [Localized Anomaly Detection via Differentiable D-vine Copulas](https://arxiv.org/abs/2607.25020)
...
### [127] [Chart-Supported or Model-Supplied? Examining MLLM-Generated Claims for Accessible Visualization](https://arxiv.org/abs/2607.25021)
...
### [133] [How Often Should a Recommender Call an LLM? Value-Weighted Routing, Monitoring, and Seasonal Robustness](https://arxiv.org/abs/2607.25068)
*Bhavtosh Rath*
...
### [139] [Less Data, Better Alignment: Data-Centric Multi-Evaluator Agreement for Preference Optimization](https://arxiv.org/abs/2607.25136)
...
### [141] [Inferring Missing Trajectory Data with Temporal Convolutional Networks](https://arxiv.org/abs/2607.25147)
...
### [143] [PreDiff-LM: Pretrained Discrete Masked Diffusion Language Modeling with Hybrid Attention](https://arxiv.org/abs/2607.25157)
...
### [160] [COVENANT: Natural-Language Workflow Compilation for Aligned Agent Execution](https://arxiv.org/abs/2607.25400)
...
### [161] [Context Assembly as the Controlled Variable: A Control-Theoretic View of Harness Policies for Frozen LLM Agents](https://arxiv.org/abs/2607.25408)
*Debjyoti Paul*
...
### [171] [Are the High-weight Neurons the Important Ones in Image Classification Neural Networks?](https://arxiv.org/abs/2607.25529)
...
### [178] [A Density-Matrix Framework for Electronic-Structure Analysis of Functional-Group and Salt Effects in Lithium-Metal Electrolytes](https://arxiv.org/abs/2607.25597)
...
Abstract (英文): Objective: Concept bottleneck models route prediction through interpretable intermediate variables, and their validity is normally judged by how accurately those variables are predicted. We ask whether that judgement is sufficient, using left ventricular volumes as the concepts underlying ejection fraction estimation from echocardiographic video.
...
### [195] [Speculate While You Reason: Teaching Agents to Predict Their Next Tool Call via Joint Agent-Speculator RL](https://arxiv.org/abs/2607.25816)
...
### [196] [Distributed Constraint Optimization via Online Learning and Iterative Pricing with Application to Large-Scale Satellite Scheduling](https://arxiv.org/abs/2607.25835)
...
### [198] [Runtime Uncertainty Monitoring for LLM-Based Multi-Agent Systems Using Bayesian Networks](https://arxiv.org/abs/2607.25877)
...
### [209] [Spatiotemporal dynamics of grasshopper habitats under future climate projections, vegetation growth, and land use change](https://doi.org/10.1016/j.jag.2026.105481)
...
### [210] [Quantifying methane emissions from large coal mine using Sentinel-5 Precursor satellite data and Gaussian plume model](https://doi.org/10.1016/j.jag.2026.105491)
...
### [211] [Enabling maize mapping in double-cropping regions of Argentina and Brazil without ground reference data by leveraging multiple satellite platforms](https://doi.org/10.1016/j.jag.2026.105489)
...
### [212] [SuperDove satellite detection of matter-loaded windrows with a focus on extreme environmental events](https://doi.org/10.1016/j.jag.2026.105469)
...
### [213] [An integrated picture fuzzy entropy–MAIRCA–TOPSIS framework for sustainable soil suitability evaluation](https://doi.org/10.1016/j.jag.2026.105474)
...
### [214] [A transferable framework for roof vegetation mapping across tropical cities based on open-source multimodal data and morphology-aware UDASS](https://doi.org/10.1016/j.jag.2026.105490)
...
### [215] [MFRXG: A multi-feature stacking ensemble RF-XGBoost model for total nitrogen retrieval in the Yellow River from Landsat 8/9 data](https://doi.org/10.1016/j.jag.2026.105492)
...
### [216] [HeightCLIP: A vision-language network for height estimation from monocular remote sensing imagery](https://doi.org/10.1016/j.jag.2026.105499)
...
### [217] [Urban digital twin for environmentally sensitive mobility planning: conceptual framework and application in pilot region Leipzig](https://doi.org/10.1016/j.jag.2026.105477)
...
### [218] [DINO-Pheno-Cluster: Integrating few-shot foundation models and UAV time-series for spatiotemporal growth and functional characterization of alfalfa](https://doi.org/10.1016/j.jag.2026.105497)
...
### [219] [PLGF-NET: A Physics-Guided Local-Global fusion network for GNSS-R high wind speed retrieval](https://doi.org/10.1016/j.jag.2026.105493)
...
### [220] [Earth Observation–Based Machine learning for operational forecasting of harmful algal blooms in the Arabian Gulf and Sea of Oman](https://doi.org/10.1016/j.jag.2026.105501)
...
### [221] [BQEL-Net: A bimodal quantitative ensemble learning network with uncertainty-aware for vectorized extraction of martian impact craters from bimodal catalogic-and-quantitative dataset (BCQDS)](https://doi.org/10.1016/j.jag.2026.105494)
...
### [222] [Identification and classification of risk zones for Calliptamus italicus based on remote sensing and ensemble modeling: considering population density and habitat suitability](https://doi.org/10.1016/j.jag.2026.105498)
...
### [223] [An interpretable Earth observation framework for estimating lake dissolved organic carbon in Sweden using Sentinel-2 and ERA5-Land data](https://doi.org/10.1016/j.jag.2026.105488)
...
### [224] [Fusing very high-resolution aerial imagery with Sentinel-1 and Sentinel-2 time series improves multi-year orchard type classification](https://doi.org/10.1016/j.jag.2026.105495)
...
### [225] [SWOT-derived high-resolution lake surface topography for enhanced lake water level retrieval](https://doi.org/10.1080/15481603.2026.2707798)
...
### [226] [A singularity regression kriging for spatial prediction](https://doi.org/10.1080/15481603.2026.2690341)
...
### [227] [Integrating local spatial outliers into context-aware spatial prediction models](https://doi.org/10.1080/15481603.2026.2700126)
...
### [228] [Landsat-derived gap-free monthly 30-m dataset (2000–2021) unraveling intra-annual surface water dynamics on the Tibetan Plateau](https://doi.org/10.1080/15481603.2026.2707752)
...
### [229] [Generalised spatial error for validation](https://doi.org/10.1080/15481603.2026.2690327)
...
### [230] [Improved estimation of daily surface all-wave net radiation from FY3D MERSI-II data based on pseudo-label learning](https://doi.org/10.1080/15481603.2026.2702169)
...
### [231] [DPSF: A Dynamic Patch Shape Selection Framework for Cross-Model Transferable Adversarial Attacks](https://doi.org/10.3390/rs18142426)
...
### [232] [CLIFF: A Multi-Modal Remote Sensing Model for Geological Hazard Monitoring Based on Bitemporal UAV Images](https://doi.org/10.3390/rs18142432)
...
### [233] [LHEM-MSegNet: A Landslide Hazard Extraction Model Based on Multi-Source Data Fusion](https://doi.org/10.3390/rs18142429)
...
### [234] [Fugitive Methane Monitoring: A Systems Review of Physics, Technology, Economics, and Regulation](https://doi.org/10.3390/rs18142433)
*P. Sobrón*
...
### [235] [Vertical Canopy Gap Profiles Reveal Structural Divergence Among Central African Old-Growth Forest Types](https://doi.org/10.3390/rs18142431)
...
### [236] [Evaluating Waterlogging Risk Inequality in a Megacity](https://doi.org/10.3390/rs18142428)
...
### [237] [Hydrological Evolution of Siling Co over the Past 38 Years: Lake Area, Water Level Monitoring, and Water Storage Estimation Based on Multi-Source Remote Sensing](https://doi.org/10.3390/rs18142427)
...
### [238] [An Integrated and Hierarchical Geophysical Workflow for Subsurface Cavity Assessment in Legacy Mining Districts](https://doi.org/10.3390/rs18142430)
...
### [239] [Empirical Evaluation of Normality Tests and Heavy-Tailed Error Models for NMEA-Derived GNSS Positioning Data from a Low-Cost Receiver](https://doi.org/10.3390/rs18152446)
...
### [240] [Near-Real-Time Flood Disaster Monitoring Based on Moonlight and Multi-Source Remote Sensing: A Case Study of Zhengzhou Rainstorm](https://doi.org/10.3390/rs18152435)
...
### [241] [GTSNet: A Global Topography-Aware Segmentation Network for Remote Sensing Identification of Unstable Rock Masses](https://doi.org/10.3390/rs18152445)
...
### [242] [Rapid Strong Earthquake Magnitude Estimation Based on Near-Field High-Rate GNSS Data Using Deep Learning](https://doi.org/10.3390/rs18152444)
...
### [243] [Landslide Susceptibility Mapping Using an Image–Tabular Joint Deep Learning Framework: A Case Study of the Tacheng Region, Xinjiang, China](https://doi.org/10.3390/rs18152436)
...
### [244] [TCM-CR: Multi-Temporal SAR–Optical Cloud Removal with a Reference Image and Gated Bounded Residual](https://doi.org/10.3390/rs18152443)
...
### [245] [Effect of Shape on the Temperature of a Blackbody: Implications for Remote Sensing of Interplanetary Dust Particles](https://doi.org/10.3390/rs18152434)
...
### [246] [First-Derivative Analysis for Estimating Water Quality and Optical Metrics in Shallow Coastal Waters](https://doi.org/10.3390/rs18152441)
...
### [247] [Delineating Roofing Materials in Urban Areas Using Transformed High-Resolution Satellite Imagery and Convolutional Neural Networks](https://doi.org/10.3390/rs18152440)
...
### [248] [Improved Weighted Nuclear Norm Minimization for Infrared Dim and Small-Target Detection Based on Low-Rank Clustering](https://doi.org/10.3390/rs18152442)
...
### [249] [CMGFDet: Cross-Modal Gated Fusion Network with Multi-Receptive Field Aggregation for RGB–Infrared Aerial Object Detection](https://doi.org/10.3390/rs18152439)
...
### [250] [Efficient Online Sparse Target Reconstruction for Stochastic Radiation Radar Based on Progressive Staring Sparse Pruning Approach](https://doi.org/10.3390/rs18152438)
...
### [251] [Task-Specific Negative Sample Selection for Multi-Hazard Susceptibility Mapping of Slope-Instability Hazards](https://doi.org/10.3390/rs18152437)
...
### [252] [An Improved Recognition Technique for Ship Targets Based on Dual-Path Cooperative Fusion Mechanism](https://doi.org/10.3390/rs18152447)
...
### [253] [A Decade of Remote Sensing for Vegetation Monitoring with Sentinel-2](https://doi.org/10.3390/rs18152448)
...
### [254] [Quantifying Tidal Asymmetry of Suspended Sediment Concentration in Macro-Tidal Embayments: A Sentinel-2 Based Framework](https://doi.org/10.3390/rs18152450)
...
### [255] [Multi-Scale Lightweight Spectral Attention Network for Hyperspectral Image Classification](https://doi.org/10.3390/rs18152451)
...
### [256] [GeoMamba: Geometric-Prior-Infused Multi-Scale Deformable Visual Mamba for Crack Semantic Segmentation](https://doi.org/10.3390/rs18152449)
...
### [257] [Spatially Robust Land Cover Classification with Multi-Seasonal Sentinel-2 Imagery: A Comparison of CNN, UNet++, ConvNeXt and ViT](https://doi.org/10.3390/rs18152463)
...
### [258] [Maize Yield Prediction via Data Fusion of UAV Multi/Hyperspectral Imagery and In-Field Measurements](https://doi.org/10.3390/rs18152460)
...
### [259] [Integrating Phenological and Management Signals for Cross-Regional Ginger Mapping with Multi-Temporal Sentinel-2](https://doi.org/10.3390/rs18152453)
...
### [260] [Ground Motion Monitoring System of InSAR.Hungary: Results and Validation Findings](https://doi.org/10.3390/rs18152466)
*Bálint Magyar*
...
### [261] [Monitoring Coastal Surface Roughness Suppression Associated with Algal Blooms and Pollutants Using NASA SWOT Observations](https://doi.org/10.3390/rs18152464)
...
### [262] [Joint 3D Reconstruction and Classification of Aircraft Based on Single-Image Neural Implicit Optimization](https://doi.org/10.3390/rs18152461)
...
### [263] [Discrete Space-Target Trajectory Detection with a Linearity-Enhanced Network on Stacked Optical Images](https://doi.org/10.3390/rs18152457)
...
### [264] [Ensemble Learning with Multi-Source Data Fusion for Modeling and Gap-Filling of Streetscape Greenery: An Application to Shichahai, Beijing](https://doi.org/10.3390/rs18152459)
...
### [265] [Spatio-Temporal Monitoring of the Invasive Plant Alternanthera philoxeroides in a Narrow River Using Sentinel-2 Time-Series Data](https://doi.org/10.3390/rs18152462)
...
### [266] [Design and Performance Analysis of a Mid-Wave Infrared, Compressive Sensing Based, Multispectral Imager for the Detection of High Temperature Events](https://doi.org/10.3390/rs18152454)
...
### [267] [Synthetic Surface Roughness Using Eigen-Space Transformation Approach for Improved Surface Soil Moisture Retrieval from C-Band SAR Data](https://doi.org/10.3390/rs18152455)
...
### [268] [A CASA-Based, MODIS-Constrained Framework for Consistent Annual NPP Simulation in Alpine Complex Environments: A Case Study of the Gannan Plateau](https://doi.org/10.3390/rs18152456)
...
### [269] [Geometry-Guided Diffusion SAR Point Cloud Denoising](https://doi.org/10.3390/rs18152458)
...
### [270] [Testing a Novel Transfer Learning Approach to Estimate War-Related Crop Yield Losses in Ukraine](https://doi.org/10.3390/rs18152465)
...
### [271] [DPMSCH-Net: A Dual Prior-Guidance Multi-Scale SSM-CNN Hybrid Network with Manifold Constraints for Hyperspectral Image Classification Under Small-Sample Conditions](https://doi.org/10.3390/rs18152452)
...
### [272] [Urban sidewalk detection via a cross-view joint segmentation method using satellite and street-view imagery](https://doi.org/10.1016/j.isprsjprs.2026.07.003)
...
### [273] [Edge-preserving and uncertainty-guided domain adaptation for weakly supervised rooftop photovoltaic mapping](https://doi.org/10.1016/j.isprsjprs.2026.07.008)
...
### [274] [SARMelt: MGLANet-driven high-resolution surface melt mapping of circum-Antarctic ice shelves from Sentinel-1 imagery during 2015–2023](https://doi.org/10.1016/j.isprsjprs.2026.07.012)
...
### [275] [Tracking forest carbon and growth in large-scale passive restoration using multi-temporal airborne lidar](https://doi.org/10.1016/j.isprsjprs.2026.07.013)
...
### [276] [Editorial Board](https://doi.org/10.1016/s0924-2716(26)00365-5)
*Unknown Author*
...
### [277] [Deep learning-based decoupling of hydro-meteorological signals from Cheonji caldera lake water levels for volcanic precursor detection](https://doi.org/10.1016/j.isprsjprs.2026.07.006)

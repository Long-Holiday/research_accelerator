...
- [RSE](#RSE) [Total: 4]
- [JAG](#JAG) [Total: 9]
- [Remote Sensing](#Remote Sensing) [Total: 55]
...
Abstract (英文): Magnetic Resonance Imaging (MRI) is often acquired with anisotropic resolution to reduce scan time, producing stair-step artifacts along the through-plane direction. In through-plane MRI super-resolution, an efficiency-fidelity trade-off arises: feed-forward regressors are fast but oversmooth at large slice-thicknesses, while sampling-based methods improve fidelity at high inference cost. We propose DRIFT, a two-stage thickness-conditioned rectified flow framework for through-plane MRI super-resolution with continuous input slice-thickness. Stage 1 employs an Anatomical Projection Network (APN) to map low-resolution patches to a coarse high-resolution manifold, providing a deterministic anatomical initialization that shortens the residual transport of Stage 2 and stabilizes slice-wise refinement. Stage 2 refines details via rectified flow and introduces a Physics-Aware Difficulty (PAD) metric derived from slice-thickness induced through-plane bandwidth deficit to guide an Adaptive Integration Scheduler (AIS), allocating ODE steps by thickness. A Consistent Endpoint Trajectory Alignment (CETA) loss enforces thickness-consistent reconstructions. Experiments show that DRIFT outperforms super-resolution baselines while reducing inference cost. Code, models, and interactive demos are available at https://yoonseokchoi-ai.github.io/drift-eccv2026/.
...
### [192] [A hybrid machine learning and data assimilation framework for penman–monteith evapotranspiration estimation over China](https://doi.org/10.1016/j.rse.2026.115565)
...
### [193] [An improved 15-year record of ice sheet elevation from CryoSat-2 radar altimetry](https://doi.org/10.1016/j.rse.2026.115561)
...
### [194] [Probability of detection for airborne sensing of methane plumes using long wavelength infrared hyperspectral imaging](https://doi.org/10.1016/j.rse.2026.115556)
...
### [195] [Fine-scale deformation pattern and mechanism of high-fill canals revealed by multi-temporal InSAR](https://doi.org/10.1016/j.rse.2026.115567)
...
### [196] [BLB_TVI: A hyperspectral triangular index for satellite-scale characterization of rice bacterial leaf blight severity](https://doi.org/10.1016/j.jag.2026.105472)
...
### [197] [Individual urban street tree detection and species-level mapping from street-view images and GIS data](https://doi.org/10.1016/j.jag.2026.105449)
...
### [198] [A high-resolution interchange classification model enhanced by multi-scale geometric structural feature fusion](https://doi.org/10.1016/j.jag.2026.105450)
...
### [199] [From flood extent mapping to mechanism-aware flood products: integrating flood type classification into satellite-based flood monitoring](https://doi.org/10.1016/j.jag.2026.105482)
...
### [200] [Spatiotemporal bias in OCO-2 XCO2 retrievals relative to TCCON observations](https://doi.org/10.1016/j.jag.2026.105466)
...
### [201] [Satellite evidence of reduced resistance and resilience to water stress after antecedent fire across a rainfall gradient in northern Australia](https://doi.org/10.1016/j.jag.2026.105478)
...
### [202] [The impacts of cover crop biomass on satellite-based detectability of cover crops in Maryland](https://doi.org/10.1016/j.jag.2026.105453)
...
### [203] [A PROSPECT-guided multi-task learning hybrid framework for simultaneous retrieval of leaf chlorophyll and carotenoids](https://doi.org/10.1016/j.jag.2026.105467)
...
### [204] [LC-SLab — An object-based deep learning framework for large-scale land cover classification from satellite imagery and sparse in-situ labels](https://doi.org/10.1016/j.jag.2026.105476)
...
### [205] [IC-EWH: Energy-Weighted Hough Transform with Iterative Curvature Compensation for Squint Angle Estimation of Highly Squinted SAR](https://doi.org/10.3390/rs18142344)
...
### [206] [Seasonal Variability of the Surface Circulation in the Tyrrhenian Sea: New Insights from SWOT Altimetry and Tide Gauge Records](https://doi.org/10.3390/rs18142346)
...
### [207] [Satellite Embedding Features for Grassland Aboveground Biomass Estimation in Complex Mountainous Terrain: A Case Study of the Three Parallel Rivers Region, China](https://doi.org/10.3390/rs18142348)
...
### [208] [Insta-BDA: Instance-Aware Building Damage Assessment and Counting via Foundation Model Fusion](https://doi.org/10.3390/rs18142347)
...
### [209] [A Method for Extracting Small Moving Targets Based on Temporal and Spatial Saliency Features](https://doi.org/10.3390/rs18142349)
...
### [210] [Fed-RSAdapter: Federated Fine-Tuning of Remote Sensing Images via Multi-Scale Adapter Modules](https://doi.org/10.3390/rs18142352)
...
### [211] [Long-Term Vegetation Dynamics Across Distance Buffers Along the Gonghe–Yushu Expressway Corridor on the Qinghai–Xizang Plateau](https://doi.org/10.3390/rs18142354)
...
### [212] [Estimating Actual Evapotranspiration in Orchard Systems Using the ALARM Energy Balance Model and MODIS Data](https://doi.org/10.3390/rs18142351)
...
### [213] [Spectral-Prior-Guided Swin TransUnet for Sparse-Aperture FMCW MIMO-SAR Imaging](https://doi.org/10.3390/rs18142350)
...
### [214] [Remote Sensing of Coastal Saline-Alkali Land in China: Progress in Identification, Ecological Restoration, and Sustainable Management](https://doi.org/10.3390/rs18142345)
...
### [215] [Land Use/Land Cover Classification of the Qinghai Lake Basin Using Multitemporal Sentinel-1/2 Imagery](https://doi.org/10.3390/rs18142353)
...
### [216] [Enabling More Efficient Dynamic Earth Observation: Wide-Area, High-Resolution Dual-Axis Bidirectional Scanning Imaging and the Associated Multi-Parameter Optimization](https://doi.org/10.3390/rs18142364)
...
### [217] [Marine Heatwaves and NAO-Related Ocean–Atmosphere Variability in the North Atlantic](https://doi.org/10.3390/rs18142363)
...
### [218] [GENCP: GAN-Based Ground Control Point Generation for Satellite Image Georeferencing](https://doi.org/10.3390/rs18142356)
...
### [219] [Residual Noise Learning for Atmospheric Correction of InSAR Unwrapped Maps](https://doi.org/10.3390/rs18142359)
...
### [220] [Hyperspectral Imaging of Seagrass and Macroalgae Using Uncrewed Aerial and Surface Vehicles for Coastal Habitat Mapping](https://doi.org/10.3390/rs18142361)
...
### [221] [ESGS: A 3D Reconstruction Method for the Martian Surface Based on Optical Remote Sensing Images](https://doi.org/10.3390/rs18142357)
...
### [222] [SFE-FM: A Dual-Branch Network with Spectral Feature Enhancement and Feature Mixing for Hyperspectral Image Classification](https://doi.org/10.3390/rs18142362)
...
### [223] [AVANET: A Multiscale Weak-Texture-Aware Network for Snow Avalanche Recognition Using Aerial Imagery](https://doi.org/10.3390/rs18142358)
...
### [224] [Forest Fire Monitoring Based on Cloud Parameters: A Case Study in Southern Hunan](https://doi.org/10.3390/rs18142360)
...
### [225] [Toward Remote Sensing of Wildland Fuel Combustibility: A Pilot Study Evaluating an Experimental Method to Link Fuel Spectral Reflectance with Fire Behaviour and Emissions](https://doi.org/10.3390/rs18142355)
...
### [226] [A Remote Sensing-Based Groundwater Level Monitoring System Using Machine Learning](https://doi.org/10.3390/rs18142372)
...
### [227] [High-Precision Flood Extraction from High-Resolution Remote Sensing Images by Integrating FCN-RAM and Tolerance Rough Set](https://doi.org/10.3390/rs18142373)
...
### [228] [Earth Observation-Driven Inference for Level-4 Terrestrial Products: Process-Based, Machine Learning, and Hybrid Frameworks](https://doi.org/10.3390/rs18142371)
...
### [229] [A Dynamic Irrigation Event Identification Method Driven by Spatiotemporal Fusion and Dynamic Samples Using an Attention-Enhanced Bi-LSTM Model](https://doi.org/10.3390/rs18142367)
...
### [230] [A Coupled Spatiotemporal Stability and Multi-Source Physical Constraint Method for Glacial Lake Extraction: A Case Study in the Central Himalayas](https://doi.org/10.3390/rs18142370)
...
### [231] [Fine-Scale Spartina alterniflora Mapping Using Advanced Deep Learning and High-Resolution UAV Imagery](https://doi.org/10.3390/rs18142375)
...
### [232] [MambaHSINet: A Dual-Branch Bidirectional State Space Network for Hyperspectral Tree Species Classification](https://doi.org/10.3390/rs18142368)
...
### [233] [Freeze–Thaw State Detection over the Mid-to-High Latitudes of the Northern Hemisphere Using Tianmu-1 Multi-GNSS-R](https://doi.org/10.3390/rs18142369)
...
### [234] [A Lightweight Field-to-Site Coupled Framework for 15-Day Sea Surface Temperature Forecasting in Marine Ranching Areas: A Case Study in the Northern Yellow Sea](https://doi.org/10.3390/rs18142374)
...
### [235] [Mapping Potential Groundwater Discharge Indicators in Urban Rivers: A Thermal Remote Sensing and Machine-Learning Approach for Tangshan City](https://doi.org/10.3390/rs18142376)
...
### [236] [Comparing Low-Cost DIY and Research-Grade Hyperspectral Imaging as Coral Reef Monitoring Tools](https://doi.org/10.3390/rs18142366)
...
### [237] [Variation and Transport Characteristics of Atmospheric SF6 Column Concentrations over Hefei Retrieved from Ground-Based Remote Sensing Observations](https://doi.org/10.3390/rs18142365)
...
### [238] [Assessment of Feature Selection Methods for Machine Learning-Based Chlorophyll-a Retrieval Across Optical Water Types](https://doi.org/10.3390/rs18142381)
...
### [239] [YOLO-Based Ship Traffic Monitoring in Fujian Coastal Waters from Sentinel-2 Imagery](https://doi.org/10.3390/rs18142378)
...
### [240] [Comment on Guth et al. Benchmarking Elevation Plus Land Surface Parameters Finds FathomDEM and Copernicus DEM Win as Best Global DEMs. Remote Sens. 2025, 17, 3919](https://doi.org/10.3390/rs18142382)
...
### [241] [RailDLA-Net: An Intensity-Aware Deep Local Aggregation Framework for Railway Point Cloud Semantic Segmentation](https://doi.org/10.3390/rs18142379)
...
### [242] [Modified Freeman−Durden Decomposition and Deorientation Non-Negative Eigenvalue Decomposition for Multi-Look Polarimetric SAR Data](https://doi.org/10.3390/rs18142384)
...
### [243] [Snow Cover Classification Using High-Resolution Reconstructed FY-3E WindRAD Data](https://doi.org/10.3390/rs18142377)
...
### [244] [Urban Development Detection Along the Transportation Corridors of the Mongolian Plateau Supported by SDGSAT-1 NTL Data](https://doi.org/10.3390/rs18142380)
...
### [245] [Layer Assignment for Long-Term LiDAR Map Maintenance Using Geometric and Semantic Evidence](https://doi.org/10.3390/rs18142385)
*X Chen,Bingyu Sun*
...
### [246] [Multi-Resolution Estimation of GNSS-Based Terrestrial Water Storage Changes Using Green’s Function and Slepian Basis Function Methods](https://doi.org/10.3390/rs18142392)
...
### [247] [Station-Level Gap Filling of TROPOMI NO2 via Physics-Informed Shadow Manifold Reconstruction](https://doi.org/10.3390/rs18142387)
...
### [248] [Spatiotemporal Dynamics of Glacier Changes in Tibet from 1990 to 2025](https://doi.org/10.3390/rs18142389)
...
### [249] [Non-Iterative Autofocus Method for High-Resolution SAR Time-Domain Imaging Based on Multi-Subimage 2D-PGA](https://doi.org/10.3390/rs18142393)
...
### [250] [Spatiotemporal Dynamics and Driving Factors of Carbon Storage in the Hei River Basin: A Coupled Spatial Modeling and GeoShapley Approach](https://doi.org/10.3390/rs18142396)
...
### [251] [Contribution Disparity and Key Factor Screening of Lightning Identification and Nowcasting with Multi-Source Data](https://doi.org/10.3390/rs18142383)
...
### [252] [Weakly Supervised Fine-Grained Aircraft Detection in Remote Sensing Based on Prior-Knowledge Prototype Learning](https://doi.org/10.3390/rs18142390)
...
### [253] [The Nexus Between Urbanization and Precipitation Chemistry in the Pearl River Delta, China: Decoupling Analysis](https://doi.org/10.3390/rs18142391)
...
### [254] [SAG-DeepLabV3+: An Enhanced Deep Learning Model for High-Precision Detection of Mining-Induced Ground Fissures from UAV Imagery](https://doi.org/10.3390/rs18142388)
...
### [255] [A Fast Adjacency Effect Correction Algorithm for High-Spatial-Resolution Optical Satellite Imagery with Adaptive Local Surface Constraints](https://doi.org/10.3390/rs18142394)
...
### [256] [A Multi-Method Approach to the Analysis of Trends and Cyclical Variability in Sea Level Along the Southern Baltic Coast](https://doi.org/10.3390/rs18142398)
...
### [257] [Improving FY-4B Satellite Precipitation Retrieval over Coastal Complex Terrain of Eastern China: Deep Learning Approaches with Multi-Source Underlying Surface Data](https://doi.org/10.3390/rs18142397)
...
### [258] [Scale-Sensitive and Confounding-Audited SBAS-InSAR Evidence Representation for Landslide Susceptibility Mapping](https://doi.org/10.3390/rs18142386)
...
### [259] [Preserving Spatial Fidelity in Heterogeneous Landscapes: A Biophysical Index-Guided 1 × 1 CNN for Multi-Source Remote Sensing Fusion](https://doi.org/10.3390/rs18142395)
...
### [260] [DG-SLAM: A hybrid direct georeferencing and SLAM framework for real-time orthophoto mapping in weak-textured environments](https://doi.org/10.1016/j.isprsjprs.2026.07.004)
...
### [261] [A Hybrid Window Transformer for accurate and generalizable soil salinity prediction across China](https://doi.org/10.1080/15481603.2026.2700119)
...
### [262] [PADS: a partitioned adaptive data synthesis framework integrating SMOGN and adaptive data selection for small-sample maize yield prediction](https://doi.org/10.1080/15481603.2026.2703926)
...
### [263] [Advancing aboveground biomass mapping in Alaska's boreal forest using UAVSAR polarimetric features and NDVI-normalized field data](https://doi.org/10.1080/15481603.2026.2703308)
...
### [264] [Understanding sensitivity and accuracy of time-series change detection algorithm across multiple land disturbance scenarios](https://doi.org/10.1080/15481603.2026.2699520)
...
### [265] [Mapping annual 10-meter evergreen and non-evergreen forests in China from 2017 to 2023 with multi-source remote sensing data](https://doi.org/10.1080/15481603.2026.2702254)
...
### [266] [Improving GOME-2C red solar-induced chlorophyll fluorescence retrieval by denoising on radiance spectra](https://doi.org/10.1080/15481603.2026.2705665)
...
Abstract (英文): Ontology engineering remains a critical bottleneck in knowledge-intensive AI systems. Existing automated approaches either depend on predefined schemas, operate within narrow domains, or produce unstructured outputs unsuitable for downstream pipelines.
...
Abstract (英文): Text-to-Image (T2I) generative models have achieved remarkable progress in synthesizing high-quality visual content, yet they remain vulnerable to adversarial misuse, particularly in generating Not-Safe-For-Work (NSFW) images. Most existing jailbreak attacks primarily rely on heuristic prompt engineering or black-box optimization, treating model feedback as a binary signal (success or failure). This coarse-grained paradigm overlooks the rich information embedded in diverse failure modes, such as textual refusal, visual blocking, and semantic sanitization, resulting in inefficient exploration and severe semantic collapse.

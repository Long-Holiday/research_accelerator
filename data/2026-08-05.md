...
- [RSE](#RSE) [Total: 8]
- [Remote Sensing](#Remote Sensing) [Total: 82]
...
Abstract (英文): Four-dimensional cone beam CT (4D CBCT) is important for image-guided radiation therapy of thoracic cancers, but its use is limited by long scan times, causing high patient dose and motion/sparse-sampling artifacts.
...
Abstract (英文): We propose CLIP-EBC, the first fully CLIP-based model for accurate crowd density estimation. While the CLIP model has demonstrated remarkable success in addressing recognition tasks such as zero-shot image classification, its potential for counting has been largely unexplored due to the inherent challenges in transforming a regression problem, such as counting, into a recognition task. In this work, we investigate and enhance CLIP's ability to count, focusing specifically on the task of estimating crowd sizes from images. Existing classification-based crowd-counting frameworks have significant limitations, including the quantization of count values into bordering real-valued bins and the sole focus on classification errors. These practices result in label ambiguity near the shared borders and inaccurate prediction of count values. Hence, directly applying CLIP within these frameworks may yield suboptimal performance.
...
### [126] [STCAFormer: Spatio-temporal cross attention based transformer for fusion of remote sensing images](https://doi.org/10.1016/j.rse.2026.115594)
*Jun Li,Xiaowei He,Yantai Yang,Qinghong Sheng,Zhaocong Wu,Bo Wang,Xiao Ling,Xiang Liu,Yu Liu,Fan Gao,Libo Wang,Matthieu Molinier*
...
### [128] [An enhanced GRACE-based index for nationwide flood-prone region monitoring in China from 2003 to 2022](https://doi.org/10.1016/j.rse.2026.115600)
...
### [129] [Beyond RMSE: The GEDI imputed waveform product minimizes artificial homogeneity evident in existing global forest height maps](https://doi.org/10.1016/j.rse.2026.115591)
...
### [130] [Enhancements to the USGS Landsat Level 2 surface temperature and emissivity product for Collection 3 reprocessing](https://doi.org/10.1016/j.rse.2026.115563)
...
### [131] [Assessing SWOT's capability for surface water extent mapping: An evaluation of Level-2 High-Rate Raster water fraction](https://doi.org/10.1016/j.rse.2026.115595)
...
### [132] [Mitigating terrain effects of GEDI data on regional accounting of aboveground biomass utilizing slope-adaptive waveform metrics](https://doi.org/10.1016/j.rse.2026.115598)
...
### [133] [Extending the MAIAC algorithm for hyperspectral atmospheric correction of TROPOMI measurements: A case study over vegetated regions](https://doi.org/10.1016/j.rse.2026.115593)
...
### [134] [Phenology-Guided Early Prediction of Crop Damage Under Long-Duration Inundation Using Multi-Source SAR–Optical Imagery](https://doi.org/10.3390/rs18152481)
*Hao Zheng,Shusong Huang,Xiaojun Qiao,Bocheng Zhu*
...
### [137] [ChangePixel: Pixel-Level Evidence-Grounded Disaster Change Narration via Single-Backbone Transfer](https://doi.org/10.3390/rs18152480)
*Qinyu Zhou,Ben Yang,Xinyan Wei,Qin Ding,Tingting Leng,Xiaojing Liu*
...
### [140] [Comparative Performance Analysis of Mainstream Deep Learning and Vision Foundation Models for Small-Sample Vegetation Segmentation in High-Resolution Remote Sensing Imagery](https://doi.org/10.3390/rs18152487)
*Le Hu,Fuquan Zhang*
...
### [141] [Correction: Jang et al. Automated Machine Learning for High-Resolution Daily and Hourly Methane Emission Mapping for Rice Paddies over South Korea: Integrating MODIS, ERA5-Land, and Soil Data. Remote Sens. 2026, 18, 753](https://doi.org/10.3390/rs18152485)
...
### [142] [Influence of Lens Distortion Correction and Image Resampling on Vehicle Detection in UAV Imagery](https://doi.org/10.3390/rs18152486)
...
### [143] [Extracting Linear Structures from LiDAR Data by Msplit Estimation and Different Segmentation Approaches](https://doi.org/10.3390/rs18152488)
...
### [144] [An Automated Farm Field Unit Identification Framework for Large-Scale Farms Based on Remote Sensing Image Segmentation and Parameter Optimization](https://doi.org/10.3390/rs18152482)
...
### [145] [Sentinel-1 SAR and Temporal Lag Soil Moisture Estimation at Instrumented Field Sites: A Stacked Ensemble Approach](https://doi.org/10.3390/rs18152483)
...
### [146] [Drought-Triggering Thresholds and Vegetation Resilience Across Aridity Gradients in Central Asian Grasslands](https://doi.org/10.3390/rs18152493)
...
### [147] [Use of PSInSAR for Long-Term Surface Displacement Monitoring as a Complement to the Official Landslide Susceptibility Map in the Saguenay–Lac-Saint-Jean Region, Quebec](https://doi.org/10.3390/rs18152492)
...
### [148] [OrbitGS: High-Fidelity 3D Reconstruction of On-Orbit Non-Cooperative Targets via Physically Decoupled Gaussian Splatting](https://doi.org/10.3390/rs18152489)
...
### [149] [Deep Learning Applications in Remote Sensing for Forest Inventory Methods](https://doi.org/10.3390/rs18152490)
...
### [150] [PCINet: A Prior-Guided Correlation Interaction Network for High-Resolution Remote Sensing Image Change Detection](https://doi.org/10.3390/rs18152491)
...
### [151] [Self-Supervised Hyperspectral Image Clustering via Spatial–Frequency Interaction and Amplitude–Phase Decoupling](https://doi.org/10.3390/rs18152494)
...
### [152] [Underwater Hyperspectral Image Band Selection and Object Type Detection Method Based on Continuity and Label Constraints](https://doi.org/10.3390/rs18152499)
...
### [153] [A Hybrid Prior-Based Framework for Infrared Image Enhancement Towards Reliable Scene Interpretation](https://doi.org/10.3390/rs18152507)
...
### [154] [Sensor-Adaptive Cross-Temporal Difference Modulation for Building Damage Detection in Bi-Temporal Remote Sensing Imagery](https://doi.org/10.3390/rs18152518)
...
### [155] [VSTF-Net: A Vision-Semantic and Target-Aware Fusion Framework for Ship Detection in Complex Maritime Sensing Scenarios](https://doi.org/10.3390/rs18152517)
...
### [156] [A Real-Time Subband SAR Imaging Algorithm Based on an Approximate Echo Signal Model](https://doi.org/10.3390/rs18152520)
...
### [157] [Occlusion Removal in Remote Sensing Images Based on Deep Matrix Completion](https://doi.org/10.3390/rs18152538)
...
### [158] [Hyperspectral Image Classification Based on a Spatial–Spectral Dual-Branch Mamba Architecture](https://doi.org/10.3390/rs18152526)
...
### [159] [Impacts of Interannual Radiometric Calibration Differences on Vegetation Indices and Solar-Induced Chlorophyll Fluorescence Retrieval from Ground-Based Spectral Observations](https://doi.org/10.3390/rs18152528)
...
### [160] [Photovoltaic Panel Identification and Potential Assessment Based on Remote Sensing and Deep Learning: A Case Study of Yancheng City](https://doi.org/10.3390/rs18152542)
...
### [161] [Sensitivity-Constrained Anisotropic Regularization for Two-Track InSAR 3D Landslide Deformation Inversion in the Baihetan Reservoir Area, China](https://doi.org/10.3390/rs18152525)
...
### [162] [SIA-Net: A Scale-View Interactive Attention Network for Landslide Extraction from High-Resolution Optical Remote Sensing Images](https://doi.org/10.3390/rs18152521)
...
### [163] [PromptScaleDINO: Prompt-Stabilized and Scale-Aware Adaptation of Grounding DINO for Infrared Small Target Detection](https://doi.org/10.3390/rs18152503)
...
### [164] [GSSA: Gaussian Surfels with Spatial Awareness for Surface Reconstruction](https://doi.org/10.3390/rs18152497)
...
### [165] [DyPerceiver-Det: Instance-Wise Dynamic Perception for Fine-Grained Oriented Object Detection in Remote Sensing Images](https://doi.org/10.3390/rs18152515)
...
### [166] [Global Optimization Design of Large-Scale Constellations for Maritime Target Detection Based on Circular Scanning Radar](https://doi.org/10.3390/rs18152544)
...
### [167] [Geographically Constrained Transformer for Spatiotemporal Reconstruction of 2 m NDVI in Complex Coastal Landscapes](https://doi.org/10.3390/rs18152522)
...
### [168] [High-Resolution SMAP Soil Moisture in Agriculture: Capturing Field-Scale Variability in Soil Moisture and Evapotranspiration in the San Luis Valley](https://doi.org/10.3390/rs18152514)
...
### [169] [An Urban-Oriented Method for Tree Canopy Height Extraction Using ICESat-2 Data](https://doi.org/10.3390/rs18152510)
...
### [170] [Integrating Land Use Change and Vegetation Resilience to Assess Ecological Impacts of Expressway Construction: A Case Study of the Linghua Expressway](https://doi.org/10.3390/rs18152534)
...
### [171] [InSAR-Based Prediction of Time-Series Displacements Using a New Physics-Informed Neural Network with Prior Parameter Inversion](https://doi.org/10.3390/rs18152516)
...
### [172] [A Scalable Open Source Workflow for Riverbed Substrate Classification Using UAV Imagery](https://doi.org/10.3390/rs18152529)
...
### [173] [A Hierarchical Geometry-Driven Framework for Instance Segmentation Within Junction Regions in Steel Grid Structure Point Clouds](https://doi.org/10.3390/rs18152501)
...
### [174] [SPIF: A Spatio-Temporal Polarity Interaction Filter for Reliable Event Selection](https://doi.org/10.3390/rs18152551)
...
### [175] [RFM-UNet: Hybrid Frequency–Mamba UNet for Remote-Sensing Road Extraction](https://doi.org/10.3390/rs18152546)
...
### [176] [In Pursuit of Open-Weights Models for Intrinsic Interpretability in Wind Turbine Blade Monitoring with Tower-Mounted Radar](https://doi.org/10.3390/rs18152535)
...
### [177] [Climate-Adaptive Urban Planning: Quantitative Assessment of Drought Impact and Practical Strategies for Climate-Resilient Urban Green Spaces](https://doi.org/10.3390/rs18152531)
...
### [178] [Retrieval of Vertical Cloud Droplet Profiles and Above-Cloud Integrated Water Vapor from Hyperspectral Measurements: Reducing Liquid Water Path Retrieval Bias with Application to EMIT](https://doi.org/10.3390/rs18152556)
...
### [179] [An Adaptive Polyline-Path Mask Attention for Hyperspectral and Multispectral Image Fusion](https://doi.org/10.3390/rs18152536)
...
### [180] [Analysis of Area Changes and Driving Factors in Chirui Lake](https://doi.org/10.3390/rs18152558)
...
### [181] [A Sentinel-1 Dual-Polarimetric Scattering-Regime Framework with AMSR2 Consistency Assessment for Interannual Sea Ice Characterization in the Southern Sea of Okhotsk](https://doi.org/10.3390/rs18152498)
...
### [182] [SGW-DETR: A Spectral-Guided Graph-Structured Wavelet Transformer for UAV Infrared Object Detection Under Degradation](https://doi.org/10.3390/rs18152519)
...
### [183] [From Thermal Diagnosis to Spatial Allocation: A Remote-Sensing and Explainable Machine Learning Framework for Heat-Resilient Planning in Semi-Arid Grassland Towns](https://doi.org/10.3390/rs18152548)
...
### [184] [Impact of Clouds on Infrared and Microwave Sounding Retrieval and an Objective Correction Method for Numerical Weather Prediction](https://doi.org/10.3390/rs18152549)
...
### [185] [Calibration Optimization for Long-Term Consistency of the FY-3B Infrared Atmospheric Sounder](https://doi.org/10.3390/rs18152506)
...
### [186] [Aliasing Suppression in Synthetic Aperture Interferometric Radiometers Using Subarray-Based Antenna Architecture](https://doi.org/10.3390/rs18152552)
...
### [187] [Improving Convection-Allowing Ensemble Forecasts via Multi-Source Remote Sensing Data Assimilation Through Stepwise Cloud Analysis Initialization: A Remote Sensing Case Study](https://doi.org/10.3390/rs18152539)
...
### [188] [Enhancing Earthquake-Induced Landslide Susceptibility Mapping Through Integration of Climatological Soil Moisture: A Hybrid CNN–Swin Transformer Approach](https://doi.org/10.3390/rs18152495)
...
### [189] [Analysis of Diagnostic Absorption Troughs in Clay Alteration Within the Xiangshan Uranium Deposit Based on ZY1-02E Satellite Hyperspectral Imagery](https://doi.org/10.3390/rs18152550)
...
### [190] [Geometric Accuracy Assessment of Large-Scale ZY-3 Imagery Based on Inter-Image Consistency](https://doi.org/10.3390/rs18152509)
...
### [191] [Future Scenario Simulation and Optimization of Ecological Security Patterns Under Policy Drivers: A Case Study of the Henan Section of the Yellow River Basin, China](https://doi.org/10.3390/rs18152554)
...
### [192] [Predicting Irrigated Rice Soil–Water Conditions Using Multispectral Remote Sensing and Machine Learning in Semi-Arid Australia](https://doi.org/10.3390/rs18152504)
...
### [193] [Disproportionate Soil Loss from Fragmented Sloping Cropland in Mountainous Northeastern Yunnan: Integrating Sentinel-2, CSLE, and Landscape Metrics](https://doi.org/10.3390/rs18152537)
...
### [194] [FIRE-BYOL: A Real-Time Grassland Active-Fire Detection Algorithm Fusing VIIRS Fire Products and Himawari-8/9 Data](https://doi.org/10.3390/rs18152553)
...
### [195] [GCIE-Net: A Global and Channel Information-Enhanced Network for Ship Instance Segmentation in SAR Images](https://doi.org/10.3390/rs18152512)
...
### [196] [Study on the Distribution Characteristics and Influencing Factors of Rock Glaciers in the Lenglongling Region of the Eastern Qilian Mountains](https://doi.org/10.3390/rs18152524)
...
### [197] [Assessment of Flood Risk Using Remote Sensing and GIS Techniques Based on the Analytic Hierarchy Process (AHP) and Fuzzy AHP (FAHP) in the R’Dom Watershed (Meknes, Morocco)](https://doi.org/10.3390/rs18152500)
...
### [198] [GeoAdapt: Fine-Grained Keypoint Localization via Deformable Feature Refinement for Ground-Based Optical Remote Sensing](https://doi.org/10.3390/rs18152545)
...
### [199] [Validation Design Governs Reported Accuracy in Small UAV Hyperspectral Datasets: An Interpretable Feature-Optimization Case Study of Maize Canopy Nitrogen Concentration](https://doi.org/10.3390/rs18152502)
...
### [200] [A Method for Segmentation and Identification of Urban Functional Areas with Generalization Ability Based on Scale-Aware Feature-Enhanced Attention Mask R-CNN](https://doi.org/10.3390/rs18152541)
...
### [201] [An Improved JSEG-Based Algorithm for Segmentation of Categorical and Remote Sensing Classification Maps](https://doi.org/10.3390/rs18152543)
...
### [202] [WetVeg-2mm: An Ultra-High-Resolution UAV Dataset for Riparian Vegetation Semantic Segmentation](https://doi.org/10.3390/rs18152508)
...
### [203] [Open-Source Reproducible Pipeline for Multitemporal Vegetation Monitoring Using Sentinel-2 L2A in Cloud-Prone Tropical Regions](https://doi.org/10.3390/rs18152532)
...
### [204] [Analysis of Vegetation Dynamics and Driving Factors in Xinjiang Under Land-Use Change Trends](https://doi.org/10.3390/rs18152496)
...
### [205] [Frequency-Domain Modeling and Removal of Platform Jitter Stripes in GF-7 DSMs for Flat Terrains](https://doi.org/10.3390/rs18152557)
...
### [206] [Landslide Susceptibility Mapping Constrained by InSAR-Derived Deformation Using Multi-Source Data Integration](https://doi.org/10.3390/rs18152540)
...
### [207] [Mapping Submarine Sand Wave Bathymetry from Sentinel-2 Texture Using a Spatial-Sequential Deep Learning Model](https://doi.org/10.3390/rs18152511)
...
### [208] [Vegetation Optical Depth at Enhanced Spatial Resolution: Progress, Challenges, and Perspectives](https://doi.org/10.3390/rs18152530)
...
### [209] [Pulse RFI Mitigation for SAR Data Based on Reduced Rank Approximate](https://doi.org/10.3390/rs18152513)
...
### [210] [Sparse Rational Polynomial Coefficient Estimation Method via Low-Rank Matrix Constraint](https://doi.org/10.3390/rs18152547)
...
### [211] [Integrating Multi-Source Environmental Variables with Sentinel-3 OLCI Imagery for Interpretable Retrieval of Eutrophication Parameters in Bohai](https://doi.org/10.3390/rs18152527)
...
### [212] [TimeHome: Heterogeneous Mixture-of-Experts for Time-Series Foundation Model](https://doi.org/10.3390/rs18152533)
...
### [213] [Self-Supervised Pre-Training Style Adaptation-Guided Remote Sensing Image Change Detection Network](https://doi.org/10.3390/rs18152523)
...
### [214] [Spatiotemporal Dynamics and Driving Mechanisms of Impervious Surface Expansion in Changsha County Using Landsat Time-Series](https://doi.org/10.3390/rs18152555)
...
### [215] [A Fast ISAR Imaging Method Based on PC-2D-FIR-GEM-Net for Low SNR and Sparse Aperture Conditions](https://doi.org/10.3390/rs18152505)
...
### [216] [Development of spaceborne high-spectral-resolution lidar retrieval algorithm for ACDL/DQ-1 aerosols and clouds observation: improvements and analysis](https://doi.org/10.1080/15481603.2026.2702220)
*Guangyao Dai,Wenrui Long,Songhua Wu,Jiqiao Liu,Fanqian Meng,Shuangcheng Yang,Xiuqing Hu,Weibiao Chen*
...
Abstract (英文): The Aerosol and Carbon Detection Lidar (ACDL), which onboard Chinese atmospheric environment monitoring satellite DQ-1, is the first spaceborne lidar that employs an iodine molecular filter for high-spectral-resolution detection. In its atmospheric observation mission, it is equipped with a 532 nm parallel polarization channel, a 532 nm cross polarization channel, a 532 nm molecular channel, and a 1064 nm detection channel, enabling the direct retrieval of aerosol and cloud optical properties. ACDL has been operating stably for over three and a half years, continuously accumulating vertical profile data on aerosols and clouds. The scientific team is committed to continuously optimizing the algorithms by leveraging its unique dual-pulse laser emission scheme and the characteristics of observational data from each channel. The latest developed Baseline05 retrieval algorithm achieves higher resolution, increased valid data volume, and improved day—night consistency. Following the data flow design, the Baseline05 algorithm performs direct retrieval from raw signals (Level 1 A) to atmospheric optical parameters (Level 2 C). The data products have a vertical resolution of 50 m, and horizontal resolutions of 3.3 km at night and 6.6 km during daytime. Baseline05 improves the data pre-processing flow, with a focus on optimizing the background signal extraction and calibration scheme. In the retrieval module, Baseline05 fully exploits the high-spectral-resolution detection capability of the ACDL molecular channel, utilizing simulated ideal atmospheric signals to optimize the segmented denoising for each channel. It also innovatively develops a layer identification and iterative retrieval algorithm, enabling the identification and retrieval of stratospheric, high-latitude, and multiple thin aerosol and cloud layers. Using data product examples from nighttime and daytime observation orbits, a comparative analysis illustrates the improvements of Baseline05 in layer identification and in the retrieval of key optical parameters such as the depolarization ratio, lidar ratio, and attenuated colour ratio. The new retrieval algorithm will effectively enhance ACDL’s aerosol and cloud observation capabilities, providing a technical foundation for subsequent Level 3 product development and atmospheric pollution monitoring.

</details>


### [217] [High-precision monthly monitoring of surface water dynamics in Central Asia from 1990 to 2022 using remote sensing gap-filling techniques](https://doi.org/10.1080/15481603.2026.2689680)
*Wenjing Huang,Fuqiang Wang,Weili Duan,Junguo Liu,Jingxiu Qin,Kamshat Tussupova,Huan Yang,Lei Tang,Xiaoyu Meng*
...
Abstract (英文): Accurate monthly monitoring of surface water area (SWA) is essential for characterizing hydrological variability and supporting water-resource management in arid regions. However, persistent observation gaps caused by clouds, cloud shadows, and sensor-related missing pixels hinder the generation of temporally continuous monthly SWA records from optical imagery. To address this limitation, we developed a 30 m gap-free monthly SWA dataset for Central Asia for 1990–2022 by integrating the full Landsat archive with an image-similarity-based gap-filling (ISGF) framework. The resulting dataset was evaluated using MODIS and Sentinel observations and achieved an overall accuracy of 93.0% with a Kappa coefficient of 0.89. Additional consistency assessments against authoritative datasets yielded coefficients of determination (R²) of 0.96 for lakes and 0.98 for reservoirs. Relative to the JRC Global Surface Water product, the ISGF dataset increased the effective monitored monthly inundation area by 100–150 × 103 km², indicating a substantial reduction in omission errors associated with missing observations. At the regional scale, the maximum and minimum inundation extents were 175.6 × 103 km² and 101.4 × 103 km², respectively, with the largest inundation generally occurring from March to May and the smallest from September to November. We further identified three characteristic intra-annual SWA regimes across Central Asia: a spring flood pattern in downstream plains, a summer flood pattern in the Syr Darya and Amu Darya basins, and a summer deficit pattern in upstream rivers and mountainous reservoirs. By providing a long-term, high-resolution, and gap-free monthly SWA record, this study advances regional surface-water monitoring and offers a geospatial data foundation for sustainable water management, irrigated-agriculture resilience, and climate adaptation, with relevance to SDG 6, SDG 2, and SDG 13.

</details>


### [218] [MAPSRNet: a task-oriented super-resolution network that enhances building extraction beyond raw high-resolution imagery](https://doi.org/10.1080/15481603.2026.2704291)
...
### [219] [Monitoring water surface elevation and river width using SWOT: insights into observation geometry, phase noise, and geomorphic modulation in the Yangtze River](https://doi.org/10.1080/15481603.2026.2705654)
...
### [220] [Habitat-quality dynamics and reversal-risk diagnostics in Southwest China using a productivity–hydrology enhanced RSEI framework](https://doi.org/10.1080/15481603.2026.2711464)
...
### [221] [Ensuring continuous high-precision Earth Radiation Budget Records: a scene-dependent spectral fusion unfiltering framework for FY-3F ERM-II](https://doi.org/10.1080/15481603.2026.2709753)
...
### [222] [Beyond static graphs: a scale-variant dynamic graph-based framework integrating spatial and hierarchical relationships for urban land-use mapping](https://doi.org/10.1080/15481603.2026.2705683)
...
### [223] [MapGlue: Multimodal remote sensing image matching](https://doi.org/10.1016/j.isprsjprs.2026.07.007)
*Peihao Wu,Yongxiang Yao,Wenfei Zhang,Wei Dong,Yi Wan,Haoyu Guo,Yansheng Li,Yongjun Zhang*
...
### [225] [Advancing hyperspectral nutrient modeling through transfer learning: Insights from foliar N–P–K estimation in cranberries](https://doi.org/10.1016/j.isprsjprs.2026.07.022)
*Dongheng Yang,Yurong Huang,Nanfeng Liu,Erin Hokanson,Nicole Hansen,Philip A. Townsend*
...
### [226] [GeoGS: Geometric Prior-Guided Gaussian Splatting for robust urban reconstruction from sparse views](https://doi.org/10.1016/j.isprsjprs.2026.07.011)
*QiLin Zhang,Olaf Wysocki,B. Jutzi*
...
### [228] [Aerial–ground LiDAR place recognition with patch-level self-supervised learning and expanded reciprocal re-ranking](https://doi.org/10.1016/j.isprsjprs.2026.07.018)
...
### [229] [DAChanger: A remote sensing change detector inspired by differential amplifier circuit for signal energy Decoupling and geometric consistency](https://doi.org/10.1016/j.isprsjprs.2026.07.021)
...
### [230] [ISEE: Interactive Semantic Enrichment for Database Fields](https://arxiv.org/abs/2608.02604)
...
Abstract (英文): LLM-based agents are increasingly being deployed for data-related tasks, including data sense-making, exploration, and retrieval. However, their performance heavily depends on the clarity and completeness of data semantics. In practice, many field descriptions remain ambiguous or incomplete, as much of the essential context (e.g., the meaning of a customized field) originates from users' domain knowledge and is rarely documented publicly. This gap restricts the agents' task performance in downstream tasks, such as entity-linking. To bridge this gap, we introduce a novel and comprehensive Interactive SEmantic Enrichment system (ISEE). Given a data field description, ISEE measures its quality through a scoring system, gathers domain knowledge, and collaboratively enriches the semantics with users. Through a user study, automated user simulation, quantitative evaluation, and case study, we demonstrate that ISEE significantly reduces cognitive load, improves description quality, and enhances downstream task performance.

</details>


### [231] [Self-Organising Digital Circuits](https://arxiv.org/abs/2608.02606)
...
### [233] [PULSE: An Executable Contract Language for Spatiotemporal Knowledge Graph Engineering](https://arxiv.org/abs/2608.02630)
...
### [235] [Explainable AI for the EU Right to Explanation: A Systematic Review of the Law-XAI Translation Gap](https://arxiv.org/abs/2608.02699)
...
### [238] [BAP-SQL: Budget-Aware Observation Planning for Agentic Text-to-SQL](https://arxiv.org/abs/2608.02876)
...
Abstract (英文): Tool-using agents do not merely consume observations: their actions determine what arrives next. In agentic text-to-SQL, a broad query can spend context and database work before useful evidence appears, while post-hoc compression cannot recover omitted rows or expended work. We present BAP-SQL, which treats observation formation as a budget-control stage: it estimates query risk, rewrites SQL when useful, and delegates hard limits to an independent runtime shield. Across general 4B, specialized FINER-SQL 4B, and 7B backbones, BAP-SQL improves tight-budget success. On the primary BIRD-derived setting, it gains 3.4/3.6 percentage points over matched SFT while using 4.5/5.0% fewer tokens. Matched retraining and task-level transfer associate the gain with policy-visible planning and budget-sensitive rescue. The benefit attenuates as model capability and budget increase, reverses at the loosest setting, and does not reduce database work.

</details>


### [239] [VeriTrace: Human-Like Temporal Exploration Completes Agentic Action Space](https://arxiv.org/abs/2608.02878)
...
Abstract (英文): Latin America is missing two foundational layers of AI infrastructure: the dataset layer and the benchmark layer. This paper targets the dataset layer. The dataset layer faces two compounding problems: discovery and supply. Latin American AI datasets exist but are scattered across platforms with no shared index. Even with perfect indexing, the total volume would remain far below what frontier AI development requires. We propose DataHub: a task-first data infrastructure organized through the ontology /<task?>/<domain?>/<language?>, with mechanisms for dataset discovery, metadata, contribution, licensing, and reuse.

</details>


### [244] [Neurosymbolic Reasoning with Incremental Knowledge for Sample Efficient Hierarchical Reinforcement Learning](https://arxiv.org/abs/2608.02993)
...
Abstract (英文): Latin America is missing a foundational layer for native AI development: the benchmark layer. The benchmark layer does two things no other layer can - it audits AI systems against regional social requirements and it directs AI optimization in economically relevant environments. Without it, public institutions cannot independently evaluate foreign AI systems, and companies cannot optimize AI systems to solve local problems with SOTA performance. The cost of the missing layer is dual: a loss of auditability and a loss of optimization direction over a technology that is increasingly critical infrastructure. We propose an EvalsHub, with LatamBoard as its first regional instance - an open, task-first benchmark infrastructure where universities, public institutions, professional communities, and companies can publish, execute, compare, and maintain evaluations across models, workflows, and agents. Built once, measured forever - re-run by institutions as new AI systems ship and by industry teams after every system change. Open by design and incentive-driven by construction.

</details>


### [246] [ProPRL: Property-Aware Prerequisite Relation Learning in Educational Knowledge Graphs](https://arxiv.org/abs/2608.03006)
...
### [254] [AI Agent Economics: Can Autonomous Economic Behavior Emerge among AI Agents under Minimal External Conditions?](https://arxiv.org/abs/2608.03076)
...
### [257] [Verifiable Memory: Learning Unified Memory Management with Local and Global Verifiers for Large Language Model Agents](https://arxiv.org/abs/2608.03137)
...
### [258] [Spatial proteomics guided by H&E-based AI reveals recurrence-risk niches in triple-negative breast cancer](https://arxiv.org/abs/2608.03145)
...
### [262] [Surrogate Substitution Preserves PHI Detectability: A Multi-Detector Equivalence Study](https://arxiv.org/abs/2608.03172)
...
Abstract (英文): Transformer-based architectures have dominated sequence modeling, largely due to the expressive power of attention mechanisms. However, for a class of deterministic state tracking tasks---such as parity checking, modular counting, and parenthesis matching---attention may be overkill. In this paper, we show that \textbf{state propagation alone is sufficient}.
...
### [284] [DataSpace: Benchmarking Data Agents for Verifiable Analytics over Heterogeneous Workspaces](https://arxiv.org/abs/2608.03451)
...
### [286] [Solver-Aware Decompositions for Programming-by-Example: When Dividing Requires Knowing how to Conquer](https://arxiv.org/abs/2608.03461)
...
### [292] [Can LLM design high-quality experiments? A Comprehensive and Systematic Benchmark on Autonomous Experimental Design](https://arxiv.org/abs/2608.03501)
...
### [299] [Enhancing Tabular Learners with Context-Aware Semantic Embeddings](https://arxiv.org/abs/2608.03565)
...
### [307] [Formal Verification of Agentic Systems over Operational Data](https://arxiv.org/abs/2608.03609)
...
### [311] [When Teachers Mislead: Spurious-Signal-Aware On-Policy Distillation](https://arxiv.org/abs/2608.03632)
...
### [321] [SAT-Edge-Agent: Hardware-in-the-Loop Edge-Agent Orchestration for Onboard Satellite Intelligence](https://arxiv.org/abs/2608.03728)
*Longji He,Jeto Xu*
...
### [327] [Risky Business: Measuring The Faithfulness-Safety Tension](https://arxiv.org/abs/2608.03745)
...
Abstract (英文): Modern agent frameworks equip large language models with external skill libraries to solve complex tasks. However, it remains unclear whether these systems can effectively evolve their skills and whether the resulting skills improve task-solving capabilities. To bridge this gap, we introduce ContinualSkillBench, a dynamic evaluation framework for in-context continual skill learning. It covers five representative domains, each containing 100 interconnected subtasks ordered by increasing difficulty and opportunities for cross-task skill reuse. Our experiments show that sequential execution generally improves performance, but the gains vary substantially across models and domains. Moreover, in-context learning performs comparably to explicit skill maintenance on average, suggesting that much of the improvement arises from adaptation to prior context and feedback rather than reusable skill abstraction alone. Explicit skills nevertheless provide selective benefits for tasks requiring reusable procedures or precise outputs. We further find that less capable models tend to accumulate larger, more fragmented collections of task-specific skills. These findings show that current in-context skill evolution mechanisms can support continual adaptation, but still struggle to consistently consolidate experience into robust and transferable skills.
...
### [342] [TACT: Taxonomy-Aligned Post-Training for Pedagogically Adaptive English Tutoring](https://arxiv.org/abs/2608.03952)
...
### [345] [Should We Type or Talk to LLM Agents? A Comprehensive Study of Voice and Keyboard Input Perturbations](https://arxiv.org/abs/2608.03970)
...
### [347] [Divergent ecohydrological impacts of agricultural and urban expansions across global drylands](https://doi.org/10.1016/j.jag.2026.105505)
*Ran Wang,Wei Zhou,Tao Lin,Zhe Hao,Shibin Zhang,Conghong Huang*
...
Abstract (英文): Satellite-derived vegetation indices are widely used in forest monitoring, yet their interpretation is complicated by the fact that canopy reflectance integrates both environmental stress signals and structural variation in stands. This challenge is particularly important across broad ecological gradients, where relationships between optical metrics and stand attributes may be spatially non-stationary. Here, we analysed NDVI–stand structure relationships in Scots pine-dominated forests across the whole of Poland using 30 m HLSS30 imagery, LiDAR-derived stand metrics, and a Geographic Gaussian Process Generalised Additive Model (GGP-GAM). The study focused on closed-canopy, undisturbed Scots pine stands and examined annual NDVI variation in 2016–2022 across eight forest natural regions in relation to stand age, stand volume, top height, and the Relative Spacing Index (RSI). Mean NDVI showed persistent regional differentiation across Poland and ranged from 0.64 to 0.84. The proportion of NDVI variability explained by stand characteristics varied markedly among years and forest natural regions, indicating strong spatial and temporal heterogeneity in NDVI–structure relationships. In general, structural predictors explained a larger share of NDVI variation in years with more favourable moisture conditions, whereas in drought years this structural signal was less apparent, partly coinciding with lower and more compressed NDVI distributions. An illustrative regional analysis further showed that the direction and magnitude of the partial effects of stand attributes changed among years, demonstrating that the structural meaning of NDVI was not constant through time. The results show that NDVI should not be interpreted as a spatially invariant proxy of stand structure across heterogeneous forest landscapes. Instead, its information content depends on both regional context and annual moisture conditions. By combining harmonized optical time series, LiDAR-derived stand descriptors and spatially varying modelling, this study provides a framework for more robust interpretation of canopy greenness in large-area forest monitoring.

</details>


### [349] [Dual-polarization GNSS reflectometry for FYI–MYI sea ice type classification using microsatellite observations](https://doi.org/10.1016/j.jag.2026.105502)
...
### [350] [A partially supervised joint segmentation method for farmland and rural roads from single-class annotated remote sensing datasets](https://doi.org/10.1016/j.jag.2026.105509)
...
### [351] [Corrigendum to “Spatiotemporal dynamics of solar photovoltaics development and ecological implications in Japan from cropland to forest” [Int. J. Appl. Earth Obs. Geoinf. 150 (2026) 105348]](https://doi.org/10.1016/j.jag.2026.105508)

...
Abstract (英文): Deep Learning models can include billions of parameters or more, making it difficult to explain their internal transformations and outputs. However, explainability is increasing in importance due to the use of AI in crucial applications. This paper focuses on the interpretability of convolutional neural networks (CNNs). Building on the popular gradient based method LayerCAM for extracting internal features in CNNs, we propose an improved method named HiRA-CAM, and show that it outperforms both LayerCAM and Grad-CAM on creating useful saliency maps for object classification. The main feature of HiRA-CAM is its adaptive use of activation maps from all the layers of the CNN to arrive at a more focused saliency map.
...
Abstract (英文): Visual understanding in sports has emerged as a hot topic in computer vision in recent years. Most existing basketball video datasets adopt single action or activity as sample, which can neither preserve the temporal continuity of game events nor support complex tasks such as action anticipation. To address this issue, this paper constructs the first possession-level basketball video dataset (PL-NBA), in which each sample is composed of a complete NBA offensive possession. Collected from 60 NBA games, PL-NBA contains 11,000 valid offensive possession clips and 31,567 annotated events with player names, captions, event types and timestamps. Each video clip includes multiple events and preserves the continuity of events, which is helpful for analysis of tactic. Experiment is conducted on multiple visual understanding tasks, including event recognition, video captioning, temporal action localization and action anticipation. Experimental results show that existing methods achieve limited performance on above four tasks, demonstrating that PL-NBA is a challenging benchmark for sports video understanding.
...
Abstract (英文): Egocentric action understanding is often addressed using large video models pretrained on extensive exocentric datasets. However, many first-person actions depend on a small number of hand-object interactions involving only a few relevant entities.
...
### [67] [HLS-GPT: A generative pretrained transformer (GPT) for continental-scale NASA harmonized Landsat and Sentinel-2 (HLS) reflectance reconstruction across all bands on arbitrary dates](https://doi.org/10.1016/j.isprsjprs.2026.08.006)
...
### [68] [Real-time deformation monitoring of long-span bridges by coupling computer vision with inertial measurement](https://doi.org/10.1016/j.isprsjprs.2026.07.025)
...
### [69] [Estimation of hourly All-Weather land surface temperature in an area with frequent clouds based on satellite passive microwave remote sensing and data assimilation](https://doi.org/10.1016/j.isprsjprs.2026.08.004)
...
### [70] [SSVM: Streaming state vision model for challenging remote sensing object detection](https://doi.org/10.1016/j.isprsjprs.2026.08.003)
...
### [71] [Measuring the spatial explicitness of GeoAI and geospatial foundation models: A systematic review and future roadmap](https://doi.org/10.1016/j.isprsjprs.2026.08.001)
...
### [73] [Wind and white: the dual controls of cold waves on surface urban heat islands in China](https://doi.org/10.1016/j.isprsjprs.2026.08.008)
...
### [74] [Guided diffusion-based image editing for landslide image synthesis in remote sensing change detection](https://doi.org/10.1016/j.isprsjprs.2026.08.007)
...
### [75] [Editorial Board](https://doi.org/10.1016/s0034-4257(26)00389-5)
*Unknown Author*
...
### [76] [Orbital imaging spectroscopy of Earth’s mineral surface: Results and stability from EMIT’s first two years](https://doi.org/10.1016/j.rse.2026.115605)
...
### [77] [A novel method for generating optimal DTM in tropical peatlands using GEDI and ICESat-2 observations](https://doi.org/10.1016/j.rse.2026.115615)
...
### [78] [The cmSCOPE-D model: A transmission-dynamics-enabled SCOPE adaptation to characterize vertically stratified heterogeneity of maize disease stress](https://doi.org/10.1016/j.rse.2026.115614)
...
### [79] [Beyond L-band: 0.4-2 GHz wideband radiometry for observing surface salinity in cold seawater](https://doi.org/10.1016/j.rse.2026.115596)
...
### [81] [A synergistic thermal framework for monitoring, quantifying, and classifying volcanic activity from space](https://doi.org/10.1016/j.rse.2026.115626)
...
### [82] [Simulated AVIRIS-3 detects species-specific patterns of vegetation succession in retrogressive thaw slumps](https://doi.org/10.1016/j.jag.2026.105522)
...
### [83] [Joint learning of frequency-spatio-temporal dependencies and structural context for optical-SAR change detection](https://doi.org/10.1016/j.jag.2026.105534)
...
Abstract (英文): Multimodal change detection combines multi-source remote sensing data, such as optical and synthetic aperture radar (SAR) images, to overcome the inherent limitations of single-mode imaging mechanisms, thereby enhancing the robustness and timeliness of change information updates. However, previous Optical-SAR change detection methods still face challenges, including inadequate modeling of both modality-invariant and modality-specific characteristics, difficulty in capturing cross-modal spatio-temporal dependencies, and underutilization of land cover structural context. To address these issues, we propose a novel Optical-SAR change detection framework, namely FSTS-Net. It combines semantic features from the frequency, spatial, and temporal domains with structural features to comprehensively capture change. First, we design a frequency-spatio-temporal feature encoder integrating wavelet convolution and graph optimization theory into a state-space model to decouple cross-modal features and model bi-temporal dependencies. Second, a multi-scale graph convolutional network is built to explicitly model the spatial correlations among surface objects, thereby enhancing the representation of structural features. Finally, an adaptive fusion strategy dynamically adjusts the contribution weights of semantic and structural features to adapt to changes in information, effectively enhancing genuine change signals while suppressing pseudo-change. Our method demonstrates superior generalization and robustness over existing multimodal change detection (MMCD) methods, achieving mean Intersection over Union (mIoU) of 67.81 % on BRIGHT, 64.84 % on Wuhan-Het, and 88.55 % on Delta-SN6 datasets. The proposed FSTS-Net provides a reliable solution for multimodal change analysis. The code will be made available at: https://github.com/liuxuanguang/FSTS-Net .

</details>


### [84] [Network-inspired restructuring for individual tree segmentation in ULS point clouds](https://doi.org/10.1016/j.jag.2026.105535)
...
### [85] [Satellite embeddings for crop type classification: a comparative examination](https://doi.org/10.1016/j.jag.2026.105531)
...
### [86] [Deep learning models for estimating volume and Lorey’s height across Nordic countries using optical and SAR satellite images](https://doi.org/10.1016/j.jag.2026.105527)
...
### [87] [Unveiling the cooling effects of urban green spaces in Eastern China: spatial heterogeneity, diurnal asymmetry, and nonlinear margins of 2D/3D features](https://doi.org/10.1080/15481603.2026.2718590)
...
### [88] [A novel framework for assessing and enhancing urban ecological network resilience: integration of key species information and deduction of spatial optimization pattern](https://doi.org/10.1080/15481603.2026.2713316)
...
### [89] [Partitioning and synergistic estimation of leaf area index in dryland forests using dual-sensor Sentinel 1 and 2 imagery](https://doi.org/10.1080/15481603.2026.2713344)
*Vladislav Dubinin,Yagil Osem,Zeev Cohen,Husein Muklada,Dan Yakir,Tarin Paz‐Kagan*
...
Abstract (英文): Leaf Area Index (LAI) is a key biophysical parameter that describes forest canopy structure and function. While satellite-based approaches typically estimate total ecosystem LAI, partitioning it into forest overstory (LAIOverstory) and understory (LAIUnderstory) components remains challenging, particularly in dryland forests where open canopies and strong soil background effects influence remote sensing retrievals. A multi-sensor framework for estimating and partitioning LAI was developed and validated using Sentinel-1 (S1; SAR) and Sentinel-2 (S2; optical) imagery. The models were calibrated and validated against 117 optical (SunScan®) field measurements conducted during 2017-2023 across two long-term ecological research (LTER) sites with different overstory thinning treatments, along with 19 long-term monitoring (LTM) plots in east-Mediterranean Pinus halepensis and Pinus brutia forests, spanning an arid to dry-subhumid climatic range. Partial Least Squares Regression (PLS-R) models demonstrated strong predictive performance. Sentinel-2 predictors showed the highest sensitivity to LAIOverstory (R2 = 0.78, RMSE = 0.66). In contrast, Sentinel-1 C-band VH backscatter captured LAIUnderstory variability (R2 = 0.90, RMSE = 0.22). The combined S1 + S2 model provided the most consistent predictions, showing improved performance for both LAIOverstory (R2 = 0.85, RMSE = 0.53) and LAIUnderstory (R2 = 0.92, RMSE = 0.20), reflecting the complementary sensing mechanisms of optical and SAR observations. Thinning strongly influenced the vertical distribution of LAI in semiarid forest stands, with LAIUnderstory accounting for 16% to 45% of total LAI, depending on thinning intensity. Comparison with widely used satellite-derived LAI products (GCOM-C SGLI, PROBA-V, Sentinel-3 OLCI, MODIS, and SL2P at 10 m and 20 m) showed stronger agreement with effective PAI than with LAI, indicating systematic underestimation of ecosystem LAI in dryland forests. These findings highlight the importance of resolving vertical canopy structure for improving ecosystem monitoring and modeling in water-limited environments.
...
### [90] [Multi-Platform LiDAR Comparative Assessment for Aboveground Biomass and Carbon Estimation in Mediterranean Woody Crops](https://doi.org/10.3390/rs18162802)
...
### [91] [The Suitability of a Remote Microwave Radiometer for Detecting Volcanic Activity](https://doi.org/10.3390/rs18162797)
...
### [92] [Improving Land Surface Emissivity for Better Simulation of Microwave Radiances over Northern Latitudes](https://doi.org/10.3390/rs18162819)
...
### [93] [Context-Guided Discrimination Feature Learning in Color Space for Aircraft Detection in SAR Images](https://doi.org/10.3390/rs18162756)
...
### [94] [Effects of Deep Learning Observation Operators in Direct Radiance Assimilation of Microwave Radiation Imager in Land Surface Models](https://doi.org/10.3390/rs18162781)
...
### [95] [Kinematic Mapping and Geomorphological Analysis of Rock Glaciers in the Pirin Mountains (Bulgaria)](https://doi.org/10.3390/rs18162754)
...
### [96] [A Hex-View Perspective on Plant Disease Detection Using Remote Sensing](https://doi.org/10.3390/rs18162806)
...
### [97] [Unsupervised Gaussian-Noise-Robust Remote Sensing Change Detection via FRFCM-IRM Change Intensity Modeling and SEEDSAM-Constrained HCRF](https://doi.org/10.3390/rs18162821)
...
### [98] [Mask and Contiguity-Constrained Subarray Design for SAR Antenna Arrays](https://doi.org/10.3390/rs18162755)
...
### [99] [Freshwater Aquaculture Dynamics in China’s Jianghan Plain Revealed by Multi-Source Satellite Imagery](https://doi.org/10.3390/rs18162775)
...
### [100] [Class Semantic Prototype Guided Fusion Network for Hyperspectral and LiDAR Data Classification](https://doi.org/10.3390/rs18162768)
...
### [101] [Spatial-Temporal Analysis and Multi-Scenario Forecasting of Land Use and Net Primary Productivity in Qingdao](https://doi.org/10.3390/rs18162758)
...
### [102] [Monitoring Mangrove Forests Responses to Kaolin Pollution Using LandTrendr Time-Series Analysis](https://doi.org/10.3390/rs18162773)
...
### [103] [Redistribution of Cloud Weather States Across the Marine Cold-Air Outbreak Intensity Range in the Midlatitude North Atlantic](https://doi.org/10.3390/rs18162774)
...
### [104] [Integrating Remote Sensing and Meteorological Time Series to Assess Rice Sheath Blight Habitat Suitability at Large-Scale: A Spatiotemporal Adaptive Framework](https://doi.org/10.3390/rs18162762)
...
### [105] [Case Study on Artificial Sea Fog Dispersal Effect Evaluation Based on Visibility Lidar](https://doi.org/10.3390/rs18162761)
...
### [106] [A Multimodal Remote Sensing Framework Based on an Improved YOLO Instance Segmentation Model for Automatic Glacial Lake Extraction in Southeastern Tibet](https://doi.org/10.3390/rs18162769)
...
### [107] [A Consistency-Guided Collaborative Filtering Framework for Suppressing Structured Coherent Artifacts](https://doi.org/10.3390/rs18162780)
...
### [108] [Semantic Segmentation of Remote Sensing Images Based on RS3mamba and Wavelet Transform](https://doi.org/10.3390/rs18162779)
...
### [109] [Divergent Trends of Surface Solar Radiation Across China (1994–2022): Integrating Ground Observations with Satellite Products for Regional Attribution](https://doi.org/10.3390/rs18162782)
...
### [110] [BCNet: Boundary-Constrained Remote Sensing Change Detection Network Based on Vision Foundation Models](https://doi.org/10.3390/rs18162760)
...
### [111] [SRAC-Net: HSI-Primary Residual Adaptation with Consistency Regularization for Lightweight Hyperspectral–LiDAR Classification](https://doi.org/10.3390/rs18162767)
...
### [112] [Hybrid TLS–Tachymetry Framework for Geometric Axis Validation of a Steel Lattice Transmission Tower](https://doi.org/10.3390/rs18162757)
*Robert Gradka*
...
### [113] [High-Resolution Typhoon Risk Assessment Based on Geospatial Big Data: A Case Study of Haikou, China](https://doi.org/10.3390/rs18162770)
...
### [114] [BDNet: A Dual-Path Network for Balancing Accuracy and Efficiency in Remote Sensing Stereo Matching](https://doi.org/10.3390/rs18162777)
...
### [115] [Classification of Urban Land Subsidence Types in Fuzhou from Time-Series InSAR Using FFT-Based Filtering and Ensemble Learning](https://doi.org/10.3390/rs18162778)
...
### [116] [An Empirically Calibrated Optical Mask Approach for Estuarine Turbidity Front Detection with AlphaEarth Embeddings and Sentinel-2 Spectral–Spatial Features](https://doi.org/10.3390/rs18162765)
...
### [117] [MTC-Net: Leveraging Multi-Temporal Consistency and Multi-View Synergistic Contrastive Learning for Remote Sensing Scene Classification](https://doi.org/10.3390/rs18162764)
...
### [118] [Difference-Gated Interaction and Change-Aware Cross-Temporal Fusion Network for Remote Sensing Image Change Detection](https://doi.org/10.3390/rs18162763)
...
### [119] [Topographic Modulation of Extreme Precipitation-Driven Rainfall Erosivity in the Hengduan Mountains](https://doi.org/10.3390/rs18162772)
...
### [120] [Surface Deformation Monitoring and Subsidence Risk Zonation Along the Middle Route of the South-to-North Water Diversion Project Coupling Time-Series InSAR with AHP-FCE](https://doi.org/10.3390/rs18162766)
...
### [121] [UAV Remote Sensing Mission Scheduling for Vessel Emission Monitoring in Emission Control Areas](https://doi.org/10.3390/rs18162753)
...
### [122] [Quantifying Visual Symptom Severity in Plants Using Deep Learning: A Severity Scale Derived from Classification Model Outputs](https://doi.org/10.3390/rs18162776)
...
### [123] [A Comprehensive Comparison of Seven Surface Air Temperature Reanalysis Products over Mainland China from Multiple Spatiotemporal and Geographical Perspectives](https://doi.org/10.3390/rs18162752)
...
### [124] [Event-Guided Spatiotemporal Transformer with Conditional Diffusion Refinement for High-Intensity Precipitation Nowcasting](https://doi.org/10.3390/rs18162771)
...
### [125] [Energy Optimization-Based Segmentation and Extraction of 3D Sonar Point Clouds for Complex Underwater Structures](https://doi.org/10.3390/rs18162759)
...
### [126] [Development of a Labeled Dataset for Convection Initiation Events over China’s Central and Eastern Mainland During the Warm Season](https://doi.org/10.3390/rs18162795)
...
### [127] [Landslide Susceptibility Modeling Constrained by Multi-Scale Polygon Sampling and InSAR Deformation for High-Relief Mountainous Areas: A Case Study in the Upper Jinsha River, Southwest China](https://doi.org/10.3390/rs18162788)
...
### [128] [Multi-Source Spaceborne LiDAR Forest Canopy Height Retrieval by Integrating GEDI and ICESat-2](https://doi.org/10.3390/rs18162787)
...
### [129] [Assessing the Multi-Scale Surface Albedo Responses to Blowing Snow in East Antarctica Using Coordinated Ground and Satellite Observations](https://doi.org/10.3390/rs18162784)
...
### [130] [Source-Only Cross-Dataset Building Change Detection with Frozen DINOv3 and Hierarchical Evidence Fusion](https://doi.org/10.3390/rs18162789)
...
### [131] [Quantifying Lateral Fluvial Dynamics Using Sentinel-2: Monitoring Medium-Large Rivers in Italy](https://doi.org/10.3390/rs18162792)
...
### [132] [Intelligent Metallogenic Evaluation of Podiform Chromitites Based on Multi-Source Data Fusion and Deep Learning of Geological Structures](https://doi.org/10.3390/rs18162794)
...
### [133] [From Canopy Phenology to Lithological Signals: Evaluating Biophysical Traits with Machine Learning in the Hațeg Basin](https://doi.org/10.3390/rs18162783)
...
### [134] [Characterizing Baseline Configuration Effects on Forest Height Retrieval in Airborne P-Band TomoSAR](https://doi.org/10.3390/rs18162785)
...
### [135] [CDF-DETR: Cross-Stage Attention and Dual-Scale Feature Calibration for Small-Object Detection in UAV Remote Sensing Imagery](https://doi.org/10.3390/rs18162793)
...
### [136] [Spaceborne GNSS-R Soil Moisture Retrieval over Expansive Soils Using an Attention-Enhanced Spatio-Temporal Graph Convolution Network](https://doi.org/10.3390/rs18162790)
...
### [137] [VCDH-YOLO: Viewpoint-Conditioned Dual-Head Detection for Mixed-View Crack Inspection Across Drone and Ground Platforms](https://doi.org/10.3390/rs18162791)
...
### [138] [Integrating Ascending–Descending SBAS and PS-InSAR to Monitor Landslide Deformation in the Jinsha River Batang Reach, China](https://doi.org/10.3390/rs18162786)
...
### [139] [Atmospheric Remote Sensing Based on Satellite Oxygen-Band Observations: A Review](https://doi.org/10.3390/rs18162808)
...
### [140] [Spatial-Temporal Distribution and Microphysical Characteristics of Aerosols and Clouds over China: A Combined Satellite and Aircraft Observation Study](https://doi.org/10.3390/rs18162796)
...
### [141] [Recent Progress in Remote Sensing of Clouds and Precipitation Physics: Platforms, Applications, and Emerging Frontiers](https://doi.org/10.3390/rs18162798)
...
### [142] [Analysis and Intelligent Processing of the Underwater Navigation Adaptability of Gravity Reference Maps](https://doi.org/10.3390/rs18162812)
...
### [143] [MS-SSTNet: A Scale-Aware Spatiotemporal Learning Framework for Satellite SST Forecasting via Iterative Multiscale Decomposition and Dual-Window Modelling](https://doi.org/10.3390/rs18162803)
...
### [144] [Confidence-Aware Selective Test-Time Adaptation for Remote-Sensing Pansharpening](https://doi.org/10.3390/rs18162801)
...
### [145] [Stepped-Frequency Doppler-Coded Integrated Joint Division Multiple Access Waveform for High-Precision Traffic MIMO Radar](https://doi.org/10.3390/rs18162809)
...
### [146] [Modeling of Middle Atmospheric Water Vapor Based on TIMED/SABER Data](https://doi.org/10.3390/rs18162805)
...
### [147] [A Network-Based Framework for Characterizing Pre-Seismic Ionospheric Disturbances Using the TEC Anomaly Significance Index](https://doi.org/10.3390/rs18162810)
...
### [148] [Wave Parameter Inversion Based on Sea Clutter Characteristics](https://doi.org/10.3390/rs18162799)
...
### [149] [Machine Learning-Based Detection and Quantification of Septoria Leaf Blotch in Winter Wheat from Hyperspectral and UAV Multispectral Data](https://doi.org/10.3390/rs18162800)
...
### [150] [A Case Study on the Triggering and Maintenance Mechanisms of Dual Squall Lines over North China Within a Cold Vortex Environment](https://doi.org/10.3390/rs18162807)
...
### [151] [Spectral-Consistency-Aware Evaluation of Deep Super-Resolution Methods for UAV Five-Band Multispectral Crop Imagery](https://doi.org/10.3390/rs18162811)
...
### [152] [Geo-Consistent Centralized Multi-UAV Gaussian SLAM for Incremental Orthophoto Generation](https://doi.org/10.3390/rs18162804)
...
### [153] [Multiscale Estimation of Mangrove Biomass in Fujian Province Using UAV as a Bridging Scale](https://doi.org/10.3390/rs18162831)
...
### [154] [Asynchronous Responses of Ecosystem Carbon Gain and Groundwater Storage Under Ecological Restoration in the Loess Plateau](https://doi.org/10.3390/rs18162822)
...
### [155] [Does Immersive VR Alter Landscape Perception? A Comparative Evaluation of UAV-Derived VR Versus 2D Imagery in Rural Villages](https://doi.org/10.3390/rs18162818)
...
### [156] [Multi-Source Geophysical Data Integration for Underwater Target Detection in Complex Seabed Environments: A Case Study of the Nan’ao I Shipwreck, China](https://doi.org/10.3390/rs18162832)
...
### [158] [Dynamics of Forest Disturbance in the Canopy of Permanent Production Forests: A Multitemporal Analysis (2004–2025) Using Spectral Unmixing in the Southeastern Peruvian Amazon](https://doi.org/10.3390/rs18162813)
...
### [159] [Enhancing the Reliability, Performance, and Practical Value of Deep Learning Landslide Mapping via Pixel-Level Uncertainty Analysis](https://doi.org/10.3390/rs18162825)
...
### [160] [Multi-Scale Spatiotemporal Graph ODE Networks for Marine Chlorophyll-a Prediction](https://doi.org/10.3390/rs18162828)
...
### [161] [Spatial–Spectral Decoupling-Enhanced Lightweight Network for Few-Shot Hyperspectral Anomaly Detection in Remote Sensing Imagery](https://doi.org/10.3390/rs18162833)
...
### [162] [Multiple Vegetation Indicators Reveal Contrasting Post-Drought Recovery Time in the Yangtze River Basin Following the 2022 Extreme Drought](https://doi.org/10.3390/rs18162824)
...
### [163] [Construction and Validation of a High-Fidelity Virtual Scene for Low-Stature and High-Biodiversity Ecosystems—Simulating Multi-Modal Sensing Approaches](https://doi.org/10.3390/rs18162816)
...
### [164] [A Balanced Spectral–Spatial Cross-Fusion Network for Hyperspectral Anomaly Detection](https://doi.org/10.3390/rs18162820)
...
### [165] [Long-Horizon Mining Subsidence Forecasting and Ecological Time-Lag Assessment Using Multi-Source Remote Sensing](https://doi.org/10.3390/rs18162829)
...
### [166] [AERO: Arbitrary-Scale Equivariant Resolution Operator for Remote Sensing Image Super-Resolution](https://doi.org/10.3390/rs18162823)
...
### [167] [Dual-Domain Illumination Prior for Low-Light Remote Sensing Image Enhancement](https://doi.org/10.3390/rs18162817)
...
### [168] [Evaluating Seasonal Fidelity and Cross-Site Structural Discrimination of Sentinel-2 LAI Products in Karst Forests](https://doi.org/10.3390/rs18162830)
...
### [169] [Predicting LiDAR-Derived Canopy Leaf Area Index in Loblolly Pine Plantations with Sentinel-2 Imagery Using a Convolutional Neural Network Approach](https://doi.org/10.3390/rs18162814)
...
### [170] [GCF-Net: Stage-Aligned Optical–Elevation Fusion for Aerial Remote Sensing Semantic Segmentation](https://doi.org/10.3390/rs18162827)
...
### [171] [UNet-DFH: A Semantic Segmentation Network Combining Multi-Scale Edge Fusion and Attention-Deformable Modules for Sugarcane Mapping in Heterogeneous Karst Regions](https://doi.org/10.3390/rs18162815)
...
### [172] [Active Inference as Context Acquisition for AI Agents](https://arxiv.org/abs/2608.19202)
...
### [182] [Enforcing LLM Safety through DMD-based Classification of Prompt-Response Embedding Dynamics](https://arxiv.org/abs/2608.19579)
...
### [187] [Rethinking the Evaluation and Optimization of LLM-Based Social Simulation](https://arxiv.org/abs/2608.19689)
...
### [190] [GenMatch: An End-to-End Generative Matching Framework for Micro-View Order-Dispatching in Ride-Hailing](https://arxiv.org/abs/2608.19751)
...
Abstract (英文): Deep learning models remain vulnerable to real-world input perturbations, especially when multiple corruptions co-occur in the same input (e.g., brightness shifts and motion blur). Compositional testing reveals these interaction effects but introduces two challenges: combinatorial growth of the perturbation space as dimensions and severity levels increase, and uneven diagnostic value-many combinations yield unrealistically degraded inputs with limited practical relevance.
...
### [202] [Write Once, Run Everywhere: The Axon DSL for Shape-Safe and Framework-Agnostic LLM Architectures](https://arxiv.org/abs/2608.19889)
...
### [213] [Contrastive Mixed Prompt Learning for Incomplete Multimodal Sentiment Analysis with Unseen Modality Combination](https://arxiv.org/abs/2608.20019)
...
Abstract (英文): Memory has become a key component of large language models, enabling them to retain information and learn from long-term interactions. However, existing memory benchmarks mainly evaluate whether information is correctly extracted, stored, and retrieved, while largely overlooking how retrieved memories reshape model reasoning and affect performance on the current task. We identify memory-induced cognitive traps: even faithfully recorded and semantically relevant memories can distort model reasoning or beliefs and degrade current task performance. To systematically evaluate these failure modes, we introduce MemTrapBench, which covers two forms of cognitive traps: Reasoning Fixation and Belief Distortion. Experiments across two model families and five representative memory frameworks show that MemTrapBench is challenging: all evaluated memory strategies underperform the no-memory setting, with even the strongest methods suffering drops of more than 10%. To mitigate these cognitive traps, we propose AdaptiveMem, a simple yet effective inference-time method that instructs LLMs to avoid memory traps. AdaptiveMem mitigates cognitive traps on MemTrapBench while preserving or improving performance on standard memory benchmarks across diverse memory frameworks.

</details>


### [221] [ContractScrub: A benchmark for final review of legal contracts](https://arxiv.org/abs/2608.20204)
...
### [229] [Phantom Gains: Auditing Self-Improvement Against a Measured Null](https://arxiv.org/abs/2608.20290)

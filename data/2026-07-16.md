...
### [47] [Barnamala: Parameter-Efficient Handwritten Devanagari Recognition at Benchmark Saturation](https://arxiv.org/abs/2607.13689)
...
### [87] [CDHNet: An implicit calibration and difference-guided hierarchical perception change detection network for remote sensing images](https://doi.org/10.1016/j.isprsjprs.2026.06.040)
...
### [88] [Monitoring mining impacts using harmonic decomposition of time series vegetation indices](https://doi.org/10.1016/j.isprsjprs.2026.07.001)
...
### [89] [UniOrtho: From view-centric to unified orthographic framework for satellite semantic 3D reconstruction](https://doi.org/10.1016/j.isprsjprs.2026.06.039)
...
### [90] [Time-series framework integrating rainfall and satellite soil moisture for multi-scale urban flood risk assessment](https://doi.org/10.1016/j.jag.2026.105470)
*Sang Yeob Kim*
...
### [91] [Referring Remote Sensing Image Segmentation method based on Scene-Aware Guided Network model](https://doi.org/10.1016/j.jag.2026.105457)
...
### [92] [A SIF-Constrained Noah-MP land surface model for simulating water use efficiency and drought Resilience: Application in a Semi-Arid Basin](https://doi.org/10.1016/j.jag.2026.105460)
...
### [93] [A two-stage machine learning framework for Chl-a reconstruction and short-term prediction in eutrophic lakes using GOCI observations](https://doi.org/10.1016/j.jag.2026.105468)
...
### [94] [Reproducible mapping of marine biodiversity using autonomous surface vehicles and deep learning](https://doi.org/10.1016/j.jag.2026.105462)
...
### [95] [Label-efficient mapping of unregulated waste dumps via mixed supervision with feature masked recovery](https://doi.org/10.1016/j.jag.2026.105471)
...
### [96] [BLB_TVI: A hyperspectral triangular index for satellite-scale characterization of rice bacterial leaf blight severity](https://doi.org/10.1016/j.jag.2026.105472)
...
### [97] [Individual urban street tree detection and species-level mapping from street-view images and GIS data](https://doi.org/10.1016/j.jag.2026.105449)
...
### [98] [A high-resolution interchange classification model enhanced by multi-scale geometric structural feature fusion](https://doi.org/10.1016/j.jag.2026.105450)
...
### [99] [From flood extent mapping to mechanism-aware flood products: integrating flood type classification into satellite-based flood monitoring](https://doi.org/10.1016/j.jag.2026.105482)
...
### [100] [Spatiotemporal bias in OCO-2 XCO2 retrievals relative to TCCON observations](https://doi.org/10.1016/j.jag.2026.105466)
...
### [101] [Leveraging EMIT spectroscopy and machine learning to estimate soil texture and particle grain size in dust-producing regions](https://doi.org/10.1016/j.rse.2026.115557)
...
### [102] [Optimizing 1D-Var near-surface wind speed from SSMIS with RapidScat](https://doi.org/10.1016/j.rse.2026.115560)
...
### [103] [Seasonal mass balance of Hofsjökull ice cap, Iceland, estimated from repeat ICESat-2 satellite altimetry](https://doi.org/10.1016/j.rse.2026.115555)
...
### [104] [Synergistic analysis and vertical transport attribution of carbon monoxide surface concentrations and satellite column loadings over China](https://doi.org/10.1016/j.rse.2026.115562)
...
### [105] [A hybrid machine learning and data assimilation framework for penman–monteith evapotranspiration estimation over China](https://doi.org/10.1016/j.rse.2026.115565)
...
### [106] [An improved 15-year record of ice sheet elevation from CryoSat-2 radar altimetry](https://doi.org/10.1016/j.rse.2026.115561)
...
### [107] [OriginBlame: Record- and Token-Level Data Provenance for AI Training Datasets](https://arxiv.org/abs/2607.13037)
*Haolin Xue*
...
### [113] [Oracle Agent Memory as an Enterprise Memory Substrate for Long-Horizon AI Agents](https://arxiv.org/abs/2607.13157)
...
### [135] [Experience Memory Graph: One-Shot Error Correction for Agents](https://arxiv.org/abs/2607.13884)
...
### [136] [AIMO Interpretability Challenge](https://arxiv.org/abs/2607.13899)
...
### [142] [Using Remote Sensing Data and Google Earth Engine to Quantify Regional Climate Responses to Afforestation](https://doi.org/10.3390/rs18142305)
...
### [143] [DMSF-Net: A Dual-Encoder Multi-Source Feature Fusion Network for Fine-Grained Urban Green Space Segmentation](https://doi.org/10.3390/rs18142308)
...
### [144] [Integrating Multi-Source Remote Sensing and Meteorological Features for Fine Mapping of Crop in Liaoning Province](https://doi.org/10.3390/rs18142301)
...
### [145] [Large-Scale Interseismic Crustal Deformation, Fault Slip Rate, Coupling and Earthquake Potential in the Upper Yellow River Basin](https://doi.org/10.3390/rs18142297)
...
### [146] [A Hybrid CNN–Transformer Model for Terrace Extraction from Remote Sensing Imagery](https://doi.org/10.3390/rs18142291)
...
### [147] [A Modular and Transferable Framework for Enhancing Satellite-Derived Daily Precipitation: Adjusting Values, Aligning Distributions, and Preserving Extremes](https://doi.org/10.3390/rs18142298)
...
### [148] [Short-Term Forecasting of Ocean Surface Current Maps Using High-Frequency Radar Observations and LSTM Neural Networks: A Case Study of Southwestern Taiwan](https://doi.org/10.3390/rs18142303)
...
### [149] [Flash Drought Dynamics in China’s Major Agricultural Plains: Spatiotemporal Patterns and Crop Photosynthetic Recovery Across Cropping Systems](https://doi.org/10.3390/rs18142295)
...
### [150] [Temporary Floodplain Ponds Shape Vegetation Mosaic in a Natural River Valley: Evidence from SAR and Optical Remote Sensing](https://doi.org/10.3390/rs18142292)
...
### [151] [Large-Scale Stratigraphic Analysis of Paintings by OCT: A Supervised Learning and Volumetric Stitching Approach](https://doi.org/10.3390/rs18142300)
...
### [152] [Spatiotemporal Variation and Drivers of Vegetation Phenology Along an Urban–Rural Gradient in Rapidly Urbanizing Beijing, China](https://doi.org/10.3390/rs18142302)
...
### [153] [A Multi-Source Remote Sensing-Based AGB Synergistic Inversion Approach Integrating Terrain-Corrected Canopy Height and Forest-Type Heterogeneity](https://doi.org/10.3390/rs18142304)
...
### [154] [VFM-MoME: A Remote Sensing Landslide Image Segmentation Network Guided by a Visual Foundation Model and a Mixture of Mamba Experts](https://doi.org/10.3390/rs18142293)
...
### [155] [Vertical Structure of Air Temperature Excesses of the 2025 Mw 8.8 Kamchatka Earthquake](https://doi.org/10.3390/rs18142306)
...
### [156] [VODet: A Vertex Offset-Based Method for Oriented Object Detection in Remote Sensing Images](https://doi.org/10.3390/rs18142296)
...
### [157] [PanDiM: A Diffusion Mamba Network for High-Fidelity Pansharpening](https://doi.org/10.3390/rs18142299)
...
### [158] [Monitoring and Prediction of Ground Deformation Using InSAR and Machine Learning Approaches in Tianjin City, China](https://doi.org/10.3390/rs18142294)
...
### [159] [Geohazard Risk Identification and Validation in Hunan Province Using Synergistic Multi-Resolution SAR Monitoring](https://doi.org/10.3390/rs18142307)
...
### [160] [Surface Heat Source Variations and Driving Factors in Typical Permafrost Areas of the Tibetan Plateau](https://doi.org/10.3390/rs18142312)
...
### [161] [Integrating Deep Generative AI and Hyperspectral–Multispectral Data Fusion for Enhancing Digital Soil Mapping](https://doi.org/10.3390/rs18142320)
...
### [162] [Independent Multi-Sensor Validation of Machine-Learning Landslide Susceptibility: Footprint Construction Decides the Verdict—May 2023 Emilia-Romagna Event](https://doi.org/10.3390/rs18142318)
...
### [163] [Nonlinear Responses and Spatial Heterogeneity of Net Ecosystem Productivity to Extreme Weather Events in Central Asia](https://doi.org/10.3390/rs18142315)
...
### [164] [Structure-Confidence Guided Phase Congruency and Cascade Matching for Registration of Optical and SAR Images](https://doi.org/10.3390/rs18142322)
...
### [165] [Joint Cross-Range Scaling and Phase Autofocus for ISAR Imaging Based on Adaptive Phase Tracking with Application to Asteroid Imaging](https://doi.org/10.3390/rs18142311)
...
### [166] [Research on Few-Shot Mars Rover Onboard Surface Scene Classification Based on SE-ResNet-MTL](https://doi.org/10.3390/rs18142319)
...
### [167] [Multi-Stage Aggregation CNN–Transformer Hybrid Architecture for Infrared Small-Target Detection](https://doi.org/10.3390/rs18142309)
...
### [168] [Influence of Internal Climate Variability on Satellite-Altimeter-Derived Regional Sea-Level Trends](https://doi.org/10.3390/rs18142313)
*Se‐Hyeon Cheon*
...
### [169] [Physics-Informed Semantic Prompt Learning for Few-Shot Low-Altitude Radar Target Recognition in Remote Sensing](https://doi.org/10.3390/rs18142316)
...
### [170] [A Sub-Scene-Based GNSS-Constrained Structure from Motion for Robust Long-Corridor UAV Image Reconstruction](https://doi.org/10.3390/rs18142321)
...
### [171] [Climate-Driven Phenological Responses of Fagus sylvatica Across European Climatic Zones Using Remote Sensing](https://doi.org/10.3390/rs18142314)
...
### [172] [Removing Cirrus-Induced Errors in Operational Landsat 8 and 9 Daytime Surface Temperature Products over Waters](https://doi.org/10.3390/rs18142317)
...
### [173] [Exploring the Potential of Machine Learning Post-Processing to Generate ERA5-Consistent Atmospheric Profiles from Geostationary Satellite Retrievals](https://doi.org/10.3390/rs18142310)
...
### [174] [A New Deep Learning Method for Sea Fog Detection Using Fengyun-4A Satellite Data](https://doi.org/10.3390/rs18142334)
...
### [175] [Category-Aware Global–Local Semantic Alignment for Remote Sensing Image–Text Retrieval](https://doi.org/10.3390/rs18142335)
*Da Ha,Haisu Zhang*
...
### [176] [Deconstructing and Ameliorating Woody Volume Estimation Errors Arising from Leaves in Quantitative Structure Models of Trees](https://doi.org/10.3390/rs18142342)
...
### [177] [Decoupling Deep Mining and Tailings Consolidation-Induced Subsidence Using SBAS-InSAR and NMF: A Case Study at South Deep Gold Mine, South Africa](https://doi.org/10.3390/rs18142337)
...
### [178] [Spatiotemporal Variations in Terrestrial Water Storage and Water Scarcity Assessment Across China Based on TWSA_BTCH](https://doi.org/10.3390/rs18142324)
...
### [179] [UAV 3D Scene Understanding: A Survey from an Agent-Capability Evolution Perspective](https://doi.org/10.3390/rs18142323)
...
### [180] [Multi-Method Identification and Spatiotemporal Evolution Analysis of Active Deformation Areas in the Binchang Mining Area](https://doi.org/10.3390/rs18142339)
...
### [181] [Normalized Dynamic Fluorescence Height: An Alternative Algorithm for Chlorophyll a Estimation in Algae-Dominated Waters Using Hyperspectral Remote Sensing Reflectance from In Situ and Spaceborne Imagers](https://doi.org/10.3390/rs18142332)
...
### [182] [Assessing the Capabilities of UAV-Based Observation for Marginalized Communities: A Case Study of Roma Settlements in Slovakia](https://doi.org/10.3390/rs18142326)
...
### [183] [Nighttime Thermal Patterns and County Life Expectancy: A 20-Year Multimodal Satellite Fusion for the Contiguous United States](https://doi.org/10.3390/rs18142330)
...
### [184] [Significance-Preserving Progressive Network for Infrared and Visible Image Fusion](https://doi.org/10.3390/rs18142328)
...
### [185] [HFG-YOLO: A High-Frequency-Guided Network for Small-Object Detection](https://doi.org/10.3390/rs18142343)
...
### [186] [ECDF-Stabilized Sentinel-1 InSAR Coherence for Verification-Oriented Heritage Monitoring: A TabICLv2-SHAP and Three-Horizon DEMATEL Architecture](https://doi.org/10.3390/rs18142325)
...
### [187] [CASA-Net: Context-Aware Small-Object Adaptation Network for UAV Aerial Images](https://doi.org/10.3390/rs18142327)
...
### [188] [COSM: Satellite and Ground Segment](https://doi.org/10.3390/rs18142340)
...
### [189] [IC-EWH: Energy-Weighted Hough Transform with Iterative Curvature Compensation for Squint Angle Estimation of Highly Squinted SAR](https://doi.org/10.3390/rs18142344)
...
### [190] [Target Detection for UAV Inspection in Complex Illumination Environments: A Lightweight Dual-Modal Fusion Method with Multi-Directional Mamba Cross-Attention](https://doi.org/10.3390/rs18142329)
...
### [191] [A Dual-Perspective Analysis of Ozone Formation Sensitivity in the Yangtze River Delta: Satellite and Ground-Based Evidence](https://doi.org/10.3390/rs18142336)
...
### [192] [Enhancing the Estimation and Mapping of Soil Cadmium by Using Geospatial Information-Guided Machine Learning and Principal Component Spectra](https://doi.org/10.3390/rs18142341)
...
### [193] [Physics-Guided cGAN with Multi-Scale Attention for Robust 2D Phase Unwrapping in Low-Coherence Regions](https://doi.org/10.3390/rs18142338)
...
### [194] [Optimizing Spectral Inputs for Deep Learning-Based Vegetation Destruction Detection Using Sentinel-2 Imagery](https://doi.org/10.3390/rs18142333)
...
### [195] [Flood Regulation Service Responses to Urban Green Space Change in a Plateau Valley City: A Case Study of Lhasa, China](https://doi.org/10.3390/rs18142331)
...
### [196] [Seasonal Variability of the Surface Circulation in the Tyrrhenian Sea: New Insights from SWOT Altimetry and Tide Gauge Records](https://doi.org/10.3390/rs18142346)
...
### [197] [Satellite Embedding Features for Grassland Aboveground Biomass Estimation in Complex Mountainous Terrain: A Case Study of the Three Parallel Rivers Region, China](https://doi.org/10.3390/rs18142348)
...
### [198] [Insta-BDA: Instance-Aware Building Damage Assessment and Counting via Foundation Model Fusion](https://doi.org/10.3390/rs18142347)
...
### [199] [A Method for Extracting Small Moving Targets Based on Temporal and Spatial Saliency Features](https://doi.org/10.3390/rs18142349)
...
### [200] [Fed-RSAdapter: Federated Fine-Tuning of Remote Sensing Images via Multi-Scale Adapter Modules](https://doi.org/10.3390/rs18142352)
...
### [201] [Long-Term Vegetation Dynamics Across Distance Buffers Along the Gonghe–Yushu Expressway Corridor on the Qinghai–Xizang Plateau](https://doi.org/10.3390/rs18142354)
...
### [202] [Estimating Actual Evapotranspiration in Orchard Systems Using the ALARM Energy Balance Model and MODIS Data](https://doi.org/10.3390/rs18142351)
...
### [203] [Spectral-Prior-Guided Swin TransUnet for Sparse-Aperture FMCW MIMO-SAR Imaging](https://doi.org/10.3390/rs18142350)
...
### [204] [Remote Sensing of Coastal Saline-Alkali Land in China: Progress in Identification, Ecological Restoration, and Sustainable Management](https://doi.org/10.3390/rs18142345)
...
### [205] [Land Use/Land Cover Classification of the Qinghai Lake Basin Using Multitemporal Sentinel-1/2 Imagery](https://doi.org/10.3390/rs18142353)
...
### [206] [Analyzing dominant driving factors of ground deformation in mining area via multimodal feature fusion and explainable modeling](https://doi.org/10.1080/15481603.2026.2700121)
...
### [207] [Coupling functional heterogeneity activation and distance impedance: a distance-decay model for urban population spatial interactions](https://doi.org/10.1080/15481603.2026.2698143)
...
### [208] [A Hybrid Window Transformer for accurate and generalizable soil salinity prediction across China](https://doi.org/10.1080/15481603.2026.2700119)

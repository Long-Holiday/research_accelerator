...
Abstract (英文): Computer aided design (CAD) is ubiquitous: virtually any modern object was designed using editable CAD tools. However, with the shortage of available CAD datasets in its native editable and parametric format, boundary representation (B-Rep), it is ever more important to develop data-efficient methods for this domain.
...
Abstract (英文): This paper presents a review of the second LoViF Challenge on Real-World All-in-One Image Restoration. The challenge aims to advance unified image restoration under diverse real-world degradation conditions, including blur, low-light, haze, rain, and snow. It provides a common benchmark for evaluating the restoration accuracy, robustness, and generalization capability of models across multiple degradation categories within a unified framework. The competition attracted 158 registered participants, and 20 teams were included in the final ranking after their submitted results were successfully reproduced and verified. This report provides a comprehensive analysis of the submitted solutions and corresponding results, highlighting recent advances in real-world all-in-one image restoration. The summarized methods and empirical findings reveal effective design strategies and establish an updated benchmark for future research in real-world low-level vision.
...
Abstract (英文): We introduce the largest real-world image deblurring dataset constructed from smartphone slow-motion videos. Using 240 frames captured over one second, we simulate realistic long-exposure blur by averaging frames to produce blurry images, while using the temporally centered frame as the sharp reference. Our dataset contains over 42,000 high-resolution blur-sharp image pairs, making it approximately 10 times larger than widely used datasets, with 8 times the amount of different scenes, including indoor and outdoor environments, with varying object and camera motions. We benchmark multiple state-of-the-art (SOTA) deblurring models on our dataset and observe significant performance degradation, highlighting the complexity and diversity of our benchmark. Our dataset serves as a challenging new benchmark to facilitate robust and generalizable deblurring models.
...
### [96] [A Multi-Method Approach to the Analysis of Trends and Cyclical Variability in Sea Level Along the Southern Baltic Coast](https://doi.org/10.3390/rs18142398)
...
### [97] [Improving FY-4B Satellite Precipitation Retrieval over Coastal Complex Terrain of Eastern China: Deep Learning Approaches with Multi-Source Underlying Surface Data](https://doi.org/10.3390/rs18142397)
...
### [98] [Unified UAV Open-Vocabulary Semantic Segmentation: Benchmark Construction and LLM-Guided Text–Visual Enhancement](https://doi.org/10.3390/rs18142408)
...
### [99] [Reply to Ho et al. Comment on “Guth et al. Benchmarking Elevation Plus Land Surface Parameters Finds FathomDEM and Copernicus DEM Win as Best Global DEMs. Remote Sens. 2025, 17, 3919”](https://doi.org/10.3390/rs18142399)
...
### [100] [Heterogeneous Dual-Path Wide Residual Network for Accurate Land Use and Land Cover Image Classification](https://doi.org/10.3390/rs18142406)
...
### [101] [On the Use of SAR Images for Predicting Vegetation Indices: Challenges and Limitations](https://doi.org/10.3390/rs18142400)
...
### [102] [C2Fusion: Collaborative Conditional Diffusion Model for Infrared and Visible Remote Sensing Image Fusion](https://doi.org/10.3390/rs18142402)
...
### [103] [Robust Unsupervised Spatial-Kinematic Coupling for Satellite Laser Ranging Signal Extraction](https://doi.org/10.3390/rs18142410)
...
### [104] [Monitoring Spatiotemporal Forest Fragmentation in Urban Landscapes: An Improved Urban Fringe Mapping Approach Using Time-Series Remote Sensing Data](https://doi.org/10.3390/rs18142405)
...
### [105] [Mapping Thermokarst Lakes Using Sentinel-2 Imagery in the Qinghai–Tibet Engineering Corridor in 2020](https://doi.org/10.3390/rs18142414)
...
### [106] [Revisiting Deep Learning-Based Semantic Segmentation on Large-Scale Hydraulic-Structure LiDAR Point Clouds: A Spatial Surrogate Modeling Perspective](https://doi.org/10.3390/rs18142413)
...
### [107] [Hybrid Deep Learning–Monte Carlo-Based MNDWI Ensemble for Probabilistic Water Extent Mapping Under Dynamic Spectral Flow Conditions in Large Waterbodies](https://doi.org/10.3390/rs18142412)
...
### [108] [Seismic Inversion Based on Mamba and ResUNet++](https://doi.org/10.3390/rs18142407)
...
### [109] [Rotated Array Radar on Non-Dedicated Platforms: A Processing Method Under Rotation Velocity Errors](https://doi.org/10.3390/rs18142411)
...
### [110] [Atmospheric Dust as an Air Quality Hazard to the World Population](https://doi.org/10.3390/rs18142403)
...
### [111] [WaveUAV-YOLO: A Lightweight Architecture for UAV Object Detection with Frequency-Domain Edge Preservation and Stable Gradient Fusion](https://doi.org/10.3390/rs18142404)
...
### [112] [Evaluation of IMERG V07 Precipitation Datasets at Hourly and Daily Scales in Texas, USA](https://doi.org/10.3390/rs18142401)
...
### [113] [Enhancing Flood Susceptibility Mapping Through High-Resolution Earth Observation: A Data-Driven Comparative Analysis](https://doi.org/10.3390/rs18142418)
...
### [114] [Remote Sensing Reveals How Agricultural Restructuring Spatially Organizes Non-Cropland Ecological Restoration in the Mu Us Sandy Land](https://doi.org/10.3390/rs18142421)
...
### [115] [Minimizing Peak Sidelobe Level in MIMO-SAR Waveform Design Using a 1.5-Entmax Sparse Loss](https://doi.org/10.3390/rs18142409)
...
### [116] [MSGMamba: A Multi-Scale Dynamic Graph State-Space Model for Satellite Telemetry Anomaly Detection](https://doi.org/10.3390/rs18142420)
...
### [117] [Gated Spiking Attention Transformer for Hyperspectral Image Classification](https://doi.org/10.3390/rs18142419)
...
### [118] [DPSF: A Dynamic Patch Shape Selection Framework for Cross-Model Transferable Adversarial Attacks](https://doi.org/10.3390/rs18142426)
...
### [119] [A Knowledge-Guided Factor Graph Neural Network for Event Detection in Simulated Non-Cooperative Space Targets](https://doi.org/10.3390/rs18142423)
...
### [120] [State-Space-Based Mamba and Convolutional Neural Network Integration for Anthropogenic Geomorphic Feature Extraction from Land Surface Parameters](https://doi.org/10.3390/rs18142415)
...
### [121] [Reliability Analysis of Agricultural Foundation Models Under Distribution Shift](https://doi.org/10.3390/rs18142416)
...
### [122] [DFELD-YOLO: A Decoupled Lightweight Detection Model for UAV-Based Wind Turbine Blade Damage Inspection](https://doi.org/10.3390/rs18142422)
...
### [123] [Scattering Center Prior-Guided Diffusion for Unknown-Azimuth SAR Image Generation](https://doi.org/10.3390/rs18142417)
...
### [124] [A Framework Integrating Slope-Unit Parameter Optimization and Ensemble Machine Learning for Landslide Susceptibility Mapping](https://doi.org/10.3390/rs18142424)
...
### [125] [A UAV–TLS Point-Cloud Fusion Framework for Three-Dimensional Characterization of Mining-Induced Surface Cracks](https://doi.org/10.3390/rs18142425)
...
### [126] [CLIFF: A Multi-Modal Remote Sensing Model for Geological Hazard Monitoring Based on Bitemporal UAV Images](https://doi.org/10.3390/rs18142432)
...
### [127] [LHEM-MSegNet: A Landslide Hazard Extraction Model Based on Multi-Source Data Fusion](https://doi.org/10.3390/rs18142429)
...
### [128] [Fugitive Methane Monitoring: A Systems Review of Physics, Technology, Economics, and Regulation](https://doi.org/10.3390/rs18142433)
*P. Sobrón*
...
### [129] [Vertical Canopy Gap Profiles Reveal Structural Divergence Among Central African Old-Growth Forest Types](https://doi.org/10.3390/rs18142431)
...
### [130] [Evaluating Waterlogging Risk Inequality in a Megacity](https://doi.org/10.3390/rs18142428)
...
### [131] [Hydrological Evolution of Siling Co over the Past 38 Years: Lake Area, Water Level Monitoring, and Water Storage Estimation Based on Multi-Source Remote Sensing](https://doi.org/10.3390/rs18142427)
...
### [132] [An Integrated and Hierarchical Geophysical Workflow for Subsurface Cavity Assessment in Legacy Mining Districts](https://doi.org/10.3390/rs18142430)
...
### [133] [Empirical Evaluation of Normality Tests and Heavy-Tailed Error Models for NMEA-Derived GNSS Positioning Data from a Low-Cost Receiver](https://doi.org/10.3390/rs18152446)
...
### [134] [Near-Real-Time Flood Disaster Monitoring Based on Moonlight and Multi-Source Remote Sensing: A Case Study of Zhengzhou Rainstorm](https://doi.org/10.3390/rs18152435)
...
### [135] [GTSNet: A Global Topography-Aware Segmentation Network for Remote Sensing Identification of Unstable Rock Masses](https://doi.org/10.3390/rs18152445)
...
### [136] [Rapid Strong Earthquake Magnitude Estimation Based on Near-Field High-Rate GNSS Data Using Deep Learning](https://doi.org/10.3390/rs18152444)
...
### [137] [Landslide Susceptibility Mapping Using an Image–Tabular Joint Deep Learning Framework: A Case Study of the Tacheng Region, Xinjiang, China](https://doi.org/10.3390/rs18152436)
...
### [138] [TCM-CR: Multi-Temporal SAR–Optical Cloud Removal with a Reference Image and Gated Bounded Residual](https://doi.org/10.3390/rs18152443)
...
### [139] [Effect of Shape on the Temperature of a Blackbody: Implications for Remote Sensing of Interplanetary Dust Particles](https://doi.org/10.3390/rs18152434)
...
### [140] [First-Derivative Analysis for Estimating Water Quality and Optical Metrics in Shallow Coastal Waters](https://doi.org/10.3390/rs18152441)
...
### [141] [Delineating Roofing Materials in Urban Areas Using Transformed High-Resolution Satellite Imagery and Convolutional Neural Networks](https://doi.org/10.3390/rs18152440)
...
### [142] [Improved Weighted Nuclear Norm Minimization for Infrared Dim and Small-Target Detection Based on Low-Rank Clustering](https://doi.org/10.3390/rs18152442)
...
### [143] [CMGFDet: Cross-Modal Gated Fusion Network with Multi-Receptive Field Aggregation for RGB–Infrared Aerial Object Detection](https://doi.org/10.3390/rs18152439)
...
### [144] [Efficient Online Sparse Target Reconstruction for Stochastic Radiation Radar Based on Progressive Staring Sparse Pruning Approach](https://doi.org/10.3390/rs18152438)
...
### [145] [Task-Specific Negative Sample Selection for Multi-Hazard Susceptibility Mapping of Slope-Instability Hazards](https://doi.org/10.3390/rs18152437)
...
### [146] [An Improved Recognition Technique for Ship Targets Based on Dual-Path Cooperative Fusion Mechanism](https://doi.org/10.3390/rs18152447)
...
### [147] [A Decade of Remote Sensing for Vegetation Monitoring with Sentinel-2](https://doi.org/10.3390/rs18152448)
...
### [148] [Quantifying Tidal Asymmetry of Suspended Sediment Concentration in Macro-Tidal Embayments: A Sentinel-2 Based Framework](https://doi.org/10.3390/rs18152450)
...
### [149] [Multi-Scale Lightweight Spectral Attention Network for Hyperspectral Image Classification](https://doi.org/10.3390/rs18152451)
...
### [150] [GeoMamba: Geometric-Prior-Infused Multi-Scale Deformable Visual Mamba for Crack Semantic Segmentation](https://doi.org/10.3390/rs18152449)
...
### [151] [Optical remote sensing of sea surface wind streaks: Retrievals of wind directions and wind waves](https://doi.org/10.1016/j.rse.2026.115569)
...
### [152] [Derivative of canopy reflectance with respect to leaf density: A probabilistic rendering framework](https://doi.org/10.1016/j.rse.2026.115572)
...
### [153] [Towards efficient multi-hazard detection from single satellite imagery via spectral-semantic graph reasoning](https://doi.org/10.1016/j.rse.2026.115566)
...
### [154] [A hydraulic-geometry informed discharge retrieval algorithm for ungauged basins using ICESat-2 and Sentinel-1/2: Application to Qinghai-Tibet Plateau](https://doi.org/10.1016/j.rse.2026.115568)
...
### [155] [Normalization of Sentinel 2 data over tropical forests to nadir BRDF adjusted reflectance](https://doi.org/10.1016/j.rse.2026.115583)
...
### [156] [Toward accurate disease diagnosis of fruit trees: Integrating a novel dual-angle vegetation index with canopy vertical distribution knowledge](https://doi.org/10.1016/j.rse.2026.115573)
...
### [157] [Editorial Board](https://doi.org/10.1016/s0034-4257(26)00347-0)
*Unknown Author*
...
### [158] [Label-efficient 3D forest mapping: Self-supervised and transfer learning for instance segmentation, semantic segmentation, and species classification](https://doi.org/10.1016/j.rse.2026.115564)
...
### [159] [Enhanced land surface phenology detections in the western U.S. drylands by fusing harmonized Landsat and Sentinel-2 observations with near-surface PhenoCam time series](https://doi.org/10.1016/j.rse.2026.115588)
...
### [160] [Substantial improvement of geostationary satellite-derived shortwave radiation product through correcting geolocation displacement](https://doi.org/10.1016/j.rse.2026.115589)
...
### [161] [Breaking barriers in rice chlorophyll retrieval from satellite imagery: Mitigating row structure and saturation effects via RiceGORT and chlorophyll sensitivity enhancement](https://doi.org/10.1016/j.rse.2026.115581)
...
### [162] [Retrieval of sea surface salinity from SMAP L-band radiometry under rainfall conditions](https://doi.org/10.1016/j.rse.2026.115570)
...
### [163] [A scattering model-informed deep transfer learning framework for surface soil moisture retrieval](https://doi.org/10.1016/j.rse.2026.115571)
...
### [164] [Integrating UAV image time-series with multi-source environmental features for sequential wildfire spread prediction](https://doi.org/10.1016/j.jag.2026.105473)
...
### [165] [Extreme climate effects on the occurrence and frequency of glacial debris flows: evidence from the Parlung Tsangpo Basin, Southeastern Tibetan Plateau](https://doi.org/10.1016/j.jag.2026.105475)
...
### [166] [Generation of high-precision precipitable water vapor products from morphed integrated microwave imagery](https://doi.org/10.1016/j.jag.2026.105485)
...
### [167] [Pioneering Test-Time training for robust Fine-Grained chlorophyll-a retrieval from Sentinel-2: Unveiling China’s lake eutrophication dynamics (2018–2025)](https://doi.org/10.1016/j.jag.2026.105487)
...
### [168] [Self-supervised spectral unmixing using scene-aware deep priors](https://doi.org/10.1016/j.jag.2026.105483)
...
### [169] [Spatiotemporal dynamics of grasshopper habitats under future climate projections, vegetation growth, and land use change](https://doi.org/10.1016/j.jag.2026.105481)
...
### [170] [Quantifying methane emissions from large coal mine using Sentinel-5 Precursor satellite data and Gaussian plume model](https://doi.org/10.1016/j.jag.2026.105491)
...
### [171] [Enabling maize mapping in double-cropping regions of Argentina and Brazil without ground reference data by leveraging multiple satellite platforms](https://doi.org/10.1016/j.jag.2026.105489)
...
### [172] [SuperDove satellite detection of matter-loaded windrows with a focus on extreme environmental events](https://doi.org/10.1016/j.jag.2026.105469)
...
### [173] [An integrated picture fuzzy entropy–MAIRCA–TOPSIS framework for sustainable soil suitability evaluation](https://doi.org/10.1016/j.jag.2026.105474)
...
### [174] [A transferable framework for roof vegetation mapping across tropical cities based on open-source multimodal data and morphology-aware UDASS](https://doi.org/10.1016/j.jag.2026.105490)
...
### [175] [MFRXG: A multi-feature stacking ensemble RF-XGBoost model for total nitrogen retrieval in the Yellow River from Landsat 8/9 data](https://doi.org/10.1016/j.jag.2026.105492)
...
### [176] [HeightCLIP: A vision-language network for height estimation from monocular remote sensing imagery](https://doi.org/10.1016/j.jag.2026.105499)
...
### [177] [Urban digital twin for environmentally sensitive mobility planning: conceptual framework and application in pilot region Leipzig](https://doi.org/10.1016/j.jag.2026.105477)
...
### [178] [DINO-Pheno-Cluster: Integrating few-shot foundation models and UAV time-series for spatiotemporal growth and functional characterization of alfalfa](https://doi.org/10.1016/j.jag.2026.105497)
...
### [179] [PLGF-NET: A Physics-Guided Local-Global fusion network for GNSS-R high wind speed retrieval](https://doi.org/10.1016/j.jag.2026.105493)
...
### [180] [Spatial heterogeneity of land subsidence in the california central valley: a model-based attribution perspective](https://doi.org/10.1080/15481603.2026.2706911)
...
### [181] [Dominant associations of precipitation and soil water with global vegetation reversals under climate change](https://doi.org/10.1080/15481603.2026.2702240)
...
### [182] [SWOT-derived high-resolution lake surface topography for enhanced lake water level retrieval](https://doi.org/10.1080/15481603.2026.2707798)
...
### [183] [A singularity regression kriging for spatial prediction](https://doi.org/10.1080/15481603.2026.2690341)
...
### [188] [JAXBench: Benchmarking Autonomous TPU Kernel Optimization](https://arxiv.org/abs/2607.20466)
...
### [195] [Incomplete Prompt Jailbreaks in Large Language Models](https://arxiv.org/abs/2607.20473)
...
### [200] [Beyond Liars' Bench: The Impact of Lie Typology, Depth, and Sparsity on Deception Detection in LLMs](https://arxiv.org/abs/2607.20479)
...
Abstract (英文): Multi-agent LLM frameworks typically fix their team topology at boot time. When an individual agent becomes overloaded at runtime, for example by mixing too many action categories, accumulating tool errors, or queueing behind too many calls, the system has no mechanism to restructure itself. We introduce Autonomous Topology Mutation (ATM), a runtime team-mutation mechanism for multi-agent LLM frameworks. ATM combines telemetry-driven overload detection with three safety invariants that gate each structural change: capability monotonicity, state-routing completeness, and shadow-before-live validation.
...
### [214] [Isolating LLM Alignment from Regex: Zero Coverage and Metric-Dependent Divergence Under Adversarial Mutation](https://arxiv.org/abs/2607.20494)
...
### [228] [CANN Bench: Benchmarking Agent Generated Kernels against Real NPU and Algorithmic Limits](https://arxiv.org/abs/2607.20518)
...
### [234] [PromptPack: Scaling LLM Annotation Agents for Online Recommendation](https://arxiv.org/abs/2607.20528)
...
### [236] [AppWorld-UL: Benchmarking Diverse Agent-User Interactions for Tool-Use](https://arxiv.org/abs/2607.20536)
...
### [240] [KeySI: An Interaction Framework for Tuning Text Embeddings Based on Human Feedback](https://arxiv.org/abs/2607.20556)
...
### [243] [ArbiGraph: Arbitrarily Scalable Verifiable Task Graphs for Evaluating Context Management](https://arxiv.org/abs/2607.20764)
...
### [257] [Representing Entity Importance in AI Knowledge Systems: A Dual-Signal Framework of Audience Evaluation and Structural Authority](https://arxiv.org/abs/2607.20925)
*Shen Xu*
...
### [258] [SciExplore: Evaluating Autonomous Agents from Scientific Navigation to Information Integration](https://arxiv.org/abs/2607.20926)
...
### [264] [Workflow-Localized Mechanism Learning: Attribution-Guided Repair and Knowledge Reuse for Structured Agent Skills](https://arxiv.org/abs/2607.20999)
...
### [267] [EmoAgent-R1: Towards Multimodal Emotion Understanding with Reinforcement Learning-based Dynamic Agent Specialization](https://arxiv.org/abs/2607.21013)
...
### [271] [AttriMem: Attribution-Guided Process Feedback for Agent Memory Learning](https://arxiv.org/abs/2607.21106)
...
### [277] [Identifying Good Rules for Efficient SAT Encodings of Single-Constant Multiplication Using Machine Learning](https://arxiv.org/abs/2607.21188)
...
### [301] [Same Dangerous Objective, Opposite Advice: Direct Exposure versus Multi-Agent Mediation](https://arxiv.org/abs/2607.21518)
*Linjun Li*
...
### [302] [The Boundaries of Automation: A Theory of Persistent Human Participation](https://arxiv.org/abs/2607.21547)
...
### [307] [Urban sidewalk detection via a cross-view joint segmentation method using satellite and street-view imagery](https://doi.org/10.1016/j.isprsjprs.2026.07.003)
...
### [308] [Edge-preserving and uncertainty-guided domain adaptation for weakly supervised rooftop photovoltaic mapping](https://doi.org/10.1016/j.isprsjprs.2026.07.008)
...
### [309] [SARMelt: MGLANet-driven high-resolution surface melt mapping of circum-Antarctic ice shelves from Sentinel-1 imagery during 2015–2023](https://doi.org/10.1016/j.isprsjprs.2026.07.012)
...
### [310] [Tracking forest carbon and growth in large-scale passive restoration using multi-temporal airborne lidar](https://doi.org/10.1016/j.isprsjprs.2026.07.013)
...
### [311] [Editorial Board](https://doi.org/10.1016/s0924-2716(26)00365-5)
*Unknown Author*
